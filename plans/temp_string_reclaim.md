...
- `string(number)`: das_lexical_cast_int_* x8, das_lexical_cast_fp_f/d (runtime_string.cpp:210-260)
- strip / strip_left / strip_right (:127-150 - all allocate or return null; initial
  suspicion wrong)
- chop (:206), slice x2 (:215/:224), reverse (:232)
...
- loop N x `consume(string(i))` -> string-heap flat (string_heap_bytes_allocated / temp_string_size).
