...
| 2 | Qwen3.5-0.8B-Q4_K_M (local requant, the hybrid test twin) | 0.53 | qwen35 hybrid | works | 16651 / 314.2 | 16752 / 280.0 | 0.99 / 1.12 | 8580 / 314.8 | 14760 / 280.3 |
...
| 12 | Qwen3.5-9B-IQ4_XS | 5.47 | qwen35 hybrid | works (re-measured no pin, ctx 262143) | 2700 / 62.94 | 2794 / 66.82 | 0.97 / 0.94 | 738 / 63.17 | 2199 / 66.26 |
| 13 | Qwen3.5-9B-MTP-Q5_K_M | 6.64 | qwen35 hybrid | works | 2743 / 57.29 | 2752 / 59.67 | 1.00 / 0.96 | 728 / 57.64 | 2102 / 59.41 |
| 14 | Qwen3.5-9B-MTP-UD-Q5_K_XL | 6.87 | qwen35 hybrid | works (re-measured no pin; pp at 10 reps - the 5-rep run drifted, see notes) | 2698 / 56.40 | 2783 / 58.12 | 0.97 / 0.97 | 767 / 56.72 | 2098 / 57.86 |
...
| 24 | Qwen3.6-35B-A3B-MTP-UD-Q4_K_M | 22.13 | qwen3moe hybrid | works on the per-op tier: deltanet triples of 30 layers, attention quads of 10, experts of [16..40) resident, [0..16) streamed; llama.cpp -ngl 99 OOMs, its cells = the same-split offload (experts 0-15 on the CPU; -ngl 24 in the notes) | 657.6 / 36.39 | 414.1 / 36.76 | 1.59 / 0.99 | 422.3 / 37.03 | 393.4 / 37.06 |
