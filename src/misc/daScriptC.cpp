...
DAS_APIEI uint32_t SIDEEFFECTS_none = uint32_t(SideEffects::none);
DAS_APIEI uint32_t SIDEEFFECTS_unsafe = uint32_t(SideEffects::unsafe);
DAS_APIEI uint32_t SIDEEFFECTS_userScenario = uint32_t(SideEffects::userScenario);
DAS_APIEI uint32_t SIDEEFFECTS_modifyExternal = uint32_t(SideEffects::modifyExternal);
DAS_APIEI uint32_t SIDEEFFECTS_accessExternal = uint32_t(SideEffects::accessExternal);
DAS_APIEI uint32_t SIDEEFFECTS_modifyArgument = uint32_t(SideEffects::modifyArgument);
DAS_APIEI uint32_t SIDEEFFECTS_modifyArgumentAndExternal = uint32_t(SideEffects::modifyArgumentAndExternal);
DAS_APIEI uint32_t SIDEEFFECTS_worstDefault = uint32_t(SideEffects::worstDefault);
DAS_APIEI uint32_t SIDEEFFECTS_accessGlobal = uint32_t(SideEffects::accessGlobal);
DAS_APIEI uint32_t SIDEEFFECTS_invoke =  uint32_t(SideEffects::invoke);
DAS_APIEI uint32_t SIDEEFFECTS_inferredSideEffects =  uint32_t(SideEffects::inferredSideEffects);
