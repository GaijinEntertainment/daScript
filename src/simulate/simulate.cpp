...
namespace das
{
    ...
    void Context::throw_error_at ( const LineInfo * at, DAS_FORMAT_STRING_PREFIX const char * message, ... ) DAS_FORMAT_PRINT_ATTRIBUTE(3,4) {
    ...
    void Context::throw_error_ex ( DAS_FORMAT_STRING_PREFIX const char * message, ... ) DAS_FORMAT_PRINT_ATTRIBUTE(2,3) {
        const int PRINT_BUFFER_SIZE = 8192;
        char buffer[PRINT_BUFFER_SIZE];
        va_list args;
        va_start (args, message);
