...
namespace das {
    ...
    typedef SimNode_IfZeroThenElse<int32_t> SimNode_IfZeroThenElseAny;
...
#define FUSION_OP1_SUBEXPR(CTYPE,node)      ((static_cast<SimNode_IfZeroThenElseAny *>(node))->cond)

#undef IMPLEMENT_OP1_SETUP_NODE
#define IMPLEMENT_OP1_SETUP_NODE(result,node) \
    auto rn = (SimNode_Op1If *)result; \
    auto sn = (SimNode_IfZeroThenElseAny *)node; \
