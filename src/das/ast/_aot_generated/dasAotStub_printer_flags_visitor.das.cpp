...
inline void finalize_ff7f4f06efed0617 ( Context * __context__, printer_flags_visitor::SetPrinterFlags & ____this_rename_at_15_0 );
inline void _FuncSetPrinterFlagsTickpreVisitExprBlockExpression_9ebbc33751f1ad0f ( Context * __context__, printer_flags_visitor::SetPrinterFlags & __self_rename_at_16_1, smart_ptr_raw<ExprBlock> const  __block1_rename_at_16_2, smart_ptr_raw<Expression> __expr_rename_at_16_3 );
inline void _FuncSetPrinterFlagsTickpreVisitExprNewArgument_ad2edfbd1fcea2b4 ( Context * __context__, printer_flags_visitor::SetPrinterFlags & __self_rename_at_20_4, smart_ptr_raw<ExprNew> const  __call_rename_at_20_5, smart_ptr_raw<Expression> __expr_rename_at_20_6, bool __last_rename_at_20_7 );
inline void _FuncSetPrinterFlagsTickpreVisitExprCallArgument_4323560711b1a651 ( Context * __context__, printer_flags_visitor::SetPrinterFlags & __self_rename_at_24_8, smart_ptr_raw<ExprCall> const  __casll_rename_at_24_9, smart_ptr_raw<Expression> __expr_rename_at_24_10, bool __last_rename_at_24_11 );
inline void _FuncSetPrinterFlagsTickpreVisitExprLooksLikeCallArgument_be9df749a92a7daf ( Context * __context__, printer_flags_visitor::SetPrinterFlags & __self_rename_at_28_12, smart_ptr_raw<ExprLooksLikeCall> const  __call_rename_at_28_13, smart_ptr_raw<Expression> __expr_rename_at_28_14, bool __last_rename_at_28_15 );
inline void _FuncSetPrinterFlagsTickpreVisitExprIfThenElse_bdf2d194418759c6 ( Context * __context__, printer_flags_visitor::SetPrinterFlags & __self_rename_at_32_16, smart_ptr_raw<ExprIfThenElse> __expr_rename_at_32_17 );
inline void _FuncSetPrinterFlagsTickpreVisitExprWhile_4de6639732fb77c2 ( Context * __context__, printer_flags_visitor::SetPrinterFlags & __self_rename_at_36_18, smart_ptr_raw<ExprWhile> __expr_rename_at_36_19 );
inline void _FuncSetPrinterFlagsTickpreVisitExprReturn_b178731db47c310f ( Context * __context__, printer_flags_visitor::SetPrinterFlags & __self_rename_at_40_20, smart_ptr_raw<ExprReturn> __expr_rename_at_40_21 );
inline void _FuncSetPrinterFlagsTickpreVisitExprCopy_8d293e0d4748a6f1 ( Context * __context__, printer_flags_visitor::SetPrinterFlags & __self_rename_at_46_22, smart_ptr_raw<ExprCopy> __expr_rename_at_46_23 );
inline void _FuncSetPrinterFlagsTickpreVisitExprClone_fb1fa1453431441f ( Context * __context__, printer_flags_visitor::SetPrinterFlags & __self_rename_at_52_24, smart_ptr_raw<ExprClone> __expr_rename_at_52_25 );
inline void _FuncSetPrinterFlagsTickpreVisitExprVar_a70d8bf87359b5f6 ( Context * __context__, printer_flags_visitor::SetPrinterFlags & __self_rename_at_58_26, smart_ptr_raw<ExprVar> __expr_rename_at_58_27 );
inline void _FuncSetPrinterFlagsTickpreVisitExprTypeInfo_e094c2496943b327 ( Context * __context__, printer_flags_visitor::SetPrinterFlags & __self_rename_at_62_28, smart_ptr_raw<ExprTypeInfo> __expr_rename_at_62_29 );
inline void _FuncSetPrinterFlagsTickpreVisitExprArrayComprehension_27b1d41e20d1bc40 ( Context * __context__, printer_flags_visitor::SetPrinterFlags & __self_rename_at_68_30, smart_ptr_raw<ExprArrayComprehension> __expr_rename_at_68_31 );
inline void _FuncSetPrinterFlags_0x27___finalize_84ef6c5131bc98df ( Context * __context__, printer_flags_visitor::SetPrinterFlags & __self_rename_at_15_32 );
inline void used_flags_d900633eb30e42a1 ( Context * __context__ );
inline printer_flags_visitor::SetPrinterFlags SetPrinterFlags_3df163228492380b ( Context * __context__ );
...
inline void _FuncSetPrinterFlags_0x27___finalize_84ef6c5131bc98df ( Context * __context__, printer_flags_visitor::SetPrinterFlags &  __self_rename_at_15_32 )
{
    finalize_ff7f4f06efed0617(__context__,das_arg<printer_flags_visitor::SetPrinterFlags>::pass(__self_rename_at_15_32));
}

inline void used_flags_d900633eb30e42a1 ( Context * __context__ )
{
    das_new<printer_flags_visitor::SetPrinterFlags>::make_and_init(__context__,[&]() { return SetPrinterFlags_3df163228492380b(__context__); });
...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    aotLib[0x5911a286d4e332b7] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&finalize_ff7f4f06efed0617>>();
    };
    aotLib[0x949b1706e2d2ea92] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncSetPrinterFlagsTickpreVisitExprBlockExpression_9ebbc33751f1ad0f>>();
    };
    aotLib[0x8324d8599fefe22] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncSetPrinterFlagsTickpreVisitExprNewArgument_ad2edfbd1fcea2b4>>();
    };
    aotLib[0x4abd70b26e90d7f0] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncSetPrinterFlagsTickpreVisitExprCallArgument_4323560711b1a651>>();
    };
    aotLib[0xcb4cb7c91f7cddb0] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncSetPrinterFlagsTickpreVisitExprLooksLikeCallArgument_be9df749a92a7daf>>();
    };
    aotLib[0xbaf3053c7f483938] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncSetPrinterFlagsTickpreVisitExprIfThenElse_bdf2d194418759c6>>();
    };
    aotLib[0x7a963f12767d42fc] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncSetPrinterFlagsTickpreVisitExprWhile_4de6639732fb77c2>>();
    };
    aotLib[0x9225d8a01818ec08] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncSetPrinterFlagsTickpreVisitExprReturn_b178731db47c310f>>();
    };
    aotLib[0x546463005b03f17] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncSetPrinterFlagsTickpreVisitExprCopy_8d293e0d4748a6f1>>();
    };
    aotLib[0x20aa22834ccdafc1] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncSetPrinterFlagsTickpreVisitExprClone_fb1fa1453431441f>>();
    };
    aotLib[0x7e695876e446b593] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncSetPrinterFlagsTickpreVisitExprVar_a70d8bf87359b5f6>>();
    };
    aotLib[0x6fa9fa8bef83c8f7] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncSetPrinterFlagsTickpreVisitExprTypeInfo_e094c2496943b327>>();
    };
    aotLib[0xbbe63231cf695fc0] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncSetPrinterFlagsTickpreVisitExprArrayComprehension_27b1d41e20d1bc40>>();
    };
    aotLib[0x2eb3894dec6b92b6] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncSetPrinterFlags_0x27___finalize_84ef6c5131bc98df>>();
    };
    aotLib[0x7e7f14b7a1e07acf] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&used_flags_d900633eb30e42a1>>();
    };
    aotLib[0x40e4d7c8715a054b] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_AotCMRES<&SetPrinterFlags_3df163228492380b>>();
    };
