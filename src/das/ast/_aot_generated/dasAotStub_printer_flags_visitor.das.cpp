...
inline void finalize_da593eb12fcc0553 ( Context * __context__, printer_flags_visitor::SetPrinterFlags & ____this_rename_at_15_0 );
inline void _FuncSetPrinterFlagsTickpreVisitExprBlockExpression_2c5e9676145ea353 ( Context * __context__, printer_flags_visitor::SetPrinterFlags & __self_rename_at_16_1, smart_ptr_raw<ExprBlock> const  __block1_rename_at_16_2, smart_ptr_raw<Expression> __expr_rename_at_16_3 );
inline void _FuncSetPrinterFlagsTickpreVisitExprNewArgument_ccff22e54404a902 ( Context * __context__, printer_flags_visitor::SetPrinterFlags & __self_rename_at_20_4, smart_ptr_raw<ExprNew> const  __call_rename_at_20_5, smart_ptr_raw<Expression> __expr_rename_at_20_6, bool __last_rename_at_20_7 );
inline void _FuncSetPrinterFlagsTickpreVisitExprCallArgument_99beec5bd29f63b ( Context * __context__, printer_flags_visitor::SetPrinterFlags & __self_rename_at_24_8, smart_ptr_raw<ExprCall> const  __casll_rename_at_24_9, smart_ptr_raw<Expression> __expr_rename_at_24_10, bool __last_rename_at_24_11 );
inline void _FuncSetPrinterFlagsTickpreVisitExprLooksLikeCallArgument_c7916ed7599ecbae ( Context * __context__, printer_flags_visitor::SetPrinterFlags & __self_rename_at_28_12, smart_ptr_raw<ExprLooksLikeCall> const  __call_rename_at_28_13, smart_ptr_raw<Expression> __expr_rename_at_28_14, bool __last_rename_at_28_15 );
inline void _FuncSetPrinterFlagsTickpreVisitExprIfThenElse_d51e850b5c589722 ( Context * __context__, printer_flags_visitor::SetPrinterFlags & __self_rename_at_32_16, smart_ptr_raw<ExprIfThenElse> __expr_rename_at_32_17 );
inline void _FuncSetPrinterFlagsTickpreVisitExprWhile_be8569e3e9398141 ( Context * __context__, printer_flags_visitor::SetPrinterFlags & __self_rename_at_36_18, smart_ptr_raw<ExprWhile> __expr_rename_at_36_19 );
inline void _FuncSetPrinterFlagsTickpreVisitExprReturn_1a23d320eef01da4 ( Context * __context__, printer_flags_visitor::SetPrinterFlags & __self_rename_at_40_20, smart_ptr_raw<ExprReturn> __expr_rename_at_40_21 );
inline void _FuncSetPrinterFlagsTickpreVisitExprCopy_e48af10ed001be6f ( Context * __context__, printer_flags_visitor::SetPrinterFlags & __self_rename_at_46_22, smart_ptr_raw<ExprCopy> __expr_rename_at_46_23 );
inline void _FuncSetPrinterFlagsTickpreVisitExprClone_ecf014da5dff05a1 ( Context * __context__, printer_flags_visitor::SetPrinterFlags & __self_rename_at_52_24, smart_ptr_raw<ExprClone> __expr_rename_at_52_25 );
inline void _FuncSetPrinterFlagsTickpreVisitExprVar_4e9c380d8f4277e9 ( Context * __context__, printer_flags_visitor::SetPrinterFlags & __self_rename_at_58_26, smart_ptr_raw<ExprVar> __expr_rename_at_58_27 );
inline void _FuncSetPrinterFlagsTickpreVisitExprTypeInfo_64c4d7e699419029 ( Context * __context__, printer_flags_visitor::SetPrinterFlags & __self_rename_at_62_28, smart_ptr_raw<ExprTypeInfo> __expr_rename_at_62_29 );
inline void _FuncSetPrinterFlagsTickpreVisitExprArrayComprehension_d91b7feb308a7569 ( Context * __context__, printer_flags_visitor::SetPrinterFlags & __self_rename_at_68_30, smart_ptr_raw<ExprArrayComprehension> __expr_rename_at_68_31 );
inline void _FuncSetPrinterFlags_0x27___finalize_4435075f1d77f256 ( Context * __context__, printer_flags_visitor::SetPrinterFlags & __self_rename_at_15_32 );
inline void used_flags_8916541c8b1939bf ( Context * __context__ );
inline printer_flags_visitor::SetPrinterFlags SetPrinterFlags_e805b2cde394f0b6 ( Context * __context__ );
...
inline void _FuncSetPrinterFlags_0x27___finalize_4435075f1d77f256 ( Context * __context__, printer_flags_visitor::SetPrinterFlags &  __self_rename_at_15_32 )
{
    finalize_da593eb12fcc0553(__context__,das_arg<printer_flags_visitor::SetPrinterFlags>::pass(__self_rename_at_15_32));
}

inline void used_flags_8916541c8b1939bf ( Context * __context__ )
{
    das_new<printer_flags_visitor::SetPrinterFlags>::make_and_init(__context__,[&]() { return SetPrinterFlags_e805b2cde394f0b6(__context__); });
...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    aotLib[0xa5997eaee2632ece] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&finalize_da593eb12fcc0553>>();
    };
    aotLib[0x1961e3f01f7dca05] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncSetPrinterFlagsTickpreVisitExprBlockExpression_2c5e9676145ea353>>();
    };
    aotLib[0x928ce6dbd0e1e02d] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncSetPrinterFlagsTickpreVisitExprNewArgument_ccff22e54404a902>>();
    };
    aotLib[0x28332d34f662f0b0] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncSetPrinterFlagsTickpreVisitExprCallArgument_99beec5bd29f63b>>();
    };
    aotLib[0xa2bff6ec1c8942a6] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncSetPrinterFlagsTickpreVisitExprLooksLikeCallArgument_c7916ed7599ecbae>>();
    };
    aotLib[0x475085881372efdc] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncSetPrinterFlagsTickpreVisitExprIfThenElse_d51e850b5c589722>>();
    };
    aotLib[0xd238fc1be08cfacd] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncSetPrinterFlagsTickpreVisitExprWhile_be8569e3e9398141>>();
    };
    aotLib[0xc22d37c1ed528b4b] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncSetPrinterFlagsTickpreVisitExprReturn_1a23d320eef01da4>>();
    };
    aotLib[0x6641dec8ea1b067] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncSetPrinterFlagsTickpreVisitExprCopy_e48af10ed001be6f>>();
    };
    aotLib[0x90e438027c8c7d7b] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncSetPrinterFlagsTickpreVisitExprClone_ecf014da5dff05a1>>();
    };
    aotLib[0xf523d15d31fd2221] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncSetPrinterFlagsTickpreVisitExprVar_4e9c380d8f4277e9>>();
    };
    aotLib[0x9b0bcef752f2466] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncSetPrinterFlagsTickpreVisitExprTypeInfo_64c4d7e699419029>>();
    };
    aotLib[0xd8912aef5bedaff7] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncSetPrinterFlagsTickpreVisitExprArrayComprehension_d91b7feb308a7569>>();
    };
    aotLib[0xc7d438d3f41ef28e] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncSetPrinterFlags_0x27___finalize_4435075f1d77f256>>();
    };
    aotLib[0x7301f035e111df33] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&used_flags_8916541c8b1939bf>>();
    };
    aotLib[0xc4a2876ec137040] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_AotCMRES<&SetPrinterFlags_e805b2cde394f0b6>>();
    };
