...
namespace das {
    ...
    StructInfo * DebugInfoHelper::makeStructureDebugInfo ( const Structure & st ) {
        ...
        auto cppName = describeCppType(&tdecl, CpptSubstitureRef::no,CpptSkipRef::yes, CpptSkipConst::yes);
    ...
    TypeInfo * DebugInfoHelper::makeTypeInfo ( TypeInfo * info, const TypeDeclPtr & type ) {
        ...
        auto cppName = describeCppType(type, CpptSubstitureRef::no,CpptSkipRef::yes, CpptSkipConst::yes);
