...
# define DAS_YYTOKENTYPE
  enum das_yytokentype
  {
    ...
    BRACBRB = 403,                 /* "[{"  */
    CBRCBRB = 404,                 /* "{{"  */
    INTEGER = 405,                 /* "integer constant"  */
    LONG_INTEGER = 406,            /* "long integer constant"  */
    UNSIGNED_INTEGER = 407,        /* "unsigned integer constant"  */
    UNSIGNED_LONG_INTEGER = 408,   /* "unsigned long integer constant"  */
    FLOAT = 409,                   /* "floating point constant"  */
    DOUBLE = 410,                  /* "double constant"  */
    NAME = 411,                    /* "name"  */
    BEGIN_STRING = 412,            /* "start of the string"  */
    STRING_CHARACTER = 413,        /* STRING_CHARACTER  */
    STRING_CHARACTER_ESC = 414,    /* STRING_CHARACTER_ESC  */
    END_STRING = 415,              /* "end of the string"  */
    BEGIN_STRING_EXPR = 416,       /* "{"  */
    END_STRING_EXPR = 417,         /* "}"  */
    END_OF_READ = 418,             /* "end of failed eader macro"  */
    UNARY_MINUS = 419,             /* UNARY_MINUS  */
    UNARY_PLUS = 420,              /* UNARY_PLUS  */
    PRE_INC = 421,                 /* PRE_INC  */
    PRE_DEC = 422,                 /* PRE_DEC  */
    POST_INC = 423,                /* POST_INC  */
    POST_DEC = 424,                /* POST_DEC  */
    DEREF = 425                    /* DEREF  */
  };
