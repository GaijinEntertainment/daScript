...
void SimNode_CallBase::visitCall(SimVisitor &) {
...
// ---- PassVisitor ----
void PassVisitor::preVisitProgram(Program *) {}
void PassVisitor::visitProgram(Program *) {}
void PassVisitor::reportFolding() {}
void PassVisitor::preVisit(Function *) {}
FunctionPtr PassVisitor::visit(Function * fn) { return fn; }

// ---- Program stubs ----
bool Program::optimizationRefFolding(int32_t) { return false; }
bool Program::optimizationConstFolding(int32_t) { return false; }
bool Program::optimizationBlockFolding(int32_t) { return false; }
bool Program::optimizationCondFolding(int32_t) { return false; }
bool Program::optimizationUnused(TextWriter &, int32_t) { return false; }
bool Program::simulate(Context &, TextWriter &, StackAllocator *) { return false; }
void Program::checkSideEffects() {}
void Program::makeMacroModule(TextWriter &) {}

// ---- ExprInvoke ----
bool ExprInvoke::isCopyOrMove() const { return false; }

// ---- Function::makeSimNode ----
SimNode * Function::makeSimNode(Context &, const vector<ExpressionPtr> &) {
...
// ---- getSemanticHash ----
uint64_t getSemanticHash(SimNode *, Context *) { return 0; }

// ---- describeCppType ----
string describeCppType(const smart_ptr_raw<TypeDecl> &, CpptSubstitureRef, CpptSkipRef, CpptSkipConst, CpptRedundantConst, ChooseSmartPtr) { return ""; }

// ---- compileDaScript / parseDaScript ----
ProgramPtr compileDaScript(const string &, const smart_ptr<FileAccess> &, TextWriter &, ModuleGroup &, CodeOfPolicies) { return nullptr; }
ProgramPtr parseDaScript(const string &, const string &, const smart_ptr<FileAccess> &, TextWriter &, ModuleGroup &, bool, bool, CodeOfPolicies) { return nullptr; }

// ---- ExprRef2Value::GetR2V ----
SimNode * ExprRef2Value::GetR2V ( Context &, const LineInfo &, const TypeDeclPtr &, SimNode * ) {
    DAS_FATAL_ERROR("ExprRef2Value::GetR2V called on stub");
    return nullptr;
}

// ---- SimFunction::getLineInfo ----
const LineInfo * SimFunction::getLineInfo() const {
