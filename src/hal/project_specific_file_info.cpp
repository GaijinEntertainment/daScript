...
DAS_RT_API smart_ptr<das::FileAccess> get_file_access( char * pak ) {
...
DAS_RT_API Context * get_context( int stackSize ) {
...
DAS_RT_API Context * get_clone_context( Context * ctx, uint32_t category ) {
