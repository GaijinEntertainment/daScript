...
IMPLEMENT_EXTERNAL_TYPE_FACTORY(FileAccess,das::FileAccess)
...
// debugInfoHelper
    ...
    // Logic-op function annotations (!, &&, ||, ^^). Parser builds these to
    // combine [annotation] expressions on functions; pure compile-time.
