...
#define MATH_FUN_OP2A(fun)                              \
    ...
    public:
        Module_Math() : Module("math") {
            ...
            addExternEx<float2(float2),DAS_BIND_FUN(normalize2)>(*this, lib, "safe_normalize", SideEffects::none, "safe_normalize2");
            addExternEx<float3(float3),DAS_BIND_FUN(normalize3)>(*this, lib, "safe_normalize", SideEffects::none, "safe_normalize3");
            addExternEx<float4(float4),DAS_BIND_FUN(normalize4)>(*this, lib, "safe_normalize", SideEffects::none, "safe_normalize4");
