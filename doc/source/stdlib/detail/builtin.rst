...
.. |structure_macro-builtin-no_default_initializer| replace:: [no_default_initializer] specifies that structure will not have default initializer generated by the compiler.
...
.. |function_annotation-builtin-unsafe_when_not_clone_array| replace:: Marks function as unsafe to be called outside of the `clone` of the array.
...
.. |function_annotation-builtin-expect_ref| replace:: A contract to mark function argument to be a reference.
...
.. |function-builtin-set_aot| replace:: Notifies compiler that AOT is being generated.

.. |function-builtin-reset_aot| replace:: Notifies compiler that AOT is no longer being generated.

.. |function-builtin-compiling_file_name| replace:: returns name of the file currently being compiled.

.. |function-builtin-compiling_module_name| replace:: returns name of the module currently being compiled.

.. |function-builtin-__bit_set| replace:: Sets the specified bit in the bitfield.

.. |function-builtin-insert_clone| replace:: inserts cloned key into the table

.. |function-builtin-emplace_new| replace:: constructs a new element in-place in the table, set, or array

.. |function-builtin-insert_default| replace:: inserts key into the table or set, if it doesn't already exist

.. |function-builtin-emplace_default| replace:: constructs a new default element in-place in the table, set, or array, if it doesn't already exist

.. |function-builtin-get_with_default| replace:: gets the value from the table, add it with a default value if it does not exist. Callback is invoked with the value.

.. |function-builtin-modify| replace:: modifies the value in the table, if it exists. Callback is invoked with the value.

.. |function-builtin-get_value| replace:: gets the value from the table.
