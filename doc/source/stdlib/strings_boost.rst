...
++++++++++++++
  ...
  *  :ref:`join (iterable:auto(TT) const[-1];separator:string const;blk:block\<(var writer:strings::StringBuilderWriter -const;elem:TT const):void\> const) : string <function-_at_strings_boost_c__c_join_C[-1]Y_ls_TT_gr_._Cs_CN_ls_writer;elem_gr_0_ls_H_ls_strings_c__c_StringBuilderWriter_gr_;CY_ls_TT_gr_L_gr_1_ls_v_gr__builtin_>` 
...
.. das:function:: join(iterable: auto(TT) const[-1]; separator: string const; blk: block<(var writer:strings::StringBuilderWriter -const;elem:TT const):void> const)
