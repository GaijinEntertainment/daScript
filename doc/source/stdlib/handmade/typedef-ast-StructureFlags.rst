...
C++ data layout.
C++ layout not POD type, i.e. has alignment to accommodate for inheritance.
This structure is compiler-generated.
This structure is using persistent heap (C++ heap).
This structure is a lambda.
...
This structure has initialized fields.
