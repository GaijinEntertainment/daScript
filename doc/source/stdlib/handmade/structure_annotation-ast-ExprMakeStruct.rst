...
Array of structures being made
Optional block expression to run after the struct is made
Constructor function to call, if any
Flags specific to make-struct expressions
