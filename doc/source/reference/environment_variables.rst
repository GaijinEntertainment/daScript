...
.. This page has NO content of its own. The single source is the markdown skill
   skills/environment_variables.md, which is repo-side only (deliberately NOT in
   install/skills.list -- it documents the repo's C++ env_cfg accessors), so this
   page is how the variable list reaches users. Edit the .md.
...
.. include:: ../../../skills/environment_variables.md
