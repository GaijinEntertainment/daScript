...
coding assistants, the cross-file duplicate-function detector and its
AI judge, the runtime profiler and memory-leak tracker, and a cheat
sheet for every built-in leak-detection mechanism.
