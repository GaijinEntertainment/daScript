...
.. seealso::
   ...
   Full source: :download:`modules/dasImgui/examples/tutorial/input_text.das <../../../../../modules/dasImgui/examples/tutorial/input_text.das>`

   Features-side demos: ``modules/dasImgui/examples/features/inputs_text.das`` (all five
   non-filter forms) and ``modules/dasImgui/examples/features/input_text_callback.das``
