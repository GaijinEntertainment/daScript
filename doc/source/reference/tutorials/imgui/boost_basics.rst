...
Source: ``modules/dasImgui/examples/tutorial/boost_basics.das``.
...
.. seealso::
   ...
   Full source: :download:`modules/dasImgui/examples/tutorial/boost_basics.das <../../../../../modules/dasImgui/examples/tutorial/boost_basics.das>`

   Richer reference: ``modules/dasImgui/examples/tutorial/visual_aids_tour.das`` — keeper
