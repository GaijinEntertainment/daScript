...
.. seealso::
   ...
   Full source: :download:`modules/dasImgui/examples/tutorial/plot.das <../../../../../modules/dasImgui/examples/tutorial/plot.das>`

   Features-side demos: ``modules/dasImgui/examples/features/plot_widgets.das``
   (array form), ``modules/dasImgui/examples/features/plot_getter.das`` (lambda form).
