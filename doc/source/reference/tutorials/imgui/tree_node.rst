...
* ``tree_node_ex(IDENT, (...))`` — ``[widget]`` leaf. Returns a bool;
  ...
  see ``modules/dasImgui/examples/features/tree_node_ex.das`` for the rail-side demo and
  ``modules/dasImgui/examples/features/tree_node_open_manual.das`` for the sibling
  same_line pattern.
...
.. seealso::
   ...
   Full source: :download:`modules/dasImgui/examples/tutorial/tree_node.das <../../../../../modules/dasImgui/examples/tutorial/tree_node.das>`
