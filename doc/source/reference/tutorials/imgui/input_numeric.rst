...
.. seealso::
   ...
   Full source: :download:`modules/dasImgui/examples/tutorial/input_numeric.das <../../../../../modules/dasImgui/examples/tutorial/input_numeric.das>`

   Features-side demo: ``modules/dasImgui/examples/features/inputs_numeric.das`` — every
