...
.. seealso::
   ...
   Full source: :download:`modules/dasImgui/examples/tutorial/widgets_tour.das <../../../../../modules/dasImgui/examples/tutorial/widgets_tour.das>`

   Richer reference: ``modules/dasImgui/examples/features/inputs_*.das`` — every widget with
