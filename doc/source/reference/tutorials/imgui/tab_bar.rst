...
.. seealso::
   ...
   Full source: :download:`modules/dasImgui/examples/tutorial/tab_bar.das <../../../../../modules/dasImgui/examples/tutorial/tab_bar.das>`

   Features-side demos: ``modules/dasImgui/examples/features/containers_layout.das`` —
   tab_bar + tree_node + collapsing_header composition;
   ``modules/dasImgui/examples/features/tab_item_button.das`` — the ``tab_item_button``
