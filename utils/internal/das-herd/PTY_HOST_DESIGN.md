...
- Watcher and rich client are STOPPED (Boris's go). Release bundle at
  ...
  --root utils/internal/das-herd/ptyhost`, 7s).
...
`daslang.exe utils/internal/das-herd/ptyhost/main.das -- --session <id> --listen <ep>
...
- `.das_package` under `utils/internal/das-herd/ptyhost/` declares `release_main`,
