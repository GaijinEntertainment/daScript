...
```powershell
powershell.exe -NoProfile -File <origin>/utils/internal/das-herd/dasherd.ps1 whoami
```
...
```powershell
powershell.exe -NoProfile -File <origin>/utils/internal/das-herd/dasherd.ps1 bundle sync `
  --manifest path/to/bundle.json
powershell.exe -NoProfile -File <origin>/utils/internal/das-herd/dasherd.ps1 bundle list
```
...
```powershell
powershell.exe -NoProfile -File <origin>/utils/internal/das-herd/dasherd.ps1 repository list
powershell.exe -NoProfile -File <origin>/utils/internal/das-herd/dasherd.ps1 repository add --path D:/Work/dasVulkan
```
...
```powershell
powershell.exe -NoProfile -File <origin>/utils/internal/das-herd/dasherd.ps1 inbox list
powershell.exe -NoProfile -File <origin>/utils/internal/das-herd/dasherd.ps1 inbox get hf_42
powershell.exe -NoProfile -File <origin>/utils/internal/das-herd/dasherd.ps1 inbox ack hf_42
powershell.exe -NoProfile -File <origin>/utils/internal/das-herd/dasherd.ps1 inbox complete hf_42
```
