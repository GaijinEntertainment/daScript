...
`utils/internal/das-herd/dasherd.ps1` implements `whoami`, Inbox list/get/ack/complete,
...
available for diagnostics. `utils/internal/das-herd/dasherder.md` is the agent-facing
