...
TARGETS=(daslang test_aot_bench test_llvm_aot dasModuleSQLITE dasModulePUGIXML dasModuleAudio dasModuleMinfft dasModuleTerminal dasModuleUnitTest dasModuleLLVM)
