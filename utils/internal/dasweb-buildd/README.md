...
```bash
podman build -t dasweb-builder:2 -f utils/internal/dasweb-buildd/Containerfile .
```
...
```bash
daslang dastest/dastest.das -- --test utils/internal/dasweb-buildd/test_buildd_core.das
```
