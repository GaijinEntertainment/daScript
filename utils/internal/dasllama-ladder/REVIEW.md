...
passes `validate_record_submission`, and every official record store passes
`validate_record_store` (shape only - official records predate the `dasllama_version` stamp).**
