...
```
daslang utils/internal/dasweb-verify/main.das
```
...
```
daslang dastest/dastest.das -- --test utils/internal/dasweb-verify/test_verify_core.das
```
...
```
cd utils/internal/dasweb-verify/browser
