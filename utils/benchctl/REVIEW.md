...
**Never add a run-record field without saying in `utils/internal/bench-stand/README.md` section 2
what reads it - the viewer, or a person opening the record.** A field nobody named is one nobody
notices going wrong.
