...
foreach ($f in @("main.das","openai_server.das","model_catalog.das","serving_knobs.das","cli.das","cli_args.das","cli_repl.das","control.html","watchdog.json","tray.ico",".das_package")) {
