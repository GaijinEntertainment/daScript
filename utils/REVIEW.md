...
**A file belonging to a tool — any direct child directory of `utils/` or `utils/internal/` —
answers to that tool's own `REVIEW.md` too when it carries one**, wherever the diff puts the file.
