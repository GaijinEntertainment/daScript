...
| `skills/dupe_audit.md` | Auditing a diff or a file set for duplicated or parameterizable code - the one-implementation rule; before claiming a helper is new; before opening EVERY big PR (the `check_duplicates` target) |
