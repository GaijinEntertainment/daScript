...
(2x-wide Q, partial NEOX rope 64/256, sigma out-gate); the 35B adds grouped MoE routing + the
sigmoid-gated shared expert + f32-on-disk beta/alpha. Metal vs Metal, the 3B methodology
...
the whole-graph 35B (deltanet scan + routed experts + shexp + f32 beta/alpha slabs all
