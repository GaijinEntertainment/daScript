...
- 2026-09-02 `modules/dasLLAMA/mtp_plan.md` -> `history/dasLLAMA/mtp_plan.md` - the MTP depth-N arc's plan and measurement log (S0-S7: the NextN round, the batched same-slab verify, the gemma assistant drafter, the k4 two-row tile and pair walk, the ruler); shipped with the arc, its open items live in `followup_general.md` #70-#86
