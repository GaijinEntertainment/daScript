...
optimize-on, scales with width x live-range).
...
- Width padding: 9 cells -> 2xfloat4 + 1, or 3xfloat3 - which wastes fewer lanes/nodes.
...
- [x] **Phase 2 - general SLP: evaluated, NOT pursued.** Corpus survey showed Phase 1 already
  ...
  Full reasoning in `FINDINGS.md` sec. "Phase 2 (general SLP) - evaluated, not pursued".
