...
The section a cited function answers for.

## Buffers {#buffers}

The second section, so one function can be shown citing two.

## Token {#token}

The section a cited structure answers for.

## Lexer {#lexer}

The section a cited class answers for.
