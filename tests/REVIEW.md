...
`*_words` function that compiles a shader and returns its emitted words - or a change to
`spirv/test_census.das` to `spirv/REVIEW.md`; a test that calls `tick_debug_agent` to
`debug_agent/REVIEW.md`.
