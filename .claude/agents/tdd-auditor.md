...
- A rejection branch's instrument is a reliably-failing fixture (a `failed_*`/`cant_*`
  file, an `expect error[NNNNN]` directive, a must-panic case) — its control is inverted:
