...
extern DAS_THREAD_LOCAL2(das::vector<das::float3>, 0x01c67c0a)   g_pos;
extern DAS_THREAD_LOCAL2(das::vector<das::float3>, 0x72ace5c7)   g_vel;
extern DAS_THREAD_LOCAL2(das::vector<das::float3 *>, 0xf81c229b) g_velBoxed;
extern DAS_THREAD_LOCAL2(das::vector<EsComponent>, 0xc19bf781)   g_components;
