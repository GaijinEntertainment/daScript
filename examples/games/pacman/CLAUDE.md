...
| Pellet | 10 |
| Power pill | 50 |
| Ghost (combo x1-4) | 200 / 400 / 800 / 1600 |
| Cherry | 100 |
| Strawberry | 300 |
...
- **Maze**: 21x23 cell grid - `0`=open, `1`=wall, `2`=pellet, `3`=power pill, `4`=ghost house interior, `5`=ghost house door; tunnel wrap handled via column boundary logic (no special cell type)
