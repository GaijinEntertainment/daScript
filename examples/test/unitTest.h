...
uint64_t CheckEid ( TestObjectFoo & foo, char * const name, das::Context * context );
uint64_t CheckEidHint ( TestObjectFoo & foo, char * const name, uint64_t hashHint, das::Context * context );
