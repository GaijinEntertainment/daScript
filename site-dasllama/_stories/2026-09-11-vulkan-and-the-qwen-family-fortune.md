...
<!-- figures: every first-card row is pp512 / tg128 tokens per second on Boris's RTX 5060 Ti 16 GB (Windows
     ...
     (das 245481f64, the merge of PR #3954); the KHR figures (the
     ...
     -ngl 99 fails the load). The 3060 -> 5060 Ti beat is Boris's, July 2026. Stas's report: PR #3988's branch (debug-jit, the x86-vnni512 class profile, no box
     ...
     the `[vk_dispatch]` classes, and those of them whose base is a `...T` template. The first tile's "half
     the speed" is Qwen3-4B Q4_K_M pp512 on the 5060 Ti under DASLLAMA_COOPMAT=mm, 2026-09-07: 752 against
     the integer tile's 1564, the arc's board rows before and at the first tile (the 3051 -> 4764 chain follows). -->

Boris had an RTX 3060 in July, and things were working so well. Then he got an RTX 5060 Ti,
