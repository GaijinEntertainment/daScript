...
ships as a 32 MB `.dlim` beside a 65 MB [Kyutai Pocket TTS](https://github.com/kyutai-labs/pocket-tts) file with one voice inside and no phoneme
packs; you type the words, Enter tells the story, Tab asks for dialogue. The model, the training recipe and the hit-rate numbers are on
