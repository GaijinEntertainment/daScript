...
inline StructInfo const  * _FuncrttiTickclass_infoTick15801393167907430156_d12f79df67b2fc1e ( Context * __context__, type_traits::TypeInfoGetFieldsNum const  & __cl_rename_at_116_2 );
...
inline StructInfo const  * _FuncrttiTickclass_infoTick15801393167907430156_cac2c6a419cf171e ( Context * __context__, type_traits::IsSubclassOf const  & __cl_rename_at_116_6 );
inline Program * _FuncbuiltinTickget_ptrTick5807679485210906136_8bde9cd3c6801837 ( Context * __context__, smart_ptr_raw<Program> __src_rename_at_1732_7 );
...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    aotLib[0xf0e3fd00abc15718] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTickpushTick10769833213962245646_e98940bd647b096c
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, TArray<ast::AstTypeInfoMacro *> & , ast::AstTypeInfoMacro *  ),&_FuncbuiltinTickpushTick10769833213962245646_e98940bd647b096c>>();
    };
    aotLib[0x6b0765f575e4a10b] = +[](Context & ctx) -> SimNode* { // _FuncrttiTickclass_infoTick15801393167907430156_d12f79df67b2fc1e
        return ctx.code->makeNode<SimNode_Aot<StructInfo const  * (*) ( Context * __context__, type_traits::TypeInfoGetFieldsNum const  &  ),&_FuncrttiTickclass_infoTick15801393167907430156_d12f79df67b2fc1e>>();
    };
    aotLib[0x43593cf229002796] = +[](Context & ctx) -> SimNode* { // _FuncrttiTickclass_infoTick15801393167907430156_9a401643351dc149
        return ctx.code->makeNode<SimNode_Aot<StructInfo const  * (*) ( Context * __context__, type_traits::TypeInfoHasProperty const  &  ),&_FuncrttiTickclass_infoTick15801393167907430156_9a401643351dc149>>();
    };
    ...
    aotLib[0x76db3df7dd1a6b4c] = +[](Context & ctx) -> SimNode* { // _FuncrttiTickclass_infoTick15801393167907430156_cac2c6a419cf171e
        return ctx.code->makeNode<SimNode_Aot<StructInfo const  * (*) ( Context * __context__, type_traits::IsSubclassOf const  &  ),&_FuncrttiTickclass_infoTick15801393167907430156_cac2c6a419cf171e>>();
    };
    aotLib[0xa241ae4c7a78ed20] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTickget_ptrTick5807679485210906136_8bde9cd3c6801837
        return ctx.code->makeNode<SimNode_Aot<Program * (*) ( Context * __context__, smart_ptr_raw<Program>  ),&_FuncbuiltinTickget_ptrTick5807679485210906136_8bde9cd3c6801837>>();
    };
