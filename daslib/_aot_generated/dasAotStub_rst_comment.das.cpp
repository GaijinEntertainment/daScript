...
inline smart_ptr_raw<CommentReader> _FuncastTickmake_comment_readerTick2128729122050972798_c601789b0f6f6081 ( Context * __context__, char * const  __name_rename_at_709_13, rst_comment::RstComment * __someClassPtr_rename_at_709_14 );
...
inline void _FuncastTickadd_new_comment_readerTick9279614113534996372_7ca33631a1409093 ( Context * __context__, char * const  __name_rename_at_895_28, rst_comment::RstComment * __someClassPtr_rename_at_895_29 );
...
inline smart_ptr_raw<CommentReader> _FuncastTickmake_comment_readerTick2128729122050972798_c601789b0f6f6081 ( Context * __context__, char * const  __name_rename_at_709_13, rst_comment::RstComment * __someClassPtr_rename_at_709_14 )
{
    _FuncbuiltinTickpushTick10769833213962245646_83228c404c1c5840(__context__,das_arg<TArray<ast::AstCommentReader *>>::pass(das_global<TArray<ast::AstCommentReader *>,0xd806bcc7af45ea49>(__context__) /*gc_root_AstCommentReader*/),das_reinterpret<ast::AstCommentReader *>::pass(__someClassPtr_rename_at_709_14));
    StructInfo const  * __classInfo_rename_at_712_15 = ((StructInfo const  *)_FuncrttiTickclass_infoTick15801393167907430156_68ef95a75daadc0f(__context__,das_arg<rst_comment::RstComment>::pass(das_deref(__context__,__someClassPtr_rename_at_709_14))));
    return /* <- */ das_auto_cast_move<smart_ptr_raw<CommentReader>>::cast(makeCommentReader(das_auto_cast<void * const >::cast(__someClassPtr_rename_at_709_14),__classInfo_rename_at_712_15,__context__));
}
...
inline char * _FuncrstTickfunction_file_nameTick11623859247758201540_65bb98f9eb4f2359 ( Context * __context__, smart_ptr_raw<Function> const  __value_rename_at_69_22 )
{
    ...
    das_copy(__mn_rename_at_71_23,das_invoke_function<char * const >::invoke<char * const ,TArray<AutoTuple<char *,char *>> const  &>(__context__,nullptr,Func(__context__->fnByMangledName(/*@strings_boost::replace_multiple Cs C1<N<text;replacement>0<s;s>U>A*/ 5840488413950466740u)),__mn_rename_at_71_23,das_arg<TArray<AutoTuple<char *,char *>>>::pass((_temp_make_local_72_32_48 = (_FuncbuiltinTickto_array_moveTick3185538323411982277_8551a3ae50f28771(__context__,das_arg<TDim<AutoTuple<char *,char *>,1>>::pass((([&]() -> TDim<AutoTuple<char *,char *>,1>& {
...
inline void _FuncastTickadd_new_comment_readerTick9279614113534996372_7ca33631a1409093 ( Context * __context__, char * const  __name_rename_at_895_28, rst_comment::RstComment * __someClassPtr_rename_at_895_29 )
{
    smart_ptr_raw<CommentReader> __ann_rename_at_896_30; memset(&__ann_rename_at_896_30,0,sizeof(__ann_rename_at_896_30));
    /* finally */ auto __finally_895= das_finally([&](){
    das_delete_handle<smart_ptr_raw<CommentReader>>::clear(__context__,__ann_rename_at_896_30);
    /* end finally */ });
    __ann_rename_at_896_30; das_zero(__ann_rename_at_896_30); das_move(__ann_rename_at_896_30, _FuncastTickmake_comment_readerTick2128729122050972798_c601789b0f6f6081(__context__,__name_rename_at_895_28,__someClassPtr_rename_at_895_29));
    addModuleCommentReader(thisModule(__context__,((LineInfoArg *)(&LineInfo::g_LineInfoNULL))),__ann_rename_at_896_30,__context__,((LineInfoArg *)(&LineInfo::g_LineInfoNULL)));
}
...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    ...
    aotLib[0xbb9cd50941a71ce6] = +[](Context & ctx) -> SimNode* { // finalize_47949244503253d8
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, AutoTuple<char *,char *,char *> &  ),&finalize_47949244503253d8>>();
    };
    ...
    aotLib[0x5efc799ca5255cf8] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTickpushTick10769833213962245646_83228c404c1c5840
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, TArray<ast::AstCommentReader *> & , ast::AstCommentReader *  ),&_FuncbuiltinTickpushTick10769833213962245646_83228c404c1c5840>>();
    };
    aotLib[0xb91dc9118b1b94ad] = +[](Context & ctx) -> SimNode* { // _FuncrttiTickclass_infoTick15801393167907430156_68ef95a75daadc0f
        return ctx.code->makeNode<SimNode_Aot<StructInfo const  * (*) ( Context * __context__, rst_comment::RstComment const  &  ),&_FuncrttiTickclass_infoTick15801393167907430156_68ef95a75daadc0f>>();
    };
    aotLib[0xc886291e17d1acd4] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTickto_array_moveTick3185538323411982277_8551a3ae50f28771
        return ctx.code->makeNode<SimNode_AotCMRES<TArray<AutoTuple<char *,char *>> (*) ( Context * __context__, TDim<AutoTuple<char *,char *>,1> &  ),&_FuncbuiltinTickto_array_moveTick3185538323411982277_8551a3ae50f28771>>();
    };
    ...
    aotLib[0xa38e1903eccf01d8] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTickfinalizeTick13836114024949725080_9f4e5aa8ea20038d
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, TArray<AutoTuple<char *,char *,char *>> &  ),&_FuncbuiltinTickfinalizeTick13836114024949725080_9f4e5aa8ea20038d>>();
    };
    aotLib[0xd1c13704b2e23709] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTick_return_with_lockcheckTick2939372000839727345_8b6108add31580fc
        return ctx.code->makeNode<SimNode_Aot<rst_comment::RstComment & (*) ( Context * __context__, rst_comment::RstComment &  ),&_FuncbuiltinTick_return_with_lockcheckTick2939372000839727345_8b6108add31580fc>>();
    };
    aotLib[0x1b7b9a15993ea7d8] = +[](Context & ctx) -> SimNode* { // _FuncastTickmake_comment_readerTick2128729122050972798_c601789b0f6f6081
        return ctx.code->makeNode<SimNode_Aot<smart_ptr_raw<CommentReader> (*) ( Context * __context__, char * const  , rst_comment::RstComment *  ),&_FuncastTickmake_comment_readerTick2128729122050972798_c601789b0f6f6081>>();
    };
    ...
    aotLib[0xcd163b78e9968e88] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTickpushTick10769833213962245646_80924a0d6aecc2bf
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, TArray<AutoTuple<char *,char *,char *>> & , AutoTuple<char *,char *,char *> &  ),&_FuncbuiltinTickpushTick10769833213962245646_80924a0d6aecc2bf>>();
    };
    ...
    aotLib[0x2171884abbd589fc] = +[](Context & ctx) -> SimNode* { // _FuncastTickadd_new_comment_readerTick9279614113534996372_7ca33631a1409093
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, char * const  , rst_comment::RstComment *  ),&_FuncastTickadd_new_comment_readerTick9279614113534996372_7ca33631a1409093>>();
    };
