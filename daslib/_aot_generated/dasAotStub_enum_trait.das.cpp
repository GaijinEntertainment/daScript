...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    ...
    aotLib[0x48e5f1e30db38e93] = +[](Context & ctx) -> SimNode* { // _FuncrttiTickclass_infoTick15801393167907430156_db89bd2a6ff1ad7e
        return ctx.code->makeNode<SimNode_Aot<StructInfo const  * (*) ( Context * __context__, enum_trait::TypeInfoGetEnumLength const  &  ),&_FuncrttiTickclass_infoTick15801393167907430156_db89bd2a6ff1ad7e>>();
    };
    aotLib[0x35cb746aff3af72c] = +[](Context & ctx) -> SimNode* { // _FuncrttiTickclass_infoTick15801393167907430156_544f4e3f951187ef
        return ctx.code->makeNode<SimNode_Aot<StructInfo const  * (*) ( Context * __context__, enum_trait::TypeInfoGetEnumNames const  &  ),&_FuncrttiTickclass_infoTick15801393167907430156_544f4e3f951187ef>>();
    };
    aotLib[0x2ec7a324528feed3] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTickiter_rangeTick1065493836214144684_7880c0bbee885dd8
        return ctx.code->makeNode<SimNode_Aot<range (*) ( Context * __context__, das::vector<Enumeration::EnumEntry> const  &  ),&_FuncbuiltinTickiter_rangeTick1065493836214144684_7880c0bbee885dd8>>();
    };
