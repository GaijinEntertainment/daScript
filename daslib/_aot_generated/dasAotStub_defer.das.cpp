...
inline StructInfo const  * _FuncrttiTickclass_infoTick15801393167907430156_9f0829198e80797b ( Context * __context__, defer::DeferMacro const  & __cl_rename_at_116_2 );
inline void _FuncbuiltinTickpushTick10769833213962245646_9a94d5ed4f7c5f3d ( Context * __context__, TArray<ast::AstCallMacro *> & __Arr_rename_at_181_3, ast::AstCallMacro * __value_rename_at_181_4 );
inline StructInfo const  * _FuncrttiTickclass_infoTick15801393167907430156_675fe3078b60c25f ( Context * __context__, defer::DeferDeleteMacro const  & __cl_rename_at_116_5 );
inline smart_ptr_raw<FunctionAnnotation> _FuncastTickmake_function_annotationTick3074191368936885601_52e5a76825f117e ( Context * __context__, char * const  __name_rename_at_626_6, defer::DeferMacro * __someClassPtr_rename_at_626_7 );
inline void _Funcast_boostTicksetup_tag_annotationTick4095297895764883997_37079e3e67a004a8 ( Context * __context__, char * const  __name_rename_at_273_9, char * const  __tag_rename_at_273_10, defer::DeferMacro * __classPtr_rename_at_273_11 );
...
inline smart_ptr_raw<FunctionAnnotation> _FuncastTickmake_function_annotationTick3074191368936885601_52e5a76825f117e ( Context * __context__, char * const  __name_rename_at_626_6, defer::DeferMacro * __someClassPtr_rename_at_626_7 )
{
    _FuncbuiltinTickpushTick10769833213962245646_e64fa0322491795(__context__,das_arg<TArray<ast::AstFunctionAnnotation *>>::pass(das_global<TArray<ast::AstFunctionAnnotation *>,0x70a17c19e372bb43>(__context__) /*gc_root_AstFunctionAnnotation*/),das_reinterpret<ast::AstFunctionAnnotation *>::pass(__someClassPtr_rename_at_626_7));
    StructInfo const  * __classInfo_rename_at_629_8 = ((StructInfo const  *)_FuncrttiTickclass_infoTick15801393167907430156_9f0829198e80797b(__context__,das_arg<defer::DeferMacro>::pass(das_deref(__context__,__someClassPtr_rename_at_626_7))));
    return /* <- */ das_auto_cast_move<smart_ptr_raw<FunctionAnnotation>>::cast(makeFunctionAnnotation(__name_rename_at_626_6,das_auto_cast<void * const >::cast(__someClassPtr_rename_at_626_7),__classInfo_rename_at_629_8,__context__));
}
...
inline void _Funcast_boostTicksetup_tag_annotationTick4095297895764883997_37079e3e67a004a8 ( Context * __context__, char * const  __name_rename_at_273_9, char * const  __tag_rename_at_273_10, defer::DeferMacro * __classPtr_rename_at_273_11 )
{
    ...
    /* end finally */ });
    __ann_rename_at_274_12; das_zero(__ann_rename_at_274_12); das_move(__ann_rename_at_274_12, _FuncastTickmake_function_annotationTick3074191368936885601_52e5a76825f117e(__context__,__name_rename_at_273_9,__classPtr_rename_at_273_11));
...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    ...
    aotLib[0xd41881c2d20b1016] = +[](Context & ctx) -> SimNode* { // _FuncrttiTickclass_infoTick15801393167907430156_9f0829198e80797b
        return ctx.code->makeNode<SimNode_Aot<StructInfo const  * (*) ( Context * __context__, defer::DeferMacro const  &  ),&_FuncrttiTickclass_infoTick15801393167907430156_9f0829198e80797b>>();
    };
    ...
    aotLib[0x6a9544a6805b8a83] = +[](Context & ctx) -> SimNode* { // _FuncrttiTickclass_infoTick15801393167907430156_675fe3078b60c25f
        return ctx.code->makeNode<SimNode_Aot<StructInfo const  * (*) ( Context * __context__, defer::DeferDeleteMacro const  &  ),&_FuncrttiTickclass_infoTick15801393167907430156_675fe3078b60c25f>>();
    };
    aotLib[0x4e9abcb5e7aa32ff] = +[](Context & ctx) -> SimNode* { // _FuncastTickmake_function_annotationTick3074191368936885601_52e5a76825f117e
        return ctx.code->makeNode<SimNode_Aot<smart_ptr_raw<FunctionAnnotation> (*) ( Context * __context__, char * const  , defer::DeferMacro *  ),&_FuncastTickmake_function_annotationTick3074191368936885601_52e5a76825f117e>>();
    };
    aotLib[0x4747bbaf7d36d6f0] = +[](Context & ctx) -> SimNode* { // _Funcast_boostTicksetup_tag_annotationTick4095297895764883997_37079e3e67a004a8
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, char * const  , char * const  , defer::DeferMacro *  ),&_Funcast_boostTicksetup_tag_annotationTick4095297895764883997_37079e3e67a004a8>>();
    };
