...
inline void finalize_eef6fcd067cd43cb ( Context * __context__, AutoTuple<char *,char *> &  ____this_rename_at_1197_4 )
{
    memset(&(____this_rename_at_1197_4), 0, TypeSize<AutoTuple<char *,char *>>::size);
}
...
inline void finalize_3776fc7b3e3cd043 ( Context * __context__, templates_boost::Template &  ____this_rename_at_13_35 )
{
    ...
    memset(&(____this_rename_at_13_35), 0, TypeSize<templates_boost::Template>::size);
}
...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    ...
    aotLib[0x4f0997d07db46565] = +[](Context & ctx) -> SimNode* { // finalize_eef6fcd067cd43cb
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, AutoTuple<char *,char *> &  ),&finalize_eef6fcd067cd43cb>>();
    };
    aotLib[0x9dc28248df54b8d0] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTickvaluesTick1351216622833168869_a3fd0ea19752c392
        return ctx.code->makeNode<SimNode_AotCMRES<Sequence DAS_COMMENT((AutoTuple<char *,char *> &)) (*) ( Context * __context__, TTable<char *,AutoTuple<char *,char *>> &  ),&_FuncbuiltinTickvaluesTick1351216622833168869_a3fd0ea19752c392>>();
    };
    ...
    aotLib[0x49a33e451bca4830] = +[](Context & ctx) -> SimNode* { // _FuncrttiTickclass_infoTick15801393167907430156_62564a9a74988487
        return ctx.code->makeNode<SimNode_Aot<StructInfo const  * (*) ( Context * __context__, instance_function::InstanceFunctionAnnotation const  &  ),&_FuncrttiTickclass_infoTick15801393167907430156_62564a9a74988487>>();
    };
    aotLib[0xbf8193d556c1c212] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTickfinalizeTick5454204887383796109_7b5d09a060f52175
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, TTable<char *,AutoTuple<char *,char *>> &  ),&_FuncbuiltinTickfinalizeTick5454204887383796109_7b5d09a060f52175>>();
    };
    ...
    aotLib[0x983ed38ca578aa6] = +[](Context & ctx) -> SimNode* { // finalize_3776fc7b3e3cd043
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, templates_boost::Template &  ),&finalize_3776fc7b3e3cd043>>();
    };
