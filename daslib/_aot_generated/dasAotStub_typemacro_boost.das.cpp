...
inline void _FuncbuiltinTickresizeTick4811697762258667383_cf69ca810a04167a ( Context * __context__, TArray<AutoTuple<char *,AutoVariant<bool,int32_t,uint32_t,int64_t,uint64_t,float,double,char *,vec4f>>> & __Arr_rename_at_68_0, int32_t __newSize_rename_at_68_1 );
...
inline int32_t _FuncbuiltinTicklengthTick18150397773952384912_7d0e628860ea2349 ( Context * __context__, TDim<AutoTuple<char *,AutoVariant<bool,int32_t,uint32_t,int64_t,uint64_t,float,double,char *,vec4f>>,1> const  & __a_rename_at_581_4 );
...
inline TArray<AutoTuple<char *,AutoVariant<bool,int32_t,uint32_t,int64_t,uint64_t,float,double,char *,vec4f>>> _FuncbuiltinTickto_array_moveTick3185538323411982277_704d3da0761ab5d5 ( Context * __context__, TDim<AutoTuple<char *,AutoVariant<bool,int32_t,uint32_t,int64_t,uint64_t,float,double,char *,vec4f>>,1> & __a_rename_at_1342_18 );
...
inline Structure * _FuncbuiltinTickget_ptrTick5807679485210906136_1c1ac1d8f5641a51 ( Context * __context__, smart_ptr<Structure> __src_rename_at_1732_28 );
...
inline TArray<AutoTuple<char *,AutoVariant<bool,int32_t,uint32_t,int64_t,uint64_t,float,double,char *,vec4f>>> _FuncbuiltinTickto_array_moveTick3185538323411982277_704d3da0761ab5d5 ( Context * __context__, TDim<AutoTuple<char *,AutoVariant<bool,int32_t,uint32_t,int64_t,uint64_t,float,double,char *,vec4f>>,1> &  __a_rename_at_1342_18 )
{
    ...
    _FuncbuiltinTickresizeTick4811697762258667383_cf69ca810a04167a(__context__,das_reinterpret<TArray<AutoTuple<char *,RttiValue>>>::pass(das_arg<TArray<AutoTuple<char *,AutoVariant<bool,int32_t,uint32_t,int64_t,uint64_t,float,double,char *,vec4f>>>>::pass(__arr_rename_at_1344_19)),1);
...
inline smart_ptr_raw<Expression> _Funcast_boostTickconvert_to_expressionTick11707039267614988023_c545e308a61d940f ( Context * __context__, int32_t __value_rename_at_882_20 )
{
    ...
    return /* <- */ das_auto_cast_move<smart_ptr_raw<Expression>>::cast(das_invoke_function<smart_ptr_raw<Expression>>::invoke<int32_t,LineInfo const  &>(__context__,nullptr,Func(__context__->fnByMangledName(/*@typemacro_boost::ast_boost`convert_to_expression`16483834305137942954 C=Xi CH<rtti::LineInfo>*/ 3761456562203872175u)),__value_rename_at_882_20,das_arg<LineInfo>::pass((_temp_make_local_883_43_32 = (/*c-tor*/ LineInfo(/*end-c-tor*/))))));
}

inline smart_ptr_raw<Expression> _Funcast_boostTickconvert_to_expressionTick11707039267614988023_48a5beb36940388d ( Context * __context__, char * const  __value_rename_at_882_21 )
{
    LineInfo _temp_make_local_883_43_32; _temp_make_local_883_43_32;
    return /* <- */ das_auto_cast_move<smart_ptr_raw<Expression>>::cast(das_invoke_function<smart_ptr_raw<Expression>>::invoke<char * const ,LineInfo const  &>(__context__,nullptr,Func(__context__->fnByMangledName(/*@typemacro_boost::ast_boost`convert_to_expression`16483834305137942954 C=Xs CH<rtti::LineInfo>*/ 2378972982766058457u)),__value_rename_at_882_21,das_arg<LineInfo>::pass((_temp_make_local_883_43_32 = (/*c-tor*/ LineInfo(/*end-c-tor*/))))));
}
...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    aotLib[0x7298926084bbacf7] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTickresizeTick4811697762258667383_cf69ca810a04167a
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, TArray<AutoTuple<char *,AutoVariant<bool,int32_t,uint32_t,int64_t,uint64_t,float,double,char *,vec4f>>> & , int32_t  ),&_FuncbuiltinTickresizeTick4811697762258667383_cf69ca810a04167a>>();
    };
    ...
    aotLib[0xebacfe18dcfe8f5f] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTicklengthTick18150397773952384912_7d0e628860ea2349
        return ctx.code->makeNode<SimNode_Aot<int32_t (*) ( Context * __context__, TDim<AutoTuple<char *,AutoVariant<bool,int32_t,uint32_t,int64_t,uint64_t,float,double,char *,vec4f>>,1> const  &  ),&_FuncbuiltinTicklengthTick18150397773952384912_7d0e628860ea2349>>();
    };
    ...
    aotLib[0xf7fb031c9c6c344d] = +[](Context & ctx) -> SimNode* { // _FuncrttiTickclass_infoTick15801393167907430156_f6d476408197914e
        return ctx.code->makeNode<SimNode_Aot<StructInfo const  * (*) ( Context * __context__, typemacro_boost::TypeMacroMacro const  &  ),&_FuncrttiTickclass_infoTick15801393167907430156_f6d476408197914e>>();
    };
    ...
    aotLib[0xf6612553cb2bf669] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTickto_array_moveTick3185538323411982277_704d3da0761ab5d5
        return ctx.code->makeNode<SimNode_AotCMRES<TArray<AutoTuple<char *,AutoVariant<bool,int32_t,uint32_t,int64_t,uint64_t,float,double,char *,vec4f>>> (*) ( Context * __context__, TDim<AutoTuple<char *,AutoVariant<bool,int32_t,uint32_t,int64_t,uint64_t,float,double,char *,vec4f>>,1> &  ),&_FuncbuiltinTickto_array_moveTick3185538323411982277_704d3da0761ab5d5>>();
    };
    aotLib[0xfcfe79d4e57c782d] = +[](Context & ctx) -> SimNode* { // _Funcast_boostTickconvert_to_expressionTick11707039267614988023_c545e308a61d940f
    ...
    aotLib[0x5f1e3c9623cb6b62] = +[](Context & ctx) -> SimNode* { // _Funcast_boostTickconvert_to_expressionTick11707039267614988023_48a5beb36940388d
