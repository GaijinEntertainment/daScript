...
inline void _FuncbuiltinTickresizeTick4811697762258667383_da9a1b540204afa1 ( Context * __context__, TArray<AutoTuple<char *,AutoVariant<bool,int32_t,uint32_t,int64_t,uint64_t,float,double,char *,vec4f>>> & __Arr_rename_at_68_0, int32_t __newSize_rename_at_68_1 );
inline void clone_361586e3a680f068 ( Context * __context__, smart_ptr_raw<Expression> & __dest_rename_at_1092_2, smart_ptr_raw<Expression> const  __src_rename_at_1092_3 );
inline int32_t _FuncbuiltinTicklengthTick18150397773952384912_f54cef4ed0176b86 ( Context * __context__, TDim<AutoTuple<char *,AutoVariant<bool,int32_t,uint32_t,int64_t,uint64_t,float,double,char *,vec4f>>,1> const  & __a_rename_at_581_4 );
inline void _FuncbuiltinTickpushTick10769833213962245646_577e5c7310ce42 ( Context * __context__, TArray<ast::AstFunctionAnnotation *> & __Arr_rename_at_181_5, ast::AstFunctionAnnotation * __value_rename_at_181_6 );
inline StructInfo const  * _FuncrttiTickclass_infoTick15801393167907430156_b59fe504098fc695 ( Context * __context__, typemacro_boost::TypeMacroMacro const  & __cl_rename_at_116_7 );
...
inline TArray<AutoTuple<char *,AutoVariant<bool,int32_t,uint32_t,int64_t,uint64_t,float,double,char *,vec4f>>> _FuncbuiltinTickto_array_moveTick3185538323411982277_5b494db3ec211cc5 ( Context * __context__, TDim<AutoTuple<char *,AutoVariant<bool,int32_t,uint32_t,int64_t,uint64_t,float,double,char *,vec4f>>,1> & __a_rename_at_1375_18 );
inline smart_ptr_raw<Expression> _Funcast_boostTickconvert_to_expressionTick11707039267614988023_3d5b256cf3c76f71 ( Context * __context__, int32_t __value_rename_at_882_20 );
inline smart_ptr_raw<Expression> _Funcast_boostTickconvert_to_expressionTick11707039267614988023_9ded184c562cbb49 ( Context * __context__, char * const  __value_rename_at_882_21 );
inline char * _FuncastTickdescribeTick2562845734617055679_b1fd376d21aa823f ( Context * __context__, smart_ptr_raw<TypeDecl> const  __decl_rename_at_38_22, bool __extra_rename_at_38_23, bool __contracts_rename_at_38_24, bool __modules_rename_at_38_25 );
inline smart_ptr_raw<Expression> _FuncbuiltinTickadd_ptr_refTick918185754185293024_57e0a3ad82c2c7f5 ( Context * __context__, smart_ptr_raw<Expression> const  __src_rename_at_1777_26 );
inline Structure * _FuncbuiltinTickget_ptrTick5807679485210906136_8d7fcd469d7e47c6 ( Context * __context__, smart_ptr_raw<Structure> __src_rename_at_1765_28 );
...
inline TArray<AutoTuple<char *,AutoVariant<bool,int32_t,uint32_t,int64_t,uint64_t,float,double,char *,vec4f>>> _FuncbuiltinTickto_array_moveTick3185538323411982277_5b494db3ec211cc5 ( Context * __context__, TDim<AutoTuple<char *,AutoVariant<bool,int32_t,uint32_t,int64_t,uint64_t,float,double,char *,vec4f>>,1> &  __a_rename_at_1375_18 )
{
    ...
    _FuncbuiltinTickresizeTick4811697762258667383_da9a1b540204afa1(__context__,das_arg<TArray<AutoTuple<char *,AutoVariant<bool,int32_t,uint32_t,int64_t,uint64_t,float,double,char *,vec4f>>>>::pass(__arr_rename_at_1377_19),1);
...
inline smart_ptr_raw<Expression> _FuncbuiltinTickadd_ptr_refTick918185754185293024_57e0a3ad82c2c7f5 ( Context * __context__, smart_ptr_raw<Expression> const  __src_rename_at_1777_26 )
{
    smart_ptr_raw<Expression> __dst_rename_at_1779_27; das_zero(__dst_rename_at_1779_27); das_move(__dst_rename_at_1779_27, _FuncbuiltinTickclone_to_moveTick2007252383599261567_57e0a3ad82c2c7f5(__context__,das_cast<smart_ptr_raw<Expression>>::cast(__src_rename_at_1777_26)));
...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    aotLib[0x9a3f49cbf2fba8f2] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncbuiltinTickresizeTick4811697762258667383_da9a1b540204afa1>>();
    };
    aotLib[0x926909a4c08dee78] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&clone_361586e3a680f068>>();
    };
    aotLib[0x5cb5e1736ff6df07] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncbuiltinTicklengthTick18150397773952384912_f54cef4ed0176b86>>();
    };
    ...
    aotLib[0x293c8a7ea41010d6] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncrttiTickclass_infoTick15801393167907430156_b59fe504098fc695>>();
    };
    ...
    aotLib[0x63321f9897935db2] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_AotCMRES<&_FuncbuiltinTickto_array_moveTick3185538323411982277_5b494db3ec211cc5>>();
    };
    ...
    aotLib[0xad537daa0f31e996] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_Funcast_boostTickconvert_to_expressionTick11707039267614988023_9ded184c562cbb49>>();
    };
    ...
    aotLib[0x2052c5899ba75a76] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncbuiltinTickget_ptrTick5807679485210906136_8d7fcd469d7e47c6>>();
    };
