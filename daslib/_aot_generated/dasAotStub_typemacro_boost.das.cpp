...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    aotLib[0x40de2454735fdda9] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTickresizeTick4811697762258667383_ba6198643c09cf0e
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, TArray<AutoTuple<char *,AutoVariant<bool,int32_t,uint32_t,int64_t,uint64_t,float,double,char *,vec4f>>> & , int32_t  ),&_FuncbuiltinTickresizeTick4811697762258667383_ba6198643c09cf0e>>();
    };
    ...
    aotLib[0xeef27ce9148978b1] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTicklengthTick18150397773952384912_a870648d308a6130
        return ctx.code->makeNode<SimNode_Aot<int32_t (*) ( Context * __context__, TDim<AutoTuple<char *,AutoVariant<bool,int32_t,uint32_t,int64_t,uint64_t,float,double,char *,vec4f>>,1> const  &  ),&_FuncbuiltinTicklengthTick18150397773952384912_a870648d308a6130>>();
    };
    ...
    aotLib[0x33fe5008bb200111] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTickto_array_moveTick3185538323411982277_77313f057747cf52
        return ctx.code->makeNode<SimNode_AotCMRES<TArray<AutoTuple<char *,AutoVariant<bool,int32_t,uint32_t,int64_t,uint64_t,float,double,char *,vec4f>>> (*) ( Context * __context__, TDim<AutoTuple<char *,AutoVariant<bool,int32_t,uint32_t,int64_t,uint64_t,float,double,char *,vec4f>>,1> &  ),&_FuncbuiltinTickto_array_moveTick3185538323411982277_77313f057747cf52>>();
    };
    aotLib[0xc8cdf98124ca0d0e] = +[](Context & ctx) -> SimNode* { // _Funcast_boostTickconvert_to_expressionTick11707039267614988023_c545e308a61d940f
    ...
    aotLib[0xe4308c203c68cd59] = +[](Context & ctx) -> SimNode* { // _Funcast_boostTickconvert_to_expressionTick11707039267614988023_48a5beb36940388d
