...
namespace das {
namespace _anon_8525048497131421341 {
...
static_assert(sizeof(RemoveCallArgsMacro)==112,"structure size mismatch with DAS");
static_assert(offsetof(RemoveCallArgsMacro,__rtti)==0,"structure field offset mismatch with DAS");
static_assert(offsetof(RemoveCallArgsMacro,__finalize)==8,"structure field offset mismatch with DAS");
static_assert(offsetof(RemoveCallArgsMacro,transform)==16,"structure field offset mismatch with DAS");
static_assert(offsetof(RemoveCallArgsMacro,verifyCall)==24,"structure field offset mismatch with DAS");
static_assert(offsetof(RemoveCallArgsMacro,apply)==32,"structure field offset mismatch with DAS");
static_assert(offsetof(RemoveCallArgsMacro,generic_apply)==40,"structure field offset mismatch with DAS");
static_assert(offsetof(RemoveCallArgsMacro,finish)==48,"structure field offset mismatch with DAS");
static_assert(offsetof(RemoveCallArgsMacro,patch)==56,"structure field offset mismatch with DAS");
static_assert(offsetof(RemoveCallArgsMacro,fixup)==64,"structure field offset mismatch with DAS");
static_assert(offsetof(RemoveCallArgsMacro,lint)==72,"structure field offset mismatch with DAS");
static_assert(offsetof(RemoveCallArgsMacro,complete)==80,"structure field offset mismatch with DAS");
static_assert(offsetof(RemoveCallArgsMacro,isCompatible)==88,"structure field offset mismatch with DAS");
static_assert(offsetof(RemoveCallArgsMacro,isSpecialized)==96,"structure field offset mismatch with DAS");
static_assert(offsetof(RemoveCallArgsMacro,appendToMangledName)==104,"structure field offset mismatch with DAS");
}
...
inline StructInfo const  * _FuncrttiTickclass_infoTick15801393167907430156_89e057b82337b354 ( Context * __context__, remove_call_args::RemoveCallArgsMacro const  & __cl_rename_at_116_2 );
...
inline void _FuncbuiltinTicksortTick5995501125257068354_2f5e31a88a531a99 ( Context * __context__, TArray<int32_t> & __a_rename_at_1577_6, Block DAS_COMMENT((bool,int32_t,int32_t)) const  & __cmp_rename_at_1577_7 );
inline range _FuncbuiltinTickiter_rangeTick1065493836214144684_80fa2303a9fad6b7 ( Context * __context__, AnnotationList const  & __foo_rename_at_1251_8 );
...
inline void _FuncbuiltinTicksortTick5995501125257068354_2f5e31a88a531a99 ( Context * __context__, TArray<int32_t> &  __a_rename_at_1577_6, Block DAS_COMMENT((bool,int32_t,int32_t)) const  &  __cmp_rename_at_1577_7 )
{
    builtin_sort_array_any_ref_cblock_T(das_arg<TArray<int32_t>>::pass(__a_rename_at_1577_6),4,builtin_array_size(das_arg<TArray<int32_t>>::pass(__a_rename_at_1577_6)),__cmp_rename_at_1577_7,__context__,((LineInfoArg *)(&LineInfo::g_LineInfoNULL)));
}

inline range _FuncbuiltinTickiter_rangeTick1065493836214144684_80fa2303a9fad6b7 ( Context * __context__, AnnotationList const  &  __foo_rename_at_1251_8 )
{
    return das_auto_cast<range>::cast(mk_range(das_vector_length(__foo_rename_at_1251_8)));
}
...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    ...
    aotLib[0x93d64cf4e18ec387] = +[](Context & ctx) -> SimNode* { // _FuncrttiTickclass_infoTick15801393167907430156_89e057b82337b354
        return ctx.code->makeNode<SimNode_Aot<StructInfo const  * (*) ( Context * __context__, remove_call_args::RemoveCallArgsMacro const  &  ),&_FuncrttiTickclass_infoTick15801393167907430156_89e057b82337b354>>();
    };
    ...
    aotLib[0xbf539bde820b092a] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTickpushTick14133213201864676143_527bd39f2798fbd0
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, TArray<int32_t> & , int32_t  ),&_FuncbuiltinTickpushTick14133213201864676143_527bd39f2798fbd0>>();
    };
    aotLib[0x21fa63b4f3c11d8b] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTicksortTick5995501125257068354_2f5e31a88a531a99
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, TArray<int32_t> & , Block DAS_COMMENT((bool,int32_t,int32_t)) const  &  ),&_FuncbuiltinTicksortTick5995501125257068354_2f5e31a88a531a99>>();
    };
    aotLib[0xb6f9dc3309ffcda3] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTickiter_rangeTick1065493836214144684_80fa2303a9fad6b7
        return ctx.code->makeNode<SimNode_Aot<range (*) ( Context * __context__, AnnotationList const  &  ),&_FuncbuiltinTickiter_rangeTick1065493836214144684_80fa2303a9fad6b7>>();
    };
	resolveTypeInfoAnnotations();
}

} // namespace _anon_8525048497131421341
AotListBase impl_aot_remove_call_args(_anon_8525048497131421341::registerAotFunctions);
} // namespace das
