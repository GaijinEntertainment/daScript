...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    ...
    aotLib[0x72e96a3e3597a923] = +[](Context & ctx) -> SimNode* { // find_arg_10618c5f1c38edc2
        return ctx.code->makeNode<SimNode_AotCMRES<AutoVariant<bool,int32_t,uint32_t,int64_t,uint64_t,float,double,char *,vec4f> (*) ( Context * __context__, char * const  , AnnotationArgumentList const  &  ),&find_arg_10618c5f1c38edc2>>();
    };
    aotLib[0xca8ab2c17fa91cef] = +[](Context & ctx) -> SimNode* { // find_arg_1b2553f295c6c9f6
        return ctx.code->makeNode<SimNode_AotCMRES<AutoVariant<bool,int32_t,uint32_t,int64_t,uint64_t,float,double,char *,vec4f> (*) ( Context * __context__, AnnotationArgumentList const  & , char * const   ),&find_arg_1b2553f295c6c9f6>>();
    };
    ...
    aotLib[0x54cf7aac741411c0] = +[](Context & ctx) -> SimNode* { // walk_and_convert_array_ee3d32559a523360
    ...
    aotLib[0x4bb9068f3a09c372] = +[](Context & ctx) -> SimNode* { // walk_and_convert_dim_307e83e2e898f055
    ...
    aotLib[0xc9b0ad48a447da4d] = +[](Context & ctx) -> SimNode* { // walk_and_convert_pointer_99fa96f2fad2fabb
    ...
    aotLib[0x3905abf867054828] = +[](Context & ctx) -> SimNode* { // walk_and_convert_tuple_d283511dc79b27c5
    ...
    aotLib[0xa525497c201f4b35] = +[](Context & ctx) -> SimNode* { // walk_and_convert_structure_461cae90387df9d8
    ...
    aotLib[0x7260d935ce94c14d] = +[](Context & ctx) -> SimNode* { // walk_and_convert_variant_50ce6cc7d88f2c68
    ...
    aotLib[0x8378ca12a8697d70] = +[](Context & ctx) -> SimNode* { // walk_and_convert_table_2f282e6c7908d091
    ...
    aotLib[0x4a70d8c17df28ad] = +[](Context & ctx) -> SimNode* { // walk_and_convert_52e7fa0c06656c3c
    ...
    aotLib[0x3c1bad92be4bb9c6] = +[](Context & ctx) -> SimNode* { // append_annotation_b981e8a02afe1ee4
        return ctx.code->makeNode<SimNode_Aot<smart_ptr_raw<AnnotationDeclaration> (*) ( Context * __context__, char * const  , char * const  , TArray<AutoTuple<char *,AutoVariant<bool,int32_t,uint32_t,int64_t,uint64_t,float,double,char *,vec4f>>> const  &  ),&append_annotation_b981e8a02afe1ee4>>();
    };
    ...
    aotLib[0x82ff7a302d1df852] = +[](Context & ctx) -> SimNode* { // append_annotation_8d7b2c303573ac
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, smart_ptr_raw<Function> , char * const  , char * const  , TArray<AutoTuple<char *,AutoVariant<bool,int32_t,uint32_t,int64_t,uint64_t,float,double,char *,vec4f>>> const  &  ),&append_annotation_8d7b2c303573ac>>();
    };
    aotLib[0x2943da9d5d5dc725] = +[](Context & ctx) -> SimNode* { // append_annotation_58166e5ad7a07209
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, smart_ptr_raw<ExprBlock> , char * const  , char * const  , TArray<AutoTuple<char *,AutoVariant<bool,int32_t,uint32_t,int64_t,uint64_t,float,double,char *,vec4f>>> const  &  ),&append_annotation_58166e5ad7a07209>>();
    };
    aotLib[0xd9f3641ca9146d96] = +[](Context & ctx) -> SimNode* { // append_annotation_4557d674e6f0275a
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, smart_ptr_raw<Structure> , char * const  , char * const  , TArray<AutoTuple<char *,AutoVariant<bool,int32_t,uint32_t,int64_t,uint64_t,float,double,char *,vec4f>>> const  &  ),&append_annotation_4557d674e6f0275a>>();
    };
