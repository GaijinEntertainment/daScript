...
inline void _FuncCONTEXTTickinternal_enable_profiler_1fb51d4dfe399b06 ( Context * __context__, uint64_t __ctxId_rename_at_90_0, bool __enabled_rename_at_90_1 );
inline void _FuncCONTEXT_CLONETickinternal_enable_profiler_1fb51d4dfe399b06 ( Context * __context__, uint64_t __ctxId_rename_at_14_2, bool __enabled_rename_at_14_3 );
inline uint64_t _FuncbuiltinTickintptrTick11320822648609276562_8c85e7dff751212 ( Context * __context__, void * const  __p_rename_at_15_4 );
inline void internal_enable_profiler_1fb51d4dfe399b06 ( Context * __context__, uint64_t __ctxId_rename_at_14_5, bool __enabled_rename_at_14_6 );
inline void enable_profiler_2d8bea62b4bacaef ( Context * __context__, Context & __ctx_rename_at_22_7 );
inline void disable_profiler_2d8bea62b4bacaef ( Context * __context__, Context & __ctx_rename_at_26_8 );
...
inline void _FuncCONTEXTTickinternal_enable_profiler_1fb51d4dfe399b06 ( Context * __context__, uint64_t __ctxId_rename_at_90_0, bool __enabled_rename_at_90_1 )
{
    ...
    _FuncCONTEXT_CLONETickinternal_enable_profiler_1fb51d4dfe399b06(__context__,__ctxId_rename_at_90_0,__enabled_rename_at_90_1);
}

inline void _FuncCONTEXT_CLONETickinternal_enable_profiler_1fb51d4dfe399b06 ( Context * __context__, uint64_t __ctxId_rename_at_14_2, bool __enabled_rename_at_14_3 ) { das_stack_prologue __prologue(__context__,80,"CONTEXT_CLONE`internal_enable_profiler " DAS_FILE_LINE);
{
...
inline void enable_profiler_2d8bea62b4bacaef ( Context * __context__, Context &  __ctx_rename_at_22_7 )
{
    internal_enable_profiler_1fb51d4dfe399b06(__context__,_FuncbuiltinTickintptrTick11320822648609276562_8c85e7dff751212(__context__,das_auto_cast<void * const >::cast(das_ref(__context__,__ctx_rename_at_22_7))),true);
}

inline void disable_profiler_2d8bea62b4bacaef ( Context * __context__, Context &  __ctx_rename_at_26_8 )
{
    internal_enable_profiler_1fb51d4dfe399b06(__context__,_FuncbuiltinTickintptrTick11320822648609276562_8c85e7dff751212(__context__,das_auto_cast<void * const >::cast(das_ref(__context__,__ctx_rename_at_26_8))),false);
}

static void registerAotFunctions ( AotLibrary & aotLib ) {
    aotLib[0x88d59aa4b8eef04d] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncCONTEXTTickinternal_enable_profiler_1fb51d4dfe399b06>>();
    };
    aotLib[0x982cec1f7d858b03] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncCONTEXT_CLONETickinternal_enable_profiler_1fb51d4dfe399b06>>();
    };
    ...
    aotLib[0xa4356c03e0d39e93] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&internal_enable_profiler_1fb51d4dfe399b06>>();
    };
    aotLib[0x4b68dbc9781bba15] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&enable_profiler_2d8bea62b4bacaef>>();
    };
    aotLib[0x4b68dbc9781bba15] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&disable_profiler_2d8bea62b4bacaef>>();
    };
    // [[ init script ]]
