...
inline void _FuncCONTEXT_CLONETickinternal_enable_profiler_efa02bb71ea20bcd ( Context * __context__, uint64_t __ctxId_rename_at_14_2, bool __enabled_rename_at_14_3 ) { das_stack_prologue __prologue(__context__,80,"CONTEXT_CLONE`internal_enable_profiler " DAS_FILE_LINE);
{
    lockDebugAgent(das_make_block<void>(__context__,0,0,&__func_info__955909f57bd61177,[&]() -> void{
        das_invoke_function<void>::invoke<uint64_t,bool>(__context__,nullptr,Func(__context__->fnByMangledName(/*@profiler::set_enable_profiler u64 Cb*/ 1450059989827903851u)),__ctxId_rename_at_14_2,__enabled_rename_at_14_3);
...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    aotLib[0xfca7001704070a79] = +[](Context & ctx) -> SimNode* { // _FuncCONTEXTTickinternal_enable_profiler_9259ac347efac90d
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, uint64_t , bool  ),&_FuncCONTEXTTickinternal_enable_profiler_9259ac347efac90d>>();
    };
    aotLib[0xe9eeed31e8090051] = +[](Context & ctx) -> SimNode* { // _FuncCONTEXT_CLONETickinternal_enable_profiler_efa02bb71ea20bcd
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, uint64_t , bool  ),&_FuncCONTEXT_CLONETickinternal_enable_profiler_efa02bb71ea20bcd>>();
    };
    aotLib[0x4577f8df0b21841b] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTickintptrTick11320822648609276562_814d48688d3fb11d
        return ctx.code->makeNode<SimNode_Aot<uint64_t (*) ( Context * __context__, void * const   ),&_FuncbuiltinTickintptrTick11320822648609276562_814d48688d3fb11d>>();
    };
    aotLib[0x6bf987a594e1454a] = +[](Context & ctx) -> SimNode* { // internal_enable_profiler_49af0bcaf84865fa
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, uint64_t , bool  ),&internal_enable_profiler_49af0bcaf84865fa>>();
    };
    aotLib[0xae293b0b849a6913] = +[](Context & ctx) -> SimNode* { // enable_profiler_f1a7d4ae3b806df7
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, Context &  ),&enable_profiler_f1a7d4ae3b806df7>>();
    };
    aotLib[0x92e9ad71dd13f815] = +[](Context & ctx) -> SimNode* { // disable_profiler_32fa37bfb0ad4434
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, Context &  ),&disable_profiler_32fa37bfb0ad4434>>();
    };
    // [[ init script ]]
