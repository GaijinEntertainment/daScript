...
inline smart_ptr_raw<FunctionAnnotation> _FuncastTickmake_function_annotationTick3074191368936885601_d7275c2be9ee6d77 ( Context * __context__, char * const  __name_rename_at_626_3, temp_strings::TempStringMacro * __someClassPtr_rename_at_626_4 );
...
inline smart_ptr_raw<FunctionAnnotation> _FuncastTickmake_function_annotationTick3074191368936885601_d7275c2be9ee6d77 ( Context * __context__, char * const  __name_rename_at_626_3, temp_strings::TempStringMacro * __someClassPtr_rename_at_626_4 )
{
    _FuncbuiltinTickpushTick10769833213962245646_e64fa0322491795(__context__,das_arg<TArray<ast::AstFunctionAnnotation *>>::pass(das_global<TArray<ast::AstFunctionAnnotation *>,0x70a17c19e372bb43>(__context__) /*gc_root_AstFunctionAnnotation*/),das_reinterpret<ast::AstFunctionAnnotation *>::pass(__someClassPtr_rename_at_626_4));
    StructInfo const  * __classInfo_rename_at_629_5 = ((StructInfo const  *)_FuncrttiTickclass_infoTick15801393167907430156_544195c767e53b30(__context__,das_arg<temp_strings::TempStringMacro>::pass(das_deref(__context__,__someClassPtr_rename_at_626_4))));
    return /* <- */ das_auto_cast_move<smart_ptr_raw<FunctionAnnotation>>::cast(makeFunctionAnnotation(__name_rename_at_626_3,das_auto_cast<void * const >::cast(__someClassPtr_rename_at_626_4),__classInfo_rename_at_629_5,__context__));
}
...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    ...
    aotLib[0x8d7c2a448314e348] = +[](Context & ctx) -> SimNode* { // _FuncrttiTickclass_infoTick15801393167907430156_544195c767e53b30
        return ctx.code->makeNode<SimNode_Aot<StructInfo const  * (*) ( Context * __context__, temp_strings::TempStringMacro const  &  ),&_FuncrttiTickclass_infoTick15801393167907430156_544195c767e53b30>>();
    };
    aotLib[0xc32e3d8b214c9bc5] = +[](Context & ctx) -> SimNode* { // _FuncastTickmake_function_annotationTick3074191368936885601_d7275c2be9ee6d77
        return ctx.code->makeNode<SimNode_Aot<smart_ptr_raw<FunctionAnnotation> (*) ( Context * __context__, char * const  , temp_strings::TempStringMacro *  ),&_FuncastTickmake_function_annotationTick3074191368936885601_d7275c2be9ee6d77>>();
    };
    aotLib[0x6aa470625ce18c04] = +[](Context & ctx) -> SimNode* { // _Funcast_boostTicksetup_tag_annotationTick4095297895764883997_6b4fceb19f25a20c
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, char * const  , char * const  , temp_strings::TempStringMacro *  ),&_Funcast_boostTicksetup_tag_annotationTick4095297895764883997_6b4fceb19f25a20c>>();
    };
