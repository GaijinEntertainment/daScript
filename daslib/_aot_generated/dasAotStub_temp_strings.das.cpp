...
static_assert(sizeof(TempStringMacro)==112,"structure size mismatch with DAS");
static_assert(offsetof(TempStringMacro,__rtti)==0,"structure field offset mismatch with DAS");
static_assert(offsetof(TempStringMacro,__finalize)==8,"structure field offset mismatch with DAS");
static_assert(offsetof(TempStringMacro,transform)==16,"structure field offset mismatch with DAS");
static_assert(offsetof(TempStringMacro,verifyCall)==24,"structure field offset mismatch with DAS");
static_assert(offsetof(TempStringMacro,apply)==32,"structure field offset mismatch with DAS");
static_assert(offsetof(TempStringMacro,generic_apply)==40,"structure field offset mismatch with DAS");
static_assert(offsetof(TempStringMacro,finish)==48,"structure field offset mismatch with DAS");
static_assert(offsetof(TempStringMacro,patch)==56,"structure field offset mismatch with DAS");
static_assert(offsetof(TempStringMacro,fixup)==64,"structure field offset mismatch with DAS");
static_assert(offsetof(TempStringMacro,lint)==72,"structure field offset mismatch with DAS");
static_assert(offsetof(TempStringMacro,complete)==80,"structure field offset mismatch with DAS");
static_assert(offsetof(TempStringMacro,isCompatible)==88,"structure field offset mismatch with DAS");
static_assert(offsetof(TempStringMacro,isSpecialized)==96,"structure field offset mismatch with DAS");
static_assert(offsetof(TempStringMacro,appendToMangledName)==104,"structure field offset mismatch with DAS");
}
...
inline StructInfo const  * _FuncrttiTickclass_infoTick15801393167907430156_296184f9e02890d ( Context * __context__, temp_strings::TempStringMacro const  & __cl_rename_at_116_2 );
inline smart_ptr_raw<FunctionAnnotation> _FuncastTickmake_function_annotationTick3074191368936885601_7c3f029e79cda0dd ( Context * __context__, char * const  __name_rename_at_622_3, temp_strings::TempStringMacro * __someClassPtr_rename_at_622_4 );
inline void _Funcast_boostTicksetup_tag_annotationTick4095297895764883997_402ba5d2b1fef0d6 ( Context * __context__, char * const  __name_rename_at_273_6, char * const  __tag_rename_at_273_7, temp_strings::TempStringMacro * __classPtr_rename_at_273_8 );
...
inline smart_ptr_raw<FunctionAnnotation> _FuncastTickmake_function_annotationTick3074191368936885601_7c3f029e79cda0dd ( Context * __context__, char * const  __name_rename_at_622_3, temp_strings::TempStringMacro * __someClassPtr_rename_at_622_4 )
{
    _FuncbuiltinTickpushTick10769833213962245646_17d5a7b0b5dc7d2a(__context__,das_arg<TArray<ast::AstFunctionAnnotation *>>::pass(das_global<TArray<ast::AstFunctionAnnotation *>,0x70a17c19e372bb43>(__context__) /*gc_root_AstFunctionAnnotation*/),das_reinterpret<ast::AstFunctionAnnotation *>::pass(__someClassPtr_rename_at_622_4));
    StructInfo const  * __classInfo_rename_at_625_5 = ((StructInfo const  *)_FuncrttiTickclass_infoTick15801393167907430156_296184f9e02890d(__context__,das_arg<temp_strings::TempStringMacro>::pass(das_deref(__context__,__someClassPtr_rename_at_622_4))));
    return /* <- */ das_auto_cast_move<smart_ptr_raw<FunctionAnnotation>>::cast(makeFunctionAnnotation(__name_rename_at_622_3,das_auto_cast<void * const >::cast(__someClassPtr_rename_at_622_4),__classInfo_rename_at_625_5,__context__));
}
...
inline void _Funcast_boostTicksetup_tag_annotationTick4095297895764883997_402ba5d2b1fef0d6 ( Context * __context__, char * const  __name_rename_at_273_6, char * const  __tag_rename_at_273_7, temp_strings::TempStringMacro * __classPtr_rename_at_273_8 )
{
    ...
    /* end finally */ });
    __ann_rename_at_274_9; das_zero(__ann_rename_at_274_9); das_move(__ann_rename_at_274_9, _FuncastTickmake_function_annotationTick3074191368936885601_7c3f029e79cda0dd(__context__,__name_rename_at_273_6,__classPtr_rename_at_273_8));
    das_invoke_function<void>::invoke<char * const ,smart_ptr_raw<FunctionAnnotation>>(__context__,nullptr,Func(__context__->fnByMangledName(/*@ast_boost::apply_tag_annotation Cs Y<FunctionAnnotationPtr>1<H<ast::FunctionAnnotation>>?M*/ 8536632802977626562u)),__tag_rename_at_273_7,__ann_rename_at_274_9);
...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    ...
    aotLib[0x53aa64b01eff8ed2] = +[](Context & ctx) -> SimNode* { // _FuncrttiTickclass_infoTick15801393167907430156_296184f9e02890d
        return ctx.code->makeNode<SimNode_Aot<StructInfo const  * (*) ( Context * __context__, temp_strings::TempStringMacro const  &  ),&_FuncrttiTickclass_infoTick15801393167907430156_296184f9e02890d>>();
    };
    aotLib[0xd083bd1ea1768ab6] = +[](Context & ctx) -> SimNode* { // _FuncastTickmake_function_annotationTick3074191368936885601_7c3f029e79cda0dd
        return ctx.code->makeNode<SimNode_Aot<smart_ptr_raw<FunctionAnnotation> (*) ( Context * __context__, char * const  , temp_strings::TempStringMacro *  ),&_FuncastTickmake_function_annotationTick3074191368936885601_7c3f029e79cda0dd>>();
    };
    aotLib[0xdeb9266b5d99758] = +[](Context & ctx) -> SimNode* { // _Funcast_boostTicksetup_tag_annotationTick4095297895764883997_402ba5d2b1fef0d6
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, char * const  , char * const  , temp_strings::TempStringMacro *  ),&_Funcast_boostTicksetup_tag_annotationTick4095297895764883997_402ba5d2b1fef0d6>>();
    };
    aotLib[0x429b14747cf78ef4] = +[](Context & ctx) -> SimNode* { // build_temp_string_14c32651a048dea0
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, Block DAS_COMMENT((void,StringBuilderWriter)) const  & , Block DAS_COMMENT((void,char * const )) const  &  ),&build_temp_string_14c32651a048dea0>>();
    };
    aotLib[0x1654bdb2e4ae27bb] = +[](Context & ctx) -> SimNode* { // temp_string_25bc86055a9f53c4
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, char * const  , Block DAS_COMMENT((void,char * const )) const  &  ),&temp_string_25bc86055a9f53c4>>();
    };
    aotLib[0x6ff6445d4979fb2d] = +[](Context & ctx) -> SimNode* { // temp_string_a673a80a2716fd47
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, TArray<uint8_t> const  & , Block DAS_COMMENT((void,char * const )) const  &  ),&temp_string_a673a80a2716fd47>>();
    };
    // [[ init script ]]
