...
inline smart_ptr_raw<Expression> _FuncbuiltinTickclone_to_moveTick2007252383599261567_1413454fe2b92f68 ( Context * __context__, smart_ptr_raw<Expression> const  __clone_src_rename_at_1089_2 );
...
inline StructInfo const  * _FuncrttiTickclass_infoTick15801393167907430156_fcc707178104eec ( Context * __context__, generic_return::GenericReturn const  & __cl_rename_at_116_6 );
inline smart_ptr_raw<Expression> _FuncbuiltinTickadd_ptr_refTick918185754185293024_a573a1c727c1b6c ( Context * __context__, smart_ptr_raw<Expression> const  __src_rename_at_1777_7 );
...
inline smart_ptr_raw<Expression> _FuncbuiltinTickclone_to_moveTick2007252383599261567_1413454fe2b92f68 ( Context * __context__, smart_ptr_raw<Expression> const  __clone_src_rename_at_1089_2 )
{
    ...
    clone_912660ab1e667e4b(__context__,__clone_dest_rename_at_1091_3,__clone_src_rename_at_1089_2);
...
inline smart_ptr_raw<Expression> _FuncbuiltinTickadd_ptr_refTick918185754185293024_a573a1c727c1b6c ( Context * __context__, smart_ptr_raw<Expression> const  __src_rename_at_1777_7 )
{
    smart_ptr_raw<Expression> __dst_rename_at_1779_8; das_zero(__dst_rename_at_1779_8); das_move(__dst_rename_at_1779_8, _FuncbuiltinTickclone_to_moveTick2007252383599261567_1413454fe2b92f68(__context__,das_cast<smart_ptr_raw<Expression>>::cast(__src_rename_at_1777_7)));
...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    ...
    aotLib[0x362d0bf5715e197f] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncrttiTickclass_infoTick15801393167907430156_fcc707178104eec>>();
    };
