...
inline void _FuncbuiltinTickpushTick10769833213962245646_d8d4a649436ee872 ( Context * __context__, TArray<ast::AstStructureAnnotation *> & __Arr_rename_at_181_0, ast::AstStructureAnnotation * __value_rename_at_181_1 );
inline StructInfo const  * _FuncrttiTickclass_infoTick15801393167907430156_2dee86d5badc5886 ( Context * __context__, interfaces::InterfaceMacro const  & __cl_rename_at_116_2 );
inline StructInfo const  * _FuncrttiTickclass_infoTick15801393167907430156_b409bc9778c695ef ( Context * __context__, interfaces::ImplementsMacro const  & __cl_rename_at_116_3 );
inline void _FuncbuiltinTickemplace_newTick990257600204377963_3af2bc704dc8522 ( Context * __context__, TArray<smart_ptr_raw<Expression>> & __Arr_rename_at_1036_4, smart_ptr_raw<Expression> __value_rename_at_1036_5 );
inline void _FuncbuiltinTickfinalizeTick13836114024949725080_9f199f97decbabbe ( Context * __context__, TArray<smart_ptr_raw<Expression>> & __a_rename_at_1215_6 );
inline void _FuncbuiltinTickfinalizeTick13836114024949725080_70f04f60487df041 ( Context * __context__, TArray<smart_ptr_raw<Variable>> & __a_rename_at_1215_8 );
inline void clone_c457b03ffcf7a4b5 ( Context * __context__, smart_ptr_raw<Expression> & __dest_rename_at_116_10, void * const  __src_rename_at_116_11 );
inline void _FuncbuiltinTickemplace_newTick990257600204377963_41746a9dfe098539 ( Context * __context__, TArray<smart_ptr_raw<Variable>> & __Arr_rename_at_1036_12, smart_ptr_raw<Variable> __value_rename_at_1036_13 );
...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    ...
    aotLib[0x4e3f19857e12abba] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncrttiTickclass_infoTick15801393167907430156_2dee86d5badc5886>>();
    };
    aotLib[0x209a573b2921f989] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncrttiTickclass_infoTick15801393167907430156_b409bc9778c695ef>>();
    };
