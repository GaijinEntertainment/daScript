...
static_assert(sizeof(MonthNameAndDay)==16,"structure size mismatch with DAS");
static_assert(offsetof(MonthNameAndDay,name)==0,"structure field offset mismatch with DAS");
static_assert(offsetof(MonthNameAndDay,days)==8,"structure field offset mismatch with DAS");
}
namespace faker {
...
inline void _FuncbuiltinTickresizeTick4811697762258667383_401f694502683cef ( Context * __context__, TArray<TTuple<16,range,char *>> & __Arr_rename_at_68_2, int32_t __newSize_rename_at_68_3 );
...
inline int32_t _FuncbuiltinTicklengthTick18150397773952384912_3a6bd4fafb6564b7 ( Context * __context__, TDim<TTuple<16,range,char *>,1> const  & __a_rename_at_581_9 );
inline int32_t _FuncbuiltinTicklengthTick18150397773952384912_9095ca2d63c1721d ( Context * __context__, TDim<TTuple<16,range,char *>,2> const  & __a_rename_at_581_10 );
...
inline void _FuncbuiltinTickfinalizeTick13836114024949725080_947eb3679f75acfb ( Context * __context__, TArray<uint8_t> & __a_rename_at_1183_13 );
inline bool _FuncbuiltinTicknextTick17450348357676149856_78a056decb3ca45d ( Context * __context__, Sequence DAS_COMMENT((uint32_t)) & __it_rename_at_1224_14, uint32_t & __value_rename_at_1224_15 );
...
inline faker::MonthNameAndDay MonthNameAndDay_cc8a0af1d2e9f6ed ( Context * __context__ );
inline TArray<faker::MonthNameAndDay> _FuncbuiltinTickto_array_moveTick3185538323411982277_978394c279bac03f ( Context * __context__, TDim<faker::MonthNameAndDay,12> & __a_rename_at_1343_98 );
inline TArray<TTuple<16,range,char *>> _FuncbuiltinTickto_array_moveTick3185538323411982277_1a5781405ff696dd ( Context * __context__, TDim<TTuple<16,range,char *>,1> & __a_rename_at_1343_100 );
inline TArray<TTuple<16,range,char *>> _FuncbuiltinTickto_array_moveTick3185538323411982277_aa3e7370cfbb5f4f ( Context * __context__, TDim<TTuple<16,range,char *>,2> & __a_rename_at_1343_102 );
inline TArray<regex::ReNode *> _FuncbuiltinTickto_array_moveTick3185538323411982277_b89e28f7cfb5d3e4 ( Context * __context__, TDim<regex::ReNode *,11> & __a_rename_at_1343_104 );
inline TArray<int32_t> _FuncbuiltinTickto_array_moveTick3185538323411982277_941c3382ff6a8f19 ( Context * __context__, TDim<int32_t,12> & __a_rename_at_1343_106 );

void __init_script ( Context * __context__, bool __init_shared )
{
    TDim<faker::MonthNameAndDay,12> _temp_make_local_24_24_32;
    regex::Regex _temp_make_local_61_31_32;
    TDim<TTuple<16,range,char *>,1> _temp_make_local_61_31_176;
    regex::Regex _temp_make_local_62_22_32;
    TDim<TTuple<16,range,char *>,1> _temp_make_local_62_22_224;
    regex::Regex _temp_make_local_63_23_32;
    TDim<TTuple<16,range,char *>,1> _temp_make_local_63_23_176;
    regex::Regex _temp_make_local_64_22_32;
    TDim<TTuple<16,range,char *>,1> _temp_make_local_64_22_176;
    regex::Regex _temp_make_local_65_25_32;
    TDim<TTuple<16,range,char *>,1> _temp_make_local_65_25_144;
    regex::Regex _temp_make_local_66_28_32;
    TDim<TTuple<16,range,char *>,1> _temp_make_local_66_28_144;
    regex::Regex _temp_make_local_67_24_32;
    TDim<TTuple<16,range,char *>,2> _temp_make_local_67_24_336;
    regex::Regex _temp_make_local_68_17_32;
    TDim<regex::ReNode *,11> _temp_make_local_68_17_144;
    TDim<TTuple<16,range,char *>,2> _temp_make_local_68_17_416;
    ...
    das_global<TArray<faker::MonthNameAndDay>,0x1d0bed6094e46065>(__context__) = _FuncbuiltinTickto_array_moveTick3185538323411982277_978394c279bac03f(__context__,das_arg<TDim<faker::MonthNameAndDay,12>>::pass((([&]() -> TDim<faker::MonthNameAndDay,12>& {
        _temp_make_local_24_24_32(0,__context__) = (([&]() -> faker::MonthNameAndDay {
            faker::MonthNameAndDay __mks_24 = MonthNameAndDay_cc8a0af1d2e9f6ed(__context__);
        ...
        _temp_make_local_24_24_32(1,__context__) = (([&]() -> faker::MonthNameAndDay {
            faker::MonthNameAndDay __mks_25 = MonthNameAndDay_cc8a0af1d2e9f6ed(__context__);
        ...
        _temp_make_local_24_24_32(9,__context__) = (([&]() -> faker::MonthNameAndDay {
            faker::MonthNameAndDay __mks_33 = MonthNameAndDay_cc8a0af1d2e9f6ed(__context__);
        ...
        _temp_make_local_24_24_32(10,__context__) = (([&]() -> faker::MonthNameAndDay {
            faker::MonthNameAndDay __mks_34 = MonthNameAndDay_cc8a0af1d2e9f6ed(__context__);
        ...
        _temp_make_local_24_24_32(11,__context__) = (([&]() -> faker::MonthNameAndDay {
            faker::MonthNameAndDay __mks_35 = MonthNameAndDay_cc8a0af1d2e9f6ed(__context__);
    ...
    das_global<regex::Regex,0x24f6b93c51999c1e>(__context__) = das_invoke_function<regex::Regex>::invoke_cmres<regex::Regex &>(__context__,nullptr,Func(__context__->fnByMangledName(/*@regex::regex_compile S<regex::Regex>*/ 2547527318735144132u)),das_arg<regex::Regex>::pass((([&]() -> regex::Regex& {
        ...
        das_move((_temp_make_local_61_31_32.groups),(_FuncbuiltinTickto_array_moveTick3185538323411982277_1a5781405ff696dd(__context__,das_arg<TDim<TTuple<16,range,char *>,1>>::pass((([&]() -> TDim<TTuple<16,range,char *>,1>& {
            _temp_make_local_61_31_176(0,__context__) = (([&]() -> TTuple<16,range,char *> {
                TTuple<16,range,char *> __mkt_61;
                das_get_tuple_field<range,0>::get(__mkt_61) = range(0,0);
                das_get_tuple_field<char *,8>::get(__mkt_61) = nullptr;
                return __mkt_61;
            })());
    ...
    das_global<regex::Regex,0x21aa63079ae9f66c>(__context__) = das_invoke_function<regex::Regex>::invoke_cmres<regex::Regex &>(__context__,nullptr,Func(__context__->fnByMangledName(/*@regex::regex_compile S<regex::Regex>*/ 2547527318735144132u)),das_arg<regex::Regex>::pass((([&]() -> regex::Regex& {
        ...
        das_move((_temp_make_local_62_22_32.groups),(_FuncbuiltinTickto_array_moveTick3185538323411982277_1a5781405ff696dd(__context__,das_arg<TDim<TTuple<16,range,char *>,1>>::pass((([&]() -> TDim<TTuple<16,range,char *>,1>& {
            _temp_make_local_62_22_224(0,__context__) = (([&]() -> TTuple<16,range,char *> {
                TTuple<16,range,char *> __mkt_62;
                das_get_tuple_field<range,0>::get(__mkt_62) = range(0,0);
                das_get_tuple_field<char *,8>::get(__mkt_62) = nullptr;
                return __mkt_62;
            })());
    ...
    das_global<regex::Regex,0x4df21bb6fd7700f>(__context__) = das_invoke_function<regex::Regex>::invoke_cmres<regex::Regex &>(__context__,nullptr,Func(__context__->fnByMangledName(/*@regex::regex_compile S<regex::Regex>*/ 2547527318735144132u)),das_arg<regex::Regex>::pass((([&]() -> regex::Regex& {
        ...
        das_move((_temp_make_local_63_23_32.groups),(_FuncbuiltinTickto_array_moveTick3185538323411982277_1a5781405ff696dd(__context__,das_arg<TDim<TTuple<16,range,char *>,1>>::pass((([&]() -> TDim<TTuple<16,range,char *>,1>& {
            _temp_make_local_63_23_176(0,__context__) = (([&]() -> TTuple<16,range,char *> {
                TTuple<16,range,char *> __mkt_63;
                das_get_tuple_field<range,0>::get(__mkt_63) = range(0,0);
                das_get_tuple_field<char *,8>::get(__mkt_63) = nullptr;
                return __mkt_63;
            })());
    ...
    das_global<regex::Regex,0x51c1ac4928d6065d>(__context__) = das_invoke_function<regex::Regex>::invoke_cmres<regex::Regex &>(__context__,nullptr,Func(__context__->fnByMangledName(/*@regex::regex_compile S<regex::Regex>*/ 2547527318735144132u)),das_arg<regex::Regex>::pass((([&]() -> regex::Regex& {
        ...
        das_move((_temp_make_local_64_22_32.groups),(_FuncbuiltinTickto_array_moveTick3185538323411982277_1a5781405ff696dd(__context__,das_arg<TDim<TTuple<16,range,char *>,1>>::pass((([&]() -> TDim<TTuple<16,range,char *>,1>& {
            _temp_make_local_64_22_176(0,__context__) = (([&]() -> TTuple<16,range,char *> {
                TTuple<16,range,char *> __mkt_64;
                das_get_tuple_field<range,0>::get(__mkt_64) = range(0,0);
                das_get_tuple_field<char *,8>::get(__mkt_64) = nullptr;
                return __mkt_64;
            })());
    ...
    das_global<regex::Regex,0xf00d441d5ca5cb8f>(__context__) = das_invoke_function<regex::Regex>::invoke_cmres<regex::Regex &>(__context__,nullptr,Func(__context__->fnByMangledName(/*@regex::regex_compile S<regex::Regex>*/ 2547527318735144132u)),das_arg<regex::Regex>::pass((([&]() -> regex::Regex& {
        ...
        das_move((_temp_make_local_65_25_32.groups),(_FuncbuiltinTickto_array_moveTick3185538323411982277_1a5781405ff696dd(__context__,das_arg<TDim<TTuple<16,range,char *>,1>>::pass((([&]() -> TDim<TTuple<16,range,char *>,1>& {
            _temp_make_local_65_25_144(0,__context__) = (([&]() -> TTuple<16,range,char *> {
                TTuple<16,range,char *> __mkt_65;
                das_get_tuple_field<range,0>::get(__mkt_65) = range(0,0);
                das_get_tuple_field<char *,8>::get(__mkt_65) = nullptr;
                return __mkt_65;
            })());
    ...
    das_global<regex::Regex,0x9b6bf05d029f187a>(__context__) = das_invoke_function<regex::Regex>::invoke_cmres<regex::Regex &>(__context__,nullptr,Func(__context__->fnByMangledName(/*@regex::regex_compile S<regex::Regex>*/ 2547527318735144132u)),das_arg<regex::Regex>::pass((([&]() -> regex::Regex& {
        ...
        das_move((_temp_make_local_66_28_32.groups),(_FuncbuiltinTickto_array_moveTick3185538323411982277_1a5781405ff696dd(__context__,das_arg<TDim<TTuple<16,range,char *>,1>>::pass((([&]() -> TDim<TTuple<16,range,char *>,1>& {
            _temp_make_local_66_28_144(0,__context__) = (([&]() -> TTuple<16,range,char *> {
                TTuple<16,range,char *> __mkt_66;
                das_get_tuple_field<range,0>::get(__mkt_66) = range(0,0);
                das_get_tuple_field<char *,8>::get(__mkt_66) = nullptr;
                return __mkt_66;
            })());
    ...
    das_global<regex::Regex,0xb47e9636ac90db6a>(__context__) = das_invoke_function<regex::Regex>::invoke_cmres<regex::Regex &>(__context__,nullptr,Func(__context__->fnByMangledName(/*@regex::regex_compile S<regex::Regex>*/ 2547527318735144132u)),das_arg<regex::Regex>::pass((([&]() -> regex::Regex& {
        ...
        das_move((_temp_make_local_67_24_32.groups),(_FuncbuiltinTickto_array_moveTick3185538323411982277_aa3e7370cfbb5f4f(__context__,das_arg<TDim<TTuple<16,range,char *>,2>>::pass((([&]() -> TDim<TTuple<16,range,char *>,2>& {
            _temp_make_local_67_24_336(0,__context__) = (([&]() -> TTuple<16,range,char *> {
                TTuple<16,range,char *> __mkt_67;
                das_get_tuple_field<range,0>::get(__mkt_67) = range(0,0);
                das_get_tuple_field<char *,8>::get(__mkt_67) = nullptr;
                return __mkt_67;
            })());
            _temp_make_local_67_24_336(1,__context__) = (([&]() -> TTuple<16,range,char *> {
                TTuple<16,range,char *> __mkt_67;
                das_get_tuple_field<range,0>::get(__mkt_67) = range(0,0);
                das_get_tuple_field<char *,8>::get(__mkt_67) = ((char *) "1");
                return __mkt_67;
            })());
    ...
    das_global<regex::Regex,0xcced403b1d8ad2c6>(__context__) = das_invoke_function<regex::Regex>::invoke_cmres<regex::Regex &>(__context__,nullptr,Func(__context__->fnByMangledName(/*@regex::regex_compile S<regex::Regex>*/ 2547527318735144132u)),das_arg<regex::Regex>::pass((([&]() -> regex::Regex& {
        ...
        das_move((_temp_make_local_68_17_32.groups),(_FuncbuiltinTickto_array_moveTick3185538323411982277_aa3e7370cfbb5f4f(__context__,das_arg<TDim<TTuple<16,range,char *>,2>>::pass((([&]() -> TDim<TTuple<16,range,char *>,2>& {
            _temp_make_local_68_17_416(0,__context__) = (([&]() -> TTuple<16,range,char *> {
                TTuple<16,range,char *> __mkt_68;
                das_get_tuple_field<range,0>::get(__mkt_68) = range(0,0);
                das_get_tuple_field<char *,8>::get(__mkt_68) = nullptr;
                return __mkt_68;
            })());
            _temp_make_local_68_17_416(1,__context__) = (([&]() -> TTuple<16,range,char *> {
                TTuple<16,range,char *> __mkt_68;
                das_get_tuple_field<range,0>::get(__mkt_68) = range(0,0);
                das_get_tuple_field<char *,8>::get(__mkt_68) = ((char *) "1");
                return __mkt_68;
            })());
...
inline void _FuncbuiltinTickresizeTick4811697762258667383_401f694502683cef ( Context * __context__, TArray<TTuple<16,range,char *>> &  __Arr_rename_at_68_2, int32_t __newSize_rename_at_68_3 )
{
    builtin_array_resize(das_arg<TArray<TTuple<16,range,char *>>>::pass(__Arr_rename_at_68_2),__newSize_rename_at_68_3,16,__context__,((LineInfoArg *)(&LineInfo::g_LineInfoNULL)));
}
...
inline void _FuncbuiltinTickfinalizeTick13836114024949725080_947eb3679f75acfb ( Context * __context__, TArray<uint8_t> &  __a_rename_at_1183_13 )
{
    builtin_array_free(das_arg<TArray<uint8_t>>::pass(__a_rename_at_1183_13),1,__context__,((LineInfoArg *)(&LineInfo::g_LineInfoNULL)));
}

inline bool _FuncbuiltinTicknextTick17450348357676149856_78a056decb3ca45d ( Context * __context__, Sequence DAS_COMMENT((uint32_t)) &  __it_rename_at_1224_14, uint32_t & __value_rename_at_1224_15 )
{
    return das_auto_cast<bool>::cast(builtin_iterator_iterate(das_arg<Sequence DAS_COMMENT((uint32_t))>::pass(__it_rename_at_1224_14),das_auto_cast<void * const >::cast(das_ref(__context__,__value_rename_at_1224_15)),__context__));
}
...
inline char * any_string_15f79099e6d9ab67 ( Context * __context__, faker::Faker &  __faker_rename_at_85_26 )
{
    return das_auto_cast<char *>::cast(das_invoke_function<char * const >::invoke<regex::Regex &,Sequence DAS_COMMENT((uint32_t)) &>(__context__,nullptr,Func(__context__->fnByMangledName(/*@regex::re_gen S<regex::Regex> Y<ReGenRandom>1<u>G*/ 5343660501358238925u)),das_arg<regex::Regex>::pass(das_global<regex::Regex,0xf00d441d5ca5cb8f>(__context__) /*re_string*/),das_arg<Sequence DAS_COMMENT((uint32_t))>::pass(__faker_rename_at_85_26.rnd)));
}

inline char * any_file_name_d4403d4c1c61d33a ( Context * __context__, faker::Faker &  __faker_rename_at_90_27 )
{
    return das_auto_cast<char *>::cast(das_invoke_function<char * const >::invoke<regex::Regex &,Sequence DAS_COMMENT((uint32_t)) &>(__context__,nullptr,Func(__context__->fnByMangledName(/*@regex::re_gen S<regex::Regex> Y<ReGenRandom>1<u>G*/ 5343660501358238925u)),das_arg<regex::Regex>::pass(das_global<regex::Regex,0x9b6bf05d029f187a>(__context__) /*re_file_name*/),das_arg<Sequence DAS_COMMENT((uint32_t))>::pass(__faker_rename_at_90_27.rnd)));
}
...
inline float random_float_d13f217e417a6195 ( Context * __context__, faker::Faker &  __faker_rename_at_137_40 )
{
    ...
    return das_auto_cast<float>::cast(das_invoke_function<float>::invoke<uint32_t>(__context__,nullptr,Func(__context__->fnByMangledName(/*@math_bits::uint_bits_to_float Cu*/ 10976829601970950943u)),__i_rename_at_139_41));
}
...
inline int64_t random_int64_adcf614eb324bd6 ( Context * __context__, faker::Faker &  __faker_rename_at_245_61 )
{
    TVariant<16,8,TDim<uint32_t,2>,double,int64_t,uint64_t> __b_rename_at_247_62 = (([&]() -> TVariant<16,8,TDim<uint32_t,2>,double,int64_t,uint64_t> {
        TVariant<16,8,TDim<uint32_t,2>,double,int64_t,uint64_t> __mkv_247;
        das_get_variant_field<TDim<uint32_t,2>,8,0>::set(__mkv_247) = (([&]() -> TDim<uint32_t,2> {
    ...
    return das_auto_cast<int64_t>::cast(das_get_variant_field<int64_t,8,2>::get(__b_rename_at_247_62));
}

inline uint64_t random_uint64_1dd8cfc88f1278b3 ( Context * __context__, faker::Faker &  __faker_rename_at_251_63 )
{
    TVariant<16,8,TDim<uint32_t,2>,double,int64_t,uint64_t> __b_rename_at_253_64 = (([&]() -> TVariant<16,8,TDim<uint32_t,2>,double,int64_t,uint64_t> {
        TVariant<16,8,TDim<uint32_t,2>,double,int64_t,uint64_t> __mkv_253;
        das_get_variant_field<TDim<uint32_t,2>,8,0>::set(__mkv_253) = (([&]() -> TDim<uint32_t,2> {
    ...
    return das_auto_cast<uint64_t>::cast(das_get_variant_field<uint64_t,8,3>::get(__b_rename_at_253_64));
}

inline double random_double_630e8e853e6b1b86 ( Context * __context__, faker::Faker &  __faker_rename_at_257_65 )
{
    TVariant<16,8,TDim<uint32_t,2>,double,int64_t,uint64_t> __b_rename_at_259_66 = (([&]() -> TVariant<16,8,TDim<uint32_t,2>,double,int64_t,uint64_t> {
        TVariant<16,8,TDim<uint32_t,2>,double,int64_t,uint64_t> __mkv_259;
        das_get_variant_field<TDim<uint32_t,2>,8,0>::set(__mkv_259) = (([&]() -> TDim<uint32_t,2> {
    ...
    return das_auto_cast<double>::cast(das_get_variant_field<double,8,1>::get(__b_rename_at_259_66));
}
...
inline char * number_e6356a1f306d478b ( Context * __context__, faker::Faker &  __faker_rename_at_279_72 )
{
    return das_auto_cast<char *>::cast(das_invoke_function<char * const >::invoke<regex::Regex &,Sequence DAS_COMMENT((uint32_t)) &>(__context__,nullptr,Func(__context__->fnByMangledName(/*@regex::re_gen S<regex::Regex> Y<ReGenRandom>1<u>G*/ 5343660501358238925u)),das_arg<regex::Regex>::pass(das_global<regex::Regex,0xcced403b1d8ad2c6>(__context__) /*re_number*/),das_arg<Sequence DAS_COMMENT((uint32_t))>::pass(__faker_rename_at_279_72.rnd)));
}

inline char * positive_int_3b17567f1d556fcd ( Context * __context__, faker::Faker &  __faker_rename_at_284_73 )
{
    return das_auto_cast<char *>::cast(das_invoke_function<char * const >::invoke<regex::Regex &,Sequence DAS_COMMENT((uint32_t)) &>(__context__,nullptr,Func(__context__->fnByMangledName(/*@regex::re_gen S<regex::Regex> Y<ReGenRandom>1<u>G*/ 5343660501358238925u)),das_arg<regex::Regex>::pass(das_global<regex::Regex,0x24f6b93c51999c1e>(__context__) /*re_positive_int*/),das_arg<Sequence DAS_COMMENT((uint32_t))>::pass(__faker_rename_at_284_73.rnd)));
}

inline char * any_int_4cd336181cd47a54 ( Context * __context__, faker::Faker &  __faker_rename_at_289_74 )
{
    return das_auto_cast<char *>::cast(das_invoke_function<char * const >::invoke<regex::Regex &,Sequence DAS_COMMENT((uint32_t)) &>(__context__,nullptr,Func(__context__->fnByMangledName(/*@regex::re_gen S<regex::Regex> Y<ReGenRandom>1<u>G*/ 5343660501358238925u)),das_arg<regex::Regex>::pass(das_global<regex::Regex,0x21aa63079ae9f66c>(__context__) /*re_int*/),das_arg<Sequence DAS_COMMENT((uint32_t))>::pass(__faker_rename_at_289_74.rnd)));
}

inline char * any_hex_907ff563a60e99f8 ( Context * __context__, faker::Faker &  __faker_rename_at_294_75 )
{
    return das_auto_cast<char *>::cast(das_invoke_function<char * const >::invoke<regex::Regex &,Sequence DAS_COMMENT((uint32_t)) &>(__context__,nullptr,Func(__context__->fnByMangledName(/*@regex::re_gen S<regex::Regex> Y<ReGenRandom>1<u>G*/ 5343660501358238925u)),das_arg<regex::Regex>::pass(das_global<regex::Regex,0x51c1ac4928d6065d>(__context__) /*re_hex*/),das_arg<Sequence DAS_COMMENT((uint32_t))>::pass(__faker_rename_at_294_75.rnd)));
}

inline char * any_float_b56b5b6b39494ad9 ( Context * __context__, faker::Faker &  __faker_rename_at_299_76 )
{
    return das_auto_cast<char *>::cast(das_invoke_function<char * const >::invoke<regex::Regex &,Sequence DAS_COMMENT((uint32_t)) &>(__context__,nullptr,Func(__context__->fnByMangledName(/*@regex::re_gen S<regex::Regex> Y<ReGenRandom>1<u>G*/ 5343660501358238925u)),das_arg<regex::Regex>::pass(das_global<regex::Regex,0xb47e9636ac90db6a>(__context__) /*re_float*/),das_arg<Sequence DAS_COMMENT((uint32_t))>::pass(__faker_rename_at_299_76.rnd)));
}

inline char * any_uint_38a9a332ddf833e4 ( Context * __context__, faker::Faker &  __faker_rename_at_304_77 )
{
    return das_auto_cast<char *>::cast(das_invoke_function<char * const >::invoke<regex::Regex &,Sequence DAS_COMMENT((uint32_t)) &>(__context__,nullptr,Func(__context__->fnByMangledName(/*@regex::re_gen S<regex::Regex> Y<ReGenRandom>1<u>G*/ 5343660501358238925u)),das_arg<regex::Regex>::pass(das_global<regex::Regex,0x4df21bb6fd7700f>(__context__) /*re_uint*/),das_arg<Sequence DAS_COMMENT((uint32_t))>::pass(__faker_rename_at_304_77.rnd)));
}
...
inline faker::Faker Faker_f3a80b9fc0a885fc ( Context * __context__ )
{
    return /* <- */ das_auto_cast_move<faker::Faker>::cast((([&]() -> faker::Faker {
        ...
        das_move((__mks_49.rnd),(das_invoke_function<Sequence DAS_COMMENT((uint32_t))>::invoke_cmres<int32_t>(__context__,nullptr,Func(__context__->fnByMangledName(/*@random::each_random_uint Ci*/ 5161397497796109868u)),13)));
...
inline faker::MonthNameAndDay MonthNameAndDay_cc8a0af1d2e9f6ed ( Context * __context__ )
{
    return /* <- */ das_auto_cast_move<faker::MonthNameAndDay>::cast((([&]() -> faker::MonthNameAndDay {
        faker::MonthNameAndDay __mks_19;
        das_zero(__mks_19);
        return __mks_19;
    })()));
}
...
inline TArray<faker::MonthNameAndDay> _FuncbuiltinTickto_array_moveTick3185538323411982277_978394c279bac03f ( Context * __context__, TDim<faker::MonthNameAndDay,12> &  __a_rename_at_1343_98 )
{
    TArray<faker::MonthNameAndDay> __arr_rename_at_1345_99; das_zero(__arr_rename_at_1345_99);
    _FuncbuiltinTickresizeTick4811697762258667383_4a11e1a2d7a26774(__context__,das_arg<TArray<faker::MonthNameAndDay>>::pass(__arr_rename_at_1345_99),12);
    das_copy(das_cast<TDim<faker::MonthNameAndDay,12>>::cast(das_ref(__context__,__arr_rename_at_1345_99(0,__context__))),__a_rename_at_1343_98);
    return /* <- */ das_auto_cast_move<TArray<faker::MonthNameAndDay>>::cast(__arr_rename_at_1345_99);
}

inline TArray<TTuple<16,range,char *>> _FuncbuiltinTickto_array_moveTick3185538323411982277_1a5781405ff696dd ( Context * __context__, TDim<TTuple<16,range,char *>,1> &  __a_rename_at_1343_100 )
{
    TArray<TTuple<16,range,char *>> __arr_rename_at_1345_101; das_zero(__arr_rename_at_1345_101);
    _FuncbuiltinTickresizeTick4811697762258667383_401f694502683cef(__context__,das_arg<TArray<TTuple<16,range,char *>>>::pass(__arr_rename_at_1345_101),1);
    das_copy(das_cast<TDim<TTuple<16,range,char *>,1>>::cast(das_ref(__context__,__arr_rename_at_1345_101(0,__context__))),__a_rename_at_1343_100);
    return /* <- */ das_auto_cast_move<TArray<TTuple<16,range,char *>>>::cast(__arr_rename_at_1345_101);
}

inline TArray<TTuple<16,range,char *>> _FuncbuiltinTickto_array_moveTick3185538323411982277_aa3e7370cfbb5f4f ( Context * __context__, TDim<TTuple<16,range,char *>,2> &  __a_rename_at_1343_102 )
{
    TArray<TTuple<16,range,char *>> __arr_rename_at_1345_103; das_zero(__arr_rename_at_1345_103);
    _FuncbuiltinTickresizeTick4811697762258667383_401f694502683cef(__context__,das_arg<TArray<TTuple<16,range,char *>>>::pass(__arr_rename_at_1345_103),2);
    das_copy(das_cast<TDim<TTuple<16,range,char *>,2>>::cast(das_ref(__context__,__arr_rename_at_1345_103(0,__context__))),__a_rename_at_1343_102);
    return /* <- */ das_auto_cast_move<TArray<TTuple<16,range,char *>>>::cast(__arr_rename_at_1345_103);
}

inline TArray<regex::ReNode *> _FuncbuiltinTickto_array_moveTick3185538323411982277_b89e28f7cfb5d3e4 ( Context * __context__, TDim<regex::ReNode *,11> &  __a_rename_at_1343_104 )
{
    TArray<regex::ReNode *> __arr_rename_at_1345_105; das_zero(__arr_rename_at_1345_105);
    _FuncbuiltinTickresizeTick4811697762258667383_839271fc9974c3bd(__context__,das_arg<TArray<regex::ReNode *>>::pass(__arr_rename_at_1345_105),11);
    das_copy(das_cast<TDim<regex::ReNode *,11>>::cast(das_ref(__context__,__arr_rename_at_1345_105(0,__context__))),__a_rename_at_1343_104);
    return /* <- */ das_auto_cast_move<TArray<regex::ReNode *>>::cast(__arr_rename_at_1345_105);
}

inline TArray<int32_t> _FuncbuiltinTickto_array_moveTick3185538323411982277_941c3382ff6a8f19 ( Context * __context__, TDim<int32_t,12> &  __a_rename_at_1343_106 )
{
    TArray<int32_t> __arr_rename_at_1345_107; das_zero(__arr_rename_at_1345_107);
    _FuncbuiltinTickresizeTick4811697762258667383_1bdb9995fa062a51(__context__,das_arg<TArray<int32_t>>::pass(__arr_rename_at_1345_107),12);
    das_copy(das_cast<TDim<int32_t,12>>::cast(das_ref(__context__,__arr_rename_at_1345_107(0,__context__))),__a_rename_at_1343_106);
    return /* <- */ das_auto_cast_move<TArray<int32_t>>::cast(__arr_rename_at_1345_107);
}

static void registerAotFunctions ( AotLibrary & aotLib ) {
    aotLib[0x8fefe4f4cbc5da87] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTickresizeTick4811697762258667383_4a11e1a2d7a26774
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, TArray<faker::MonthNameAndDay> & , int32_t  ),&_FuncbuiltinTickresizeTick4811697762258667383_4a11e1a2d7a26774>>();
    };
    ...
    aotLib[0x3c523d3e76a38b81] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTicklengthTick18150397773952384912_33b466afca139f51
        return ctx.code->makeNode<SimNode_Aot<int32_t (*) ( Context * __context__, TDim<faker::MonthNameAndDay,12> const  &  ),&_FuncbuiltinTicklengthTick18150397773952384912_33b466afca139f51>>();
    };
    ...
    aotLib[0x79398589a9811ed4] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTicklengthTick18150397773952384912_9095ca2d63c1721d
        return ctx.code->makeNode<SimNode_Aot<int32_t (*) ( Context * __context__, TDim<TTuple<16,range,char *>,2> const  &  ),&_FuncbuiltinTicklengthTick18150397773952384912_9095ca2d63c1721d>>();
    };
    aotLib[0x7cd773c8ecab5771] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTicklengthTick18150397773952384912_1b80d94ba0caeb30
        return ctx.code->makeNode<SimNode_Aot<int32_t (*) ( Context * __context__, TDim<regex::ReNode *,11> const  &  ),&_FuncbuiltinTicklengthTick18150397773952384912_1b80d94ba0caeb30>>();
    };
    aotLib[0xc01bbb247bf1148e] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTicklengthTick18150397773952384912_196e9bb4a20e4071
        return ctx.code->makeNode<SimNode_Aot<int32_t (*) ( Context * __context__, TDim<int32_t,12> const  &  ),&_FuncbuiltinTicklengthTick18150397773952384912_196e9bb4a20e4071>>();
    };
    ...
    aotLib[0xcb85e5d8e0e4fafb] = +[](Context & ctx) -> SimNode* { // Faker_59d46974b1b304d6
        return ctx.code->makeNode<SimNode_AotCMRES<faker::Faker (*) ( Context * __context__, Sequence DAS_COMMENT((uint32_t)) &  ),&Faker_59d46974b1b304d6>>();
    };
    aotLib[0x1ed56f08bf5b6e47] = +[](Context & ctx) -> SimNode* { // long_string_875b49b236ac4f89
        return ctx.code->makeNode<SimNode_Aot<char * (*) ( Context * __context__, faker::Faker &  ),&long_string_875b49b236ac4f89>>();
    };
    aotLib[0xf0873fd960424664] = +[](Context & ctx) -> SimNode* { // any_string_15f79099e6d9ab67
        return ctx.code->makeNode<SimNode_Aot<char * (*) ( Context * __context__, faker::Faker &  ),&any_string_15f79099e6d9ab67>>();
    };
    aotLib[0x5bef4d1e31689a87] = +[](Context & ctx) -> SimNode* { // any_file_name_d4403d4c1c61d33a
        return ctx.code->makeNode<SimNode_Aot<char * (*) ( Context * __context__, faker::Faker &  ),&any_file_name_d4403d4c1c61d33a>>();
    };
    aotLib[0xc13fe671966070a4] = +[](Context & ctx) -> SimNode* { // random_int_3a09c34719d6987a
        return ctx.code->makeNode<SimNode_Aot<int32_t (*) ( Context * __context__, faker::Faker &  ),&random_int_3a09c34719d6987a>>();
    };
    aotLib[0xd9db6e68230bb405] = +[](Context & ctx) -> SimNode* { // random_uint_48c1d96ee6a2fa1f
        return ctx.code->makeNode<SimNode_Aot<uint32_t (*) ( Context * __context__, faker::Faker &  ),&random_uint_48c1d96ee6a2fa1f>>();
    };
    aotLib[0x6e901de4cefc2dc9] = +[](Context & ctx) -> SimNode* { // random_int8_adba239cfdd164ec
        return ctx.code->makeNode<SimNode_Aot<int8_t (*) ( Context * __context__, faker::Faker &  ),&random_int8_adba239cfdd164ec>>();
    };
    aotLib[0x36392943ce79b312] = +[](Context & ctx) -> SimNode* { // random_uint8_fed21af9d9296d72
        return ctx.code->makeNode<SimNode_Aot<uint8_t (*) ( Context * __context__, faker::Faker &  ),&random_uint8_fed21af9d9296d72>>();
    };
    aotLib[0x8319b397a3a640d3] = +[](Context & ctx) -> SimNode* { // random_int16_6895cd7e3df642c6
        return ctx.code->makeNode<SimNode_Aot<int16_t (*) ( Context * __context__, faker::Faker &  ),&random_int16_6895cd7e3df642c6>>();
    };
    aotLib[0x3b5673f54683ae72] = +[](Context & ctx) -> SimNode* { // random_uint16_c1e31ef902e5b237
        return ctx.code->makeNode<SimNode_Aot<uint16_t (*) ( Context * __context__, faker::Faker &  ),&random_uint16_c1e31ef902e5b237>>();
    };
    aotLib[0x408882a1e868bc6f] = +[](Context & ctx) -> SimNode* { // random_float_d13f217e417a6195
        return ctx.code->makeNode<SimNode_Aot<float (*) ( Context * __context__, faker::Faker &  ),&random_float_d13f217e417a6195>>();
    };
    aotLib[0xd890d6256208e4f5] = +[](Context & ctx) -> SimNode* { // random_int2_b996057eeb767b29
        return ctx.code->makeNode<SimNode_Aot<int2 (*) ( Context * __context__, faker::Faker &  ),&random_int2_b996057eeb767b29>>();
    };
    aotLib[0xe4b0511a7b4e90ca] = +[](Context & ctx) -> SimNode* { // random_range_42248669d64f6bfa
        return ctx.code->makeNode<SimNode_Aot<range (*) ( Context * __context__, faker::Faker &  ),&random_range_42248669d64f6bfa>>();
    };
    aotLib[0xd24a080e2d9861ac] = +[](Context & ctx) -> SimNode* { // random_range64_4e2d75e337fba734
        return ctx.code->makeNode<SimNode_Aot<range64 (*) ( Context * __context__, faker::Faker &  ),&random_range64_4e2d75e337fba734>>();
    };
    aotLib[0x7b619273dd290dd5] = +[](Context & ctx) -> SimNode* { // random_int3_786c72029f36e903
        return ctx.code->makeNode<SimNode_Aot<int3 (*) ( Context * __context__, faker::Faker &  ),&random_int3_786c72029f36e903>>();
    };
    aotLib[0xe4e6ad65fa8f1ad2] = +[](Context & ctx) -> SimNode* { // random_int4_43c372a071bb6152
        return ctx.code->makeNode<SimNode_Aot<int4 (*) ( Context * __context__, faker::Faker &  ),&random_int4_43c372a071bb6152>>();
    };
    aotLib[0x6bd644235daa272c] = +[](Context & ctx) -> SimNode* { // random_uint2_7bb4853565727aa3
        return ctx.code->makeNode<SimNode_Aot<uint2 (*) ( Context * __context__, faker::Faker &  ),&random_uint2_7bb4853565727aa3>>();
    };
    aotLib[0x70f55b987b16641e] = +[](Context & ctx) -> SimNode* { // random_urange_6b7ba6fed631c313
        return ctx.code->makeNode<SimNode_Aot<urange (*) ( Context * __context__, faker::Faker &  ),&random_urange_6b7ba6fed631c313>>();
    };
    aotLib[0x51aa24d3acf87828] = +[](Context & ctx) -> SimNode* { // random_urange64_58a23a7a62739555
        return ctx.code->makeNode<SimNode_Aot<urange64 (*) ( Context * __context__, faker::Faker &  ),&random_urange64_58a23a7a62739555>>();
    };
    aotLib[0x9f402ffc7be1ca26] = +[](Context & ctx) -> SimNode* { // random_uint3_cf2ec874dcc57e46
        return ctx.code->makeNode<SimNode_Aot<uint3 (*) ( Context * __context__, faker::Faker &  ),&random_uint3_cf2ec874dcc57e46>>();
    };
    aotLib[0x18872fddf025f68a] = +[](Context & ctx) -> SimNode* { // random_uint4_73b5ca3ed3c2246a
        return ctx.code->makeNode<SimNode_Aot<uint4 (*) ( Context * __context__, faker::Faker &  ),&random_uint4_73b5ca3ed3c2246a>>();
    };
    aotLib[0x1857c5aa1852afb8] = +[](Context & ctx) -> SimNode* { // random_float2_ae58988e8cdb9d2e
        return ctx.code->makeNode<SimNode_Aot<float2 (*) ( Context * __context__, faker::Faker &  ),&random_float2_ae58988e8cdb9d2e>>();
    };
    aotLib[0x16ff0e7afe24550d] = +[](Context & ctx) -> SimNode* { // random_float3_78ce5f1725e2deaf
        return ctx.code->makeNode<SimNode_Aot<float3 (*) ( Context * __context__, faker::Faker &  ),&random_float3_78ce5f1725e2deaf>>();
    };
    aotLib[0xccda100b6626a3a] = +[](Context & ctx) -> SimNode* { // random_float4_600d6fdfcbdad12a
        return ctx.code->makeNode<SimNode_Aot<float4 (*) ( Context * __context__, faker::Faker &  ),&random_float4_600d6fdfcbdad12a>>();
    };
    aotLib[0x4260f5f6a7b91d54] = +[](Context & ctx) -> SimNode* { // random_float3x3_bc3a1d35f3f59d7a
        return ctx.code->makeNode<SimNode_AotCMRES<float3x3 (*) ( Context * __context__, faker::Faker &  ),&random_float3x3_bc3a1d35f3f59d7a>>();
    };
    aotLib[0x27f233ac183f0237] = +[](Context & ctx) -> SimNode* { // random_float3x4_298a931cbd00a5b
        return ctx.code->makeNode<SimNode_AotCMRES<float3x4 (*) ( Context * __context__, faker::Faker &  ),&random_float3x4_298a931cbd00a5b>>();
    };
    aotLib[0xd3e8b03e0b995d89] = +[](Context & ctx) -> SimNode* { // random_float4x4_55310cc6af0b00d3
        return ctx.code->makeNode<SimNode_AotCMRES<float4x4 (*) ( Context * __context__, faker::Faker &  ),&random_float4x4_55310cc6af0b00d3>>();
    };
    aotLib[0xe1dd4ad8ad53ea1c] = +[](Context & ctx) -> SimNode* { // random_int64_adcf614eb324bd6
        return ctx.code->makeNode<SimNode_Aot<int64_t (*) ( Context * __context__, faker::Faker &  ),&random_int64_adcf614eb324bd6>>();
    };
    aotLib[0xa996e367d4b08e87] = +[](Context & ctx) -> SimNode* { // random_uint64_1dd8cfc88f1278b3
        return ctx.code->makeNode<SimNode_Aot<uint64_t (*) ( Context * __context__, faker::Faker &  ),&random_uint64_1dd8cfc88f1278b3>>();
    };
    aotLib[0xcf7390d0a9ac1a1b] = +[](Context & ctx) -> SimNode* { // random_double_630e8e853e6b1b86
        return ctx.code->makeNode<SimNode_Aot<double (*) ( Context * __context__, faker::Faker &  ),&random_double_630e8e853e6b1b86>>();
    };
    aotLib[0x8e54dd482ac2a7b2] = +[](Context & ctx) -> SimNode* { // any_set_80905e8b9babc71e
        return ctx.code->makeNode<SimNode_AotCMRES<TDim<uint32_t,8> (*) ( Context * __context__, faker::Faker &  ),&any_set_80905e8b9babc71e>>();
    };
    aotLib[0xae2b38efb61dc718] = +[](Context & ctx) -> SimNode* { // any_char_663cdf081aea103
        return ctx.code->makeNode<SimNode_Aot<int32_t (*) ( Context * __context__, faker::Faker &  ),&any_char_663cdf081aea103>>();
    };
    aotLib[0x2c60e53e140eee21] = +[](Context & ctx) -> SimNode* { // number_e6356a1f306d478b
        return ctx.code->makeNode<SimNode_Aot<char * (*) ( Context * __context__, faker::Faker &  ),&number_e6356a1f306d478b>>();
    };
    aotLib[0xceeebd7605b5dcb6] = +[](Context & ctx) -> SimNode* { // positive_int_3b17567f1d556fcd
        return ctx.code->makeNode<SimNode_Aot<char * (*) ( Context * __context__, faker::Faker &  ),&positive_int_3b17567f1d556fcd>>();
    };
    aotLib[0x9d1cbebcb356d984] = +[](Context & ctx) -> SimNode* { // any_int_4cd336181cd47a54
        return ctx.code->makeNode<SimNode_Aot<char * (*) ( Context * __context__, faker::Faker &  ),&any_int_4cd336181cd47a54>>();
    };
    aotLib[0x56209ab1d44771be] = +[](Context & ctx) -> SimNode* { // any_hex_907ff563a60e99f8
        return ctx.code->makeNode<SimNode_Aot<char * (*) ( Context * __context__, faker::Faker &  ),&any_hex_907ff563a60e99f8>>();
    };
    aotLib[0xd262c3a0ccdd4cf7] = +[](Context & ctx) -> SimNode* { // any_float_b56b5b6b39494ad9
        return ctx.code->makeNode<SimNode_Aot<char * (*) ( Context * __context__, faker::Faker &  ),&any_float_b56b5b6b39494ad9>>();
    };
    aotLib[0xb59d432eabc80453] = +[](Context & ctx) -> SimNode* { // any_uint_38a9a332ddf833e4
        return ctx.code->makeNode<SimNode_Aot<char * (*) ( Context * __context__, faker::Faker &  ),&any_uint_38a9a332ddf833e4>>();
    };
    aotLib[0x77f7eb7022e71de1] = +[](Context & ctx) -> SimNode* { // month_a77a201e79dc2fcb
        return ctx.code->makeNode<SimNode_Aot<char * (*) ( Context * __context__, faker::Faker &  ),&month_a77a201e79dc2fcb>>();
    };
    aotLib[0xb8bc426b7e13b709] = +[](Context & ctx) -> SimNode* { // day_87ca72478971c017
        return ctx.code->makeNode<SimNode_Aot<char * (*) ( Context * __context__, faker::Faker &  ),&day_87ca72478971c017>>();
    };
    aotLib[0x5de5ae6ea88e199c] = +[](Context & ctx) -> SimNode* { // is_leap_year_f2fa3913235d8028
        return ctx.code->makeNode<SimNode_Aot<bool (*) ( Context * __context__, uint32_t  ),&is_leap_year_f2fa3913235d8028>>();
    };
    aotLib[0xea59a740f9808a45] = +[](Context & ctx) -> SimNode* { // week_day_c6e5984db790860a
        return ctx.code->makeNode<SimNode_Aot<int32_t (*) ( Context * __context__, uint32_t , uint32_t , uint32_t  ),&week_day_c6e5984db790860a>>();
    };
    aotLib[0x3e404894b0fef31c] = +[](Context & ctx) -> SimNode* { // week_day_1dff8672450230ad
        return ctx.code->makeNode<SimNode_Aot<int32_t (*) ( Context * __context__, int32_t , int32_t , int32_t  ),&week_day_1dff8672450230ad>>();
    };
    aotLib[0x829b31c6072e84c7] = +[](Context & ctx) -> SimNode* { // date_716f0be714892d81
        return ctx.code->makeNode<SimNode_Aot<char * (*) ( Context * __context__, faker::Faker &  ),&date_716f0be714892d81>>();
    };
    aotLib[0x55a347cf32ebdcfa] = +[](Context & ctx) -> SimNode* { // Faker_f3a80b9fc0a885fc
        return ctx.code->makeNode<SimNode_AotCMRES<faker::Faker (*) ( Context * __context__ ),&Faker_f3a80b9fc0a885fc>>();
    };
    aotLib[0x9409072fc093ed0d] = +[](Context & ctx) -> SimNode* { // MonthNameAndDay_cc8a0af1d2e9f6ed
        return ctx.code->makeNode<SimNode_AotCMRES<faker::MonthNameAndDay (*) ( Context * __context__ ),&MonthNameAndDay_cc8a0af1d2e9f6ed>>();
    };
    aotLib[0x91b517ac491af44e] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTickto_array_moveTick3185538323411982277_978394c279bac03f
        return ctx.code->makeNode<SimNode_AotCMRES<TArray<faker::MonthNameAndDay> (*) ( Context * __context__, TDim<faker::MonthNameAndDay,12> &  ),&_FuncbuiltinTickto_array_moveTick3185538323411982277_978394c279bac03f>>();
    };
    aotLib[0x1dfd45c192faeef5] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTickto_array_moveTick3185538323411982277_1a5781405ff696dd
        return ctx.code->makeNode<SimNode_AotCMRES<TArray<TTuple<16,range,char *>> (*) ( Context * __context__, TDim<TTuple<16,range,char *>,1> &  ),&_FuncbuiltinTickto_array_moveTick3185538323411982277_1a5781405ff696dd>>();
    };
    aotLib[0xef58a349f7d06df5] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTickto_array_moveTick3185538323411982277_aa3e7370cfbb5f4f
        return ctx.code->makeNode<SimNode_AotCMRES<TArray<TTuple<16,range,char *>> (*) ( Context * __context__, TDim<TTuple<16,range,char *>,2> &  ),&_FuncbuiltinTickto_array_moveTick3185538323411982277_aa3e7370cfbb5f4f>>();
    };
    aotLib[0xc0c42654cc802572] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTickto_array_moveTick3185538323411982277_b89e28f7cfb5d3e4
        return ctx.code->makeNode<SimNode_AotCMRES<TArray<regex::ReNode *> (*) ( Context * __context__, TDim<regex::ReNode *,11> &  ),&_FuncbuiltinTickto_array_moveTick3185538323411982277_b89e28f7cfb5d3e4>>();
    };
    aotLib[0xf361194fc4feb410] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTickto_array_moveTick3185538323411982277_941c3382ff6a8f19
        return ctx.code->makeNode<SimNode_AotCMRES<TArray<int32_t> (*) ( Context * __context__, TDim<int32_t,12> &  ),&_FuncbuiltinTickto_array_moveTick3185538323411982277_941c3382ff6a8f19>>();
    };
    // [[ init script ]]
    aotLib[0xe39cd9c849a3b43c] = +[](Context & ctx) -> SimNode* {
