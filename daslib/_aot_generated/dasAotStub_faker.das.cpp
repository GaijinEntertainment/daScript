...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    ...
    aotLib[0x79398589a9811ed4] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTicklengthTick18150397773952384912_9095ca2d63c1721d
        return ctx.code->makeNode<SimNode_Aot<int32_t (*) ( Context * __context__, TDim<AutoTuple<range,char *>,2> const  &  ),&_FuncbuiltinTicklengthTick18150397773952384912_9095ca2d63c1721d>>();
    };
    ...
    aotLib[0x7d1aa9ff401df157] = +[](Context & ctx) -> SimNode* { // month_a77a201e79dc2fcb
    ...
    aotLib[0xfc9c1ad3aeaea536] = +[](Context & ctx) -> SimNode* { // date_716f0be714892d81
    ...
    aotLib[0x1dfd45c192faeef5] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTickto_array_moveTick3185538323411982277_1a5781405ff696dd
        return ctx.code->makeNode<SimNode_AotCMRES<TArray<AutoTuple<range,char *>> (*) ( Context * __context__, TDim<AutoTuple<range,char *>,1> &  ),&_FuncbuiltinTickto_array_moveTick3185538323411982277_1a5781405ff696dd>>();
    };
    aotLib[0xef58a349f7d06df5] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTickto_array_moveTick3185538323411982277_aa3e7370cfbb5f4f
        return ctx.code->makeNode<SimNode_AotCMRES<TArray<AutoTuple<range,char *>> (*) ( Context * __context__, TDim<AutoTuple<range,char *>,2> &  ),&_FuncbuiltinTickto_array_moveTick3185538323411982277_aa3e7370cfbb5f4f>>();
    };
