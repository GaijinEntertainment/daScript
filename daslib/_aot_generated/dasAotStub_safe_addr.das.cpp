...
inline smart_ptr_raw<FunctionAnnotation> _FuncastTickmake_function_annotationTick3074191368936885601_4418d6a36c08d1b9 ( Context * __context__, char * const  __name_rename_at_626_5, safe_addr::SafeAddrMacro * __someClassPtr_rename_at_626_6 );
inline smart_ptr_raw<FunctionAnnotation> _FuncastTickmake_function_annotationTick3074191368936885601_c48f5c2d32f99dfd ( Context * __context__, char * const  __name_rename_at_626_8, safe_addr::SharedAddrMacro * __someClassPtr_rename_at_626_9 );
inline smart_ptr_raw<FunctionAnnotation> _FuncastTickmake_function_annotationTick3074191368936885601_93921a0e6fa79f2b ( Context * __context__, char * const  __name_rename_at_626_11, safe_addr::TempValueMacro * __someClassPtr_rename_at_626_12 );
...
inline smart_ptr_raw<FunctionAnnotation> _FuncastTickmake_function_annotationTick3074191368936885601_4418d6a36c08d1b9 ( Context * __context__, char * const  __name_rename_at_626_5, safe_addr::SafeAddrMacro * __someClassPtr_rename_at_626_6 )
{
    _FuncbuiltinTickpushTick10769833213962245646_e64fa0322491795(__context__,das_arg<TArray<ast::AstFunctionAnnotation *>>::pass(das_global<TArray<ast::AstFunctionAnnotation *>,0x70a17c19e372bb43>(__context__) /*gc_root_AstFunctionAnnotation*/),das_reinterpret<ast::AstFunctionAnnotation *>::pass(__someClassPtr_rename_at_626_6));
    StructInfo const  * __classInfo_rename_at_629_7 = ((StructInfo const  *)_FuncrttiTickclass_infoTick15801393167907430156_e4d068f8c9d808e5(__context__,das_arg<safe_addr::SafeAddrMacro>::pass(das_deref(__context__,__someClassPtr_rename_at_626_6))));
    return /* <- */ das_auto_cast_move<smart_ptr_raw<FunctionAnnotation>>::cast(makeFunctionAnnotation(__name_rename_at_626_5,das_auto_cast<void * const >::cast(__someClassPtr_rename_at_626_6),__classInfo_rename_at_629_7,__context__));
}

inline smart_ptr_raw<FunctionAnnotation> _FuncastTickmake_function_annotationTick3074191368936885601_c48f5c2d32f99dfd ( Context * __context__, char * const  __name_rename_at_626_8, safe_addr::SharedAddrMacro * __someClassPtr_rename_at_626_9 )
{
    _FuncbuiltinTickpushTick10769833213962245646_e64fa0322491795(__context__,das_arg<TArray<ast::AstFunctionAnnotation *>>::pass(das_global<TArray<ast::AstFunctionAnnotation *>,0x70a17c19e372bb43>(__context__) /*gc_root_AstFunctionAnnotation*/),das_reinterpret<ast::AstFunctionAnnotation *>::pass(__someClassPtr_rename_at_626_9));
    StructInfo const  * __classInfo_rename_at_629_10 = ((StructInfo const  *)_FuncrttiTickclass_infoTick15801393167907430156_a511a317554846b4(__context__,das_arg<safe_addr::SharedAddrMacro>::pass(das_deref(__context__,__someClassPtr_rename_at_626_9))));
    return /* <- */ das_auto_cast_move<smart_ptr_raw<FunctionAnnotation>>::cast(makeFunctionAnnotation(__name_rename_at_626_8,das_auto_cast<void * const >::cast(__someClassPtr_rename_at_626_9),__classInfo_rename_at_629_10,__context__));
}

inline smart_ptr_raw<FunctionAnnotation> _FuncastTickmake_function_annotationTick3074191368936885601_93921a0e6fa79f2b ( Context * __context__, char * const  __name_rename_at_626_11, safe_addr::TempValueMacro * __someClassPtr_rename_at_626_12 )
{
    _FuncbuiltinTickpushTick10769833213962245646_e64fa0322491795(__context__,das_arg<TArray<ast::AstFunctionAnnotation *>>::pass(das_global<TArray<ast::AstFunctionAnnotation *>,0x70a17c19e372bb43>(__context__) /*gc_root_AstFunctionAnnotation*/),das_reinterpret<ast::AstFunctionAnnotation *>::pass(__someClassPtr_rename_at_626_12));
    StructInfo const  * __classInfo_rename_at_629_13 = ((StructInfo const  *)_FuncrttiTickclass_infoTick15801393167907430156_6d4ea7031e951f7d(__context__,das_arg<safe_addr::TempValueMacro>::pass(das_deref(__context__,__someClassPtr_rename_at_626_12))));
    return /* <- */ das_auto_cast_move<smart_ptr_raw<FunctionAnnotation>>::cast(makeFunctionAnnotation(__name_rename_at_626_11,das_auto_cast<void * const >::cast(__someClassPtr_rename_at_626_12),__classInfo_rename_at_629_13,__context__));
}
...
inline void _Funcast_boostTicksetup_tag_annotationTick4095297895764883997_bd8aa2a7ab06a770 ( Context * __context__, char * const  __name_rename_at_273_18, char * const  __tag_rename_at_273_19, safe_addr::SharedAddrMacro * __classPtr_rename_at_273_20 )
{
    ...
    das_invoke_function<void>::invoke<char * const ,smart_ptr_raw<FunctionAnnotation>>(__context__,nullptr,Func(__context__->fnByMangledName(/*@ast_boost::apply_tag_annotation Cs Y<FunctionAnnotationPtr>1<H<ast::FunctionAnnotation>>?M*/ 8536632802977626562u)),__tag_rename_at_273_19,__ann_rename_at_274_21);
...
inline void _Funcast_boostTicksetup_tag_annotationTick4095297895764883997_80a1209dc7a73916 ( Context * __context__, char * const  __name_rename_at_273_22, char * const  __tag_rename_at_273_23, safe_addr::TempValueMacro * __classPtr_rename_at_273_24 )
{
    ...
    das_invoke_function<void>::invoke<char * const ,smart_ptr_raw<FunctionAnnotation>>(__context__,nullptr,Func(__context__->fnByMangledName(/*@ast_boost::apply_tag_annotation Cs Y<FunctionAnnotationPtr>1<H<ast::FunctionAnnotation>>?M*/ 8536632802977626562u)),__tag_rename_at_273_23,__ann_rename_at_274_25);
...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    ...
    aotLib[0xc3bfc2a2e6d4e241] = +[](Context & ctx) -> SimNode* { // _FuncrttiTickclass_infoTick15801393167907430156_e4d068f8c9d808e5
        return ctx.code->makeNode<SimNode_Aot<StructInfo const  * (*) ( Context * __context__, safe_addr::SafeAddrMacro const  &  ),&_FuncrttiTickclass_infoTick15801393167907430156_e4d068f8c9d808e5>>();
    };
    aotLib[0x1e818db192e17aef] = +[](Context & ctx) -> SimNode* { // _FuncrttiTickclass_infoTick15801393167907430156_a511a317554846b4
        return ctx.code->makeNode<SimNode_Aot<StructInfo const  * (*) ( Context * __context__, safe_addr::SharedAddrMacro const  &  ),&_FuncrttiTickclass_infoTick15801393167907430156_a511a317554846b4>>();
    };
    aotLib[0x19a2435d0af034e2] = +[](Context & ctx) -> SimNode* { // _FuncrttiTickclass_infoTick15801393167907430156_6d4ea7031e951f7d
        return ctx.code->makeNode<SimNode_Aot<StructInfo const  * (*) ( Context * __context__, safe_addr::TempValueMacro const  &  ),&_FuncrttiTickclass_infoTick15801393167907430156_6d4ea7031e951f7d>>();
    };
    aotLib[0x8ee4d783874f461b] = +[](Context & ctx) -> SimNode* { // _FuncastTickmake_function_annotationTick3074191368936885601_4418d6a36c08d1b9
        return ctx.code->makeNode<SimNode_Aot<smart_ptr_raw<FunctionAnnotation> (*) ( Context * __context__, char * const  , safe_addr::SafeAddrMacro *  ),&_FuncastTickmake_function_annotationTick3074191368936885601_4418d6a36c08d1b9>>();
    };
    aotLib[0xcb995bd93c1034db] = +[](Context & ctx) -> SimNode* { // _FuncastTickmake_function_annotationTick3074191368936885601_c48f5c2d32f99dfd
        return ctx.code->makeNode<SimNode_Aot<smart_ptr_raw<FunctionAnnotation> (*) ( Context * __context__, char * const  , safe_addr::SharedAddrMacro *  ),&_FuncastTickmake_function_annotationTick3074191368936885601_c48f5c2d32f99dfd>>();
    };
    aotLib[0x7096795ea6bb698] = +[](Context & ctx) -> SimNode* { // _FuncastTickmake_function_annotationTick3074191368936885601_93921a0e6fa79f2b
        return ctx.code->makeNode<SimNode_Aot<smart_ptr_raw<FunctionAnnotation> (*) ( Context * __context__, char * const  , safe_addr::TempValueMacro *  ),&_FuncastTickmake_function_annotationTick3074191368936885601_93921a0e6fa79f2b>>();
    };
    aotLib[0x5417968edebc0ee7] = +[](Context & ctx) -> SimNode* { // _Funcast_boostTicksetup_tag_annotationTick4095297895764883997_47a4aec5bc3e02fc
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, char * const  , char * const  , safe_addr::SafeAddrMacro *  ),&_Funcast_boostTicksetup_tag_annotationTick4095297895764883997_47a4aec5bc3e02fc>>();
    };
    aotLib[0x78ea98730bbfa960] = +[](Context & ctx) -> SimNode* { // _Funcast_boostTicksetup_tag_annotationTick4095297895764883997_bd8aa2a7ab06a770
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, char * const  , char * const  , safe_addr::SharedAddrMacro *  ),&_Funcast_boostTicksetup_tag_annotationTick4095297895764883997_bd8aa2a7ab06a770>>();
    };
    aotLib[0x4e135c4bc67027eb] = +[](Context & ctx) -> SimNode* { // _Funcast_boostTicksetup_tag_annotationTick4095297895764883997_80a1209dc7a73916
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, char * const  , char * const  , safe_addr::TempValueMacro *  ),&_Funcast_boostTicksetup_tag_annotationTick4095297895764883997_80a1209dc7a73916>>();
    };
