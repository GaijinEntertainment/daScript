...
inline void _FuncLintVisitorTickpreVisitFunction_3e6910647f75d12f ( Context * __context__, lint::LintVisitor &  __self_rename_at_39_35, smart_ptr_raw<Function> const  __fun_rename_at_39_36 )
{
    das_copy(__self_rename_at_39_35.noLint,false);
    {
        ...
        smart_ptr_raw<AnnotationDeclaration> const  * __ann_rename_at_41_37;
...
{
    {
        ...
        smart_ptr_raw<Variable> const  * __v_rename_at_142_66;
        ...
        {
            das_invoke_method<void,offsetof(lint::LintVisitor,validate_var)>::invoke<lint::LintVisitor &,smart_ptr_raw<Variable> const ,bool>(__context__,nullptr,das_arg<lint::LintVisitor>::pass(__self_rename_at_141_64),(*__v_rename_at_142_66),true);
        }
...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    ...
    aotLib[0x4548c254b2d2efc2] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncbuiltinTick_return_with_lockcheckTick2939372000839727345_e8728e1dafbd5358>>();
    };
    ...
    aotLib[0x5bded5fdbe7c3e53] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncbuiltinTickpopTick1161079256290593740_3bfc3a673ced7fa2>>();
    };
    aotLib[0x9b7e45c8bea4d675] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncbuiltinTickbackTick18296309835877697278_e492987e0a1f2c26>>();
    };
    ...
    aotLib[0xd965938d14a70241] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncbuiltinTickget_ptrTick5807679485210906136_e8ac63235fcb6d6c>>();
    };
    aotLib[0x8f8ade607bd36ada] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncbuiltinTickget_ptrTick8468476673553620226_8d777f33f0af2fa5>>();
    };
    aotLib[0x3a9036884d0cfc88] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_Funcstrings_boostTickeqTick10467641742855300050_515bd3bb9c23dd46>>();
    };
    aotLib[0xf14aca799c211e2a] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncbuiltinTickget_ptrTick8468476673553620226_847aa4ed7b360b51>>();
    };
    ...
    aotLib[0x5943ad05f6a3b36a] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_AotCMRES<&LintVisitor_5055dc0e315810f0>>();
    };
    ...
    aotLib[0x6e7eadf9135cf166] = +[](Context & ctx) -> SimNode* {
