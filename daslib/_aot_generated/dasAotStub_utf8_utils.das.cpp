...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    ...
    aotLib[0x6f5b5ff36fdd650a] = +[](Context & ctx) -> SimNode* { // decode_unicode_escape_df0808a06ace62b0
        return ctx.code->makeNode<SimNode_Aot<char * (*) ( Context * __context__, char * const   ),&decode_unicode_escape_df0808a06ace62b0>>();
    };
    // [[ init script ]]
