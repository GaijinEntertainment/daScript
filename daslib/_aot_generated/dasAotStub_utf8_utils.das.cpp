...
namespace das {
namespace _anon_6195617824259852036 {
...
inline TArray<uint8_t> _FuncbuiltinTickto_array_moveTick3185538323411982277_ba90b9e0923e6277 ( Context * __context__, TDim<uint8_t,2> & __a_rename_at_1343_4 );
inline TArray<uint8_t> _FuncbuiltinTickto_array_moveTick3185538323411982277_1a0ad6f653eeb2ac ( Context * __context__, TDim<uint8_t,3> & __a_rename_at_1343_6 );
inline TArray<uint8_t> _FuncbuiltinTickto_array_moveTick3185538323411982277_21b6a0bab5d7baaa ( Context * __context__, TDim<uint8_t,4> & __a_rename_at_1343_8 );
inline TArray<uint8_t> _FuncbuiltinTickto_array_moveTick3185538323411982277_d728636f5ab2a3f8 ( Context * __context__, TDim<uint8_t,1> & __a_rename_at_1343_10 );
...
inline char * decode_unicode_escape_8e0a7817ce6cdcf4 ( Context * __context__, char * const  __str_rename_at_224_71 );
...
inline TArray<uint8_t> _FuncbuiltinTickto_array_moveTick3185538323411982277_ba90b9e0923e6277 ( Context * __context__, TDim<uint8_t,2> &  __a_rename_at_1343_4 )
{
    TArray<uint8_t> __arr_rename_at_1345_5; das_zero(__arr_rename_at_1345_5);
    _FuncbuiltinTickresizeTick4811697762258667383_2333bfdfd8018176(__context__,das_arg<TArray<uint8_t>>::pass(__arr_rename_at_1345_5),2);
    das_copy(das_cast<TDim<uint8_t,2>>::cast(das_ref(__context__,__arr_rename_at_1345_5(0,__context__))),__a_rename_at_1343_4);
    return /* <- */ das_auto_cast_move<TArray<uint8_t>>::cast(__arr_rename_at_1345_5);
}

inline TArray<uint8_t> _FuncbuiltinTickto_array_moveTick3185538323411982277_1a0ad6f653eeb2ac ( Context * __context__, TDim<uint8_t,3> &  __a_rename_at_1343_6 )
{
    TArray<uint8_t> __arr_rename_at_1345_7; das_zero(__arr_rename_at_1345_7);
    _FuncbuiltinTickresizeTick4811697762258667383_2333bfdfd8018176(__context__,das_arg<TArray<uint8_t>>::pass(__arr_rename_at_1345_7),3);
    das_copy(das_cast<TDim<uint8_t,3>>::cast(das_ref(__context__,__arr_rename_at_1345_7(0,__context__))),__a_rename_at_1343_6);
    return /* <- */ das_auto_cast_move<TArray<uint8_t>>::cast(__arr_rename_at_1345_7);
}

inline TArray<uint8_t> _FuncbuiltinTickto_array_moveTick3185538323411982277_21b6a0bab5d7baaa ( Context * __context__, TDim<uint8_t,4> &  __a_rename_at_1343_8 )
{
    TArray<uint8_t> __arr_rename_at_1345_9; das_zero(__arr_rename_at_1345_9);
    _FuncbuiltinTickresizeTick4811697762258667383_2333bfdfd8018176(__context__,das_arg<TArray<uint8_t>>::pass(__arr_rename_at_1345_9),4);
    das_copy(das_cast<TDim<uint8_t,4>>::cast(das_ref(__context__,__arr_rename_at_1345_9(0,__context__))),__a_rename_at_1343_8);
    return /* <- */ das_auto_cast_move<TArray<uint8_t>>::cast(__arr_rename_at_1345_9);
}

inline TArray<uint8_t> _FuncbuiltinTickto_array_moveTick3185538323411982277_d728636f5ab2a3f8 ( Context * __context__, TDim<uint8_t,1> &  __a_rename_at_1343_10 )
{
    TArray<uint8_t> __arr_rename_at_1345_11; das_zero(__arr_rename_at_1345_11);
    _FuncbuiltinTickresizeTick4811697762258667383_2333bfdfd8018176(__context__,das_arg<TArray<uint8_t>>::pass(__arr_rename_at_1345_11),1);
    das_copy(das_cast<TDim<uint8_t,1>>::cast(das_ref(__context__,__arr_rename_at_1345_11(0,__context__))),__a_rename_at_1343_10);
    return /* <- */ das_auto_cast_move<TArray<uint8_t>>::cast(__arr_rename_at_1345_11);
}
...
inline char * decode_unicode_escape_8e0a7817ce6cdcf4 ( Context * __context__, char * const  __str_rename_at_224_71 ) { das_stack_prologue __prologue(__context__,384,"decode_unicode_escape " DAS_FILE_LINE);
{
        ...
        builtin_string_peek(__str_rename_at_224_71,das_make_block<void,TArray<uint8_t> const  &>(__context__,144,0,&__func_info__2f76c7f7dd4f0b27,[&](TArray<uint8_t> const  & __p_rename_at_226_73) -> void{
            ...
            while ( __i_rename_at_227_74 < __llen_rename_at_228_75 )
            {
                if ( das_equ_val(__p_rename_at_226_73(__i_rename_at_227_74,__context__),0x5c) )
                {
                    ...
                    while ( (__j_rename_at_234_78 < __jlen_rename_at_235_79) && das_invoke_function<bool>::invoke<int32_t>(__context__,nullptr,Func(__context__->fnByMangledName(/*@strings_boost::is_hex Ci*/ 13255244687218186342u)),int32_t(__p_rename_at_226_73(__j_rename_at_234_78,__context__))) )
                    {
...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    aotLib[0x5f2482cc28bc3b00] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTicklengthTick18150397773952384912_424e5a5af176be26
        return ctx.code->makeNode<SimNode_Aot<int32_t (*) ( Context * __context__, TDim<uint8_t,2> const  &  ),&_FuncbuiltinTicklengthTick18150397773952384912_424e5a5af176be26>>();
    };
    aotLib[0x6fe85bba2d9b3792] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTicklengthTick18150397773952384912_2d5894d58d05f52
        return ctx.code->makeNode<SimNode_Aot<int32_t (*) ( Context * __context__, TDim<uint8_t,3> const  &  ),&_FuncbuiltinTicklengthTick18150397773952384912_2d5894d58d05f52>>();
    };
    aotLib[0x526025a25c517ee9] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTicklengthTick18150397773952384912_5e3beb551331dc06
        return ctx.code->makeNode<SimNode_Aot<int32_t (*) ( Context * __context__, TDim<uint8_t,4> const  &  ),&_FuncbuiltinTicklengthTick18150397773952384912_5e3beb551331dc06>>();
    };
    aotLib[0x6c2b0f397612e34b] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTicklengthTick18150397773952384912_1e99f990a58976cb
        return ctx.code->makeNode<SimNode_Aot<int32_t (*) ( Context * __context__, TDim<uint8_t,1> const  &  ),&_FuncbuiltinTicklengthTick18150397773952384912_1e99f990a58976cb>>();
    };
    aotLib[0x13c291e559c1178d] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTickto_array_moveTick3185538323411982277_ba90b9e0923e6277
        return ctx.code->makeNode<SimNode_AotCMRES<TArray<uint8_t> (*) ( Context * __context__, TDim<uint8_t,2> &  ),&_FuncbuiltinTickto_array_moveTick3185538323411982277_ba90b9e0923e6277>>();
    };
    aotLib[0x874148240ba53e70] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTickto_array_moveTick3185538323411982277_1a0ad6f653eeb2ac
        return ctx.code->makeNode<SimNode_AotCMRES<TArray<uint8_t> (*) ( Context * __context__, TDim<uint8_t,3> &  ),&_FuncbuiltinTickto_array_moveTick3185538323411982277_1a0ad6f653eeb2ac>>();
    };
    aotLib[0x4e0d182e087b694b] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTickto_array_moveTick3185538323411982277_21b6a0bab5d7baaa
        return ctx.code->makeNode<SimNode_AotCMRES<TArray<uint8_t> (*) ( Context * __context__, TDim<uint8_t,4> &  ),&_FuncbuiltinTickto_array_moveTick3185538323411982277_21b6a0bab5d7baaa>>();
    };
    aotLib[0x7b02d904566d5285] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTickto_array_moveTick3185538323411982277_d728636f5ab2a3f8
        return ctx.code->makeNode<SimNode_AotCMRES<TArray<uint8_t> (*) ( Context * __context__, TDim<uint8_t,1> &  ),&_FuncbuiltinTickto_array_moveTick3185538323411982277_d728636f5ab2a3f8>>();
    };
    ...
    aotLib[0x3fd458c03e0e1bc4] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTick_return_with_lockcheckTick2939372000839727345_1a59b191ca6010ed
        return ctx.code->makeNode<SimNode_Aot<TArray<uint32_t> & (*) ( Context * __context__, TArray<uint32_t> &  ),&_FuncbuiltinTick_return_with_lockcheckTick2939372000839727345_1a59b191ca6010ed>>();
    };
    ...
    aotLib[0xeb5dd5f9d13978f3] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTickpushTick10769833213962245646_427d344a8b35c688
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, TArray<uint32_t> & , uint32_t  ),&_FuncbuiltinTickpushTick10769833213962245646_427d344a8b35c688>>();
    };
    ...
    aotLib[0x46001bd7127d172b] = +[](Context & ctx) -> SimNode* { // utf16_to_utf32_cff3dafb1197cdfe
        return ctx.code->makeNode<SimNode_Aot<uint32_t (*) ( Context * __context__, uint32_t , uint32_t  ),&utf16_to_utf32_cff3dafb1197cdfe>>();
    };
    aotLib[0x1d80df2a87f5d37] = +[](Context & ctx) -> SimNode* { // utf8_encode_15cfb73a783e13c3
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, TArray<uint8_t> & , uint32_t  ),&utf8_encode_15cfb73a783e13c3>>();
    };
    aotLib[0xa82221cffa011996] = +[](Context & ctx) -> SimNode* { // utf8_encode_2d952f7f68ca2b1c
        return ctx.code->makeNode<SimNode_AotCMRES<TArray<uint8_t> (*) ( Context * __context__, uint32_t  ),&utf8_encode_2d952f7f68ca2b1c>>();
    };
    aotLib[0xf6144c3e88540c9b] = +[](Context & ctx) -> SimNode* { // utf8_encode_889398f5ff1395f8
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, TArray<uint8_t> & , TArray<uint32_t> const  &  ),&utf8_encode_889398f5ff1395f8>>();
    };
    aotLib[0x562526173e008e5a] = +[](Context & ctx) -> SimNode* { // utf8_encode_bb86a30e653769b3
        return ctx.code->makeNode<SimNode_AotCMRES<TArray<uint8_t> (*) ( Context * __context__, TArray<uint32_t> const  &  ),&utf8_encode_bb86a30e653769b3>>();
    };
    aotLib[0x1a3234293f14078e] = +[](Context & ctx) -> SimNode* { // utf8_length_907cab2006cee353
        return ctx.code->makeNode<SimNode_Aot<int32_t (*) ( Context * __context__, TArray<uint8_t> const  &  ),&utf8_length_907cab2006cee353>>();
    };
    aotLib[0x488c7268b82f5ab6] = +[](Context & ctx) -> SimNode* { // utf8_length_12b5fbe4d57291a4
        return ctx.code->makeNode<SimNode_Aot<int32_t (*) ( Context * __context__, char * const   ),&utf8_length_12b5fbe4d57291a4>>();
    };
    aotLib[0xf07e14b83278670c] = +[](Context & ctx) -> SimNode* { // is_first_byte_of_utf8_char_54d6de0ccc3233ff
        return ctx.code->makeNode<SimNode_Aot<bool (*) ( Context * __context__, uint8_t  ),&is_first_byte_of_utf8_char_54d6de0ccc3233ff>>();
    };
    aotLib[0x3b17c0ad59e73aa6] = +[](Context & ctx) -> SimNode* { // contains_utf8_bom_726579135064e73d
        return ctx.code->makeNode<SimNode_Aot<bool (*) ( Context * __context__, TArray<uint8_t> const  &  ),&contains_utf8_bom_726579135064e73d>>();
    };
    aotLib[0xf7f7c8398c467786] = +[](Context & ctx) -> SimNode* { // contains_utf8_bom_64466034c8e654eb
        return ctx.code->makeNode<SimNode_Aot<bool (*) ( Context * __context__, char * const   ),&contains_utf8_bom_64466034c8e654eb>>();
    };
    aotLib[0x1b238807503fe2d4] = +[](Context & ctx) -> SimNode* { // is_utf8_string_valid_d24fc2ea4690cc02
        return ctx.code->makeNode<SimNode_Aot<bool (*) ( Context * __context__, TArray<uint8_t> const  &  ),&is_utf8_string_valid_d24fc2ea4690cc02>>();
    };
    aotLib[0x4187a84932c9680c] = +[](Context & ctx) -> SimNode* { // is_utf8_string_valid_76d0a9290bfdca2a
        return ctx.code->makeNode<SimNode_Aot<bool (*) ( Context * __context__, char * const   ),&is_utf8_string_valid_76d0a9290bfdca2a>>();
    };
    aotLib[0x1b23d845338fcc5e] = +[](Context & ctx) -> SimNode* { // utf8_decode_52e084b93ad4506a
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, TArray<uint32_t> & , TArray<uint8_t> const  &  ),&utf8_decode_52e084b93ad4506a>>();
    };
    aotLib[0x7f6a8b11913cf894] = +[](Context & ctx) -> SimNode* { // utf8_decode_51ff5fd68ff03ae1
        return ctx.code->makeNode<SimNode_AotCMRES<TArray<uint32_t> (*) ( Context * __context__, TArray<uint8_t> const  &  ),&utf8_decode_51ff5fd68ff03ae1>>();
    };
    aotLib[0xef2b9dd4721d9ff9] = +[](Context & ctx) -> SimNode* { // utf8_decode_3fd2d37cfb73e2d
        return ctx.code->makeNode<SimNode_AotCMRES<TArray<uint32_t> (*) ( Context * __context__, char * const   ),&utf8_decode_3fd2d37cfb73e2d>>();
    };
    aotLib[0x66709658358af242] = +[](Context & ctx) -> SimNode* { // utf8_decode_14c6fb677c005963
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, TArray<uint32_t> & , char * const   ),&utf8_decode_14c6fb677c005963>>();
    };
    aotLib[0x9873654d943a1a04] = +[](Context & ctx) -> SimNode* { // decode_unicode_escape_8e0a7817ce6cdcf4
        return ctx.code->makeNode<SimNode_Aot<char * (*) ( Context * __context__, char * const   ),&decode_unicode_escape_8e0a7817ce6cdcf4>>();
    };
    // [[ init script ]]
...
AotListBase impl_aot_utf8_utils(_anon_6195617824259852036::registerAotFunctions);
} // namespace das
