...
inline int32_t _FuncbuiltinTicklengthTick18150397773952384912_8924d568ae15c627 ( Context * __context__, TDim<uint8_t,2> const  & __a_rename_at_581_0 );
inline int32_t _FuncbuiltinTicklengthTick18150397773952384912_9dc25a6813327d8a ( Context * __context__, TDim<uint8_t,3> const  & __a_rename_at_581_1 );
inline int32_t _FuncbuiltinTicklengthTick18150397773952384912_876c88e6150f3015 ( Context * __context__, TDim<uint8_t,4> const  & __a_rename_at_581_2 );
inline int32_t _FuncbuiltinTicklengthTick18150397773952384912_630149089a809fff ( Context * __context__, TDim<uint8_t,1> const  & __a_rename_at_581_3 );
inline TArray<uint8_t> _FuncbuiltinTickto_array_moveTick3185538323411982277_c78c6b393becaeaa ( Context * __context__, TDim<uint8_t,2> & __a_rename_at_1375_4 );
inline TArray<uint8_t> _FuncbuiltinTickto_array_moveTick3185538323411982277_c60b650d5251f23f ( Context * __context__, TDim<uint8_t,3> & __a_rename_at_1375_6 );
inline TArray<uint8_t> _FuncbuiltinTickto_array_moveTick3185538323411982277_f0fc7e1ebd381ced ( Context * __context__, TDim<uint8_t,4> & __a_rename_at_1375_8 );
inline TArray<uint8_t> _FuncbuiltinTickto_array_moveTick3185538323411982277_ee64b3c558d03193 ( Context * __context__, TDim<uint8_t,1> & __a_rename_at_1375_10 );
inline TArray<uint8_t> & _FuncbuiltinTick_return_with_lockcheckTick2939372000839727345_b03382bd660b7650 ( Context * __context__, TArray<uint8_t> & __a_rename_at_50_12 );
inline TArray<uint32_t> & _FuncbuiltinTick_return_with_lockcheckTick2939372000839727345_542642850e45b365 ( Context * __context__, TArray<uint32_t> & __a_rename_at_50_13 );
inline void _FuncbuiltinTickpushTick14133213201864676143_d8f0a51920afdbe4 ( Context * __context__, TArray<uint8_t> & __Arr_rename_at_165_14, uint8_t __value_rename_at_165_15 );
...
inline void _FuncbuiltinTickpushTick10769833213962245646_9e01ae7861ebbd4c ( Context * __context__, TArray<uint32_t> & __Arr_rename_at_181_18, uint32_t __value_rename_at_181_19 );
inline void _FuncbuiltinTickresizeTick4811697762258667383_71af0b01dbdb30b2 ( Context * __context__, TArray<uint8_t> & __Arr_rename_at_68_20, int32_t __newSize_rename_at_68_21 );
inline uint32_t utf16_to_utf32_4accdbc7c053b25 ( Context * __context__, uint32_t __high_rename_at_10_22, uint32_t __low_rename_at_10_23 );
inline void utf8_encode_6f198025ba29e8fb ( Context * __context__, TArray<uint8_t> & __dest_array_rename_at_18_24, uint32_t __ch_rename_at_18_25 );
inline TArray<uint8_t> utf8_encode_7ba5e24450754bfc ( Context * __context__, uint32_t __ch_rename_at_38_26 );
inline void utf8_encode_75988af893dceb50 ( Context * __context__, TArray<uint8_t> & __dest_array_rename_at_61_27, TArray<uint32_t> const  & __source_utf32_string_rename_at_61_28 );
inline TArray<uint8_t> utf8_encode_b6b6d2f902ca7d83 ( Context * __context__, TArray<uint32_t> const  & __source_utf32_string_rename_at_69_30 );
inline int32_t utf8_length_3b384448a99ef0a7 ( Context * __context__, TArray<uint8_t> const  & __utf8_string_rename_at_80_33 );
inline int32_t utf8_length_f065f8e1e965b045 ( Context * __context__, char * const  __utf8_string_rename_at_92_36 );
inline bool is_first_byte_of_utf8_char_b03f82b76c79f3c5 ( Context * __context__, uint8_t __ch_rename_at_104_39 );
inline bool contains_utf8_bom_8ffb66694926e49a ( Context * __context__, TArray<uint8_t> const  & __utf8_string_rename_at_110_41 );
inline bool contains_utf8_bom_383ef1852eae7df0 ( Context * __context__, char * const  __utf8_string_rename_at_116_42 );
inline bool is_utf8_string_valid_8ffb66694926e49a ( Context * __context__, TArray<uint8_t> const  & __utf8_string_rename_at_154_43 );
inline bool is_utf8_string_valid_383ef1852eae7df0 ( Context * __context__, char * const  __utf8_string_rename_at_167_49 );
inline void utf8_decode_40ac4529d86fd52b ( Context * __context__, TArray<uint32_t> & __dest_utf32_string_rename_at_180_55, TArray<uint8_t> const  & __source_utf8_string_rename_at_180_56 );
inline TArray<uint32_t> utf8_decode_de0bc33c996f0ff0 ( Context * __context__, TArray<uint8_t> const  & __source_utf8_string_rename_at_199_63 );
inline TArray<uint32_t> utf8_decode_9d56bd9de8f6b62e ( Context * __context__, char * const  __source_utf8_string_rename_at_207_65 );
inline void utf8_decode_4b8aecf7ba702a09 ( Context * __context__, TArray<uint32_t> & __dest_utf32_string_rename_at_217_68, char * const  __source_utf8_string_rename_at_217_69 );
inline char * decode_unicode_escape_f4d706cf7ae62b2d ( Context * __context__, char * const  __str_rename_at_224_71 );
...
inline TArray<uint8_t> _FuncbuiltinTickto_array_moveTick3185538323411982277_c78c6b393becaeaa ( Context * __context__, TDim<uint8_t,2> &  __a_rename_at_1375_4 )
{
    ...
    _FuncbuiltinTickresizeTick4811697762258667383_71af0b01dbdb30b2(__context__,das_arg<TArray<uint8_t>>::pass(__arr_rename_at_1377_5),2);
...
inline TArray<uint8_t> _FuncbuiltinTickto_array_moveTick3185538323411982277_c60b650d5251f23f ( Context * __context__, TDim<uint8_t,3> &  __a_rename_at_1375_6 )
{
    ...
    _FuncbuiltinTickresizeTick4811697762258667383_71af0b01dbdb30b2(__context__,das_arg<TArray<uint8_t>>::pass(__arr_rename_at_1377_7),3);
...
inline TArray<uint8_t> _FuncbuiltinTickto_array_moveTick3185538323411982277_f0fc7e1ebd381ced ( Context * __context__, TDim<uint8_t,4> &  __a_rename_at_1375_8 )
{
    ...
    _FuncbuiltinTickresizeTick4811697762258667383_71af0b01dbdb30b2(__context__,das_arg<TArray<uint8_t>>::pass(__arr_rename_at_1377_9),4);
...
inline TArray<uint8_t> _FuncbuiltinTickto_array_moveTick3185538323411982277_ee64b3c558d03193 ( Context * __context__, TDim<uint8_t,1> &  __a_rename_at_1375_10 )
{
    ...
    _FuncbuiltinTickresizeTick4811697762258667383_71af0b01dbdb30b2(__context__,das_arg<TArray<uint8_t>>::pass(__arr_rename_at_1377_11),1);
...
inline void utf8_encode_6f198025ba29e8fb ( Context * __context__, TArray<uint8_t> &  __dest_array_rename_at_18_24, uint32_t __ch_rename_at_18_25 )
{
    ...
    {
        _FuncbuiltinTickpushTick14133213201864676143_d8f0a51920afdbe4(__context__,das_arg<TArray<uint8_t>>::pass(__dest_array_rename_at_18_24),uint8_t(__ch_rename_at_18_25));
    } else if ( __ch_rename_at_18_25 < 0x800u )
    {
        _FuncbuiltinTickpushTick14133213201864676143_d8f0a51920afdbe4(__context__,das_arg<TArray<uint8_t>>::pass(__dest_array_rename_at_18_24),uint8_t((__ch_rename_at_18_25 >> 0x6u) + 0xc0u));
        _FuncbuiltinTickpushTick14133213201864676143_d8f0a51920afdbe4(__context__,das_arg<TArray<uint8_t>>::pass(__dest_array_rename_at_18_24),uint8_t((__ch_rename_at_18_25 & 0x3fu) + 0x80u));
    } else if ( __ch_rename_at_18_25 < 0x10000u )
    {
        _FuncbuiltinTickpushTick14133213201864676143_d8f0a51920afdbe4(__context__,das_arg<TArray<uint8_t>>::pass(__dest_array_rename_at_18_24),uint8_t((__ch_rename_at_18_25 >> 0xcu) + 0xe0u));
        _FuncbuiltinTickpushTick14133213201864676143_d8f0a51920afdbe4(__context__,das_arg<TArray<uint8_t>>::pass(__dest_array_rename_at_18_24),uint8_t(((__ch_rename_at_18_25 >> 0x6u) & 0x3fu) + 0x80u));
        _FuncbuiltinTickpushTick14133213201864676143_d8f0a51920afdbe4(__context__,das_arg<TArray<uint8_t>>::pass(__dest_array_rename_at_18_24),uint8_t((__ch_rename_at_18_25 & 0x3fu) + 0x80u));
    } else {
        _FuncbuiltinTickpushTick14133213201864676143_d8f0a51920afdbe4(__context__,das_arg<TArray<uint8_t>>::pass(__dest_array_rename_at_18_24),uint8_t((__ch_rename_at_18_25 >> 0x12u) + 0xf0u));
        _FuncbuiltinTickpushTick14133213201864676143_d8f0a51920afdbe4(__context__,das_arg<TArray<uint8_t>>::pass(__dest_array_rename_at_18_24),uint8_t(((__ch_rename_at_18_25 >> 0xcu) & 0x3fu) + 0x80u));
        _FuncbuiltinTickpushTick14133213201864676143_d8f0a51920afdbe4(__context__,das_arg<TArray<uint8_t>>::pass(__dest_array_rename_at_18_24),uint8_t(((__ch_rename_at_18_25 >> 0x6u) & 0x3fu) + 0x80u));
        _FuncbuiltinTickpushTick14133213201864676143_d8f0a51920afdbe4(__context__,das_arg<TArray<uint8_t>>::pass(__dest_array_rename_at_18_24),uint8_t((__ch_rename_at_18_25 & 0x3fu) + 0x80u));
    };
}
...
inline TArray<uint8_t> utf8_encode_7ba5e24450754bfc ( Context * __context__, uint32_t __ch_rename_at_38_26 )
{
    if ( __ch_rename_at_38_26 < 0x80u )
    {
        ...
        return /* <- */ das_auto_cast_move<TArray<uint8_t>>::cast(_FuncbuiltinTick_return_with_lockcheckTick2939372000839727345_b03382bd660b7650(__context__,das_arg<TArray<uint8_t>>::pass((_temp_make_local_41_19_32 = (_FuncbuiltinTickto_array_moveTick3185538323411982277_ee64b3c558d03193(__context__,das_arg<TDim<uint8_t,1>>::pass((([&]() -> TDim<uint8_t,1>& {
    ...
    } else if ( __ch_rename_at_38_26 < 0x800u )
    {
        ...
        return /* <- */ das_auto_cast_move<TArray<uint8_t>>::cast(_FuncbuiltinTick_return_with_lockcheckTick2939372000839727345_b03382bd660b7650(__context__,das_arg<TArray<uint8_t>>::pass((_temp_make_local_43_19_80 = (_FuncbuiltinTickto_array_moveTick3185538323411982277_c78c6b393becaeaa(__context__,das_arg<TDim<uint8_t,2>>::pass((([&]() -> TDim<uint8_t,2>& {
    ...
    } else if ( __ch_rename_at_38_26 < 0x10000u )
    {
        ...
        return /* <- */ das_auto_cast_move<TArray<uint8_t>>::cast(_FuncbuiltinTick_return_with_lockcheckTick2939372000839727345_b03382bd660b7650(__context__,das_arg<TArray<uint8_t>>::pass((_temp_make_local_47_19_128 = (_FuncbuiltinTickto_array_moveTick3185538323411982277_c60b650d5251f23f(__context__,das_arg<TDim<uint8_t,3>>::pass((([&]() -> TDim<uint8_t,3>& {
        ...
        return /* <- */ das_auto_cast_move<TArray<uint8_t>>::cast(_FuncbuiltinTick_return_with_lockcheckTick2939372000839727345_b03382bd660b7650(__context__,das_arg<TArray<uint8_t>>::pass((_temp_make_local_52_19_176 = (_FuncbuiltinTickto_array_moveTick3185538323411982277_f0fc7e1ebd381ced(__context__,das_arg<TDim<uint8_t,4>>::pass((([&]() -> TDim<uint8_t,4>& {
...
{
    {
        ...
        {
            utf8_encode_6f198025ba29e8fb(__context__,das_arg<TArray<uint8_t>>::pass(__dest_array_rename_at_61_27),(*__ch_rename_at_63_29));
        }
...
inline TArray<uint8_t> utf8_encode_b6b6d2f902ca7d83 ( Context * __context__, TArray<uint32_t> const  &  __source_utf32_string_rename_at_69_30 )
{
    ...
    _FuncbuiltinTickreserveTick3994685146752941225_71af0b01dbdb30b2(__context__,das_arg<TArray<uint8_t>>::pass(__dest_array_rename_at_71_31),builtin_array_size(__source_utf32_string_rename_at_69_30));
    {
        ...
        {
            utf8_encode_6f198025ba29e8fb(__context__,das_arg<TArray<uint8_t>>::pass(__dest_array_rename_at_71_31),(*__ch_rename_at_73_32));
        }
        __ch_iterator.close(__context__,(__ch_rename_at_73_32));
    };
    return /* <- */ das_auto_cast_move<TArray<uint8_t>>::cast(_FuncbuiltinTick_return_with_lockcheckTick2939372000839727345_b03382bd660b7650(__context__,das_arg<TArray<uint8_t>>::pass(__dest_array_rename_at_71_31)));
}
...
inline void utf8_decode_40ac4529d86fd52b ( Context * __context__, TArray<uint32_t> &  __dest_utf32_string_rename_at_180_55, TArray<uint8_t> const  &  __source_utf8_string_rename_at_180_56 )
{
    ...
    int32_t __i_rename_at_185_60 = (contains_utf8_bom_8ffb66694926e49a(__context__,__source_utf8_string_rename_at_180_56) ? das_auto_cast<int32_t>::cast(3) : das_auto_cast<int32_t>::cast(0));
    while ( __i_rename_at_185_60 < __length_rename_at_184_59 )
    {
        ...
        {
            _FuncbuiltinTickpushTick10769833213962245646_9e01ae7861ebbd4c(__context__,das_arg<TArray<uint32_t>>::pass(__dest_utf32_string_rename_at_180_55),__codepoint_rename_at_182_57);
        };
    };
}
...
inline TArray<uint32_t> utf8_decode_de0bc33c996f0ff0 ( Context * __context__, TArray<uint8_t> const  &  __source_utf8_string_rename_at_199_63 )
{
    ...
    utf8_decode_40ac4529d86fd52b(__context__,das_arg<TArray<uint32_t>>::pass(__dest_utf32_string_rename_at_201_64),__source_utf8_string_rename_at_199_63);
    return /* <- */ das_auto_cast_move<TArray<uint32_t>>::cast(_FuncbuiltinTick_return_with_lockcheckTick2939372000839727345_542642850e45b365(__context__,das_arg<TArray<uint32_t>>::pass(__dest_utf32_string_rename_at_201_64)));
}

inline TArray<uint32_t> utf8_decode_9d56bd9de8f6b62e ( Context * __context__, char * const  __source_utf8_string_rename_at_207_65 ) { das_stack_prologue __prologue(__context__,96,"utf8_decode " DAS_FILE_LINE);
{
    ...
    builtin_string_peek(__source_utf8_string_rename_at_207_65,das_make_block<void,TArray<uint8_t> const  &>(__context__,80,0,&__func_info__5f4b6da70ca496e2,[&](TArray<uint8_t> const  & __arr_rename_at_210_67) -> void{
        utf8_decode_40ac4529d86fd52b(__context__,das_arg<TArray<uint32_t>>::pass(__dest_utf32_string_rename_at_209_66),__arr_rename_at_210_67);
    }),__context__,((LineInfoArg *)(&LineInfo::g_LineInfoNULL)));
    return /* <- */ das_auto_cast_move<TArray<uint32_t>>::cast(_FuncbuiltinTick_return_with_lockcheckTick2939372000839727345_542642850e45b365(__context__,das_arg<TArray<uint32_t>>::pass(__dest_utf32_string_rename_at_209_66)));
}}

inline void utf8_decode_4b8aecf7ba702a09 ( Context * __context__, TArray<uint32_t> &  __dest_utf32_string_rename_at_217_68, char * const  __source_utf8_string_rename_at_217_69 ) { das_stack_prologue __prologue(__context__,96,"utf8_decode " DAS_FILE_LINE);
{
    builtin_string_peek(__source_utf8_string_rename_at_217_69,das_make_block<void,TArray<uint8_t> const  &>(__context__,80,0,&__func_info__5f4b6da70ca496e2,[&](TArray<uint8_t> const  & __arr_rename_at_219_70) -> void{
        utf8_decode_40ac4529d86fd52b(__context__,das_arg<TArray<uint32_t>>::pass(__dest_utf32_string_rename_at_217_68),__arr_rename_at_219_70);
    }),__context__,((LineInfoArg *)(&LineInfo::g_LineInfoNULL)));
}}

inline char * decode_unicode_escape_f4d706cf7ae62b2d ( Context * __context__, char * const  __str_rename_at_224_71 ) { das_stack_prologue __prologue(__context__,384,"decode_unicode_escape " DAS_FILE_LINE);
{
    return das_auto_cast<char *>::cast(((char * const )(builtin_build_string_T([&](StringBuilderWriter & __writer_rename_at_225_72) DAS_AOT_INLINE_LAMBDA -> void{
        builtin_string_peek(__str_rename_at_224_71,das_make_block<void,TArray<uint8_t> const  &>(__context__,144,0,&__func_info__2f76c7f7dd4f0b27,[&](TArray<uint8_t> const  & __p_rename_at_226_73) -> void{
            ...
            _FuncbuiltinTickreserveTick3994685146752941225_71af0b01dbdb30b2(__context__,das_arg<TArray<uint8_t>>::pass(__bang_rename_at_229_76),8);
            ...
            while ( __i_rename_at_227_74 < __llen_rename_at_228_75 )
            {
                if ( das_equ_val(__p_rename_at_226_73(__i_rename_at_227_74,__context__),0x5c) )
                {
                    ...
                    _FuncbuiltinTickresizeTick4811697762258667383_71af0b01dbdb30b2(__context__,das_arg<TArray<uint8_t>>::pass(__bang_rename_at_229_76),0);
                    while ( (__j_rename_at_234_78 < __jlen_rename_at_235_79) && is_hex(int32_t(__p_rename_at_226_73(__j_rename_at_234_78,__context__))) )
                    {
                        _FuncbuiltinTickpushTick14133213201864676143_d8f0a51920afdbe4(__context__,das_arg<TArray<uint8_t>>::pass(__bang_rename_at_229_76),__p_rename_at_226_73(__j_rename_at_234_78,__context__));
                    ...
                    if ( builtin_array_size(das_arg<TArray<uint8_t>>::pass(__bang_rename_at_229_76)) == 4 )
                    {
                        ...
                        if ( (__utf32_rename_at_242_80 >= 0xd800u) && (__utf32_rename_at_242_80 <= 0xdfffu) )
                        {
                            if ( __high_surrogate_rename_at_231_77 == 0x0u )
                            {
                                ...
                                das_call_interop<StringBuilderWriter &>::call(&builtin_write_string,__context__,SimNode_AotInterop<2>(__tinfo_2,cast<StringBuilderWriter &>::from(__writer_rename_at_225_72),cast<char * const >::from(((char * const )(builtin_string_from_array(das_arg<TArray<uint8_t>>::pass((_temp_make_local_250_55_320 = (utf8_encode_7ba5e24450754bfc(__context__,__pair_rename_at_248_82)))),__context__,((LineInfoArg *)(&LineInfo::g_LineInfoNULL))))))));
                            };
                        } else {
                            TArray<uint8_t> _temp_make_local_253_51_352; _temp_make_local_253_51_352;
                            das_call_interop<StringBuilderWriter &>::call(&builtin_write_string,__context__,SimNode_AotInterop<2>(__tinfo_3,cast<StringBuilderWriter &>::from(__writer_rename_at_225_72),cast<char * const >::from(((char * const )(builtin_string_from_array(das_arg<TArray<uint8_t>>::pass((_temp_make_local_253_51_352 = (utf8_encode_7ba5e24450754bfc(__context__,__utf32_rename_at_242_80)))),__context__,((LineInfoArg *)(&LineInfo::g_LineInfoNULL))))))));
                        };
...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    aotLib[0xf52c78ab7258913d] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncbuiltinTicklengthTick18150397773952384912_8924d568ae15c627>>();
    };
    aotLib[0xb8cde23803517ed3] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncbuiltinTicklengthTick18150397773952384912_9dc25a6813327d8a>>();
    };
    aotLib[0x76898bcfa631a7c7] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncbuiltinTicklengthTick18150397773952384912_876c88e6150f3015>>();
    };
    aotLib[0x95b04271e166080f] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncbuiltinTicklengthTick18150397773952384912_630149089a809fff>>();
    };
    aotLib[0xcbc9f65375a1fb48] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_AotCMRES<&_FuncbuiltinTickto_array_moveTick3185538323411982277_c78c6b393becaeaa>>();
    };
    aotLib[0x2eef2016603565bc] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_AotCMRES<&_FuncbuiltinTickto_array_moveTick3185538323411982277_c60b650d5251f23f>>();
    };
    aotLib[0xa9cea1ade7dc1d7c] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_AotCMRES<&_FuncbuiltinTickto_array_moveTick3185538323411982277_f0fc7e1ebd381ced>>();
    };
    aotLib[0x85a0bdf51b664d26] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_AotCMRES<&_FuncbuiltinTickto_array_moveTick3185538323411982277_ee64b3c558d03193>>();
    };
    ...
    aotLib[0xcb923d9c648cf438] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncbuiltinTick_return_with_lockcheckTick2939372000839727345_542642850e45b365>>();
    };
    ...
    aotLib[0xfac93b68966069d3] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncbuiltinTickpushTick10769833213962245646_9e01ae7861ebbd4c>>();
    };
    aotLib[0x5790e8dbf9ae0c92] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncbuiltinTickresizeTick4811697762258667383_71af0b01dbdb30b2>>();
    };
    aotLib[0x98ff7ca2922904c5] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&utf16_to_utf32_4accdbc7c053b25>>();
    };
    aotLib[0xf2ed6bb8662d447c] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&utf8_encode_6f198025ba29e8fb>>();
    };
    aotLib[0xa7848755c2799199] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_AotCMRES<&utf8_encode_7ba5e24450754bfc>>();
    };
    aotLib[0xb3fc465b803c839] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&utf8_encode_75988af893dceb50>>();
    };
    aotLib[0x45252911e7ccb261] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_AotCMRES<&utf8_encode_b6b6d2f902ca7d83>>();
    };
    aotLib[0xc749a79862158c00] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&utf8_length_3b384448a99ef0a7>>();
    };
    aotLib[0xfb13f7b2fdb0c4db] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&utf8_length_f065f8e1e965b045>>();
    };
    aotLib[0x4df9c3c7ece07646] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&is_first_byte_of_utf8_char_b03f82b76c79f3c5>>();
    };
    aotLib[0x5ce0ff1603e2652f] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&contains_utf8_bom_8ffb66694926e49a>>();
    };
    aotLib[0x2a000af6de4e31df] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&contains_utf8_bom_383ef1852eae7df0>>();
    };
    aotLib[0x5ce0ff1603e2652f] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&is_utf8_string_valid_8ffb66694926e49a>>();
    };
    aotLib[0x2a000af6de4e31df] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&is_utf8_string_valid_383ef1852eae7df0>>();
    };
    aotLib[0x5c9e113a261d48ee] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&utf8_decode_40ac4529d86fd52b>>();
    };
    aotLib[0x982569abc741f9af] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_AotCMRES<&utf8_decode_de0bc33c996f0ff0>>();
    };
    aotLib[0xd533080633f33602] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_AotCMRES<&utf8_decode_9d56bd9de8f6b62e>>();
    };
    aotLib[0x509bfc2fd90aa585] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&utf8_decode_4b8aecf7ba702a09>>();
    };
    aotLib[0x85799348d0a02024] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&decode_unicode_escape_f4d706cf7ae62b2d>>();
    };
    // [[ init script ]]
