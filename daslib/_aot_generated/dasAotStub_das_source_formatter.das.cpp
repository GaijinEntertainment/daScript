...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    ...
    aotLib[0x52d8f0772589855e] = +[](Context & ctx) -> SimNode* { // parse_all_tokens_b5d5b68330cdfcd0
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, das_source_formatter::FormatterCtx &  ),&parse_all_tokens_b5d5b68330cdfcd0>>();
    };
    ...
    aotLib[0x53b7dd25c9bdd4ae] = +[](Context & ctx) -> SimNode* { // process_formatter_tokens_a63e2ffa4c8206b6
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, das_source_formatter::FormatterCtx &  ),&process_formatter_tokens_a63e2ffa4c8206b6>>();
    };
    ...
    aotLib[0x76299977413a1e82] = +[](Context & ctx) -> SimNode* { // do_format_4835418a8469e5fa
    ...
    aotLib[0x26d8db9170833ef9] = +[](Context & ctx) -> SimNode* { // format_source_string_f69d100c71c99a8c
        return ctx.code->makeNode<SimNode_Aot<char * (*) ( Context * __context__, char * const  &  ),&format_source_string_f69d100c71c99a8c>>();
    };
    aotLib[0xbed3d0168e4fcf75] = +[](Context & ctx) -> SimNode* { // format_source_58c20f6bcb79eabd
    ...
    aotLib[0x400629cb54db70cf] = +[](Context & ctx) -> SimNode* { // format_source_f3ae203349d40bcb
