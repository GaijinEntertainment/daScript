...
inline void finalize_9eb64692a374c6cb ( Context * __context__, TTuple<16,char *,char *> & ____this_rename_at_1187_0 );
...
inline void _FuncbuiltinTickpushTick10769833213962245646_2f7ec56c9ac7d6d0 ( Context * __context__, TArray<TTuple<16,char *,char *>> & __Arr_rename_at_181_2, TTuple<16,char *,char *> & __value_rename_at_181_3 );
inline void _FuncbuiltinTickfinalizeTick13836114024949725080_baa2ae866f630441 ( Context * __context__, TArray<TTuple<16,char *,char *>> & __a_rename_at_1183_4 );
...
inline Sequence DAS_COMMENT((char *)) _FuncbuiltinTickkeysTick2205854368403803976_2df91d3f4a5c8888 ( Context * __context__, TTable<char *,char *> const  & __a_rename_at_1129_8 );
inline Sequence DAS_COMMENT((char * &)) _FuncbuiltinTickvaluesTick1935193042646774172_bb2c3e8e5405df3b ( Context * __context__, TTable<char *,char *> const  & __a_rename_at_1144_10 );
inline void _FuncbuiltinTicksortTick5995501125257068354_4524eaa061a094a8 ( Context * __context__, TArray<TTuple<16,char *,char *>> & __a_rename_at_1577_12, Block DAS_COMMENT((bool,TTuple<16,char *,char *> const ,TTuple<16,char *,char *> const )) const  & __cmp_rename_at_1577_13 );
...
inline void finalize_9eb64692a374c6cb ( Context * __context__, TTuple<16,char *,char *> &  ____this_rename_at_1187_0 )
{
    memset(&(____this_rename_at_1187_0), 0, 16);
}
...
inline void _FuncbuiltinTickpushTick10769833213962245646_2f7ec56c9ac7d6d0 ( Context * __context__, TArray<TTuple<16,char *,char *>> &  __Arr_rename_at_181_2, TTuple<16,char *,char *> &  __value_rename_at_181_3 )
{
    das_copy(__Arr_rename_at_181_2(builtin_array_push_back(das_arg<TArray<TTuple<16,char *,char *>>>::pass(__Arr_rename_at_181_2),16,__context__,((LineInfoArg *)(&LineInfo::g_LineInfoNULL))),__context__),__value_rename_at_181_3);
}
...
{
    {
        ...
        das_iterator<TArray<TTuple<16,char *,char *>>> __aV_iterator(__a_rename_at_1183_4);
        TTuple<16,char *,char *> * __aV_rename_at_1185_5;
        __need_loop_1185 = __aV_iterator.first(__context__,(__aV_rename_at_1185_5)) && __need_loop_1185;
        for ( ; __need_loop_1185 ; __need_loop_1185 = __aV_iterator.next(__context__,(__aV_rename_at_1185_5)) )
        {
            finalize_9eb64692a374c6cb(__context__,das_arg<TTuple<16,char *,char *>>::pass((*__aV_rename_at_1185_5)));
        }
        __aV_iterator.close(__context__,(__aV_rename_at_1185_5));
    };
    builtin_array_free(das_arg<TArray<TTuple<16,char *,char *>>>::pass(__a_rename_at_1183_4),16,__context__,((LineInfoArg *)(&LineInfo::g_LineInfoNULL)));
}
...
inline Sequence DAS_COMMENT((char *)) _FuncbuiltinTickkeysTick2205854368403803976_2df91d3f4a5c8888 ( Context * __context__, TTable<char *,char *> const  &  __a_rename_at_1129_8 )
{
    Sequence DAS_COMMENT((char *)) __it_rename_at_1130_9; das_zero(__it_rename_at_1130_9);
    builtin_table_keys(das_arg<Sequence DAS_COMMENT((char *))>::pass(__it_rename_at_1130_9),__a_rename_at_1129_8,8,__context__,((LineInfoArg *)(&LineInfo::g_LineInfoNULL)));
    return /* <- */ das_auto_cast_move<Sequence DAS_COMMENT((char *))>::cast(__it_rename_at_1130_9);
}

inline Sequence DAS_COMMENT((char * &)) _FuncbuiltinTickvaluesTick1935193042646774172_bb2c3e8e5405df3b ( Context * __context__, TTable<char *,char *> const  &  __a_rename_at_1144_10 )
{
    Sequence DAS_COMMENT((char * *)) __it_rename_at_1145_11; das_zero(__it_rename_at_1145_11);
    builtin_table_values(das_arg<Sequence DAS_COMMENT((char * const ))>::pass(__it_rename_at_1145_11),__a_rename_at_1144_10,8,__context__,((LineInfoArg *)(&LineInfo::g_LineInfoNULL)));
    return /* <- */ das_auto_cast_move<Sequence DAS_COMMENT((char * &))>::cast(__it_rename_at_1145_11);
}

inline void _FuncbuiltinTicksortTick5995501125257068354_4524eaa061a094a8 ( Context * __context__, TArray<TTuple<16,char *,char *>> &  __a_rename_at_1577_12, Block DAS_COMMENT((bool,TTuple<16,char *,char *> const ,TTuple<16,char *,char *> const )) const  &  __cmp_rename_at_1577_13 )
{
    builtin_sort_array_any_cblock_T(das_arg<TArray<TTuple<16,char *,char *>>>::pass(__a_rename_at_1577_12),16,builtin_array_size(das_arg<TArray<TTuple<16,char *,char *>>>::pass(__a_rename_at_1577_12)),__cmp_rename_at_1577_13,__context__,((LineInfoArg *)(&LineInfo::g_LineInfoNULL)));
}
...
inline char * uri_compose_query_in_order_c110ae58bd0a3254 ( Context * __context__, TTable<char *,char *> const  &  __query_rename_at_44_24 )
{
    ...
    TArray<TTuple<16,char *,char *>> __vq_rename_at_46_25; das_zero(__vq_rename_at_46_25);
    {
        ...
        {
            TTuple<16,char *,char *> _temp_make_local_48_20_128; _temp_make_local_48_20_128;
            _FuncbuiltinTickpushTick10769833213962245646_2f7ec56c9ac7d6d0(__context__,das_arg<TArray<TTuple<16,char *,char *>>>::pass(__vq_rename_at_46_25),das_arg<TTuple<16,char *,char *>>::pass((([&]() -> TTuple<16,char *,char *>& {
                das_get_tuple_field<char *,0>::get(_temp_make_local_48_20_128) = __key_rename_at_47_28;
                das_get_tuple_field<char *,8>::get(_temp_make_local_48_20_128) = (*__value_rename_at_47_29);
    ...
    builtin_sort_array_any_cblock_T(das_arg<TArray<TTuple<16,char *,char *>>>::pass(__vq_rename_at_46_25),16,0,[&](TTuple<16,char *,char *> const  & __a_rename_at_50_30, TTuple<16,char *,char *> const  & __b_rename_at_50_31) DAS_AOT_INLINE_LAMBDA -> bool{
        return das_auto_cast<bool>::cast((SimPolicy<char *>::Equ(cast<char *>::from(das_get_tuple_field<char *,0>::get(__a_rename_at_50_30)),cast<char *>::from(das_get_tuple_field<char *,0>::get(__b_rename_at_50_31)),*__context__,nullptr)) ? das_auto_cast<bool>::cast((SimPolicy<char *>::Less(cast<char *>::from(das_get_tuple_field<char *,8>::get(__a_rename_at_50_30)),cast<char *>::from(das_get_tuple_field<char *,8>::get(__b_rename_at_50_31)),*__context__,nullptr))) : das_auto_cast<bool>::cast((SimPolicy<char *>::Less(cast<char *>::from(das_get_tuple_field<char *,0>::get(__a_rename_at_50_30)),cast<char *>::from(das_get_tuple_field<char *,0>::get(__b_rename_at_50_31)),*__context__,nullptr))));
    },__context__,((LineInfoArg *)(&LineInfo::g_LineInfoNULL)));
    char * __res_rename_at_58_32 = ((char *)(char *)(((char * const )(builtin_build_string_T([&](StringBuilderWriter & __tw_rename_at_58_33) DAS_AOT_INLINE_LAMBDA -> void{
        bool __first_rename_at_59_34 = true;
        {
            ...
            das_iterator<TArray<TTuple<16,char *,char *>>> __kv_iterator(__vq_rename_at_46_25);
            TTuple<16,char *,char *> * __kv_rename_at_60_35;
            ...
            for ( ; __need_loop_60 ; __need_loop_60 = __kv_iterator.next(__context__,(__kv_rename_at_60_35)) )
            {
                ...
                das_call_interop<StringBuilderWriter &>::call(&builtin_write_string,__context__,SimNode_AotInterop<2>(__tinfo_6,cast<StringBuilderWriter &>::from(__tw_rename_at_58_33),cast<char *>::from(das_get_tuple_field<char *,0>::get((*__kv_rename_at_60_35)))));
                if ( !builtin_empty(das_get_tuple_field<char *,8>::get((*__kv_rename_at_60_35))) )
                {
                    ...
                    das_call_interop<StringBuilderWriter &>::call(&builtin_write_string,__context__,SimNode_AotInterop<2>(__tinfo_8,cast<StringBuilderWriter &>::from(__tw_rename_at_58_33),cast<char *>::from(das_get_tuple_field<char *,8>::get((*__kv_rename_at_60_35)))));
                };
            }
            __kv_iterator.close(__context__,(__kv_rename_at_60_35));
        };
    },__context__,((LineInfoArg *)(&LineInfo::g_LineInfoNULL)))))));
    _FuncbuiltinTickfinalizeTick13836114024949725080_baa2ae866f630441(__context__,das_arg<TArray<TTuple<16,char *,char *>>>::pass(__vq_rename_at_46_25));
...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    aotLib[0xdcb94002410ce3ed] = +[](Context & ctx) -> SimNode* { // finalize_9eb64692a374c6cb
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, TTuple<16,char *,char *> &  ),&finalize_9eb64692a374c6cb>>();
    };
    ...
    aotLib[0x6e4c5e9811061cac] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTickpushTick10769833213962245646_2f7ec56c9ac7d6d0
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, TArray<TTuple<16,char *,char *>> & , TTuple<16,char *,char *> &  ),&_FuncbuiltinTickpushTick10769833213962245646_2f7ec56c9ac7d6d0>>();
    };
    aotLib[0x777463895cad056a] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTickfinalizeTick13836114024949725080_baa2ae866f630441
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, TArray<TTuple<16,char *,char *>> &  ),&_FuncbuiltinTickfinalizeTick13836114024949725080_baa2ae866f630441>>();
    };
    ...
    aotLib[0xb58c472181b851f0] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTicksortTick5995501125257068354_4524eaa061a094a8
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, TArray<TTuple<16,char *,char *>> & , Block DAS_COMMENT((bool,TTuple<16,char *,char *> const ,TTuple<16,char *,char *> const )) const  &  ),&_FuncbuiltinTicksortTick5995501125257068354_4524eaa061a094a8>>();
    };
    aotLib[0xc5c07999e07face8] = +[](Context & ctx) -> SimNode* { // uri_split_full_path_61c8cae43e9301c5
        return ctx.code->makeNode<SimNode_AotCMRES<TArray<char *> (*) ( Context * __context__, Uri const  &  ),&uri_split_full_path_61c8cae43e9301c5>>();
    };
    aotLib[0x3b153912aea97865] = +[](Context & ctx) -> SimNode* { // uri_compose_query_8e868129edf6b854
        return ctx.code->makeNode<SimNode_Aot<char * (*) ( Context * __context__, TTable<char *,char *> const  &  ),&uri_compose_query_8e868129edf6b854>>();
    };
    aotLib[0x70c811f5ee06ec12] = +[](Context & ctx) -> SimNode* { // uri_compose_query_in_order_c110ae58bd0a3254
        return ctx.code->makeNode<SimNode_Aot<char * (*) ( Context * __context__, TTable<char *,char *> const  &  ),&uri_compose_query_in_order_c110ae58bd0a3254>>();
    };
    aotLib[0xa6f05457091c2006] = +[](Context & ctx) -> SimNode* { // scheme_868a118e00451a9e
        return ctx.code->makeNode<SimNode_Aot<char * (*) ( Context * __context__, Uri const  &  ),&scheme_868a118e00451a9e>>();
    };
    aotLib[0x211579d83341bcd1] = +[](Context & ctx) -> SimNode* { // user_info_4532747a877d046e
        return ctx.code->makeNode<SimNode_Aot<char * (*) ( Context * __context__, Uri const  &  ),&user_info_4532747a877d046e>>();
    };
    aotLib[0x779fde396ae60bb5] = +[](Context & ctx) -> SimNode* { // host_d328a0026aab75fe
        return ctx.code->makeNode<SimNode_Aot<char * (*) ( Context * __context__, Uri const  &  ),&host_d328a0026aab75fe>>();
    };
    aotLib[0xca780240902fad22] = +[](Context & ctx) -> SimNode* { // port_57f83a3de58711ae
        return ctx.code->makeNode<SimNode_Aot<char * (*) ( Context * __context__, Uri const  &  ),&port_57f83a3de58711ae>>();
    };
    aotLib[0x902cd0d487f0f580] = +[](Context & ctx) -> SimNode* { // path_26d1281b144ca20f
        return ctx.code->makeNode<SimNode_Aot<char * (*) ( Context * __context__, Uri const  &  ),&path_26d1281b144ca20f>>();
    };
    aotLib[0xd19b6c60bd237fe7] = +[](Context & ctx) -> SimNode* { // query_70b3028abd53148e
        return ctx.code->makeNode<SimNode_Aot<char * (*) ( Context * __context__, Uri const  &  ),&query_70b3028abd53148e>>();
    };
    aotLib[0x4128f4c1e48b36be] = +[](Context & ctx) -> SimNode* { // fragment_f9c74510412f8a1e
        return ctx.code->makeNode<SimNode_Aot<char * (*) ( Context * __context__, Uri const  &  ),&fragment_f9c74510412f8a1e>>();
    };
    aotLib[0xd4c0fd34e01c1fc9] = +[](Context & ctx) -> SimNode* { // uri_compose_f6e4390f66d274f0
        return ctx.code->makeNode<SimNode_AotCMRES<Uri (*) ( Context * __context__, char * const  , char * const  , char * const  , char * const  , char * const  , char * const  , char * const   ),&uri_compose_f6e4390f66d274f0>>();
    };
