...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    aotLib[0xdcb94002410ce3ed] = +[](Context & ctx) -> SimNode* { // finalize_9eb64692a374c6cb
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, AutoTuple<char *,char *> &  ),&finalize_9eb64692a374c6cb>>();
    };
    ...
    aotLib[0x6e4c5e9811061cac] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTickpushTick10769833213962245646_2f7ec56c9ac7d6d0
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, TArray<AutoTuple<char *,char *>> & , AutoTuple<char *,char *> &  ),&_FuncbuiltinTickpushTick10769833213962245646_2f7ec56c9ac7d6d0>>();
    };
    aotLib[0x777463895cad056a] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTickfinalizeTick13836114024949725080_baa2ae866f630441
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, TArray<AutoTuple<char *,char *>> &  ),&_FuncbuiltinTickfinalizeTick13836114024949725080_baa2ae866f630441>>();
    };
    ...
    aotLib[0xb58c472181b851f0] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTicksortTick5995501125257068354_4524eaa061a094a8
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, TArray<AutoTuple<char *,char *>> & , Block DAS_COMMENT((bool,AutoTuple<char *,char *> const ,AutoTuple<char *,char *> const )) const  &  ),&_FuncbuiltinTicksortTick5995501125257068354_4524eaa061a094a8>>();
    };
