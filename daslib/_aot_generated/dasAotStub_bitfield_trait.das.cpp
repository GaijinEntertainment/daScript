...
inline StructInfo const  * _FuncrttiTickclass_infoTick15801393167907430156_6fbd01d2d0bd13fc ( Context * __context__, bitfield_trait::EachBitfieldMacro const  & __cl_rename_at_116_2 );
inline smart_ptr_raw<FunctionAnnotation> _FuncastTickmake_function_annotationTick3074191368936885601_623c630cd00cdb06 ( Context * __context__, char * const  __name_rename_at_631_7, bitfield_trait::EachBitfieldMacro * __someClassPtr_rename_at_631_8 );
inline smart_ptr_raw<Expression> _Funcast_boostTickconvert_to_expressionTick11707039267614988023_9ded184c562cbb49 ( Context * __context__, char * const  __value_rename_at_882_10 );
...
inline void _FuncbuiltinTickfinalizeTick13836114024949725080_9f199f97decbabbe ( Context * __context__, TArray<smart_ptr_raw<Expression>> & __a_rename_at_1215_13 );
inline void _Funcast_boostTicksetup_tag_annotationTick4095297895764883997_f900909f9f81d936 ( Context * __context__, char * const  __name_rename_at_273_15, char * const  __tag_rename_at_273_16, bitfield_trait::EachBitfieldMacro * __classPtr_rename_at_273_17 );
...
inline smart_ptr_raw<FunctionAnnotation> _FuncastTickmake_function_annotationTick3074191368936885601_623c630cd00cdb06 ( Context * __context__, char * const  __name_rename_at_631_7, bitfield_trait::EachBitfieldMacro * __someClassPtr_rename_at_631_8 )
{
    ...
    StructInfo const  * __classInfo_rename_at_634_9 = ((StructInfo const  *)_FuncrttiTickclass_infoTick15801393167907430156_6fbd01d2d0bd13fc(__context__,das_arg<bitfield_trait::EachBitfieldMacro>::pass(das_deref(__context__,__someClassPtr_rename_at_631_8))));
...
inline void _Funcast_boostTicksetup_tag_annotationTick4095297895764883997_f900909f9f81d936 ( Context * __context__, char * const  __name_rename_at_273_15, char * const  __tag_rename_at_273_16, bitfield_trait::EachBitfieldMacro * __classPtr_rename_at_273_17 )
{
    ...
    /* end finally */ });
    __ann_rename_at_274_18; das_zero(__ann_rename_at_274_18); das_move(__ann_rename_at_274_18, _FuncastTickmake_function_annotationTick3074191368936885601_623c630cd00cdb06(__context__,__name_rename_at_273_15,__classPtr_rename_at_273_17));
...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    ...
    aotLib[0xd5d60df81b6ffc58] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncrttiTickclass_infoTick15801393167907430156_6fbd01d2d0bd13fc>>();
    };
    aotLib[0xaff6f0fb924b6b40] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncastTickmake_function_annotationTick3074191368936885601_623c630cd00cdb06>>();
    };
    ...
    aotLib[0x92e74562ee1746f1] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_Funcast_boostTicksetup_tag_annotationTick4095297895764883997_f900909f9f81d936>>();
    };
    // [[ init script ]]
