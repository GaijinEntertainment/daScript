...
inline smart_ptr_raw<FunctionAnnotation> _FuncastTickmake_function_annotationTick3074191368936885601_31c3e969e3d344d1 ( Context * __context__, char * const  __name_rename_at_626_7, bitfield_trait::EachBitfieldMacro * __someClassPtr_rename_at_626_8 );
...
inline smart_ptr_raw<FunctionAnnotation> _FuncastTickmake_function_annotationTick3074191368936885601_31c3e969e3d344d1 ( Context * __context__, char * const  __name_rename_at_626_7, bitfield_trait::EachBitfieldMacro * __someClassPtr_rename_at_626_8 )
{
    ...
    StructInfo const  * __classInfo_rename_at_629_9 = ((StructInfo const  *)_FuncrttiTickclass_infoTick15801393167907430156_134581600e2aea91(__context__,das_arg<bitfield_trait::EachBitfieldMacro>::pass(das_deref(__context__,__someClassPtr_rename_at_626_8))));
...
inline smart_ptr_raw<Expression> _Funcast_boostTickconvert_to_expressionTick11707039267614988023_2a80cf3c2085d3f9 ( Context * __context__, char * const  __value_rename_at_882_10 )
{
    ...
    return /* <- */ das_auto_cast_move<smart_ptr_raw<Expression>>::cast(das_invoke_function<smart_ptr_raw<Expression>>::invoke<char * const ,LineInfo const  &>(__context__,nullptr,Func(__context__->fnByMangledName(/*@bitfield_trait::ast_boost`convert_to_expression`16483834305137942954 C=Xs CH<rtti::LineInfo>*/ 212117009260425344u)),__value_rename_at_882_10,das_arg<LineInfo>::pass((_temp_make_local_883_43_32 = (/*c-tor*/ LineInfo(/*end-c-tor*/))))));
}
...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    ...
    aotLib[0x20d4cc5eb823f14e] = +[](Context & ctx) -> SimNode* { // _FuncrttiTickclass_infoTick15801393167907430156_134581600e2aea91
        return ctx.code->makeNode<SimNode_Aot<StructInfo const  * (*) ( Context * __context__, bitfield_trait::EachBitfieldMacro const  &  ),&_FuncrttiTickclass_infoTick15801393167907430156_134581600e2aea91>>();
    };
    aotLib[0x599530e2abc65a08] = +[](Context & ctx) -> SimNode* { // _FuncastTickmake_function_annotationTick3074191368936885601_31c3e969e3d344d1
        return ctx.code->makeNode<SimNode_Aot<smart_ptr_raw<FunctionAnnotation> (*) ( Context * __context__, char * const  , bitfield_trait::EachBitfieldMacro *  ),&_FuncastTickmake_function_annotationTick3074191368936885601_31c3e969e3d344d1>>();
    };
    aotLib[0x2b4b532dce355d76] = +[](Context & ctx) -> SimNode* { // _Funcast_boostTickconvert_to_expressionTick11707039267614988023_2a80cf3c2085d3f9
    ...
    aotLib[0x69428bbfdc4d7130] = +[](Context & ctx) -> SimNode* { // _Funcast_boostTicksetup_tag_annotationTick4095297895764883997_68e2d9cc7a378291
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, char * const  , char * const  , bitfield_trait::EachBitfieldMacro *  ),&_Funcast_boostTicksetup_tag_annotationTick4095297895764883997_68e2d9cc7a378291>>();
    };
    // [[ init script ]]
