...
namespace das {
namespace _anon_4926585650747666216 {
...
static_assert(sizeof(EachBitfieldMacro)==112,"structure size mismatch with DAS");
static_assert(offsetof(EachBitfieldMacro,__rtti)==0,"structure field offset mismatch with DAS");
static_assert(offsetof(EachBitfieldMacro,__finalize)==8,"structure field offset mismatch with DAS");
static_assert(offsetof(EachBitfieldMacro,transform)==16,"structure field offset mismatch with DAS");
static_assert(offsetof(EachBitfieldMacro,verifyCall)==24,"structure field offset mismatch with DAS");
static_assert(offsetof(EachBitfieldMacro,apply)==32,"structure field offset mismatch with DAS");
static_assert(offsetof(EachBitfieldMacro,generic_apply)==40,"structure field offset mismatch with DAS");
static_assert(offsetof(EachBitfieldMacro,finish)==48,"structure field offset mismatch with DAS");
static_assert(offsetof(EachBitfieldMacro,patch)==56,"structure field offset mismatch with DAS");
static_assert(offsetof(EachBitfieldMacro,fixup)==64,"structure field offset mismatch with DAS");
static_assert(offsetof(EachBitfieldMacro,lint)==72,"structure field offset mismatch with DAS");
static_assert(offsetof(EachBitfieldMacro,complete)==80,"structure field offset mismatch with DAS");
static_assert(offsetof(EachBitfieldMacro,isCompatible)==88,"structure field offset mismatch with DAS");
static_assert(offsetof(EachBitfieldMacro,isSpecialized)==96,"structure field offset mismatch with DAS");
static_assert(offsetof(EachBitfieldMacro,appendToMangledName)==104,"structure field offset mismatch with DAS");
}
...
inline StructInfo const  * _FuncrttiTickclass_infoTick15801393167907430156_8b4eab3f9a45b47b ( Context * __context__, bitfield_trait::EachBitfieldMacro const  & __cl_rename_at_116_2 );
inline smart_ptr_raw<FunctionAnnotation> _FuncastTickmake_function_annotationTick3074191368936885601_9d64bbae0d627301 ( Context * __context__, char * const  __name_rename_at_622_7, bitfield_trait::EachBitfieldMacro * __someClassPtr_rename_at_622_8 );
inline smart_ptr_raw<Expression> _Funcast_boostTickconvert_to_expressionTick11707039267614988023_2a80cf3c2085d3f9 ( Context * __context__, char * const  __value_rename_at_803_10 );
inline void _FuncbuiltinTickfinalizeTick13836114024949725080_473a42788c45df36 ( Context * __context__, TArray<smart_ptr_raw<Expression>> & __a_rename_at_1183_11 );
inline void _Funcast_boostTicksetup_tag_annotationTick4095297895764883997_a85253b5af4de0e1 ( Context * __context__, char * const  __name_rename_at_273_13, char * const  __tag_rename_at_273_14, bitfield_trait::EachBitfieldMacro * __classPtr_rename_at_273_15 );
...
inline smart_ptr_raw<FunctionAnnotation> _FuncastTickmake_function_annotationTick3074191368936885601_9d64bbae0d627301 ( Context * __context__, char * const  __name_rename_at_622_7, bitfield_trait::EachBitfieldMacro * __someClassPtr_rename_at_622_8 )
{
    ...
    StructInfo const  * __classInfo_rename_at_625_9 = ((StructInfo const  *)_FuncrttiTickclass_infoTick15801393167907430156_8b4eab3f9a45b47b(__context__,das_arg<bitfield_trait::EachBitfieldMacro>::pass(das_deref(__context__,__someClassPtr_rename_at_622_8))));
...
inline smart_ptr_raw<Expression> _Funcast_boostTickconvert_to_expressionTick11707039267614988023_2a80cf3c2085d3f9 ( Context * __context__, char * const  __value_rename_at_803_10 )
{
    ...
    return /* <- */ das_auto_cast_move<smart_ptr_raw<Expression>>::cast(das_invoke_function<smart_ptr_raw<Expression>>::invoke<char * const ,LineInfo const  &>(__context__,nullptr,Func(__context__->fnByMangledName(/*@bitfield_trait::ast_boost`convert_to_expression`16483834305137942954 C=Xs CH<rtti::LineInfo>*/ 212117009260425344u)),__value_rename_at_803_10,das_arg<LineInfo>::pass((_temp_make_local_804_43_32 = (/*c-tor*/ LineInfo(/*end-c-tor*/))))));
}
...
{
    {
        ...
        das_iterator<TArray<smart_ptr_raw<Expression>>> __aV_iterator(__a_rename_at_1183_11);
        smart_ptr_raw<Expression> * __aV_rename_at_1185_12;
        ...
        {
            das_delete_handle<smart_ptr_raw<Expression>>::clear(__context__,(*__aV_rename_at_1185_12));
        }
        __aV_iterator.close(__context__,(__aV_rename_at_1185_12));
    };
    builtin_array_free(das_arg<TArray<smart_ptr_raw<Expression>>>::pass(__a_rename_at_1183_11),8,__context__,((LineInfoArg *)(&LineInfo::g_LineInfoNULL)));
}
...
inline void _Funcast_boostTicksetup_tag_annotationTick4095297895764883997_a85253b5af4de0e1 ( Context * __context__, char * const  __name_rename_at_273_13, char * const  __tag_rename_at_273_14, bitfield_trait::EachBitfieldMacro * __classPtr_rename_at_273_15 )
{
    ...
    /* end finally */ });
    __ann_rename_at_274_16; das_zero(__ann_rename_at_274_16); das_move(__ann_rename_at_274_16, _FuncastTickmake_function_annotationTick3074191368936885601_9d64bbae0d627301(__context__,__name_rename_at_273_13,__classPtr_rename_at_273_15));
    das_invoke_function<void>::invoke<char * const ,smart_ptr_raw<FunctionAnnotation>>(__context__,nullptr,Func(__context__->fnByMangledName(/*@ast_boost::apply_tag_annotation Cs Y<FunctionAnnotationPtr>1<H<ast::FunctionAnnotation>>?M*/ 8536632802977626562u)),__tag_rename_at_273_14,__ann_rename_at_274_16);
...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    ...
    aotLib[0x9dc69a8a3f6f1e5] = +[](Context & ctx) -> SimNode* { // _FuncrttiTickclass_infoTick15801393167907430156_8b4eab3f9a45b47b
        return ctx.code->makeNode<SimNode_Aot<StructInfo const  * (*) ( Context * __context__, bitfield_trait::EachBitfieldMacro const  &  ),&_FuncrttiTickclass_infoTick15801393167907430156_8b4eab3f9a45b47b>>();
    };
    aotLib[0x2542373606b3eb40] = +[](Context & ctx) -> SimNode* { // _FuncastTickmake_function_annotationTick3074191368936885601_9d64bbae0d627301
        return ctx.code->makeNode<SimNode_Aot<smart_ptr_raw<FunctionAnnotation> (*) ( Context * __context__, char * const  , bitfield_trait::EachBitfieldMacro *  ),&_FuncastTickmake_function_annotationTick3074191368936885601_9d64bbae0d627301>>();
    };
    aotLib[0x9c375070a6b58114] = +[](Context & ctx) -> SimNode* { // _Funcast_boostTickconvert_to_expressionTick11707039267614988023_2a80cf3c2085d3f9
        return ctx.code->makeNode<SimNode_Aot<smart_ptr_raw<Expression> (*) ( Context * __context__, char * const   ),&_Funcast_boostTickconvert_to_expressionTick11707039267614988023_2a80cf3c2085d3f9>>();
    };
    ...
    aotLib[0x9a485fc44edb89d] = +[](Context & ctx) -> SimNode* { // _Funcast_boostTicksetup_tag_annotationTick4095297895764883997_a85253b5af4de0e1
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, char * const  , char * const  , bitfield_trait::EachBitfieldMacro *  ),&_Funcast_boostTicksetup_tag_annotationTick4095297895764883997_a85253b5af4de0e1>>();
    };
    // [[ init script ]]
...
AotListBase impl_aot_bitfield_trait(_anon_4926585650747666216::registerAotFunctions);
} // namespace das
