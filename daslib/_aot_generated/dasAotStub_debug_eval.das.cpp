...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    ...
    aotLib[0xe55374de1b7aa0a7] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTickclearTick13739625760977891612_bc21a7c19d5d96ed
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, TTable<char *,debug_eval::Result> &  ),&_FuncbuiltinTickclearTick13739625760977891612_bc21a7c19d5d96ed>>();
    };
    aotLib[0x7b002e2201d6f482] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTickkeysTick2205854368403803976_d3d21e2c8adb2e77
        return ctx.code->makeNode<SimNode_AotCMRES<Sequence DAS_COMMENT((char *)) (*) ( Context * __context__, TTable<char *,debug_eval::Result> const  &  ),&_FuncbuiltinTickkeysTick2205854368403803976_d3d21e2c8adb2e77>>();
    };
    aotLib[0xd326d6f30877a35a] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTickvaluesTick1935193042646774172_fa9f9c260fe9a102
        return ctx.code->makeNode<SimNode_AotCMRES<Sequence DAS_COMMENT((debug_eval::Result &)) (*) ( Context * __context__, TTable<char *,debug_eval::Result> const  &  ),&_FuncbuiltinTickvaluesTick1935193042646774172_fa9f9c260fe9a102>>();
    };
    ...
    aotLib[0x3611d31809ac9af] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTickresizeTick4811697762258667383_f497868bddc80ac1
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, TArray<AutoVariant<int64_t,int32_t,char *,char *,char *>> & , int32_t  ),&_FuncbuiltinTickresizeTick4811697762258667383_f497868bddc80ac1>>();
    };
    aotLib[0xcfe9411d2674cd24] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTickeachTick9663565701927713696_acc6981303ddd856
        return ctx.code->makeNode<SimNode_AotCMRES<Sequence DAS_COMMENT((AutoVariant<int64_t,int32_t,char *,char *,char *>)) (*) ( Context * __context__, Lambda DAS_COMMENT((bool,AutoVariant<int64_t,int32_t,char *,char *,char *>)) const   ),&_FuncbuiltinTickeachTick9663565701927713696_acc6981303ddd856>>();
    };
    aotLib[0x6a304785603b7a5a] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTick_return_with_lockcheckTick2939372000839727345_32ef8117beffbe31
        return ctx.code->makeNode<SimNode_Aot<debug_eval::TokenStream & (*) ( Context * __context__, debug_eval::TokenStream &  ),&_FuncbuiltinTick_return_with_lockcheckTick2939372000839727345_32ef8117beffbe31>>();
    };
    aotLib[0x99f47e31f6347dab] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTickkey_existsTick16808803843923989214_f403d698c1fdad14
        return ctx.code->makeNode<SimNode_Aot<bool (*) ( Context * __context__, TTable<char *,debug_eval::Result> const  & , char * const   ),&_FuncbuiltinTickkey_existsTick16808803843923989214_f403d698c1fdad14>>();
    };
    aotLib[0xef47bba27d899465] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTickget_valueTick6803070933163225147_25700dfc8547814
        return ctx.code->makeNode<SimNode_AotCMRES<debug_eval::Result (*) ( Context * __context__, TTable<char *,debug_eval::Result> & , char * const   ),&_FuncbuiltinTickget_valueTick6803070933163225147_25700dfc8547814>>();
    };
    aotLib[0x65d385b545473069] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTickcloneTick3147220447302434744_caf9a18f00151e46
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, TTable<char *,debug_eval::Result> & , TTable<char *,debug_eval::Result> const  &  ),&_FuncbuiltinTickcloneTick3147220447302434744_caf9a18f00151e46>>();
    };
    ...
    aotLib[0x690d07de2c41d4fc] = +[](Context & ctx) -> SimNode* { // _Func_lambda_debug_eval_26_1Tickfunction_f6c2387720b0ce3f
        return ctx.code->makeNode<SimNode_Aot<bool (*) ( Context * __context__, debug_eval::_lambda_debug_eval_26_1 & , AutoVariant<int64_t,int32_t,char *,char *,char *> &  ),&_Func_lambda_debug_eval_26_1Tickfunction_f6c2387720b0ce3f>>();
    };
    ...
    aotLib[0x4978fd41c995fb2e] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTickemptyTick15399874715904164783_4d77f401303a908c
        return ctx.code->makeNode<SimNode_Aot<bool (*) ( Context * __context__, TArray<AutoVariant<int64_t,int32_t,char *,char *,char *>> const  &  ),&_FuncbuiltinTickemptyTick15399874715904164783_4d77f401303a908c>>();
    };
    aotLib[0x1c52ced26acd0c1d] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTicknextTick17450348357676149856_5cb3f1fd943d9108
        return ctx.code->makeNode<SimNode_Aot<bool (*) ( Context * __context__, Sequence DAS_COMMENT((AutoVariant<int64_t,int32_t,char *,char *,char *>)) & , AutoVariant<int64_t,int32_t,char *,char *,char *> &  ),&_FuncbuiltinTicknextTick17450348357676149856_5cb3f1fd943d9108>>();
    };
    aotLib[0xa2c2e5788842f84d] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTickbackTick18296309835877697278_237276f31a84753f
        return ctx.code->makeNode<SimNode_Aot<AutoVariant<int64_t,int32_t,char *,char *,char *> & (*) ( Context * __context__, TArray<AutoVariant<int64_t,int32_t,char *,char *,char *>> &  ),&_FuncbuiltinTickbackTick18296309835877697278_237276f31a84753f>>();
    };
    aotLib[0xc0005b2dd5939e59] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTickpopTick1161079256290593740_7a972024f8437b3f
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, TArray<AutoVariant<int64_t,int32_t,char *,char *,char *>> &  ),&_FuncbuiltinTickpopTick1161079256290593740_7a972024f8437b3f>>();
    };
    aotLib[0x83f96c6def0df1ec] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTickpushTick14133213201864676143_e9749418e214318c
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, TArray<AutoVariant<int64_t,int32_t,char *,char *,char *>> & , AutoVariant<int64_t,int32_t,char *,char *,char *> const  &  ),&_FuncbuiltinTickpushTick14133213201864676143_e9749418e214318c>>();
    };
    ...
    aotLib[0x738d9e9deff9e9d2] = +[](Context & ctx) -> SimNode* { // each_token_96e82efcebf13d0c
        return ctx.code->makeNode<SimNode_AotCMRES<Sequence DAS_COMMENT((AutoVariant<int64_t,int32_t,char *,char *,char *>)) (*) ( Context * __context__, char * const   ),&each_token_96e82efcebf13d0c>>();
    };
    aotLib[0xff4ab1d1c808b55e] = +[](Context & ctx) -> SimNode* { // TokenStream_59176a02fe830623
        return ctx.code->makeNode<SimNode_AotCMRES<debug_eval::TokenStream (*) ( Context * __context__, char * const   ),&TokenStream_59176a02fe830623>>();
    };
    aotLib[0xabeb188039d63864] = +[](Context & ctx) -> SimNode* { // token_36ce8667ed49d425
        return ctx.code->makeNode<SimNode_AotCMRES<AutoVariant<int64_t,int32_t,char *,char *,char *> (*) ( Context * __context__, debug_eval::TokenStream &  ),&token_36ce8667ed49d425>>();
    };
    aotLib[0xcbdd97a58389d1d7] = +[](Context & ctx) -> SimNode* { // unput_c08f1d95eea68a34
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, debug_eval::TokenStream & , AutoVariant<int64_t,int32_t,char *,char *,char *> const  &  ),&unput_c08f1d95eea68a34>>();
    };
    aotLib[0x141ce1f082098a12] = +[](Context & ctx) -> SimNode* { // Result_38240f4c3f9f19dc
        return ctx.code->makeNode<SimNode_AotCMRES<debug_eval::Result (*) ( Context * __context__, int64_t  ),&Result_38240f4c3f9f19dc>>();
    };
    aotLib[0xc3701292bc5c983b] = +[](Context & ctx) -> SimNode* { // Result_b262a84f440eb5c9
        return ctx.code->makeNode<SimNode_AotCMRES<debug_eval::Result (*) ( Context * __context__, bool  ),&Result_b262a84f440eb5c9>>();
    };
    aotLib[0x27beb3bc346b2338] = +[](Context & ctx) -> SimNode* { // InvalidResult_e6549533a9b44e33
        return ctx.code->makeNode<SimNode_AotCMRES<debug_eval::Result (*) ( Context * __context__ ),&InvalidResult_e6549533a9b44e33>>();
    };
    aotLib[0x5cc262f932d84597] = +[](Context & ctx) -> SimNode* { // error_3b51aee67e872094
        return ctx.code->makeNode<SimNode_AotCMRES<debug_eval::Result (*) ( Context * __context__, debug_eval::TokenStream & , char * const   ),&error_3b51aee67e872094>>();
    };
    aotLib[0xa6269dff87688e8d] = +[](Context & ctx) -> SimNode* { // getPD_950137d699d78aca
        return ctx.code->makeNode<SimNode_Aot<void * (*) ( Context * __context__, debug_eval::TokenStream & , debug_eval::Result const  & , int32_t  ),&getPD_950137d699d78aca>>();
    };
    aotLib[0x70667c0b0a1bdf90] = +[](Context & ctx) -> SimNode* { // getI_e470f5a746b3541c
        return ctx.code->makeNode<SimNode_Aot<int64_t (*) ( Context * __context__, debug_eval::TokenStream & , debug_eval::Result const  &  ),&getI_e470f5a746b3541c>>();
    };
    aotLib[0x18da356005b9e967] = +[](Context & ctx) -> SimNode* { // getT_e38a914ed5762f78
        return ctx.code->makeNode<SimNode_Aot<char * (*) ( Context * __context__, debug_eval::TokenStream & , debug_eval::Result const  &  ),&getT_e38a914ed5762f78>>();
    };
    aotLib[0x22476e3bf8dd68e4] = +[](Context & ctx) -> SimNode* { // func_call_length_e620fd2edb88dae3
        return ctx.code->makeNode<SimNode_AotCMRES<debug_eval::Result (*) ( Context * __context__, debug_eval::TokenStream & , debug_eval::Result const  &  ),&func_call_length_e620fd2edb88dae3>>();
    };
    aotLib[0x767a68a4b2e068a1] = +[](Context & ctx) -> SimNode* { // func_call_e8069ada942ecd18
        return ctx.code->makeNode<SimNode_AotCMRES<debug_eval::Result (*) ( Context * __context__, debug_eval::TokenStream & , char * const  , debug_eval::Result const  &  ),&func_call_e8069ada942ecd18>>();
    };
    aotLib[0x55a425bcd1de71c2] = +[](Context & ctx) -> SimNode* { // expr_value_eb120b4e3ca163eb
        return ctx.code->makeNode<SimNode_AotCMRES<debug_eval::Result (*) ( Context * __context__, debug_eval::TokenStream &  ),&expr_value_eb120b4e3ca163eb>>();
    };
    aotLib[0x5083a97212c3dd15] = +[](Context & ctx) -> SimNode* { // getStructFieldOffset_5201839c067f2b1b
        return ctx.code->makeNode<SimNode_AotCMRES<AutoTuple<int32_t,TypeInfo> (*) ( Context * __context__, debug_eval::TokenStream & , char * const  , debug_eval::Result &  ),&getStructFieldOffset_5201839c067f2b1b>>();
    };
    aotLib[0xe17bcb4778a95f12] = +[](Context & ctx) -> SimNode* { // getTupleFieldOffset_82d2cca0fc285ff0
        return ctx.code->makeNode<SimNode_AotCMRES<AutoTuple<int32_t,TypeInfo> (*) ( Context * __context__, debug_eval::TokenStream & , char * const  , debug_eval::Result &  ),&getTupleFieldOffset_82d2cca0fc285ff0>>();
    };
    aotLib[0x6757e625ec4f37af] = +[](Context & ctx) -> SimNode* { // getVectorOffset_f396a4629b54077a
        return ctx.code->makeNode<SimNode_AotCMRES<AutoTuple<int32_t,TypeInfo> (*) ( Context * __context__, debug_eval::TokenStream & , char * const  , debug_eval::Result &  ),&getVectorOffset_f396a4629b54077a>>();
    };
    aotLib[0xdf37cd901bc6adb1] = +[](Context & ctx) -> SimNode* { // getHandleFieldOffset_17e7898b27c06a3b
        return ctx.code->makeNode<SimNode_AotCMRES<AutoTuple<int32_t,TypeInfo> (*) ( Context * __context__, debug_eval::TokenStream & , char * const  , debug_eval::Result &  ),&getHandleFieldOffset_17e7898b27c06a3b>>();
    };
    aotLib[0x3d70fc4b10a52574] = +[](Context & ctx) -> SimNode* { // expr_field_7b9abb4b48818ee6
        return ctx.code->makeNode<SimNode_AotCMRES<debug_eval::Result (*) ( Context * __context__, debug_eval::TokenStream &  ),&expr_field_7b9abb4b48818ee6>>();
    };
    aotLib[0x894eba1f71f973aa] = +[](Context & ctx) -> SimNode* { // opDim_e93722f23b2b225d
        return ctx.code->makeNode<SimNode_AotCMRES<debug_eval::Result (*) ( Context * __context__, debug_eval::TokenStream & , int64_t , debug_eval::Result &  ),&opDim_e93722f23b2b225d>>();
    };
    aotLib[0x7c7372303d744bdc] = +[](Context & ctx) -> SimNode* { // opDimString_2d98ae0b9aba33b
        return ctx.code->makeNode<SimNode_AotCMRES<debug_eval::Result (*) ( Context * __context__, debug_eval::TokenStream & , int64_t , debug_eval::Result &  ),&opDimString_2d98ae0b9aba33b>>();
    };
    aotLib[0x19a68a43844531f2] = +[](Context & ctx) -> SimNode* { // opArray_dfcf64278e28052b
        return ctx.code->makeNode<SimNode_AotCMRES<debug_eval::Result (*) ( Context * __context__, debug_eval::TokenStream & , int64_t , debug_eval::Result &  ),&opArray_dfcf64278e28052b>>();
    };
    aotLib[0xdaef6995e8852276] = +[](Context & ctx) -> SimNode* { // opTable_2c3c0211d77b2294
        return ctx.code->makeNode<SimNode_AotCMRES<debug_eval::Result (*) ( Context * __context__, debug_eval::TokenStream & , debug_eval::Result const  & , debug_eval::Result &  ),&opTable_2c3c0211d77b2294>>();
    };
    aotLib[0x8b8365ce3bbbea0b] = +[](Context & ctx) -> SimNode* { // expr_at_eb04195e4bb4b7e4
        return ctx.code->makeNode<SimNode_AotCMRES<debug_eval::Result (*) ( Context * __context__, debug_eval::TokenStream &  ),&expr_at_eb04195e4bb4b7e4>>();
    };
    aotLib[0x3860b8d72e1a66bd] = +[](Context & ctx) -> SimNode* { // expr_unary_7eafff562dd91c36
        return ctx.code->makeNode<SimNode_AotCMRES<debug_eval::Result (*) ( Context * __context__, debug_eval::TokenStream &  ),&expr_unary_7eafff562dd91c36>>();
    };
    aotLib[0xdb3e390e2f2cfb46] = +[](Context & ctx) -> SimNode* { // expr_mul_div_a01816d0548689b4
        return ctx.code->makeNode<SimNode_AotCMRES<debug_eval::Result (*) ( Context * __context__, debug_eval::TokenStream &  ),&expr_mul_div_a01816d0548689b4>>();
    };
    aotLib[0x788a18fb081c9e5d] = +[](Context & ctx) -> SimNode* { // expr_add_sub_958f6e8350a25a01
        return ctx.code->makeNode<SimNode_AotCMRES<debug_eval::Result (*) ( Context * __context__, debug_eval::TokenStream &  ),&expr_add_sub_958f6e8350a25a01>>();
    };
    aotLib[0x8b2de92aa1cdea8a] = +[](Context & ctx) -> SimNode* { // try_accept_punkt_c1565174265ef7b3
        return ctx.code->makeNode<SimNode_Aot<bool (*) ( Context * __context__, debug_eval::TokenStream & , int32_t  ),&try_accept_punkt_c1565174265ef7b3>>();
    };
    aotLib[0xf6908204c847e37] = +[](Context & ctx) -> SimNode* { // expr_and_9edde39c3aad1048
        return ctx.code->makeNode<SimNode_AotCMRES<debug_eval::Result (*) ( Context * __context__, debug_eval::TokenStream &  ),&expr_and_9edde39c3aad1048>>();
    };
    aotLib[0xa518daa1fb61b7fe] = +[](Context & ctx) -> SimNode* { // expr_xor_466b6dbbcc14397c
        return ctx.code->makeNode<SimNode_AotCMRES<debug_eval::Result (*) ( Context * __context__, debug_eval::TokenStream &  ),&expr_xor_466b6dbbcc14397c>>();
    };
    aotLib[0xa5b47b9aa799c9fd] = +[](Context & ctx) -> SimNode* { // expr_or_bf9fadca84c5914c
        return ctx.code->makeNode<SimNode_AotCMRES<debug_eval::Result (*) ( Context * __context__, debug_eval::TokenStream &  ),&expr_or_bf9fadca84c5914c>>();
    };
    aotLib[0xf63fa1e2388437c2] = +[](Context & ctx) -> SimNode* { // expr_bool_op_a803ca1de5c0f120
        return ctx.code->makeNode<SimNode_AotCMRES<debug_eval::Result (*) ( Context * __context__, debug_eval::TokenStream &  ),&expr_bool_op_a803ca1de5c0f120>>();
    };
    aotLib[0x34fdfe9a1af1973f] = +[](Context & ctx) -> SimNode* { // expr_553a8faea7e2c9cd
        return ctx.code->makeNode<SimNode_AotCMRES<debug_eval::Result (*) ( Context * __context__, debug_eval::TokenStream &  ),&expr_553a8faea7e2c9cd>>();
    };
    aotLib[0xe577f0a1bef28361] = +[](Context & ctx) -> SimNode* { // debug_eval_cad59dc2d7e9b0bb
        return ctx.code->makeNode<SimNode_AotCMRES<debug_eval::Result (*) ( Context * __context__, TTable<char *,debug_eval::Result> const  & , char * const   ),&debug_eval_cad59dc2d7e9b0bb>>();
    };
    // [[ init script ]]
