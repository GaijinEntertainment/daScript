...
namespace das {
namespace _anon_15627452965536875548 {
...
static_assert(sizeof(ExportConstructor)==72,"structure size mismatch with DAS");
static_assert(offsetof(ExportConstructor,__rtti)==0,"structure field offset mismatch with DAS");
static_assert(offsetof(ExportConstructor,__finalize)==8,"structure field offset mismatch with DAS");
static_assert(offsetof(ExportConstructor,apply)==16,"structure field offset mismatch with DAS");
static_assert(offsetof(ExportConstructor,finish)==24,"structure field offset mismatch with DAS");
static_assert(offsetof(ExportConstructor,patch)==32,"structure field offset mismatch with DAS");
static_assert(offsetof(ExportConstructor,complete)==40,"structure field offset mismatch with DAS");
static_assert(offsetof(ExportConstructor,aotPrefix)==48,"structure field offset mismatch with DAS");
static_assert(offsetof(ExportConstructor,aotBody)==56,"structure field offset mismatch with DAS");
static_assert(offsetof(ExportConstructor,aotSuffix)==64,"structure field offset mismatch with DAS");
}
...
inline StructInfo const  * _FuncrttiTickclass_infoTick15801393167907430156_c30e3f018c99393b ( Context * __context__, export_constructor::ExportConstructor const  & __cl_rename_at_116_2 );
...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    ...
    aotLib[0xcfd83a1949621973] = +[](Context & ctx) -> SimNode* { // _FuncrttiTickclass_infoTick15801393167907430156_c30e3f018c99393b
        return ctx.code->makeNode<SimNode_Aot<StructInfo const  * (*) ( Context * __context__, export_constructor::ExportConstructor const  &  ),&_FuncrttiTickclass_infoTick15801393167907430156_c30e3f018c99393b>>();
    };
	resolveTypeInfoAnnotations();
}

} // namespace _anon_15627452965536875548
AotListBase impl_aot_export_constructor(_anon_15627452965536875548::registerAotFunctions);
} // namespace das
