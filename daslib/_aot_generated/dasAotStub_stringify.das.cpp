...
inline void _FuncbuiltinTickpushTick10769833213962245646_cc8787f882c60e16 ( Context * __context__, TArray<ast::AstReaderMacro *> & __Arr_rename_at_181_0, ast::AstReaderMacro * __value_rename_at_181_1 );
inline StructInfo const  * _FuncrttiTickclass_infoTick15801393167907430156_550fe3d910906cf1 ( Context * __context__, stringify::LongStringReader const  & __cl_rename_at_116_2 );
...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    ...
    aotLib[0x414d64a159ba873f] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncrttiTickclass_infoTick15801393167907430156_550fe3d910906cf1>>();
    };
