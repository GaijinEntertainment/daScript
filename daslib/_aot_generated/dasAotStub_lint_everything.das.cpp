...
namespace das {
namespace _anon_15819715509097459901 {
...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    ...
    aotLib[0x8526c7f6f6835f9e] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncrttiTickclass_infoTick15801393167907430156_b59e35a65424b0ee>>();
    };
	resolveTypeInfoAnnotations();
}

} // namespace _anon_15819715509097459901
AotListBase impl_aot_lint_everything(_anon_15819715509097459901::registerAotFunctions);
} // namespace das
