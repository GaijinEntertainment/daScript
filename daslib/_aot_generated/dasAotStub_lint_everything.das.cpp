...
namespace das {
namespace _anon_6044033237046991959 {
...
static_assert(sizeof(LintEverythingGlobal)==24,"structure size mismatch with DAS");
static_assert(offsetof(LintEverythingGlobal,__rtti)==0,"structure field offset mismatch with DAS");
static_assert(offsetof(LintEverythingGlobal,__finalize)==8,"structure field offset mismatch with DAS");
static_assert(offsetof(LintEverythingGlobal,apply)==16,"structure field offset mismatch with DAS");
}
...
inline StructInfo const  * _FuncrttiTickclass_infoTick15801393167907430156_256ec29cf2f0cc92 ( Context * __context__, lint_everything::LintEverythingGlobal const  & __cl_rename_at_116_2 );
...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    ...
    aotLib[0x9f61d555768b0d63] = +[](Context & ctx) -> SimNode* { // _FuncrttiTickclass_infoTick15801393167907430156_256ec29cf2f0cc92
        return ctx.code->makeNode<SimNode_Aot<StructInfo const  * (*) ( Context * __context__, lint_everything::LintEverythingGlobal const  &  ),&_FuncrttiTickclass_infoTick15801393167907430156_256ec29cf2f0cc92>>();
    };
	resolveTypeInfoAnnotations();
}

} // namespace _anon_6044033237046991959
AotListBase impl_aot_lint_everything(_anon_6044033237046991959::registerAotFunctions);
} // namespace das
