...
inline void _FuncbuiltinTickpushTick10769833213962245646_28705f34078faef ( Context * __context__, TArray<ast::AstFunctionAnnotation *> & __Arr_rename_at_181_0, ast::AstFunctionAnnotation * __value_rename_at_181_1 );
inline StructInfo const  * _FuncrttiTickclass_infoTick15801393167907430156_eac0c4eb277ad661 ( Context * __context__, stub::TemplateMacro const  & __cl_rename_at_116_2 );
...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    aotLib[0x1ffbf8698af5c8be] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncbuiltinTickpushTick10769833213962245646_28705f34078faef>>();
    };
    aotLib[0x796768945a3dea76] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncrttiTickclass_infoTick15801393167907430156_eac0c4eb277ad661>>();
    };
