...
inline void _FuncbuiltinTickresizeTick4811697762258667383_803fc984cf5cf786 ( Context * __context__, TArray<char *> & __Arr_rename_at_68_0, int32_t __newSize_rename_at_68_1 );
inline void _FuncbuiltinTickcloneTick3038771811667655495_c5f9660cb7a4b487 ( Context * __context__, TArray<char *> & __a_rename_at_1113_2, TArray<char *> const  & __b_rename_at_1113_3 );
inline TArray<char *> & _FuncbuiltinTick_return_with_lockcheckTick2939372000839727345_d1df79e2a99d6a4e ( Context * __context__, TArray<char *> & __a_rename_at_50_9 );
inline void _FuncbuiltinTickfinalizeTick13836114024949725080_b12f1b533bf4598d ( Context * __context__, TArray<TArray<int32_t>> & __a_rename_at_1215_10 );
inline void _FuncbuiltinTickfinalizeTick13836114024949725080_17d2dcdfe9e69388 ( Context * __context__, TArray<int32_t> & __a_rename_at_1215_12 );
inline void _FuncbuiltinTickresizeTick4811697762258667383_a6e331f47325c2ef ( Context * __context__, TArray<TArray<int32_t>> & __Arr_rename_at_68_13, int32_t __newSize_rename_at_68_14 );
inline void _FuncbuiltinTickresizeTick4811697762258667383_856be2a5daceccf2 ( Context * __context__, TArray<int32_t> & __Arr_rename_at_68_15, int32_t __newSize_rename_at_68_16 );
inline void _FuncbuiltinTickswapTick6899974565646937647_df01d9c7ecd3e059 ( Context * __context__, TArray<int32_t> & __a_rename_at_1813_17, TArray<int32_t> & __b_rename_at_1813_18 );
inline bool _FuncbuiltinTickemptyTick15399874715904164783_fbfd1cef66dc0961 ( Context * __context__, TArray<AutoTuple<char *,char *>> const  & __a_rename_at_585_20 );
inline char * wide_f67dc9a4e5a2552 ( Context * __context__, char * const  __text_rename_at_12_21, int32_t __width_rename_at_12_22 );
inline TArray<char *> split_873c035d13d3223b ( Context * __context__, char * const  __text_rename_at_96_24, char * const  __delim_rename_at_96_25 );
inline TArray<char *> split_by_chars_873c035d13d3223b ( Context * __context__, char * const  __text_rename_at_108_28, char * const  __delim_rename_at_108_29 );
inline int32_t levenshtein_distance_af5549107d992d0f ( Context * __context__, char * const  __s_rename_at_133_32, char * const  __t_rename_at_133_33 );
inline int32_t levenshtein_distance_fast_af5549107d992d0f ( Context * __context__, char * const  __s_rename_at_161_42, char * const  __t_rename_at_161_43 );
inline char * replace_multiple_47cf72a1bfbfcb1a ( Context * __context__, char * const  __source_rename_at_191_54, TArray<AutoTuple<char *,char *>> const  & __replaces_rename_at_191_55 );
...
inline void _FuncbuiltinTickcloneTick3038771811667655495_c5f9660cb7a4b487 ( Context * __context__, TArray<char *> &  __a_rename_at_1113_2, TArray<char *> const  &  __b_rename_at_1113_3 )
{
    ...
    _FuncbuiltinTickresizeTick4811697762258667383_803fc984cf5cf786(__context__,das_arg<TArray<char *>>::pass(__a_rename_at_1113_2),__ln_rename_at_1114_4);
...
{
    {
        ...
        {
            _FuncbuiltinTickfinalizeTick13836114024949725080_17d2dcdfe9e69388(__context__,das_arg<TArray<int32_t>>::pass((*__aV_rename_at_1217_11)));
        }
...
inline TArray<char *> split_873c035d13d3223b ( Context * __context__, char * const  __text_rename_at_96_24, char * const  __delim_rename_at_96_25 ) { das_stack_prologue __prologue(__context__,96,"split " DAS_FILE_LINE);
{
    ...
    builtin_string_split(__text_rename_at_96_24,__delim_rename_at_96_25,das_make_block<void,TArray<char *> const  &>(__context__,80,0,&__func_info__d23ecd373e379628,[&](TArray<char *> const  & __arr_rename_at_98_27) -> void{
        _FuncbuiltinTickcloneTick3038771811667655495_c5f9660cb7a4b487(__context__,das_arg<TArray<char *>>::pass(__res_rename_at_97_26),__arr_rename_at_98_27);
    }),__context__,((LineInfoArg *)(&LineInfo::g_LineInfoNULL)));
    return /* <- */ das_auto_cast_move<TArray<char *>>::cast(_FuncbuiltinTick_return_with_lockcheckTick2939372000839727345_d1df79e2a99d6a4e(__context__,das_arg<TArray<char *>>::pass(__res_rename_at_97_26)));
}}

inline TArray<char *> split_by_chars_873c035d13d3223b ( Context * __context__, char * const  __text_rename_at_108_28, char * const  __delim_rename_at_108_29 ) { das_stack_prologue __prologue(__context__,96,"split_by_chars " DAS_FILE_LINE);
{
    ...
    builtin_string_split_by_char(__text_rename_at_108_28,__delim_rename_at_108_29,das_make_block<void,TArray<char *> const  &>(__context__,80,0,&__func_info__d23ecd373e379628,[&](TArray<char *> const  & __arr_rename_at_110_31) -> void{
        _FuncbuiltinTickcloneTick3038771811667655495_c5f9660cb7a4b487(__context__,das_arg<TArray<char *>>::pass(__res_rename_at_109_30),__arr_rename_at_110_31);
    }),__context__,((LineInfoArg *)(&LineInfo::g_LineInfoNULL)));
    return /* <- */ das_auto_cast_move<TArray<char *>>::cast(_FuncbuiltinTick_return_with_lockcheckTick2939372000839727345_d1df79e2a99d6a4e(__context__,das_arg<TArray<char *>>::pass(__res_rename_at_109_30)));
}}
...
inline int32_t levenshtein_distance_af5549107d992d0f ( Context * __context__, char * const  __s_rename_at_133_32, char * const  __t_rename_at_133_33 )
{
    ...
    _FuncbuiltinTickfinalizeTick13836114024949725080_b12f1b533bf4598d(__context__,das_arg<TArray<TArray<int32_t>>>::pass(__d_rename_at_136_36));
    /* end finally */ });
    ...
    _FuncbuiltinTickresizeTick4811697762258667383_a6e331f47325c2ef(__context__,das_arg<TArray<TArray<int32_t>>>::pass(__d_rename_at_136_36),__sLen_rename_at_134_34 + 1);
    {
        ...
        {
            _FuncbuiltinTickresizeTick4811697762258667383_856be2a5daceccf2(__context__,das_arg<TArray<int32_t>>::pass(__d_rename_at_136_36(__i_rename_at_138_37,__context__)),__tLen_rename_at_135_35 + 1);
...
inline int32_t levenshtein_distance_fast_af5549107d992d0f ( Context * __context__, char * const  __s_rename_at_161_42, char * const  __t_rename_at_161_43 )
{
    ...
    _FuncbuiltinTickfinalizeTick13836114024949725080_17d2dcdfe9e69388(__context__,das_arg<TArray<int32_t>>::pass(__v0_rename_at_164_46));
    _FuncbuiltinTickfinalizeTick13836114024949725080_17d2dcdfe9e69388(__context__,das_arg<TArray<int32_t>>::pass(__v1_rename_at_166_47));
    /* end finally */ });
    ...
    _FuncbuiltinTickresizeTick4811697762258667383_856be2a5daceccf2(__context__,das_arg<TArray<int32_t>>::pass(__v0_rename_at_164_46),__tLen_rename_at_163_45 + 1);
    das_zero(__v1_rename_at_166_47);
    _FuncbuiltinTickresizeTick4811697762258667383_856be2a5daceccf2(__context__,das_arg<TArray<int32_t>>::pass(__v1_rename_at_166_47),__tLen_rename_at_163_45 + 1);
    {
    ...
    };
    {
        ...
        for ( ; __need_loop_172 ; __need_loop_172 = __i_iterator.next(__context__,(__i_rename_at_172_49)) )
        {
            ...
            _FuncbuiltinTickswapTick6899974565646937647_df01d9c7ecd3e059(__context__,das_arg<TArray<int32_t>>::pass(__v0_rename_at_164_46),das_arg<TArray<int32_t>>::pass(__v1_rename_at_166_47));
        }
...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    ...
    aotLib[0xd7b9a9901cfb24af] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncbuiltinTickcloneTick3038771811667655495_c5f9660cb7a4b487>>();
    };
    ...
    aotLib[0xa5e3f790da51c68a] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncbuiltinTickfinalizeTick13836114024949725080_b12f1b533bf4598d>>();
    };
    aotLib[0xfa45458fa8cc777f] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncbuiltinTickfinalizeTick13836114024949725080_17d2dcdfe9e69388>>();
    };
    aotLib[0xd5c33d4bc37c1931] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncbuiltinTickresizeTick4811697762258667383_a6e331f47325c2ef>>();
    };
    ...
    aotLib[0x1ddeb87db163e9ee] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncbuiltinTickswapTick6899974565646937647_df01d9c7ecd3e059>>();
    };
    aotLib[0x6db880d1fe5c5c4f] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncbuiltinTickemptyTick15399874715904164783_fbfd1cef66dc0961>>();
    };
    aotLib[0xc04abfe8e76866ab] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&wide_f67dc9a4e5a2552>>();
    };
    aotLib[0xc9e89f685d2ecae3] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_AotCMRES<&split_873c035d13d3223b>>();
    };
    aotLib[0xc9e89f685d2ecae3] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_AotCMRES<&split_by_chars_873c035d13d3223b>>();
    };
    aotLib[0xf6c1c63b1a83ceeb] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&levenshtein_distance_af5549107d992d0f>>();
    };
    aotLib[0xe49769d2ee47127a] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&levenshtein_distance_fast_af5549107d992d0f>>();
    };
    aotLib[0x63a37eedb85ee3f9] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&replace_multiple_47cf72a1bfbfcb1a>>();
    };
