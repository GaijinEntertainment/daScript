...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    ...
    aotLib[0x93680ae9c38c532] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTickemptyTick15399874715904164783_17e819552d1fbeb4
        return ctx.code->makeNode<SimNode_Aot<bool (*) ( Context * __context__, TArray<AutoTuple<char *,char *>> const  &  ),&_FuncbuiltinTickemptyTick15399874715904164783_17e819552d1fbeb4>>();
    };
    ...
    aotLib[0x80367ae3d8465b8f] = +[](Context & ctx) -> SimNode* { // replace_multiple_d0cf6948c5333e25
        return ctx.code->makeNode<SimNode_Aot<char * (*) ( Context * __context__, char * const  , TArray<AutoTuple<char *,char *>> const  &  ),&replace_multiple_d0cf6948c5333e25>>();
    };
