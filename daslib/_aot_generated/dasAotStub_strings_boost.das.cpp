...
namespace das {
namespace _anon_17517716020909677364 {
...
inline void _FuncbuiltinTickcloneTick3038771811667655495_4060192a3cb0948 ( Context * __context__, TArray<char *> & __a_rename_at_1081_2, TArray<char *> const  & __b_rename_at_1081_3 );
...
inline void _FuncbuiltinTickfinalizeTick13836114024949725080_5be9a99f60cdfbba ( Context * __context__, TArray<TArray<int32_t>> & __a_rename_at_1183_10 );
inline void _FuncbuiltinTickfinalizeTick13836114024949725080_c2c15811c6d720e8 ( Context * __context__, TArray<int32_t> & __a_rename_at_1183_12 );
...
inline void _FuncbuiltinTickswapTick6899974565646937647_4b12db88e6e6aa18 ( Context * __context__, TArray<int32_t> & __a_rename_at_1781_17, TArray<int32_t> & __b_rename_at_1781_18 );
inline bool _FuncbuiltinTickemptyTick15399874715904164783_17e819552d1fbeb4 ( Context * __context__, TArray<TTuple<16,char *,char *>> const  & __a_rename_at_585_20 );
...
inline char * replace_multiple_d0cf6948c5333e25 ( Context * __context__, char * const  __source_rename_at_191_54, TArray<TTuple<16,char *,char *>> const  & __replaces_rename_at_191_55 );
inline bool is_hex_1a798843ad8ffa83 ( Context * __context__, int32_t __ch_rename_at_217_61 );
inline bool is_tab_or_space_52c1771849866e9 ( Context * __context__, int32_t __ch_rename_at_221_62 );
...
inline void _FuncbuiltinTickcloneTick3038771811667655495_4060192a3cb0948 ( Context * __context__, TArray<char *> &  __a_rename_at_1081_2, TArray<char *> const  &  __b_rename_at_1081_3 )
{
    int32_t __ln_rename_at_1082_4 = ((int32_t)builtin_array_size(__b_rename_at_1081_3));
    _FuncbuiltinTickresizeTick4811697762258667383_14682004b38ad2a1(__context__,das_arg<TArray<char *>>::pass(__a_rename_at_1081_2),__ln_rename_at_1082_4);
    if ( __ln_rename_at_1082_4 == 0 )
    {
        return ;
    } else {
        {
            ...
            // aV: string aka TT&
            das_iterator<TArray<char *>> __aV_iterator(__a_rename_at_1081_2);
            char * * __aV_rename_at_1092_7;
            __need_loop_1092 = __aV_iterator.first(__context__,(__aV_rename_at_1092_7)) && __need_loop_1092;
            // bV: string const&#
            das_iterator<TArray<char *> const > __bV_iterator(__b_rename_at_1081_3);
            char * const  * __bV_rename_at_1092_8;
            __need_loop_1092 = __bV_iterator.first(__context__,(__bV_rename_at_1092_8)) && __need_loop_1092;
            for ( ; __need_loop_1092 ; __need_loop_1092 = __aV_iterator.next(__context__,(__aV_rename_at_1092_7)) && __bV_iterator.next(__context__,(__bV_rename_at_1092_8)) )
            {
                das_copy((*__aV_rename_at_1092_7),((char * const )(builtin_string_clone((*__bV_rename_at_1092_8),__context__,((LineInfoArg *)(&LineInfo::g_LineInfoNULL))))));
            }
            __aV_iterator.close(__context__,(__aV_rename_at_1092_7));
            __bV_iterator.close(__context__,(__bV_rename_at_1092_8));
        };
    };
}
...
{
    {
        ...
        // aV: array<int> aka TT&
        das_iterator<TArray<TArray<int32_t>>> __aV_iterator(__a_rename_at_1183_10);
        TArray<int32_t> * __aV_rename_at_1185_11;
        ...
        {
            _FuncbuiltinTickfinalizeTick13836114024949725080_c2c15811c6d720e8(__context__,das_arg<TArray<int32_t>>::pass((*__aV_rename_at_1185_11)));
        }
        __aV_iterator.close(__context__,(__aV_rename_at_1185_11));
    };
    builtin_array_free(das_arg<TArray<TArray<int32_t>>>::pass(__a_rename_at_1183_10),24,__context__,((LineInfoArg *)(&LineInfo::g_LineInfoNULL)));
}

inline void _FuncbuiltinTickfinalizeTick13836114024949725080_c2c15811c6d720e8 ( Context * __context__, TArray<int32_t> &  __a_rename_at_1183_12 )
{
    builtin_array_free(das_arg<TArray<int32_t>>::pass(__a_rename_at_1183_12),4,__context__,((LineInfoArg *)(&LineInfo::g_LineInfoNULL)));
}
...
inline void _FuncbuiltinTickswapTick6899974565646937647_4b12db88e6e6aa18 ( Context * __context__, TArray<int32_t> &  __a_rename_at_1781_17, TArray<int32_t> &  __b_rename_at_1781_18 )
{
    TArray<int32_t> __t_rename_at_1783_19; das_zero(__t_rename_at_1783_19); das_move(__t_rename_at_1783_19, __a_rename_at_1781_17);
    das_move(__a_rename_at_1781_17,__b_rename_at_1781_18);
    das_move(__b_rename_at_1781_18,__t_rename_at_1783_19);
}
    ...
    return das_auto_cast<char *>::cast((builtin_empty(__source_rename_at_191_54) || _FuncbuiltinTickemptyTick15399874715904164783_17e819552d1fbeb4(__context__,__replaces_rename_at_191_55)) ? das_auto_cast<char * const >::cast(__source_rename_at_191_54) : das_auto_cast<char * const >::cast(((char * const )(builtin_build_string_T([&](StringBuilderWriter & __writer_rename_at_196_56) DAS_AOT_INLINE_LAMBDA -> void{
        ...
        while ( __index_rename_at_197_57 < __len_rename_at_198_58 )
        {
            bool __found_rename_at_200_59 = false;
            {
                ...
                das_iterator<TArray<TTuple<16,char *,char *>> const > __replace_iterator(__replaces_rename_at_191_55);
                TTuple<16,char *,char *> const  * __replace_rename_at_201_60;
                ...
                {
                    if ( builtin_string_startswith3(__source_rename_at_191_54,__index_rename_at_197_57,das_get_tuple_field<char *,0>::get((*__replace_rename_at_201_60)),__context__) )
                    {
                        das_call_interop<StringBuilderWriter &>::call(&builtin_write_string,__context__,SimNode_AotInterop<2>(__tinfo_2,cast<StringBuilderWriter &>::from(__writer_rename_at_196_56),cast<char * const >::from(das_get_tuple_field<char *,8>::get((*__replace_rename_at_201_60)))));
                        __index_rename_at_197_57 += builtin_string_length(das_get_tuple_field<char *,0>::get((*__replace_rename_at_201_60)),__context__);
...
inline bool is_hex_1a798843ad8ffa83 ( Context * __context__, int32_t __ch_rename_at_217_61 )
{
    return das_auto_cast<bool>::cast((((__ch_rename_at_217_61 >= 48) && (__ch_rename_at_217_61 <= 57)) || ((__ch_rename_at_217_61 >= 97) && (__ch_rename_at_217_61 <= 102))) || ((__ch_rename_at_217_61 >= 65) && (__ch_rename_at_217_61 <= 70)));
}

inline bool is_tab_or_space_52c1771849866e9 ( Context * __context__, int32_t __ch_rename_at_221_62 )
{
    return das_auto_cast<bool>::cast((__ch_rename_at_221_62 == 32) || (__ch_rename_at_221_62 == 9));
}
...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    ...
    aotLib[0x4dae975ff549d69b] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTickcloneTick3038771811667655495_4060192a3cb0948
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, TArray<char *> & , TArray<char *> const  &  ),&_FuncbuiltinTickcloneTick3038771811667655495_4060192a3cb0948>>();
    };
    ...
    aotLib[0x8cfab1c459867f92] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTickfinalizeTick13836114024949725080_5be9a99f60cdfbba
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, TArray<TArray<int32_t>> &  ),&_FuncbuiltinTickfinalizeTick13836114024949725080_5be9a99f60cdfbba>>();
    };
    ...
    aotLib[0x31e785d0d32596a0] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTickresizeTick4811697762258667383_c1a73db481e59a8b
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, TArray<TArray<int32_t>> & , int32_t  ),&_FuncbuiltinTickresizeTick4811697762258667383_c1a73db481e59a8b>>();
    };
    ...
    aotLib[0x983ece9be972c6d9] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTickswapTick6899974565646937647_4b12db88e6e6aa18
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, TArray<int32_t> & , TArray<int32_t> &  ),&_FuncbuiltinTickswapTick6899974565646937647_4b12db88e6e6aa18>>();
    };
    aotLib[0x93680ae9c38c532] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTickemptyTick15399874715904164783_17e819552d1fbeb4
        return ctx.code->makeNode<SimNode_Aot<bool (*) ( Context * __context__, TArray<TTuple<16,char *,char *>> const  &  ),&_FuncbuiltinTickemptyTick15399874715904164783_17e819552d1fbeb4>>();
    };
    aotLib[0x2cdd6a9efa3197df] = +[](Context & ctx) -> SimNode* { // wide_53059f73cffda483
        return ctx.code->makeNode<SimNode_Aot<char * (*) ( Context * __context__, char * const  , int32_t  ),&wide_53059f73cffda483>>();
    };
    aotLib[0x165330731a689430] = +[](Context & ctx) -> SimNode* { // split_fd059c42eafc7a0e
        return ctx.code->makeNode<SimNode_AotCMRES<TArray<char *> (*) ( Context * __context__, char * const  , char * const   ),&split_fd059c42eafc7a0e>>();
    };
    aotLib[0xd23d132a7e215438] = +[](Context & ctx) -> SimNode* { // split_by_chars_6cab5408b0530c5d
        return ctx.code->makeNode<SimNode_AotCMRES<TArray<char *> (*) ( Context * __context__, char * const  , char * const   ),&split_by_chars_6cab5408b0530c5d>>();
    };
    aotLib[0x38cd58da5e8d5634] = +[](Context & ctx) -> SimNode* { // levenshtein_distance_81cc63ff8762bd35
        return ctx.code->makeNode<SimNode_Aot<int32_t (*) ( Context * __context__, char * const  , char * const   ),&levenshtein_distance_81cc63ff8762bd35>>();
    };
    aotLib[0x4c9205449631d7cb] = +[](Context & ctx) -> SimNode* { // levenshtein_distance_fast_4be142fb1ec75f90
        return ctx.code->makeNode<SimNode_Aot<int32_t (*) ( Context * __context__, char * const  , char * const   ),&levenshtein_distance_fast_4be142fb1ec75f90>>();
    };
    aotLib[0x80367ae3d8465b8f] = +[](Context & ctx) -> SimNode* { // replace_multiple_d0cf6948c5333e25
        return ctx.code->makeNode<SimNode_Aot<char * (*) ( Context * __context__, char * const  , TArray<TTuple<16,char *,char *>> const  &  ),&replace_multiple_d0cf6948c5333e25>>();
    };
    aotLib[0x6eba1f6e9354b5f3] = +[](Context & ctx) -> SimNode* { // is_hex_1a798843ad8ffa83
        return ctx.code->makeNode<SimNode_Aot<bool (*) ( Context * __context__, int32_t  ),&is_hex_1a798843ad8ffa83>>();
    };
    aotLib[0x6aa50c262a7d6d74] = +[](Context & ctx) -> SimNode* { // is_tab_or_space_52c1771849866e9
        return ctx.code->makeNode<SimNode_Aot<bool (*) ( Context * __context__, int32_t  ),&is_tab_or_space_52c1771849866e9>>();
    };
	resolveTypeInfoAnnotations();
}

} // namespace _anon_17517716020909677364
AotListBase impl_aot_strings_boost(_anon_17517716020909677364::registerAotFunctions);
} // namespace das
