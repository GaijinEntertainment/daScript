...
static_assert(sizeof(UnrollMacro)==112,"structure size mismatch with DAS");
static_assert(offsetof(UnrollMacro,__rtti)==0,"structure field offset mismatch with DAS");
static_assert(offsetof(UnrollMacro,__finalize)==8,"structure field offset mismatch with DAS");
static_assert(offsetof(UnrollMacro,transform)==16,"structure field offset mismatch with DAS");
static_assert(offsetof(UnrollMacro,verifyCall)==24,"structure field offset mismatch with DAS");
static_assert(offsetof(UnrollMacro,apply)==32,"structure field offset mismatch with DAS");
static_assert(offsetof(UnrollMacro,generic_apply)==40,"structure field offset mismatch with DAS");
static_assert(offsetof(UnrollMacro,finish)==48,"structure field offset mismatch with DAS");
static_assert(offsetof(UnrollMacro,patch)==56,"structure field offset mismatch with DAS");
static_assert(offsetof(UnrollMacro,fixup)==64,"structure field offset mismatch with DAS");
static_assert(offsetof(UnrollMacro,lint)==72,"structure field offset mismatch with DAS");
static_assert(offsetof(UnrollMacro,complete)==80,"structure field offset mismatch with DAS");
static_assert(offsetof(UnrollMacro,isCompatible)==88,"structure field offset mismatch with DAS");
static_assert(offsetof(UnrollMacro,isSpecialized)==96,"structure field offset mismatch with DAS");
static_assert(offsetof(UnrollMacro,appendToMangledName)==104,"structure field offset mismatch with DAS");
}
...
inline StructInfo const  * _FuncrttiTickclass_infoTick15801393167907430156_4c76780c47ab318f ( Context * __context__, unroll::UnrollMacro const  & __cl_rename_at_116_2 );
inline smart_ptr_raw<FunctionAnnotation> _FuncastTickmake_function_annotationTick3074191368936885601_946b695ee06eb12c ( Context * __context__, char * const  __name_rename_at_622_3, unroll::UnrollMacro * __someClassPtr_rename_at_622_4 );
inline void _Funcast_boostTicksetup_tag_annotationTick4095297895764883997_d65be52b3057b726 ( Context * __context__, char * const  __name_rename_at_273_6, char * const  __tag_rename_at_273_7, unroll::UnrollMacro * __classPtr_rename_at_273_8 );
inline void unroll_fe20df40e503f423 ( Context * __context__, Block DAS_COMMENT((void)) const  & __blk_rename_at_15_10 );
...
inline smart_ptr_raw<FunctionAnnotation> _FuncastTickmake_function_annotationTick3074191368936885601_946b695ee06eb12c ( Context * __context__, char * const  __name_rename_at_622_3, unroll::UnrollMacro * __someClassPtr_rename_at_622_4 )
{
    ...
    StructInfo const  * __classInfo_rename_at_625_5 = ((StructInfo const  *)_FuncrttiTickclass_infoTick15801393167907430156_4c76780c47ab318f(__context__,das_arg<unroll::UnrollMacro>::pass(das_deref(__context__,__someClassPtr_rename_at_622_4))));
...
inline void _Funcast_boostTicksetup_tag_annotationTick4095297895764883997_d65be52b3057b726 ( Context * __context__, char * const  __name_rename_at_273_6, char * const  __tag_rename_at_273_7, unroll::UnrollMacro * __classPtr_rename_at_273_8 )
{
    ...
    /* end finally */ });
    __ann_rename_at_274_9; das_zero(__ann_rename_at_274_9); das_move(__ann_rename_at_274_9, _FuncastTickmake_function_annotationTick3074191368936885601_946b695ee06eb12c(__context__,__name_rename_at_273_6,__classPtr_rename_at_273_8));
...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    ...
    aotLib[0x442d3335257d4482] = +[](Context & ctx) -> SimNode* { // _FuncrttiTickclass_infoTick15801393167907430156_4c76780c47ab318f
        return ctx.code->makeNode<SimNode_Aot<StructInfo const  * (*) ( Context * __context__, unroll::UnrollMacro const  &  ),&_FuncrttiTickclass_infoTick15801393167907430156_4c76780c47ab318f>>();
    };
    aotLib[0x9bbd7997aac9098b] = +[](Context & ctx) -> SimNode* { // _FuncastTickmake_function_annotationTick3074191368936885601_946b695ee06eb12c
        return ctx.code->makeNode<SimNode_Aot<smart_ptr_raw<FunctionAnnotation> (*) ( Context * __context__, char * const  , unroll::UnrollMacro *  ),&_FuncastTickmake_function_annotationTick3074191368936885601_946b695ee06eb12c>>();
    };
    aotLib[0xba11f35526c30f2f] = +[](Context & ctx) -> SimNode* { // _Funcast_boostTicksetup_tag_annotationTick4095297895764883997_d65be52b3057b726
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, char * const  , char * const  , unroll::UnrollMacro *  ),&_Funcast_boostTicksetup_tag_annotationTick4095297895764883997_d65be52b3057b726>>();
    };
    aotLib[0x6cd14d518fb9518a] = +[](Context & ctx) -> SimNode* { // unroll_fe20df40e503f423
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, Block DAS_COMMENT((void)) const  &  ),&unroll_fe20df40e503f423>>();
    };
    // [[ init script ]]
