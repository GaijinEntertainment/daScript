...
inline StructInfo const  * _FuncrttiTickclass_infoTick15801393167907430156_1a5d4362946e1dfa ( Context * __context__, unroll::UnrollMacro const  & __cl_rename_at_116_2 );
inline smart_ptr_raw<FunctionAnnotation> _FuncastTickmake_function_annotationTick3074191368936885601_60b055c72a0f1071 ( Context * __context__, char * const  __name_rename_at_626_3, unroll::UnrollMacro * __someClassPtr_rename_at_626_4 );
...
inline smart_ptr_raw<FunctionAnnotation> _FuncastTickmake_function_annotationTick3074191368936885601_60b055c72a0f1071 ( Context * __context__, char * const  __name_rename_at_626_3, unroll::UnrollMacro * __someClassPtr_rename_at_626_4 )
{
    ...
    StructInfo const  * __classInfo_rename_at_629_5 = ((StructInfo const  *)_FuncrttiTickclass_infoTick15801393167907430156_1a5d4362946e1dfa(__context__,das_arg<unroll::UnrollMacro>::pass(das_deref(__context__,__someClassPtr_rename_at_626_4))));
...
inline void _Funcast_boostTicksetup_tag_annotationTick4095297895764883997_c434f5f8ba663c3b ( Context * __context__, char * const  __name_rename_at_273_6, char * const  __tag_rename_at_273_7, unroll::UnrollMacro * __classPtr_rename_at_273_8 )
{
    ...
    /* end finally */ });
    __ann_rename_at_274_9; das_zero(__ann_rename_at_274_9); das_move(__ann_rename_at_274_9, _FuncastTickmake_function_annotationTick3074191368936885601_60b055c72a0f1071(__context__,__name_rename_at_273_6,__classPtr_rename_at_273_8));
...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    ...
    aotLib[0x1730a99fa61626fe] = +[](Context & ctx) -> SimNode* { // _FuncrttiTickclass_infoTick15801393167907430156_1a5d4362946e1dfa
        return ctx.code->makeNode<SimNode_Aot<StructInfo const  * (*) ( Context * __context__, unroll::UnrollMacro const  &  ),&_FuncrttiTickclass_infoTick15801393167907430156_1a5d4362946e1dfa>>();
    };
    aotLib[0x8aa92563cd23047a] = +[](Context & ctx) -> SimNode* { // _FuncastTickmake_function_annotationTick3074191368936885601_60b055c72a0f1071
        return ctx.code->makeNode<SimNode_Aot<smart_ptr_raw<FunctionAnnotation> (*) ( Context * __context__, char * const  , unroll::UnrollMacro *  ),&_FuncastTickmake_function_annotationTick3074191368936885601_60b055c72a0f1071>>();
    };
    aotLib[0xf831537867c5529c] = +[](Context & ctx) -> SimNode* { // _Funcast_boostTicksetup_tag_annotationTick4095297895764883997_c434f5f8ba663c3b
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, char * const  , char * const  , unroll::UnrollMacro *  ),&_Funcast_boostTicksetup_tag_annotationTick4095297895764883997_c434f5f8ba663c3b>>();
    };
