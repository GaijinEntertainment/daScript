...
inline void _FuncbuiltinTickfinalizeTick13836114024949725080_9761ce31b72a4dea ( Context * __context__, TArray<smart_ptr_raw<TypeDecl>> & __a_rename_at_1234_2 );
...
{
    {
        ...
        das_iterator<TArray<smart_ptr_raw<TypeDecl>>> __aV_iterator(__a_rename_at_1234_2);
        smart_ptr_raw<TypeDecl> * __aV_rename_at_1236_3;
        ...
        {
            das_delete_handle<smart_ptr_raw<TypeDecl>>::clear(__context__,(*__aV_rename_at_1236_3));
        }
        __aV_iterator.close(__context__,(__aV_rename_at_1236_3));
    };
    builtin_array_free(das_arg<TArray<smart_ptr_raw<TypeDecl>>>::pass(__a_rename_at_1234_2),8,__context__,((LineInfoArg *)(&LineInfo::g_LineInfoNULL)));
}
