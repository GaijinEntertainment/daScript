...
inline void _FuncbuiltinTickfinalizeTick13836114024949725080_615e0425516708d9 ( Context * __context__, TArray<smart_ptr_raw<TypeDecl>> & __a_rename_at_1183_2 );
inline char * _FuncastTickdescribe_cppTick4968415101487673878_c05070953a867f90 ( Context * __context__, smart_ptr_raw<TypeDecl> const  __decl_rename_at_42_4, bool __substitureRef_rename_at_42_5, bool __skipRef_rename_at_42_6, bool __skipConst_rename_at_42_7, bool __redundantConst_rename_at_42_8 );
inline void _FuncbuiltinTickpushTick10769833213962245646_b3fa6014e447ff2d ( Context * __context__, TArray<TTuple<16,char *,int32_t>> & __Arr_rename_at_181_9, TTuple<16,char *,int32_t> & __value_rename_at_181_10 );
...
{
    {
        ...
        das_iterator<TArray<smart_ptr_raw<TypeDecl>>> __aV_iterator(__a_rename_at_1183_2);
        smart_ptr_raw<TypeDecl> * __aV_rename_at_1185_3;
        ...
        {
            das_delete_handle<smart_ptr_raw<TypeDecl>>::clear(__context__,(*__aV_rename_at_1185_3));
        }
        __aV_iterator.close(__context__,(__aV_rename_at_1185_3));
    };
    builtin_array_free(das_arg<TArray<smart_ptr_raw<TypeDecl>>>::pass(__a_rename_at_1183_2),8,__context__,((LineInfoArg *)(&LineInfo::g_LineInfoNULL)));
}

inline char * _FuncastTickdescribe_cppTick4968415101487673878_c05070953a867f90 ( Context * __context__, smart_ptr_raw<TypeDecl> const  __decl_rename_at_42_4, bool __substitureRef_rename_at_42_5, bool __skipRef_rename_at_42_6, bool __skipConst_rename_at_42_7, bool __redundantConst_rename_at_42_8 )
{
    return das_auto_cast<char *>::cast(((char * const )(ast_describe_typedecl_cpp(__decl_rename_at_42_4,__substitureRef_rename_at_42_5,__skipRef_rename_at_42_6,__skipConst_rename_at_42_7,__redundantConst_rename_at_42_8,__context__,((LineInfoArg *)(&LineInfo::g_LineInfoNULL))))));
}

inline void _FuncbuiltinTickpushTick10769833213962245646_b3fa6014e447ff2d ( Context * __context__, TArray<TTuple<16,char *,int32_t>> &  __Arr_rename_at_181_9, TTuple<16,char *,int32_t> &  __value_rename_at_181_10 )
{
    das_copy(__Arr_rename_at_181_9(builtin_array_push_back(das_arg<TArray<TTuple<16,char *,int32_t>>>::pass(__Arr_rename_at_181_9),16,__context__,((LineInfoArg *)(&LineInfo::g_LineInfoNULL))),__context__),__value_rename_at_181_10);
}
...
inline void log_cpp_class_method_36d323d98780e7f9 ( Context * __context__, FILE const  * const  __cpp_file_rename_at_15_13, char * const  __name_rename_at_15_14, smart_ptr_raw<TypeDecl> const  __fntype_rename_at_15_15 )
{
    smart_ptr<TypeDecl> __cft_rename_at_16_16; memset(&__cft_rename_at_16_16,0,sizeof(__cft_rename_at_16_16));
    ...
    das_delete_handle<smart_ptr<TypeDecl>>::clear(__context__,__cft_rename_at_16_16);
    /* end finally */ });
    ...
    builtin_fwrite(__cpp_file_rename_at_15_13,das_string_builder_temp(__context__,SimNode_AotInterop<4>(__tinfo_0, cast<char * const >::from(__rettd_rename_at_18_17), cast<char * const >::from(((char *) " ")), cast<char * const >::from(__name_rename_at_15_14), cast<char * const >::from(((char *) " ( Context * __context__, Func __funcCall__")))),__context__,((LineInfoArg *)(&LineInfo::g_LineInfoNULL)));
    {
        ...
        smart_ptr<TypeDecl> const  * __argT_rename_at_20_25;
...
inline void log_cpp_class_method_call_358e578e3a125dd1 ( Context * __context__, FILE const  * const  __cpp_file_rename_at_36_28, char * const  __name_rename_at_36_29, smart_ptr_raw<TypeDecl> const  __fntype_rename_at_36_30 )
{
    ...
    builtin_fwrite(__cpp_file_rename_at_36_28,das_string_builder_temp(__context__,SimNode_AotInterop<3>(__tinfo_3, cast<char * const >::from(((char *) "das_invoke_function<")), cast<char * const >::from(__rettd_rename_at_37_31), cast<char * const >::from(((char *) ">::invoke\n      <")))),__context__,((LineInfoArg *)(&LineInfo::g_LineInfoNULL)));
    {
        ...
        smart_ptr<TypeDecl> const  * __argT_rename_at_39_39;
...
inline void log_cpp_class_adapter_92277e6cbae7f863 ( Context * __context__, FILE const  * const  __cpp_file_rename_at_66_46, char * const  __name_rename_at_66_47, smart_ptr_raw<TypeDecl> const  __cinfo_rename_at_66_48 )
{
    TArray<TTuple<16,char *,int32_t>> __methods_rename_at_72_49; memset(&__methods_rename_at_72_49,0,sizeof(__methods_rename_at_72_49));
    ...
    __types_rename_at_73_50; das_zero(__types_rename_at_73_50);
    {
        ...
        for ( ; __need_loop_74 ; __need_loop_74 = __fld_iterator.next(__context__,(__fld_rename_at_74_53)) && __idx_iterator.next(__context__,(__idx_rename_at_74_54)) )
        {
            if ( (!(((das_deref(__context__,(*__fld_rename_at_74_53).type /*_type*/)).isFunction())) || (eq_dstr_str((*__fld_rename_at_74_53).name /*name*/,((char *) "__finalize")))) || (nequ_sptr_ptr(das_auto_cast<smart_ptr_raw<void> const >::cast((*__fld_rename_at_74_53).init /*init*/),das_auto_cast<void * const >::cast(nullptr))) )
            {
                ...
                TTuple<16,char *,int32_t> _temp_make_local_78_23_240; _temp_make_local_78_23_240;
                _FuncbuiltinTickpushTick10769833213962245646_b3fa6014e447ff2d(__context__,das_arg<TArray<TTuple<16,char *,int32_t>>>::pass(__methods_rename_at_72_49),das_arg<TTuple<16,char *,int32_t>>::pass((([&]() -> TTuple<16,char *,int32_t>& {
                    das_get_tuple_field<char *,0>::get(_temp_make_local_78_23_240) = das_string_builder(__context__,SimNode_AotInterop<1>(__tinfo_6, cast<das::string const  &>::from((*__fld_rename_at_74_53).name /*name*/)));
                    das_get_tuple_field<int32_t,8>::get(_temp_make_local_78_23_240) = __idx_rename_at_74_54;
    ...
    __nmet_rename_at_81_55 = ((int32_t)builtin_array_size(das_arg<TArray<TTuple<16,char *,int32_t>>>::pass(__methods_rename_at_72_49)));
    ...
    builtin_fwrite(__cpp_file_rename_at_66_46,((char *) "  enum {\n"),__context__,((LineInfoArg *)(&LineInfo::g_LineInfoNULL)));
    {
        ...
        das_iterator<TArray<TTuple<16,char *,int32_t>>> __mn_iterator(__methods_rename_at_72_49);
        TTuple<16,char *,int32_t> * __mn_rename_at_85_58;
        ...
        {
            builtin_fwrite(__cpp_file_rename_at_66_46,das_string_builder_temp(__context__,SimNode_AotInterop<5>(__tinfo_8, cast<char * const >::from(((char *) "    __fn_")), cast<char *>::from(das_get_tuple_field<char *,0>::get((*__mn_rename_at_85_58))), cast<char * const >::from(((char *) " = ")), cast<int32_t>::from(__mni_rename_at_85_59), cast<char * const >::from(((char *) ",\n")))),__context__,((LineInfoArg *)(&LineInfo::g_LineInfoNULL)));
        }
    ...
    builtin_fwrite(__cpp_file_rename_at_66_46,das_string_builder_temp(__context__,SimNode_AotInterop<3>(__tinfo_10, cast<char * const >::from(((char *) "  ")), cast<char * const >::from(__name_rename_at_66_47), cast<char * const >::from(((char *) " ( const StructInfo * info ) {\n")))),__context__,((LineInfoArg *)(&LineInfo::g_LineInfoNULL)));
    {
        ...
        // mn: tuple<name:string;index:int>&
        das_iterator<TArray<TTuple<16,char *,int32_t>>> __mn_iterator(__methods_rename_at_72_49);
        TTuple<16,char *,int32_t> * __mn_rename_at_93_62;
        ...
        {
            builtin_fwrite(__cpp_file_rename_at_66_46,das_string_builder_temp(__context__,SimNode_AotInterop<5>(__tinfo_11, cast<char * const >::from(((char *) "      _das_class_method_offset[__fn_")), cast<char *>::from(das_get_tuple_field<char *,0>::get((*__mn_rename_at_93_62))), cast<char * const >::from(((char *) "] = info->fields[")), cast<int32_t>::from(das_get_tuple_field<int32_t,8>::get((*__mn_rename_at_93_62))), cast<char * const >::from(((char *) "]->offset;\n")))),__context__,((LineInfoArg *)(&LineInfo::g_LineInfoNULL)));
        }
    ...
    builtin_fwrite(__cpp_file_rename_at_66_46,((char *) "  }\n"),__context__,((LineInfoArg *)(&LineInfo::g_LineInfoNULL)));
    {
        ...
        // mn: tuple<name:string;index:int>&
        das_iterator<TArray<TTuple<16,char *,int32_t>>> __mn_iterator(__methods_rename_at_72_49);
        TTuple<16,char *,int32_t> * __mn_rename_at_97_66;
        ...
        {
            builtin_fwrite(__cpp_file_rename_at_66_46,das_string_builder_temp(__context__,SimNode_AotInterop<3>(__tinfo_12, cast<char * const >::from(((char *) "  __forceinline Func get_")), cast<char *>::from(das_get_tuple_field<char *,0>::get((*__mn_rename_at_97_66))), cast<char * const >::from(((char *) " ( void * self ) const {\n")))),__context__,((LineInfoArg *)(&LineInfo::g_LineInfoNULL)));
            builtin_fwrite(__cpp_file_rename_at_66_46,das_string_builder_temp(__context__,SimNode_AotInterop<3>(__tinfo_13, cast<char * const >::from(((char *) "    return getDasClassMethod(self,_das_class_method_offset[__fn_")), cast<char *>::from(das_get_tuple_field<char *,0>::get((*__mn_rename_at_97_66))), cast<char * const >::from(((char *) "]);\n")))),__context__,((LineInfoArg *)(&LineInfo::g_LineInfoNULL)));
            builtin_fwrite(__cpp_file_rename_at_66_46,((char *) "  }\n"),__context__,((LineInfoArg *)(&LineInfo::g_LineInfoNULL)));
            builtin_fwrite(__cpp_file_rename_at_66_46,((char *) "  __forceinline "),__context__,((LineInfoArg *)(&LineInfo::g_LineInfoNULL)));
            log_cpp_class_method_36d323d98780e7f9(__context__,__cpp_file_rename_at_66_46,das_string_builder(__context__,SimNode_AotInterop<2>(__tinfo_14, cast<char * const >::from(((char *) "invoke_")), cast<char *>::from(das_get_tuple_field<char *,0>::get((*__mn_rename_at_97_66))))),(*__mt_rename_at_97_67));
            ...
            log_cpp_class_method_call_358e578e3a125dd1(__context__,__cpp_file_rename_at_66_46,das_get_tuple_field<char *,0>::get((*__mn_rename_at_97_66)),(*__mt_rename_at_97_67));
            builtin_fwrite(__cpp_file_rename_at_66_46,((char *) ";\n"),__context__,((LineInfoArg *)(&LineInfo::g_LineInfoNULL)));
            builtin_fwrite(__cpp_file_rename_at_66_46,((char *) "  }\n"),__context__,((LineInfoArg *)(&LineInfo::g_LineInfoNULL)));
        }
...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    aotLib[0xa6586de04a0e7816] = +[](Context & ctx) -> SimNode* { // clone_c29a2ce3ce04a328
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, smart_ptr_raw<TypeDecl> & , smart_ptr_raw<TypeDecl> const   ),&clone_c29a2ce3ce04a328>>();
    };
    ...
    aotLib[0xb6f96876c9dcf9f9] = +[](Context & ctx) -> SimNode* { // _FuncastTickdescribe_cppTick4968415101487673878_c05070953a867f90
        return ctx.code->makeNode<SimNode_Aot<char * (*) ( Context * __context__, smart_ptr_raw<TypeDecl> const  , bool , bool , bool , bool  ),&_FuncastTickdescribe_cppTick4968415101487673878_c05070953a867f90>>();
    };
    aotLib[0x28a367e82588d43d] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTickpushTick10769833213962245646_b3fa6014e447ff2d
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, TArray<TTuple<16,char *,int32_t>> & , TTuple<16,char *,int32_t> &  ),&_FuncbuiltinTickpushTick10769833213962245646_b3fa6014e447ff2d>>();
    };
    aotLib[0x65b03675437c90e9] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTickpush_cloneTick15769051505004837089_338aab8aa242d2bb
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, TArray<smart_ptr_raw<TypeDecl>> & , smart_ptr_raw<TypeDecl> const   ),&_FuncbuiltinTickpush_cloneTick15769051505004837089_338aab8aa242d2bb>>();
    };
    aotLib[0x527d658e170f173c] = +[](Context & ctx) -> SimNode* { // log_cpp_class_method_36d323d98780e7f9
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, FILE const  * const  , char * const  , smart_ptr_raw<TypeDecl> const   ),&log_cpp_class_method_36d323d98780e7f9>>();
    };
    aotLib[0x4b406259957490cb] = +[](Context & ctx) -> SimNode* { // log_cpp_class_method_call_358e578e3a125dd1
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, FILE const  * const  , char * const  , smart_ptr_raw<TypeDecl> const   ),&log_cpp_class_method_call_358e578e3a125dd1>>();
    };
    aotLib[0xc110f29137b8426] = +[](Context & ctx) -> SimNode* { // log_cpp_class_adapter_92277e6cbae7f863
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, FILE const  * const  , char * const  , smart_ptr_raw<TypeDecl> const   ),&log_cpp_class_adapter_92277e6cbae7f863>>();
    };
