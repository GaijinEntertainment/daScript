...
inline void _FuncbuiltinTickpushTick10769833213962245646_9a94d5ed4f7c5f3d ( Context * __context__, TArray<ast::AstCallMacro *> & __Arr_rename_at_181_2, ast::AstCallMacro * __value_rename_at_181_3 );
inline StructInfo const  * _FuncrttiTickclass_infoTick15801393167907430156_3d3bc68171ac6191 ( Context * __context__, coroutines::YieldFrom const  & __cl_rename_at_116_4 );
inline StructInfo const  * _FuncrttiTickclass_infoTick15801393167907430156_f1e507096d427ad5 ( Context * __context__, coroutines::CoContinue const  & __cl_rename_at_116_5 );
inline StructInfo const  * _FuncrttiTickclass_infoTick15801393167907430156_79cc5fb0f9ea40cd ( Context * __context__, coroutines::CoAwait const  & __cl_rename_at_116_6 );
...
inline smart_ptr_raw<Expression> _FuncbuiltinTickadd_ptr_refTick918185754185293024_c38be5eeaf10cee3 ( Context * __context__, smart_ptr<Expression> const  __src_rename_at_1744_12 );
...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    ...
    aotLib[0x99deb5daf495c8f9] = +[](Context & ctx) -> SimNode* { // _FuncrttiTickclass_infoTick15801393167907430156_3d3bc68171ac6191
        return ctx.code->makeNode<SimNode_Aot<StructInfo const  * (*) ( Context * __context__, coroutines::YieldFrom const  &  ),&_FuncrttiTickclass_infoTick15801393167907430156_3d3bc68171ac6191>>();
    };
    aotLib[0x7c0089b31455bded] = +[](Context & ctx) -> SimNode* { // _FuncrttiTickclass_infoTick15801393167907430156_f1e507096d427ad5
        return ctx.code->makeNode<SimNode_Aot<StructInfo const  * (*) ( Context * __context__, coroutines::CoContinue const  &  ),&_FuncrttiTickclass_infoTick15801393167907430156_f1e507096d427ad5>>();
    };
    aotLib[0x910bfbfbaade7f7f] = +[](Context & ctx) -> SimNode* { // _FuncrttiTickclass_infoTick15801393167907430156_79cc5fb0f9ea40cd
        return ctx.code->makeNode<SimNode_Aot<StructInfo const  * (*) ( Context * __context__, coroutines::CoAwait const  &  ),&_FuncrttiTickclass_infoTick15801393167907430156_79cc5fb0f9ea40cd>>();
    };
    ...
    aotLib[0x578551b48b36b441] = +[](Context & ctx) -> SimNode* { // _FuncrttiTickclass_infoTick15801393167907430156_cbb71ea8ae1a44bd
        return ctx.code->makeNode<SimNode_Aot<StructInfo const  * (*) ( Context * __context__, coroutines::CoroutineMacro const  &  ),&_FuncrttiTickclass_infoTick15801393167907430156_cbb71ea8ae1a44bd>>();
    };
