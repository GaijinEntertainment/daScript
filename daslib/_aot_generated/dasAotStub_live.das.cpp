...
{
    {
        ...
        {
            das_invoke_function<void>::invoke<decs::Component &>(__context__,nullptr,Func(__context__->fnByMangledName(/*@decs::finalize S<decs::Component>*/ 10112443337485736379u)),das_arg<decs::Component>::pass((*__aV_rename_at_1184_18)));
        }
...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    aotLib[0xadb76bc7a4dda36a] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTickresizeTick4811697762258667383_559ca47f392751ff
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, TArray<decs::Component> & , int32_t  ),&_FuncbuiltinTickresizeTick4811697762258667383_559ca47f392751ff>>();
    };
    ...
    aotLib[0x17199d64e8a85d54] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTickfinalizeTick13836114024949725080_345f02cc82623620
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, TArray<decs::Component> &  ),&_FuncbuiltinTickfinalizeTick13836114024949725080_345f02cc82623620>>();
    };
    ...
    aotLib[0x29f0f1ae43c0d92e] = +[](Context & ctx) -> SimNode* { // _FuncarchiveTickserializeTick1002677114065211290_838b04f3311f9ee8
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, archive::Archive & , TArray<decs::Component> &  ),&_FuncarchiveTickserializeTick1002677114065211290_838b04f3311f9ee8>>();
    };
    ...
    aotLib[0x9273b1cd5e9260e] = +[](Context & ctx) -> SimNode* { // _FuncarchiveTickserializeTick4429977757536996025_190cc1e99493f13c
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, archive::Archive & , Func DAS_COMMENT((TypeInfo const  *)) &  ),&_FuncarchiveTickserializeTick4429977757536996025_190cc1e99493f13c>>();
    };
    ...
    aotLib[0xa84d4ffd7a73dafe] = +[](Context & ctx) -> SimNode* { // finalize_37451350471f63d7
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, decs::Archetype &  ),&finalize_37451350471f63d7>>();
    };
    aotLib[0x7a8c7b3c06128b3e] = +[](Context & ctx) -> SimNode* { // _FuncapplyTickstructTickArchetypeTick0x96Tick0Tick4_86443a66f85f8e05
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, decs::Archetype & , Block DAS_COMMENT((void,uint64_t &)) const  & , Block DAS_COMMENT((void,TArray<decs::Component>)) const  & , Block DAS_COMMENT((void,int32_t &)) const  & , Block DAS_COMMENT((void,int32_t &)) const  &  ),&_FuncapplyTickstructTickArchetypeTick0x96Tick0Tick4_86443a66f85f8e05>>();
    };
    ...
    aotLib[0x8957589138f093d0] = +[](Context & ctx) -> SimNode* { // finalize_f87ddce7a3ad05ec
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, AutoTuple<int32_t,uint64_t,int32_t> &  ),&finalize_f87ddce7a3ad05ec>>();
    };
    aotLib[0x32a5b519d63a68cf] = +[](Context & ctx) -> SimNode* { // _FuncapplyTicktupleTick0x6f4dd0adfbe8abacTick0xa0Tick0Tick3_69d210316d1d7319
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, AutoTuple<int32_t,uint64_t,int32_t> & , Block DAS_COMMENT((void,int32_t &)) const  & , Block DAS_COMMENT((void,uint64_t &)) const  & , Block DAS_COMMENT((void,int32_t &)) const  &  ),&_FuncapplyTicktupleTick0x6f4dd0adfbe8abacTick0xa0Tick0Tick3_69d210316d1d7319>>();
    };
    aotLib[0x292a78251254e501] = +[](Context & ctx) -> SimNode* { // finalize_c2cf16c62ac9b1f5
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, decs::CTypeInfo &  ),&finalize_c2cf16c62ac9b1f5>>();
    };
    aotLib[0x226c6be0555d0619] = +[](Context & ctx) -> SimNode* { // _FuncapplyTickstructTickCTypeInfoTick0x96Tick0Tick11_50e2ea000b6a5668
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, decs::CTypeInfo & , Block DAS_COMMENT((void,DAS_COMMENT(bound_enum) das::Type &)) const  & , Block DAS_COMMENT((void,char * &)) const  & , Block DAS_COMMENT((void,char * &)) const  & , Block DAS_COMMENT((void,uint64_t &)) const  & , Block DAS_COMMENT((void,uint32_t &)) const  & , Block DAS_COMMENT((void,Func DAS_COMMENT((void,TArray<uint8_t>)) &)) const  & , Block DAS_COMMENT((void,Func DAS_COMMENT((void,TArray<uint8_t>,TArray<uint8_t> const )) &)) const  & , Block DAS_COMMENT((void,Func DAS_COMMENT((void,archive::Archive,TArray<uint8_t>,char * const )) &)) const  & , Block DAS_COMMENT((void,Func DAS_COMMENT((char *,void * const )) &)) const  & , Block DAS_COMMENT((void,Func DAS_COMMENT((TypeInfo const  *)) &)) const  & , Block DAS_COMMENT((void,Func DAS_COMMENT((Lambda DAS_COMMENT((void)),TArray<uint8_t>)) &)) const  &  ),&_FuncapplyTickstructTickCTypeInfoTick0x96Tick0Tick11_50e2ea000b6a5668>>();
    };
    ...
    aotLib[0xfca19b58b45b1ea1] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTickresizeTick4811697762258667383_aeca051a2e04cb07
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, TArray<decs::Archetype> & , int32_t  ),&_FuncbuiltinTickresizeTick4811697762258667383_aeca051a2e04cb07>>();
    };
    aotLib[0x1018916d234af400] = +[](Context & ctx) -> SimNode* { // _FuncarchiveTickserializeTick8013964856239694639_731eb25edf591333
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, archive::Archive & , decs::Archetype &  ),&_FuncarchiveTickserializeTick8013964856239694639_731eb25edf591333>>();
    };
    ...
    aotLib[0xa0c4b4744856ced6] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTickresizeTick4811697762258667383_deb20fe608939269
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, TArray<AutoTuple<int32_t,uint64_t,int32_t>> & , int32_t  ),&_FuncbuiltinTickresizeTick4811697762258667383_deb20fe608939269>>();
    };
    aotLib[0xa6fff85a2901f5a7] = +[](Context & ctx) -> SimNode* { // _FuncarchiveTickserializeTick10018991383941125049_67930047264965f1
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, archive::Archive & , AutoTuple<int32_t,uint64_t,int32_t> &  ),&_FuncarchiveTickserializeTick10018991383941125049_67930047264965f1>>();
    };
    aotLib[0xbe9e31ad1122dda3] = +[](Context & ctx) -> SimNode* { // _FuncarchiveTickserializeTick8013964856239694639_a8ff9e2247269964
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, archive::Archive & , decs::CTypeInfo &  ),&_FuncarchiveTickserializeTick8013964856239694639_a8ff9e2247269964>>();
    };
    aotLib[0x8255bb5ee889b80d] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTickkeysTick2205854368403803976_23a113e85e5887ab
        return ctx.code->makeNode<SimNode_AotCMRES<Sequence DAS_COMMENT((char *)) (*) ( Context * __context__, TTable<char *,decs::CTypeInfo> const  &  ),&_FuncbuiltinTickkeysTick2205854368403803976_23a113e85e5887ab>>();
    };
    aotLib[0xa1c786531a6bfbc] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTickvaluesTick1351216622833168869_61c0f20a0f69d8bd
        return ctx.code->makeNode<SimNode_AotCMRES<Sequence DAS_COMMENT((decs::CTypeInfo &)) (*) ( Context * __context__, TTable<char *,decs::CTypeInfo> &  ),&_FuncbuiltinTickvaluesTick1351216622833168869_61c0f20a0f69d8bd>>();
    };
    ...
    aotLib[0xe75f8145d2820a26] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTickfinalizeTick13836114024949725080_ea18cb8662f307c1
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, TArray<decs::Archetype> &  ),&_FuncbuiltinTickfinalizeTick13836114024949725080_ea18cb8662f307c1>>();
    };
    ...
    aotLib[0x8bf6e90a54fd6dca] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTickfinalizeTick13836114024949725080_ba685a3ffd2b9e77
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, TArray<AutoTuple<int32_t,uint64_t,int32_t>> &  ),&_FuncbuiltinTickfinalizeTick13836114024949725080_ba685a3ffd2b9e77>>();
    };
    aotLib[0xcdc7d84276838fd6] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTickfinalizeTick5454204887383796109_1f7f0c3546fa051e
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, TTable<char *,decs::CTypeInfo> &  ),&_FuncbuiltinTickfinalizeTick5454204887383796109_1f7f0c3546fa051e>>();
    };
    ...
    aotLib[0x54d1787656f02f9a] = +[](Context & ctx) -> SimNode* { // _FuncarchiveTickserializeTick1002677114065211290_339f3460927c659a
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, archive::Archive & , TArray<decs::Archetype> &  ),&_FuncarchiveTickserializeTick1002677114065211290_339f3460927c659a>>();
    };
    ...
    aotLib[0xadd82cecc7f4ec98] = +[](Context & ctx) -> SimNode* { // _FuncarchiveTickserializeTick1002677114065211290_7eba8f9beff4a0ef
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, archive::Archive & , TArray<AutoTuple<int32_t,uint64_t,int32_t>> &  ),&_FuncarchiveTickserializeTick1002677114065211290_7eba8f9beff4a0ef>>();
    };
    aotLib[0xca3b26db9b509641] = +[](Context & ctx) -> SimNode* { // _FuncarchiveTickserializeTick18117489833716462019_82336b17b91a4160
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, archive::Archive & , TTable<char *,decs::CTypeInfo> &  ),&_FuncarchiveTickserializeTick18117489833716462019_82336b17b91a4160>>();
    };
    ...
    aotLib[0xa6c8bff2b25e1054] = +[](Context & ctx) -> SimNode* { // finalize_81b0d19e466110c8
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, decs::DecsState &  ),&finalize_81b0d19e466110c8>>();
    };
    aotLib[0x5c74091d38a0876d] = +[](Context & ctx) -> SimNode* { // _FuncapplyTickstructTickDecsStateTick0x96Tick0Tick7_84c01a5244f15f9e
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, decs::DecsState & , Block DAS_COMMENT((void,TTable<uint64_t,int32_t>)) const  & , Block DAS_COMMENT((void,TArray<decs::Archetype>)) const  & , Block DAS_COMMENT((void,TArray<decs::EntityId>)) const  & , Block DAS_COMMENT((void,TArray<AutoTuple<int32_t,uint64_t,int32_t>>)) const  & , Block DAS_COMMENT((void,TTable<char *,decs::CTypeInfo>)) const  & , Block DAS_COMMENT((void,TArray<decs::EcsRequest>)) const  & , Block DAS_COMMENT((void,TTable<uint64_t,int32_t>)) const  &  ),&_FuncapplyTickstructTickDecsStateTick0x96Tick0Tick7_84c01a5244f15f9e>>();
    };
    ...
    aotLib[0x1b817c2b9b8206e7] = +[](Context & ctx) -> SimNode* { // _FuncarchiveTickserializeTick8013964856239694639_a9d1c2f2f9d21c11
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, archive::Archive & , decs::DecsState &  ),&_FuncarchiveTickserializeTick8013964856239694639_a9d1c2f2f9d21c11>>();
    };
    ...
    aotLib[0x88312717d651d984] = +[](Context & ctx) -> SimNode* { // finalize_82b0f923cb1a5c28
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, live::_lambda_live_237_3 &  ),&finalize_82b0f923cb1a5c28>>();
    };
    ...
    aotLib[0xa7ba1ff5da336a77] = +[](Context & ctx) -> SimNode* { // _FuncarchiveTickmem_archive_saveTick1217508036218320246_8093c94b06c5b1d3
        return ctx.code->makeNode<SimNode_AotCMRES<TArray<uint8_t> (*) ( Context * __context__, decs::DecsState &  ),&_FuncarchiveTickmem_archive_saveTick1217508036218320246_8093c94b06c5b1d3>>();
    };
    aotLib[0x1e2b3523e83f5cdf] = +[](Context & ctx) -> SimNode* { // _FuncarchiveTickmem_archive_loadTick9860235419630369707_520cdbc5db538a78
        return ctx.code->makeNode<SimNode_Aot<bool (*) ( Context * __context__, TArray<uint8_t> & , decs::DecsState & , bool  ),&_FuncarchiveTickmem_archive_loadTick9860235419630369707_520cdbc5db538a78>>();
    };
    ...
    aotLib[0x280e46e82cd2155c] = +[](Context & ctx) -> SimNode* { // _Func_lambda_live_205_1Tickfunction_b3b7a30c2cb432a6
    ...
    aotLib[0x4978ac8f36909853] = +[](Context & ctx) -> SimNode* { // _Func_lambda_live_225_2Tickfunction_2c0f2ecd65895fe4
    ...
    aotLib[0x6194b7f6b9413ba] = +[](Context & ctx) -> SimNode* { // _Func_lambda_live_237_3Tickfunction_1dd03a040db0eba6
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, live::_lambda_live_237_3 & , decs::DecsState * const   ),&_Func_lambda_live_237_3Tickfunction_1dd03a040db0eba6>>();
    };
    aotLib[0x34a3c2a9fcac7cb0] = +[](Context & ctx) -> SimNode* { // _Func_lambda_live_237_3Tickfinalizer_7c78462166aa88ea
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, live::_lambda_live_237_3 *  ),&_Func_lambda_live_237_3Tickfinalizer_7c78462166aa88ea>>();
    };
    ...
    aotLib[0xcb32672e5a4f57fc] = +[](Context & ctx) -> SimNode* { // saveLiveContext_efcae6d209280047
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__ ),&saveLiveContext_efcae6d209280047>>();
    };
    aotLib[0xe31d0ab40ff5a5e3] = +[](Context & ctx) -> SimNode* { // restoreLiveContext_49c6d9153d13659f
    ...
    aotLib[0x71c71fdba853521b] = +[](Context & ctx) -> SimNode* { // go_live_b8a103eaa74d382f
    ...
    aotLib[0xbaaca5f617502fb1] = +[](Context & ctx) -> SimNode* { // set_new_context_a7a4593ab51c9d0c
    ...
    aotLib[0x144c8a45014c65b0] = +[](Context & ctx) -> SimNode* { // recompile_18a8bac272d4f62d
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, bool  ),&recompile_18a8bac272d4f62d>>();
    };
    aotLib[0xac225147a4e3f271] = +[](Context & ctx) -> SimNode* { // live_keypressed_c93934ab7b43c5fc
