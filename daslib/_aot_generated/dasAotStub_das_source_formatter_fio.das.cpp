...
namespace das {
namespace _anon_18145932366655449013 {
    ...
    _FuncfioTickfopenTick3937565566638487747_feeb71cd63fd8eac(__context__,__file_name_rename_at_15_4,((char *) "rb"),das_make_block<void,FILE const  * const >(__context__,112,0,&__func_info__592427a731466a4a,[&](FILE const  * const  __fr_rename_at_18_7) -> void{
        if ( __fr_rename_at_18_7 == nullptr )
        {
            ...
            builtin_map_file(__fr_rename_at_18_7,das_make_block<void,TArray<uint8_t> &>(__context__,176,0,&__func_info__9acbc0a3950e2dcd,[&](TArray<uint8_t> & __data_rename_at_22_8) -> void{
                ...
                das_copy(__formatted_rename_at_17_6,das_invoke_function<char * const >::invoke<TArray<uint8_t> const  &>(__context__,nullptr,Func(__context__->fnByMangledName(/*@das_source_formatter::format_source CI1<u8>A*/ 97653234683312325u)),das_arg<TArray<uint8_t>>::pass(__data_rename_at_22_8)));
            }),__context__,((LineInfoArg *)(&LineInfo::g_LineInfoNULL)));
        };
    }));
...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    ...
    aotLib[0xe39299f0ef43be2b] = +[](Context & ctx) -> SimNode* { // format_file_50495df36efe9eb6
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, char * const   ),&format_file_50495df36efe9eb6>>();
    };
    aotLib[0x4ab94649b2f6cd5f] = +[](Context & ctx) -> SimNode* { // format_files_5658cd111c4b8369
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, TArray<char *> const  &  ),&format_files_5658cd111c4b8369>>();
    };
    // [[ init script ]]
...
AotListBase impl_aot_das_source_formatter_fio(_anon_18145932366655449013::registerAotFunctions);
} // namespace das
