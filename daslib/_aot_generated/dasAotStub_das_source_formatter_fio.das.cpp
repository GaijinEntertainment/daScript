...
inline void _FuncfioTickfopenTick3937565566638487747_95efbb2967184b18 ( Context * __context__, char * const  __name_rename_at_12_0, char * const  __mode_rename_at_12_1, Block DAS_COMMENT((void,FILE const  * const )) const  & __blk_rename_at_12_2 );
inline void format_file_aa21a002b386667b ( Context * __context__, char * const  __file_name_rename_at_15_4 );
inline void format_files_5446b9db2f487231 ( Context * __context__, TArray<char *> const  & __file_names_rename_at_42_10 );
...
inline void format_file_aa21a002b386667b ( Context * __context__, char * const  __file_name_rename_at_15_4 ) { das_stack_prologue __prologue(__context__,256,"format_file " DAS_FILE_LINE);
{
    char * __unformatted_rename_at_16_5 = (char *)(nullptr);
    char * __formatted_rename_at_17_6 = (char *)(nullptr);
    _FuncfioTickfopenTick3937565566638487747_95efbb2967184b18(__context__,__file_name_rename_at_15_4,((char *) "rb"),das_make_block<void,FILE const  * const >(__context__,112,0,&__func_info__592427a731466a4a,[&](FILE const  * const  __fr_rename_at_18_7) -> void{
    ...
    {
        _FuncfioTickfopenTick3937565566638487747_95efbb2967184b18(__context__,__file_name_rename_at_15_4,((char *) "wb"),das_make_block<void,FILE const  * const >(__context__,240,0,&__func_info__793c57c1b60ae74a,[&](FILE const  * const  __fw_rename_at_30_9) -> void{
...
{
    {
        ...
        {
            format_file_aa21a002b386667b(__context__,(*__fname_rename_at_43_11));
        }
...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    ...
    aotLib[0x5ffe776492816b4a] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&format_file_aa21a002b386667b>>();
    };
    aotLib[0x5f7840b6766b3638] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&format_files_5446b9db2f487231>>();
    };
    // [[ init script ]]
