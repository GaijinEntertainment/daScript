...
inline StructInfo const  * _FuncrttiTickclass_infoTick15801393167907430156_da3bcd6a8793ba3 ( Context * __context__, constant_expression::ConstExprAnnotation const  & __cl_rename_at_116_2 );
inline StructInfo const  * _FuncrttiTickclass_infoTick15801393167907430156_b906980bf6680ab3 ( Context * __context__, constant_expression::ConstantExpressionMacro const  & __cl_rename_at_116_3 );
inline TArray<int32_t> & _FuncbuiltinTick_return_with_lockcheckTick2939372000839727345_3b6d77d050d4b7b2 ( Context * __context__, TArray<int32_t> & __a_rename_at_50_4 );
inline void _FuncbuiltinTick_move_with_lockcheckTick3467971516570048129_df01d9c7ecd3e059 ( Context * __context__, TArray<int32_t> & __a_rename_at_32_5, TArray<int32_t> & __b_rename_at_32_6 );
inline void _FuncbuiltinTickpush_cloneTick2035469273396957942_b824be02604b6ab6 ( Context * __context__, TArray<int32_t> & __Arr_rename_at_377_7, int32_t __value_rename_at_377_8 );
inline void _FuncbuiltinTickfinalizeTick13836114024949725080_17d2dcdfe9e69388 ( Context * __context__, TArray<int32_t> & __a_rename_at_1215_9 );
inline void _FuncbuiltinTicksortTick14088969635007481283_17d2dcdfe9e69388 ( Context * __context__, TArray<int32_t> & __a_rename_at_1550_10 );
inline TArray<int32_t> _FuncalgorithmTickuniqueTick8642070526899511001_fd5a21865cbc8fa4 ( Context * __context__, TArray<int32_t> & __a_rename_at_11_11 );
inline void _FuncbuiltinTickswapTick6899974565646937647_900b88d398e94d61 ( Context * __context__, int32_t & __a_rename_at_1813_18, int32_t & __b_rename_at_1813_19 );
inline void clone_c457b03ffcf7a4b5 ( Context * __context__, smart_ptr_raw<Expression> & __dest_rename_at_104_21, void * const  __src_rename_at_104_22 );
inline void clone_26c941acedf18a3b ( Context * __context__, smart_ptr_raw<TypeDecl> & __dest_rename_at_105_23, void * const  __src_rename_at_105_24 );
inline char * _FuncastTickdescribeTick842554968825501494_e6a33d3e7995fe10 ( Context * __context__, smart_ptr_raw<Expression> const  __expr_rename_at_48_25 );
inline void _FuncbuiltinTickpushTick10769833213962245646_b824be02604b6ab6 ( Context * __context__, TArray<int32_t> & __Arr_rename_at_181_26, int32_t __value_rename_at_181_27 );
inline void _FuncalgorithmTicksort_uniqueTick14985796887508933377_17d2dcdfe9e69388 ( Context * __context__, TArray<int32_t> & __a_rename_at_24_28 );
inline void _FuncalgorithmTickreverseTick3930920687139572544_17d2dcdfe9e69388 ( Context * __context__, TArray<int32_t> & __a_rename_at_37_30 );
inline bool _FuncbuiltinTickemptyTick15399874715904164783_f895a8528d22a299 ( Context * __context__, TArray<int32_t> const  & __a_rename_at_585_35 );
inline smart_ptr_raw<Function> _FuncastTickclone_functionTick17084718524013848691_d87351483946ce2a ( Context * __context__, Function * const  __fn_rename_at_58_36 );
    ...
    TArray<int32_t> __b_rename_at_14_13;das_zero(__b_rename_at_14_13);
    {
        ...
        for ( ; __need_loop_15 ; __need_loop_15 = __e_iterator.next(__context__,(__e_rename_at_15_16)) && __eidx_iterator.next(__context__,(__eidx_rename_at_15_17)) )
        {
            if ( (__pidx_rename_at_13_12 == -1) || (__a_rename_at_11_11(__pidx_rename_at_13_12,__context__) != (*__e_rename_at_15_16)) )
            {
                ...
                _FuncbuiltinTickpush_cloneTick2035469273396957942_b824be02604b6ab6(__context__,das_arg<TArray<int32_t>>::pass(__b_rename_at_14_13),(*__e_rename_at_15_16));
            };
        }
        __e_iterator.close(__context__,(__e_rename_at_15_16));
        __eidx_iterator.close(__context__,(__eidx_rename_at_15_17));
    };
    return /* <- */ das_auto_cast_move<TArray<int32_t>>::cast(_FuncbuiltinTick_return_with_lockcheckTick2939372000839727345_3b6d77d050d4b7b2(__context__,das_arg<TArray<int32_t>>::pass(__b_rename_at_14_13)));
}
...
inline void _FuncalgorithmTicksort_uniqueTick14985796887508933377_17d2dcdfe9e69388 ( Context * __context__, TArray<int32_t> &  __a_rename_at_24_28 )
{
    if ( _FuncbuiltinTickemptyTick15399874715904164783_f895a8528d22a299(__context__,das_arg<TArray<int32_t>>::pass(__a_rename_at_24_28)) )
    {
        return ;
    } else {
        _FuncbuiltinTicksortTick14088969635007481283_17d2dcdfe9e69388(__context__,das_arg<TArray<int32_t>>::pass(__a_rename_at_24_28));
        TArray<int32_t> __b_rename_at_32_29; das_zero(__b_rename_at_32_29); das_move(__b_rename_at_32_29, _FuncalgorithmTickuniqueTick8642070526899511001_fd5a21865cbc8fa4(__context__,das_arg<TArray<int32_t>>::pass(__a_rename_at_24_28)));
        _FuncbuiltinTickfinalizeTick13836114024949725080_17d2dcdfe9e69388(__context__,das_arg<TArray<int32_t>>::pass(__a_rename_at_24_28));
        _FuncbuiltinTick_move_with_lockcheckTick3467971516570048129_df01d9c7ecd3e059(__context__,das_arg<TArray<int32_t>>::pass(__a_rename_at_24_28),das_arg<TArray<int32_t>>::pass(__b_rename_at_32_29));
    };
}
...
inline void _FuncalgorithmTickreverseTick3930920687139572544_17d2dcdfe9e69388 ( Context * __context__, TArray<int32_t> &  __a_rename_at_37_30 )
{
    ...
    int32_t __lm1_rename_at_41_33 = ((int32_t)(__l_rename_at_39_31 - 1));
    {
        ...
        {
            _FuncbuiltinTickswapTick6899974565646937647_900b88d398e94d61(__context__,__a_rename_at_37_30(__i_rename_at_42_34,__context__),__a_rename_at_37_30((__lm1_rename_at_41_33 - __i_rename_at_42_34),__context__));
        }
...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    ...
    aotLib[0x1bfb5c5303416b3f] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncrttiTickclass_infoTick15801393167907430156_da3bcd6a8793ba3>>();
    };
    aotLib[0x7b3194e533914b27] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncrttiTickclass_infoTick15801393167907430156_b906980bf6680ab3>>();
    };
    ...
    aotLib[0x1ddeb87db163e9ee] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncbuiltinTick_move_with_lockcheckTick3467971516570048129_df01d9c7ecd3e059>>();
    };
    aotLib[0x7d1a493a011c81f] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncbuiltinTickpush_cloneTick2035469273396957942_b824be02604b6ab6>>();
    };
    ...
    aotLib[0xfa45458fa8cc777f] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncbuiltinTicksortTick14088969635007481283_17d2dcdfe9e69388>>();
    };
    aotLib[0xf9305618b50d4dd4] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_AotCMRES<&_FuncalgorithmTickuniqueTick8642070526899511001_fd5a21865cbc8fa4>>();
    };
    aotLib[0xb4ddc34893ce95e5] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncbuiltinTickswapTick6899974565646937647_900b88d398e94d61>>();
    };
    aotLib[0xdf6b646727a2146] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&clone_c457b03ffcf7a4b5>>();
    };
    aotLib[0x174491e814adacee] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&clone_26c941acedf18a3b>>();
    };
    ...
    aotLib[0xef95ba80a663d000] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncalgorithmTicksort_uniqueTick14985796887508933377_17d2dcdfe9e69388>>();
    };
    aotLib[0xaed560a81807e353] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncalgorithmTickreverseTick3930920687139572544_17d2dcdfe9e69388>>();
    };
    aotLib[0xb7b49ed499cc7dc2] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncbuiltinTickemptyTick15399874715904164783_f895a8528d22a299>>();
    };
    aotLib[0x1ddfdc54fcc50f39] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncastTickclone_functionTick17084718524013848691_d87351483946ce2a>>();
    };
