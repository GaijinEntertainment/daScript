...
inline void _FuncbuiltinTickpushTick10769833213962245646_a9f2bb178dac7e3e ( Context * __context__, TArray<ast::AstSimulateMacro *> & __Arr_rename_at_181_3, ast::AstSimulateMacro * __value_rename_at_181_4 );
inline StructInfo const  * _FuncrttiTickclass_infoTick15801393167907430156_4499f4ec7753e2d3 ( Context * __context__, validate_code::JIT_LLVM const  & __cl_rename_at_116_5 );
inline StructInfo const  * _FuncrttiTickclass_infoTick15801393167907430156_d53a2c00ed5e4a08 ( Context * __context__, validate_code::ValidateCompletionVisitor const  & __cl_rename_at_116_6 );
inline StructInfo const  * _FuncrttiTickclass_infoTick15801393167907430156_7c124e9ddeaa9ce4 ( Context * __context__, validate_code::ValidateShaderVisitor const  & __cl_rename_at_116_7 );
...
inline smart_ptr_raw<VisitorAdapter> _FuncastTickmake_visitorTick897644165917210720_d70357c1dd42de06 ( Context * __context__, validate_code::ValidateCompletionVisitor const  & __someClass_rename_at_679_21 );
...
inline smart_ptr_raw<VisitorAdapter> _FuncastTickmake_visitorTick897644165917210720_3d9ff75024a57ebd ( Context * __context__, validate_code::ValidateShaderVisitor const  & __someClass_rename_at_679_30 );
...
inline smart_ptr_raw<VisitorAdapter> _FuncastTickmake_visitorTick897644165917210720_d70357c1dd42de06 ( Context * __context__, validate_code::ValidateCompletionVisitor const  &  __someClass_rename_at_679_21 )
{
    validate_code::ValidateCompletionVisitor const  * __classPtr_rename_at_682_22 = ((validate_code::ValidateCompletionVisitor const  *)das_ref(__context__,__someClass_rename_at_679_21));
    StructInfo const  * __classInfo_rename_at_683_23 = ((StructInfo const  *)_FuncrttiTickclass_infoTick15801393167907430156_d53a2c00ed5e4a08(__context__,__someClass_rename_at_679_21));
    return /* <- */ das_auto_cast_move<smart_ptr_raw<VisitorAdapter>>::cast(makeVisitor(das_auto_cast<void * const >::cast(__classPtr_rename_at_682_22),__classInfo_rename_at_683_23,__context__));
}
...
inline smart_ptr_raw<VisitorAdapter> _FuncastTickmake_visitorTick897644165917210720_3d9ff75024a57ebd ( Context * __context__, validate_code::ValidateShaderVisitor const  &  __someClass_rename_at_679_30 )
{
    validate_code::ValidateShaderVisitor const  * __classPtr_rename_at_682_31 = ((validate_code::ValidateShaderVisitor const  *)das_ref(__context__,__someClass_rename_at_679_30));
    StructInfo const  * __classInfo_rename_at_683_32 = ((StructInfo const  *)_FuncrttiTickclass_infoTick15801393167907430156_7c124e9ddeaa9ce4(__context__,__someClass_rename_at_679_30));
    return /* <- */ das_auto_cast_move<smart_ptr_raw<VisitorAdapter>>::cast(makeVisitor(das_auto_cast<void * const >::cast(__classPtr_rename_at_682_31),__classInfo_rename_at_683_32,__context__));
}
...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    ...
    aotLib[0x681250fc6b9726a3] = +[](Context & ctx) -> SimNode* { // _FuncrttiTickclass_infoTick15801393167907430156_9990f2b58ccee9f4
        return ctx.code->makeNode<SimNode_Aot<StructInfo const  * (*) ( Context * __context__, validate_code::VerifyCompletion const  &  ),&_FuncrttiTickclass_infoTick15801393167907430156_9990f2b58ccee9f4>>();
    };
    aotLib[0xfd385aeef09d8560] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTickpushTick10769833213962245646_a9f2bb178dac7e3e
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, TArray<ast::AstSimulateMacro *> & , ast::AstSimulateMacro *  ),&_FuncbuiltinTickpushTick10769833213962245646_a9f2bb178dac7e3e>>();
    };
    aotLib[0xceecccdda592c52f] = +[](Context & ctx) -> SimNode* { // _FuncrttiTickclass_infoTick15801393167907430156_4499f4ec7753e2d3
        return ctx.code->makeNode<SimNode_Aot<StructInfo const  * (*) ( Context * __context__, validate_code::JIT_LLVM const  &  ),&_FuncrttiTickclass_infoTick15801393167907430156_4499f4ec7753e2d3>>();
    };
    aotLib[0x9fa727acd66fd598] = +[](Context & ctx) -> SimNode* { // _FuncrttiTickclass_infoTick15801393167907430156_d53a2c00ed5e4a08
        return ctx.code->makeNode<SimNode_Aot<StructInfo const  * (*) ( Context * __context__, validate_code::ValidateCompletionVisitor const  &  ),&_FuncrttiTickclass_infoTick15801393167907430156_d53a2c00ed5e4a08>>();
    };
    aotLib[0xd96b9071f2799e8e] = +[](Context & ctx) -> SimNode* { // _FuncrttiTickclass_infoTick15801393167907430156_7c124e9ddeaa9ce4
        return ctx.code->makeNode<SimNode_Aot<StructInfo const  * (*) ( Context * __context__, validate_code::ValidateShaderVisitor const  &  ),&_FuncrttiTickclass_infoTick15801393167907430156_7c124e9ddeaa9ce4>>();
    };
    ...
    aotLib[0xe676f42b437511fd] = +[](Context & ctx) -> SimNode* { // _FuncastTickmake_visitorTick897644165917210720_d70357c1dd42de06
        return ctx.code->makeNode<SimNode_Aot<smart_ptr_raw<VisitorAdapter> (*) ( Context * __context__, validate_code::ValidateCompletionVisitor const  &  ),&_FuncastTickmake_visitorTick897644165917210720_d70357c1dd42de06>>();
    };
    ...
    aotLib[0xe3718d62db748068] = +[](Context & ctx) -> SimNode* { // _FuncastTickmake_visitorTick897644165917210720_3d9ff75024a57ebd
        return ctx.code->makeNode<SimNode_Aot<smart_ptr_raw<VisitorAdapter> (*) ( Context * __context__, validate_code::ValidateShaderVisitor const  &  ),&_FuncastTickmake_visitorTick897644165917210720_3d9ff75024a57ebd>>();
    };
