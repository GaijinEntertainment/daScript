...
inline void _FuncbuiltinTickpushTick10769833213962245646_11fd1eda4dc64040 ( Context * __context__, TArray<ast::AstFunctionAnnotation *> & __Arr_rename_at_181_0, ast::AstFunctionAnnotation * __value_rename_at_181_1 );
inline StructInfo const  * _FuncrttiTickclass_infoTick15801393167907430156_d6f76bc301d0608e ( Context * __context__, validate_code::VerifyCompletion const  & __cl_rename_at_116_2 );
inline void _FuncbuiltinTickpushTick10769833213962245646_dfb3ca899107556c ( Context * __context__, TArray<ast::AstSimulateMacro *> & __Arr_rename_at_181_3, ast::AstSimulateMacro * __value_rename_at_181_4 );
inline StructInfo const  * _FuncrttiTickclass_infoTick15801393167907430156_fe98e62dc0e75ad4 ( Context * __context__, validate_code::JIT_LLVM const  & __cl_rename_at_116_5 );
inline StructInfo const  * _FuncrttiTickclass_infoTick15801393167907430156_da3b25a1a42e03b5 ( Context * __context__, validate_code::ValidateCompletionVisitor const  & __cl_rename_at_116_6 );
inline StructInfo const  * _FuncrttiTickclass_infoTick15801393167907430156_a52db8255e1aa278 ( Context * __context__, validate_code::ValidateShaderVisitor const  & __cl_rename_at_116_7 );
...
inline int32_t _FuncbuiltinTickfind_indexTick791716935952699529_21c7fbc018dcb2c ( Context * __context__, TArray<Function *> const  & __arr_rename_at_1701_10, Function * const  __key_rename_at_1701_11 );
...
inline Function * _FuncbuiltinTickget_ptrTick5807679485210906136_357549ecd3073f67 ( Context * __context__, smart_ptr_raw<Function> __src_rename_at_1784_20 );
inline smart_ptr_raw<VisitorAdapter> _FuncastTickmake_visitorTick897644165917210720_32f69b97fa03207c ( Context * __context__, validate_code::ValidateCompletionVisitor const  & __someClass_rename_at_684_21 );
inline Sequence DAS_COMMENT((Function *)) _FuncbuiltinTickkeysTick2205854368403803976_26bd925ae376930 ( Context * __context__, TTable<Function *,void> const  & __a_rename_at_1180_24 );
...
inline smart_ptr_raw<VisitorAdapter> _FuncastTickmake_visitorTick897644165917210720_dbe5d53982deca2b ( Context * __context__, validate_code::ValidateShaderVisitor const  & __someClass_rename_at_684_30 );
...
{
    {
        bool __need_loop_1702 = true;
        // i: int const
        das_iterator<range> __i_iterator(mk_range(builtin_array_size(__arr_rename_at_1701_10)));
        int32_t __i_rename_at_1702_12;
        __need_loop_1702 = __i_iterator.first(__context__,(__i_rename_at_1702_12)) && __need_loop_1702;
        for ( ; __need_loop_1702 ; __need_loop_1702 = __i_iterator.next(__context__,(__i_rename_at_1702_12)) )
        {
            if ( __arr_rename_at_1701_10(__i_rename_at_1702_12,__context__) == __key_rename_at_1701_11 )
            {
                return das_auto_cast<int32_t>::cast(__i_rename_at_1702_12);
            };
        }
        __i_iterator.close(__context__,(__i_rename_at_1702_12));
    };
...
inline Function * _FuncbuiltinTickget_ptrTick5807679485210906136_357549ecd3073f67 ( Context * __context__, smart_ptr_raw<Function> __src_rename_at_1784_20 )
{
    return das_auto_cast<Function *>::cast(das_cast<Function *>::cast(__src_rename_at_1784_20));
}
...
inline smart_ptr_raw<VisitorAdapter> _FuncastTickmake_visitorTick897644165917210720_32f69b97fa03207c ( Context * __context__, validate_code::ValidateCompletionVisitor const  &  __someClass_rename_at_684_21 )
{
    ...
    StructInfo const  * __classInfo_rename_at_688_23 = ((StructInfo const  *)_FuncrttiTickclass_infoTick15801393167907430156_da3b25a1a42e03b5(__context__,__someClass_rename_at_684_21));
...
inline Sequence DAS_COMMENT((Function *)) _FuncbuiltinTickkeysTick2205854368403803976_26bd925ae376930 ( Context * __context__, TTable<Function *,void> const  &  __a_rename_at_1180_24 )
{
    Sequence DAS_COMMENT((Function *)) __it_rename_at_1181_25;das_zero(__it_rename_at_1181_25);
    builtin_table_keys(das_arg<Sequence DAS_COMMENT((Function *))>::pass(__it_rename_at_1181_25),__a_rename_at_1180_24,8,__context__,((LineInfoArg *)(&LineInfo::g_LineInfoNULL)));
    return /* <- */ das_auto_cast_move<Sequence DAS_COMMENT((Function *))>::cast(__it_rename_at_1181_25);
}
...
inline smart_ptr_raw<VisitorAdapter> _FuncastTickmake_visitorTick897644165917210720_dbe5d53982deca2b ( Context * __context__, validate_code::ValidateShaderVisitor const  &  __someClass_rename_at_684_30 )
{
    ...
    StructInfo const  * __classInfo_rename_at_688_32 = ((StructInfo const  *)_FuncrttiTickclass_infoTick15801393167907430156_a52db8255e1aa278(__context__,__someClass_rename_at_684_30));
...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    aotLib[0x87e15fe879b4c7ea] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncbuiltinTickpushTick10769833213962245646_11fd1eda4dc64040>>();
    };
    aotLib[0x616d487e145ab0ed] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncrttiTickclass_infoTick15801393167907430156_d6f76bc301d0608e>>();
    };
    aotLib[0xb551966809a2766c] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncbuiltinTickpushTick10769833213962245646_dfb3ca899107556c>>();
    };
    aotLib[0xa97e528a77ced798] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncrttiTickclass_infoTick15801393167907430156_fe98e62dc0e75ad4>>();
    };
    aotLib[0x3c62ef39da73da18] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncrttiTickclass_infoTick15801393167907430156_da3b25a1a42e03b5>>();
    };
    aotLib[0x78b511b704d8408d] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncrttiTickclass_infoTick15801393167907430156_a52db8255e1aa278>>();
    };
    ...
    aotLib[0x5d3cac64a8de768c] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncastTickmake_visitorTick897644165917210720_32f69b97fa03207c>>();
    };
    ...
    aotLib[0x7e898efe203d577b] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncastTickmake_visitorTick897644165917210720_dbe5d53982deca2b>>();
    };
