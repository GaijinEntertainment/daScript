...
inline StructInfo const  * _FuncrttiTickclass_infoTick15801393167907430156_c2cff9325d819035 ( Context * __context__, templates::DecltypeMacro const  & __cl_rename_at_116_2 );
inline StructInfo const  * _FuncrttiTickclass_infoTick15801393167907430156_142bbab5b59bff2f ( Context * __context__, templates::DecltypeNoRefMacro const  & __cl_rename_at_116_3 );
inline void _FuncbuiltinTickpushTick10769833213962245646_577e5c7310ce42 ( Context * __context__, TArray<ast::AstFunctionAnnotation *> & __Arr_rename_at_181_4, ast::AstFunctionAnnotation * __value_rename_at_181_5 );
inline StructInfo const  * _FuncrttiTickclass_infoTick15801393167907430156_84dfddd7eb19f69a ( Context * __context__, templates::TemplateMacro const  & __cl_rename_at_116_6 );
inline void clone_e7f2e3950b291464 ( Context * __context__, smart_ptr_raw<Function> & __dest_rename_at_1092_7, smart_ptr_raw<Function> const  __src_rename_at_1092_8 );
inline smart_ptr_raw<Expression> _FuncbuiltinTickclone_to_moveTick2007252383599261567_15de45e2384edd37 ( Context * __context__, smart_ptr_raw<Expression> const  __clone_src_rename_at_1089_9 );
inline smart_ptr_raw<Function> _FuncbuiltinTickclone_to_moveTick2007252383599261567_c12049c34b7b55dd ( Context * __context__, smart_ptr_raw<Function> const  __clone_src_rename_at_1089_11 );
inline void clone_134bf37daab66962 ( Context * __context__, smart_ptr_raw<Expression> & __dest_rename_at_92_13, smart_ptr_raw<Expression> const  __src_rename_at_92_14 );
inline char * _FuncastTickdescribeTick842554968825501494_e6a33d3e7995fe10 ( Context * __context__, smart_ptr_raw<Expression> const  __expr_rename_at_48_15 );
inline int32_t _FuncbuiltinTickfind_index_ifTick4436313710217261332_9e5b44ef92d17708 ( Context * __context__, Sequence DAS_COMMENT((smart_ptr_raw<AnnotationDeclaration> &)) & __arr_rename_at_1727_16, Block DAS_COMMENT((bool,smart_ptr_raw<AnnotationDeclaration> const )) const  & __blk_rename_at_1727_17 );
inline int32_t _FuncbuiltinTickfind_index_ifTick4436313710217261332_7dba7efba37607b5 ( Context * __context__, Sequence DAS_COMMENT((smart_ptr_raw<Variable> &)) & __arr_rename_at_1727_22, Block DAS_COMMENT((bool,smart_ptr_raw<Variable> const )) const  & __blk_rename_at_1727_23 );
...
inline smart_ptr_raw<Expression> _FuncbuiltinTickclone_to_moveTick2007252383599261567_15de45e2384edd37 ( Context * __context__, smart_ptr_raw<Expression> const  __clone_src_rename_at_1089_9 )
{
    ...
    clone_134bf37daab66962(__context__,__clone_dest_rename_at_1091_10,__clone_src_rename_at_1089_9);
...
inline smart_ptr_raw<Function> _FuncbuiltinTickclone_to_moveTick2007252383599261567_c12049c34b7b55dd ( Context * __context__, smart_ptr_raw<Function> const  __clone_src_rename_at_1089_11 )
{
    ...
    clone_e7f2e3950b291464(__context__,__clone_dest_rename_at_1091_12,__clone_src_rename_at_1089_11);
...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    ...
    aotLib[0x3cf96cabe7d5358d] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncrttiTickclass_infoTick15801393167907430156_c2cff9325d819035>>();
    };
    aotLib[0xcafa606e1a061965] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncrttiTickclass_infoTick15801393167907430156_142bbab5b59bff2f>>();
    };
    ...
    aotLib[0x21f86f6b97fc4abf] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncrttiTickclass_infoTick15801393167907430156_84dfddd7eb19f69a>>();
    };
    aotLib[0x35a94659ed3fa66f] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&clone_e7f2e3950b291464>>();
    };
    aotLib[0x5fdcfbd898c759e1] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncbuiltinTickclone_to_moveTick2007252383599261567_15de45e2384edd37>>();
    };
    aotLib[0x2212ea0d6b4ec2b6] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncbuiltinTickclone_to_moveTick2007252383599261567_c12049c34b7b55dd>>();
    };
    aotLib[0xe1730e663b8b3eae] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&clone_134bf37daab66962>>();
    };
    ...
    aotLib[0x1ed02d01e120dc93] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncbuiltinTickfind_index_ifTick4436313710217261332_9e5b44ef92d17708>>();
    };
    aotLib[0xde8f7695c0014491] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncbuiltinTickfind_index_ifTick4436313710217261332_7dba7efba37607b5>>();
    };
