...
inline StructInfo const  * _FuncrttiTickclass_infoTick15801393167907430156_74108eabbc8020a3 ( Context * __context__, templates::DecltypeMacro const  & __cl_rename_at_116_2 );
inline StructInfo const  * _FuncrttiTickclass_infoTick15801393167907430156_1c69fc164eeb8e61 ( Context * __context__, templates::DecltypeNoRefMacro const  & __cl_rename_at_116_3 );
...
inline smart_ptr<Expression> _FuncbuiltinTickclone_to_moveTick2007252383599261567_7a593ef35695477e ( Context * __context__, smart_ptr<Expression> const  __clone_src_rename_at_1056_9 );
...
inline int32_t _FuncbuiltinTickfind_index_ifTick4436313710217261332_6d4d92e49ed1dae3 ( Context * __context__, Sequence DAS_COMMENT((smart_ptr<AnnotationDeclaration> &)) & __arr_rename_at_1694_16, Block DAS_COMMENT((bool,smart_ptr<AnnotationDeclaration> const )) const  & __blk_rename_at_1694_17 );
inline int32_t _FuncbuiltinTickfind_index_ifTick4436313710217261332_4b8aca0798d52ea ( Context * __context__, Sequence DAS_COMMENT((smart_ptr<Variable> &)) & __arr_rename_at_1694_22, Block DAS_COMMENT((bool,smart_ptr<Variable> const )) const  & __blk_rename_at_1694_23 );
...
inline smart_ptr<Expression> _FuncbuiltinTickclone_to_moveTick2007252383599261567_7a593ef35695477e ( Context * __context__, smart_ptr<Expression> const  __clone_src_rename_at_1056_9 )
{
    smart_ptr<Expression> __clone_dest_rename_at_1058_10; das_zero(__clone_dest_rename_at_1058_10);
    clone_a842a9854f1fbc85(__context__,__clone_dest_rename_at_1058_10,__clone_src_rename_at_1056_9);
    return /* <- */ das_auto_cast_move<smart_ptr<Expression>>::cast(__clone_dest_rename_at_1058_10);
}
...
inline int32_t _FuncbuiltinTickfind_index_ifTick4436313710217261332_6d4d92e49ed1dae3 ( Context * __context__, Sequence DAS_COMMENT((smart_ptr<AnnotationDeclaration> &)) &  __arr_rename_at_1694_16, Block DAS_COMMENT((bool,smart_ptr<AnnotationDeclaration> const )) const  &  __blk_rename_at_1694_17 )
{
    Sequence DAS_COMMENT((int32_t)) _temp_make_local_1695_22_32; _temp_make_local_1695_22_32;
    {
        ...
        das_iterator<Sequence DAS_COMMENT((smart_ptr<AnnotationDeclaration>))> __o_iterator(__arr_rename_at_1694_16);
        smart_ptr<AnnotationDeclaration> * __o_rename_at_1695_20;
        ...
        {
            if ( das_invoke<bool>::invoke<smart_ptr<AnnotationDeclaration>>(__context__,nullptr,__blk_rename_at_1694_17,(*__o_rename_at_1695_20)) )
            {
...
inline int32_t _FuncbuiltinTickfind_index_ifTick4436313710217261332_4b8aca0798d52ea ( Context * __context__, Sequence DAS_COMMENT((smart_ptr<Variable> &)) &  __arr_rename_at_1694_22, Block DAS_COMMENT((bool,smart_ptr<Variable> const )) const  &  __blk_rename_at_1694_23 )
{
    Sequence DAS_COMMENT((int32_t)) _temp_make_local_1695_22_32; _temp_make_local_1695_22_32;
    {
        ...
        das_iterator<Sequence DAS_COMMENT((smart_ptr<Variable>))> __o_iterator(__arr_rename_at_1694_22);
        smart_ptr<Variable> * __o_rename_at_1695_26;
        ...
        {
            if ( das_invoke<bool>::invoke<smart_ptr<Variable>>(__context__,nullptr,__blk_rename_at_1694_23,(*__o_rename_at_1695_26)) )
            {
...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    ...
    aotLib[0xcc2ec42af6f27401] = +[](Context & ctx) -> SimNode* { // _FuncrttiTickclass_infoTick15801393167907430156_74108eabbc8020a3
        return ctx.code->makeNode<SimNode_Aot<StructInfo const  * (*) ( Context * __context__, templates::DecltypeMacro const  &  ),&_FuncrttiTickclass_infoTick15801393167907430156_74108eabbc8020a3>>();
    };
    aotLib[0x21663c18decdd76c] = +[](Context & ctx) -> SimNode* { // _FuncrttiTickclass_infoTick15801393167907430156_1c69fc164eeb8e61
        return ctx.code->makeNode<SimNode_Aot<StructInfo const  * (*) ( Context * __context__, templates::DecltypeNoRefMacro const  &  ),&_FuncrttiTickclass_infoTick15801393167907430156_1c69fc164eeb8e61>>();
    };
    ...
    aotLib[0x5897e6e2667df721] = +[](Context & ctx) -> SimNode* { // _FuncrttiTickclass_infoTick15801393167907430156_249decbf87fecb03
        return ctx.code->makeNode<SimNode_Aot<StructInfo const  * (*) ( Context * __context__, templates::TemplateMacro const  &  ),&_FuncrttiTickclass_infoTick15801393167907430156_249decbf87fecb03>>();
    };
