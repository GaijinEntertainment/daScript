...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    aotLib[0xa6ddc4c288d44845] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTickvaluesTick1351216622833168869_a3e598199cd32e36
        return ctx.code->makeNode<SimNode_AotCMRES<Sequence DAS_COMMENT((profiler::PerfNode * &)) (*) ( Context * __context__, TTable<SimFunction *,profiler::PerfNode *> &  ),&_FuncbuiltinTickvaluesTick1351216622833168869_a3e598199cd32e36>>();
    };
    aotLib[0x2ace0787081a3f41] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTickvaluesTick1351216622833168869_ba9de0362fdc9aa9
        return ctx.code->makeNode<SimNode_AotCMRES<Sequence DAS_COMMENT((profiler::PerfContext &)) (*) ( Context * __context__, TTable<uint64_t,profiler::PerfContext> &  ),&_FuncbuiltinTickvaluesTick1351216622833168869_ba9de0362fdc9aa9>>();
    };
    aotLib[0x2f70f2c8bba18644] = +[](Context & ctx) -> SimNode* { // finalize_bf607c77b39d2bb9
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, profiler::PerfEvent &  ),&finalize_bf607c77b39d2bb9>>();
    };
    aotLib[0x913076c65272dc08] = +[](Context & ctx) -> SimNode* { // _FuncrttiTickclass_infoTick15801393167907430156_5faf74312cbe5451
        return ctx.code->makeNode<SimNode_Aot<StructInfo const  * (*) ( Context * __context__, profiler::ProfilerDebugAgent const  &  ),&_FuncrttiTickclass_infoTick15801393167907430156_5faf74312cbe5451>>();
    };
    aotLib[0x7f4f652fb3aaca74] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTick_return_with_lockcheckTick2939372000839727345_875f1de9d5688f73
        return ctx.code->makeNode<SimNode_Aot<profiler::ProfilerDebugAgent & (*) ( Context * __context__, profiler::ProfilerDebugAgent &  ),&_FuncbuiltinTick_return_with_lockcheckTick2939372000839727345_875f1de9d5688f73>>();
    };
    aotLib[0xb220f54168293a43] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTickfinalizeTick5454204887383796109_9ef6894feb95542
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, TTable<SimFunction *,profiler::PerfNode *> &  ),&_FuncbuiltinTickfinalizeTick5454204887383796109_9ef6894feb95542>>();
    };
    aotLib[0x4950e2afda5de89a] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTickfinalizeTick5454204887383796109_cc32169f37ab997f
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, TTable<uint64_t,profiler::PerfContext> &  ),&_FuncbuiltinTickfinalizeTick5454204887383796109_cc32169f37ab997f>>();
    };
    ...
    aotLib[0x585560f2ddeec475] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTickfinalizeTick13836114024949725080_94c6752d6462171a
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, TArray<profiler::PerfEvent> &  ),&_FuncbuiltinTickfinalizeTick13836114024949725080_94c6752d6462171a>>();
    };
    aotLib[0xe992a3be62c97dd9] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTickresizeTick4811697762258667383_614e3a9c4293636c
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, TArray<profiler::PerfNode *> & , int32_t  ),&_FuncbuiltinTickresizeTick4811697762258667383_614e3a9c4293636c>>();
    };
    aotLib[0xa733964f66efcf81] = +[](Context & ctx) -> SimNode* { // finalize_eb44cbf3fa3f22db
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, profiler::PerfNode &  ),&finalize_eb44cbf3fa3f22db>>();
    };
    ...
    aotLib[0x56f279c3f4977a58] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTickkey_existsTick16808803843923989214_c8e6e12e4804697f
        return ctx.code->makeNode<SimNode_Aot<bool (*) ( Context * __context__, TTable<uint64_t,profiler::PerfContext> const  & , uint64_t  ),&_FuncbuiltinTickkey_existsTick16808803843923989214_c8e6e12e4804697f>>();
    };
    aotLib[0xe6770f76355a8470] = +[](Context & ctx) -> SimNode* { // finalize_132a04503ddcd675
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, profiler::PerfContext &  ),&finalize_132a04503ddcd675>>();
    };
    ...
    aotLib[0x75cb066807b3f59e] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTickpushTick10769833213962245646_d9c98e89be6f3aa9
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, TArray<profiler::PerfEvent> & , profiler::PerfEvent &  ),&_FuncbuiltinTickpushTick10769833213962245646_d9c98e89be6f3aa9>>();
    };
    aotLib[0x16e8bc79f87c7a44] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTickkey_existsTick16808803843923989214_9ddf16f8e9a725e2
        return ctx.code->makeNode<SimNode_Aot<bool (*) ( Context * __context__, TTable<SimFunction *,profiler::PerfNode *> const  & , SimFunction * const   ),&_FuncbuiltinTickkey_existsTick16808803843923989214_9ddf16f8e9a725e2>>();
    };
    aotLib[0xbe83de5171fab979] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTickeraseTick5639988512056021548_9a1bcb3ea71b8522
        return ctx.code->makeNode<SimNode_Aot<bool (*) ( Context * __context__, TTable<uint64_t,profiler::PerfContext> & , uint64_t  ),&_FuncbuiltinTickeraseTick5639988512056021548_9a1bcb3ea71b8522>>();
    };
    ...
    aotLib[0xc98a21ca1908bb19] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTickvaluesTick1935193042646774172_589e57754e0170bc
        return ctx.code->makeNode<SimNode_AotCMRES<Sequence DAS_COMMENT((profiler::PerfNode * &)) (*) ( Context * __context__, TTable<SimFunction *,profiler::PerfNode *> const  &  ),&_FuncbuiltinTickvaluesTick1935193042646774172_589e57754e0170bc>>();
    };
    aotLib[0xca7d7f31532fc1c4] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTickpushTick10769833213962245646_ce8f6e379fcfea44
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, TArray<profiler::PerfNode *> & , profiler::PerfNode *  ),&_FuncbuiltinTickpushTick10769833213962245646_ce8f6e379fcfea44>>();
    };
    aotLib[0x32f6b931bd039789] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTickbackTick18296309835877697278_d85bb617e8ef4b7a
        return ctx.code->makeNode<SimNode_Aot<profiler::PerfNode * & (*) ( Context * __context__, TArray<profiler::PerfNode *> &  ),&_FuncbuiltinTickbackTick18296309835877697278_d85bb617e8ef4b7a>>();
    };
    aotLib[0xa004a772e8177de1] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTickpopTick1161079256290593740_82d3f3b2cf4e69b4
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, TArray<profiler::PerfNode *> &  ),&_FuncbuiltinTickpopTick1161079256290593740_82d3f3b2cf4e69b4>>();
    };
    aotLib[0xf4f3d5c126acb6b8] = +[](Context & ctx) -> SimNode* { // finalize_8e28ab4c5bbc2920
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, profiler::PerfNode * &  ),&finalize_8e28ab4c5bbc2920>>();
    };
    aotLib[0xa86dc61aee6fc5e1] = +[](Context & ctx) -> SimNode* { // finalize_a22df4460ed06c09
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, profiler::ProfilerDebugAgent &  ),&finalize_a22df4460ed06c09>>();
    };
    aotLib[0x5525673634f57126] = +[](Context & ctx) -> SimNode* { // _FuncdebugapiTickinstall_new_thread_local_debug_agentTick15124441463860820031_df029e5126654686
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, profiler::ProfilerDebugAgent *  ),&_FuncdebugapiTickinstall_new_thread_local_debug_agentTick15124441463860820031_df029e5126654686>>();
    };
    ...
    aotLib[0x5dac366df75ee25e] = +[](Context & ctx) -> SimNode* { // _FuncProfilerDebugAgentTickdependency_9d6d5d73e8b06c23
        return ctx.code->makeNode<SimNode_Aot<Func DAS_COMMENT((void,uint64_t,bool)) (*) ( Context * __context__, profiler::ProfilerDebugAgent &  ),&_FuncProfilerDebugAgentTickdependency_9d6d5d73e8b06c23>>();
    };
    aotLib[0xec2258abccee8f16] = +[](Context & ctx) -> SimNode* { // _FuncProfilerDebugAgentTickis_time_unit_correct_25f9d2ab7f2d98f3
        return ctx.code->makeNode<SimNode_Aot<bool (*) ( Context * __context__, profiler::ProfilerDebugAgent & , char * const   ),&_FuncProfilerDebugAgentTickis_time_unit_correct_25f9d2ab7f2d98f3>>();
    };
    aotLib[0xefa1ef566d8411ac] = +[](Context & ctx) -> SimNode* { // _FuncProfilerDebugAgentTickconvert_ns_to_unit_36a018949c3810e0
        return ctx.code->makeNode<SimNode_Aot<int64_t (*) ( Context * __context__, profiler::ProfilerDebugAgent & , int64_t , char * const   ),&_FuncProfilerDebugAgentTickconvert_ns_to_unit_36a018949c3810e0>>();
    };
    aotLib[0x6b865d339d3c051c] = +[](Context & ctx) -> SimNode* { // _FuncProfilerDebugAgentTickonInstall_79884d0439618d6e
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, profiler::ProfilerDebugAgent & , DebugAgent * const   ),&_FuncProfilerDebugAgentTickonInstall_79884d0439618d6e>>();
    };
    aotLib[0x2cf7290f2354c9e6] = +[](Context & ctx) -> SimNode* { // _FuncProfilerDebugAgentTickonUninstall_df0cd7115237983e
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, profiler::ProfilerDebugAgent & , DebugAgent * const   ),&_FuncProfilerDebugAgentTickonUninstall_df0cd7115237983e>>();
    };
    aotLib[0xf48726e6ad095c32] = +[](Context & ctx) -> SimNode* { // _FuncProfilerDebugAgentTickisProfileable_f648883be6e14b15
        return ctx.code->makeNode<SimNode_Aot<bool (*) ( Context * __context__, profiler::ProfilerDebugAgent & , Context &  ),&_FuncProfilerDebugAgentTickisProfileable_f648883be6e14b15>>();
    };
    aotLib[0x3a9094bb37ba556d] = +[](Context & ctx) -> SimNode* { // _FuncProfilerDebugAgentTickonCreateContext_b8c4d2ec382a1344
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, profiler::ProfilerDebugAgent & , Context &  ),&_FuncProfilerDebugAgentTickonCreateContext_b8c4d2ec382a1344>>();
    };
    aotLib[0x176047fc6a040e24] = +[](Context & ctx) -> SimNode* { // _FuncProfilerDebugAgentTickenable_profiler_c7c60c2ea3b8eb35
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, profiler::ProfilerDebugAgent & , uint64_t , bool  ),&_FuncProfilerDebugAgentTickenable_profiler_c7c60c2ea3b8eb35>>();
    };
    aotLib[0xba212639fddff6bd] = +[](Context & ctx) -> SimNode* { // _FuncProfilerDebugAgentTickonDestroyContext_f7495d404e4bfba0
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, profiler::ProfilerDebugAgent & , Context &  ),&_FuncProfilerDebugAgentTickonDestroyContext_f7495d404e4bfba0>>();
    };
    aotLib[0x3ea4e634b85266b7] = +[](Context & ctx) -> SimNode* { // _FuncProfilerDebugAgentTickonInstrumentFunctionWithMemory_78db28e3bbcd17
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, profiler::ProfilerDebugAgent & , Context & , SimFunction * , bool , uint64_t  ),&_FuncProfilerDebugAgentTickonInstrumentFunctionWithMemory_78db28e3bbcd17>>();
    };
    aotLib[0xd1a5b49c011b0e8c] = +[](Context & ctx) -> SimNode* { // _FuncProfilerDebugAgentTickonInstrumentFunction_96f578b90a66923b
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, profiler::ProfilerDebugAgent & , Context & , SimFunction * , bool , uint64_t  ),&_FuncProfilerDebugAgentTickonInstrumentFunction_96f578b90a66923b>>();
    };
    aotLib[0x9f7764e19449f83c] = +[](Context & ctx) -> SimNode* { // _FuncProfilerDebugAgentTickdump_16cbdda4b0c6973
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, profiler::ProfilerDebugAgent & , char * const   ),&_FuncProfilerDebugAgentTickdump_16cbdda4b0c6973>>();
    };
    aotLib[0xfa486e1f7a9633a7] = +[](Context & ctx) -> SimNode* { // _FuncProfilerDebugAgentTickwrite_aaa4a549c5db2470
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, profiler::ProfilerDebugAgent & , char * const   ),&_FuncProfilerDebugAgentTickwrite_aaa4a549c5db2470>>();
    };
    aotLib[0x4fe57fbc22b5ae28] = +[](Context & ctx) -> SimNode* { // _FuncProfilerDebugAgentTickdump_event_f4e3cf1303495263
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, profiler::ProfilerDebugAgent & , profiler::PerfEvent const  & , uint64_t  ),&_FuncProfilerDebugAgentTickdump_event_f4e3cf1303495263>>();
    };
    aotLib[0x13f7a0099c1056fe] = +[](Context & ctx) -> SimNode* { // _FuncProfilerDebugAgentTickdump_node_e61d95bf2dd83ed2
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, profiler::ProfilerDebugAgent & , profiler::PerfNode * const  , int32_t  ),&_FuncProfilerDebugAgentTickdump_node_e61d95bf2dd83ed2>>();
    };
    aotLib[0x26d8bffc6a20d0e2] = +[](Context & ctx) -> SimNode* { // _FuncProfilerDebugAgentTickdump_context_stack_75a85cd6d05aaa94
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, profiler::ProfilerDebugAgent & , uint64_t  ),&_FuncProfilerDebugAgentTickdump_context_stack_75a85cd6d05aaa94>>();
    };
    aotLib[0xa8ac0bebee1207d5] = +[](Context & ctx) -> SimNode* { // _FuncProfilerDebugAgentTickdump_meta_e2086c649a7ec17d
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, profiler::ProfilerDebugAgent & , Context & , uint64_t  ),&_FuncProfilerDebugAgentTickdump_meta_e2086c649a7ec17d>>();
    };
    aotLib[0x1c15d8343f727a3d] = +[](Context & ctx) -> SimNode* { // _FuncProfilerDebugAgentTickdump_events_a9ca4927f18757f9
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, profiler::ProfilerDebugAgent & , uint64_t  ),&_FuncProfilerDebugAgentTickdump_events_a9ca4927f18757f9>>();
    };
    aotLib[0xec74d7595be70148] = +[](Context & ctx) -> SimNode* { // _FuncProfilerDebugAgentTickdump_context_fd27b073a7187d7d
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, profiler::ProfilerDebugAgent & , Context & , uint64_t  ),&_FuncProfilerDebugAgentTickdump_context_fd27b073a7187d7d>>();
    };
    aotLib[0xfb67d2f2ad9705fc] = +[](Context & ctx) -> SimNode* { // _FuncProfilerDebugAgent_0x27___finalize_55718825a6cacc65
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, profiler::ProfilerDebugAgent &  ),&_FuncProfilerDebugAgent_0x27___finalize_55718825a6cacc65>>();
    };
    aotLib[0xc88839b02c3837c0] = +[](Context & ctx) -> SimNode* { // debug_agent_d95b879260e75c8e
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, Context const  &  ),&debug_agent_d95b879260e75c8e>>();
    };
    aotLib[0x112e2f107086f2d] = +[](Context & ctx) -> SimNode* { // ProfilerDebugAgent_bd056e97854e0b75
        return ctx.code->makeNode<SimNode_AotCMRES<profiler::ProfilerDebugAgent (*) ( Context * __context__ ),&ProfilerDebugAgent_bd056e97854e0b75>>();
    };
    aotLib[0x2b232266aaa5b9e1] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTickto_table_moveTick5858896087460481804_18e39d2b0245aff4
        return ctx.code->makeNode<SimNode_AotCMRES<TTable<char *,int64_t> (*) ( Context * __context__, TDim<AutoTuple<char *,int64_t>,4> &  ),&_FuncbuiltinTickto_table_moveTick5858896087460481804_18e39d2b0245aff4>>();
    };
    // [[ init script ]]
