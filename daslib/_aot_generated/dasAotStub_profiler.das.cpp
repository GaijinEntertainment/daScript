...
inline Sequence DAS_COMMENT((profiler::PerfNode * &)) _FuncbuiltinTickvaluesTick1351216622833168869_3e6efebe440ad8cc ( Context * __context__, TTable<SimFunction *,profiler::PerfNode *> & __a_rename_at_1183_0 );
inline Sequence DAS_COMMENT((profiler::PerfContext &)) _FuncbuiltinTickvaluesTick1351216622833168869_7763660ae57a05fd ( Context * __context__, TTable<uint64_t,profiler::PerfContext> & __a_rename_at_1183_2 );
inline void finalize_4bb047444d42f1a ( Context * __context__, profiler::PerfEvent & ____this_rename_at_29_4 );
inline StructInfo const  * _FuncrttiTickclass_infoTick15801393167907430156_5a8d7b1584de65c3 ( Context * __context__, profiler::ProfilerDebugAgent const  & __cl_rename_at_116_5 );
inline void _FuncbuiltinTickfinalizeTick5454204887383796109_757e5d077d6225ca ( Context * __context__, TTable<SimFunction *,profiler::PerfNode *> & __a_rename_at_1226_6 );
inline void _FuncbuiltinTickfinalizeTick5454204887383796109_5fea2602eb0f6bad ( Context * __context__, TTable<uint64_t,profiler::PerfContext> & __a_rename_at_1226_8 );
inline void _FuncbuiltinTickfinalizeTick5454204887383796109_780e6e93194ee2a8 ( Context * __context__, TTable<uint64_t,void> & __a_rename_at_1226_10 );
inline void _FuncbuiltinTickfinalizeTick5454204887383796109_976cf4566653f283 ( Context * __context__, TTable<char *,int64_t> & __a_rename_at_1226_11 );
inline void _FuncbuiltinTickfinalizeTick13836114024949725080_b0c3c1951a12b5ee ( Context * __context__, TArray<profiler::PerfEvent> & __a_rename_at_1215_12 );
inline void _FuncbuiltinTickresizeTick4811697762258667383_83d28e7ff3027146 ( Context * __context__, TArray<profiler::PerfNode *> & __Arr_rename_at_68_14, int32_t __newSize_rename_at_68_15 );
inline void finalize_251c534cd3dbcda7 ( Context * __context__, profiler::PerfNode & ____this_rename_at_17_16 );
inline bool _FuncbuiltinTickkey_existsTick16808803843923989214_3ecd0f9150dfb207 ( Context * __context__, TTable<char *,int64_t> const  & __Tab_rename_at_1047_17, char * const  __at_rename_at_1047_18 );
inline bool _FuncbuiltinTickkey_existsTick16808803843923989214_11cf4ba0ef6c0808 ( Context * __context__, TTable<uint64_t,void> const  & __Tab_rename_at_1047_19, uint64_t __at_rename_at_1047_20 );
inline void _FuncbuiltinTickinsertTick10959621454228962049_46890e73916e9f08 ( Context * __context__, TTable<uint64_t,void> & __Tab_rename_at_895_21, uint64_t __at_rename_at_895_22 );
inline bool _FuncbuiltinTickkey_existsTick16808803843923989214_4d84a94cfa919a28 ( Context * __context__, TTable<uint64_t,profiler::PerfContext> const  & __Tab_rename_at_1047_23, uint64_t __at_rename_at_1047_24 );
inline void finalize_6444fe3d819b336b ( Context * __context__, profiler::PerfContext & ____this_rename_at_38_25 );
inline bool _FuncbuiltinTickeraseTick5639988512056021548_df117d886971474b ( Context * __context__, TTable<uint64_t,void> & __Tab_rename_at_888_26, uint64_t __at_rename_at_888_27 );
inline void _FuncbuiltinTickpushTick10769833213962245646_a4fe723844ff9e7 ( Context * __context__, TArray<profiler::PerfEvent> & __Arr_rename_at_181_28, profiler::PerfEvent & __value_rename_at_181_29 );
inline bool _FuncbuiltinTickkey_existsTick16808803843923989214_68628851d23190b9 ( Context * __context__, TTable<SimFunction *,profiler::PerfNode *> const  & __Tab_rename_at_1047_30, SimFunction * const  __at_rename_at_1047_31 );
inline bool _FuncbuiltinTickeraseTick5639988512056021548_768b6f71c44f25ae ( Context * __context__, TTable<uint64_t,profiler::PerfContext> & __Tab_rename_at_888_32, uint64_t __at_rename_at_888_33 );
inline TArray<char *> _FuncbuiltinTickget_command_line_argumentsTick14327939727965569528_ac834a7fbcde97f3 ( Context * __context__ );
inline uint64_t _FuncbuiltinTickintptrTick11320822648609276562_8c85e7dff751212 ( Context * __context__, void * const  __p_rename_at_15_35 );
inline Sequence DAS_COMMENT((profiler::PerfNode * &)) _FuncbuiltinTickvaluesTick1935193042646774172_32cd4ef14d502aa8 ( Context * __context__, TTable<SimFunction *,profiler::PerfNode *> const  & __a_rename_at_1176_36 );
inline void _FuncbuiltinTickpushTick10769833213962245646_e6ba59383edc565d ( Context * __context__, TArray<profiler::PerfNode *> & __Arr_rename_at_181_38, profiler::PerfNode * __value_rename_at_181_39 );
inline profiler::PerfNode * & _FuncbuiltinTickbackTick18296309835877697278_3b40803e261b168b ( Context * __context__, TArray<profiler::PerfNode *> & __a_rename_at_473_40 );
inline void _FuncbuiltinTickpopTick1161079256290593740_bbece6ed9c77046c ( Context * __context__, TArray<profiler::PerfNode *> & __Arr_rename_at_132_42 );
inline void finalize_1d6fbca1e949373b ( Context * __context__, profiler::PerfNode * & ____this_rename_at_233_43 );
inline void finalize_9e167f5d77b26095 ( Context * __context__, profiler::ProfilerDebugAgent & ____this_rename_at_51_44 );
inline void _FuncdebugapiTickinstall_new_thread_local_debug_agentTick15124441463860820031_f22238c2acb8f53a ( Context * __context__, profiler::ProfilerDebugAgent * __agentPtr_rename_at_51_45 );
inline void set_enable_profiler_1fb51d4dfe399b06 ( Context * __context__, uint64_t __ctxId_rename_at_45_48, bool __enabled_rename_at_45_49 );
inline Func DAS_COMMENT((void,uint64_t,bool)) _FuncProfilerDebugAgentTickdependency_2e38601952f42fa2 ( Context * __context__, profiler::ProfilerDebugAgent & __self_rename_at_62_50 );
inline bool _FuncProfilerDebugAgentTickis_time_unit_correct_fab989a1861d3b1 ( Context * __context__, profiler::ProfilerDebugAgent & __self_rename_at_66_51, char * const  __unit_rename_at_66_52 );
inline int64_t _FuncProfilerDebugAgentTickconvert_ns_to_unit_d7917a1786066152 ( Context * __context__, profiler::ProfilerDebugAgent & __self_rename_at_70_53, int64_t __time_rename_at_70_54, char * const  __to_rename_at_70_55 );
inline void _FuncProfilerDebugAgentTickonInstall_57049db1d4217d7a ( Context * __context__, profiler::ProfilerDebugAgent & __self_rename_at_74_56, DebugAgent * const  __agent_rename_at_74_57 );
inline void _FuncProfilerDebugAgentTickonUninstall_57049db1d4217d7a ( Context * __context__, profiler::ProfilerDebugAgent & __self_rename_at_100_64, DebugAgent * const  __agent_rename_at_100_65 );
inline bool _FuncProfilerDebugAgentTickisProfileable_482e69b251f0de1d ( Context * __context__, profiler::ProfilerDebugAgent & __self_rename_at_107_66, Context & __ctx_rename_at_107_67 );
inline void _FuncProfilerDebugAgentTickonCreateContext_71c97ce0570194ae ( Context * __context__, profiler::ProfilerDebugAgent & __self_rename_at_111_68, Context & __ctx_rename_at_111_69 );
inline void _FuncProfilerDebugAgentTickenable_profiler_6e062781f165864b ( Context * __context__, profiler::ProfilerDebugAgent & __self_rename_at_119_70, uint64_t __ctxId_rename_at_119_71, bool __enabled_rename_at_119_72 );
inline void _FuncProfilerDebugAgentTickonDestroyContext_71c97ce0570194ae ( Context * __context__, profiler::ProfilerDebugAgent & __self_rename_at_122_73, Context & __ctx_rename_at_122_74 );
inline void _FuncProfilerDebugAgentTickonInstrumentFunctionWithMemory_ce0e0f34c7ebe105 ( Context * __context__, profiler::ProfilerDebugAgent & __self_rename_at_133_76, Context & __ctx_rename_at_133_77, SimFunction * __fun_rename_at_133_78, bool __entering_rename_at_133_79, uint64_t __userData_rename_at_133_80 );
inline void _FuncProfilerDebugAgentTickonInstrumentFunction_ce0e0f34c7ebe105 ( Context * __context__, profiler::ProfilerDebugAgent & __self_rename_at_149_84, Context & __ctx_rename_at_149_85, SimFunction * __fun_rename_at_149_86, bool __entering_rename_at_149_87, uint64_t __userData_rename_at_149_88 );
inline void _FuncProfilerDebugAgentTickdump_f967d4c425c2d2b6 ( Context * __context__, profiler::ProfilerDebugAgent & __self_rename_at_161_91, char * const  __text_rename_at_161_92 );
inline void _FuncProfilerDebugAgentTickwrite_f967d4c425c2d2b6 ( Context * __context__, profiler::ProfilerDebugAgent & __self_rename_at_169_93, char * const  __text_rename_at_169_94 );
inline void _FuncProfilerDebugAgentTickdump_event_a1415c332cd3a2e8 ( Context * __context__, profiler::ProfilerDebugAgent & __self_rename_at_174_95, profiler::PerfEvent const  & __ev_rename_at_174_96, uint64_t __tid_rename_at_174_97 );
inline void _FuncProfilerDebugAgentTickdump_node_5564b1a08048649a ( Context * __context__, profiler::ProfilerDebugAgent & __self_rename_at_179_100, profiler::PerfNode * const  __node_rename_at_179_101, int32_t __tab_rename_at_179_102 );
inline void _FuncProfilerDebugAgentTickdump_context_stack_2e5a65fdc0508d94 ( Context * __context__, profiler::ProfilerDebugAgent & __self_rename_at_202_109, uint64_t __tid_rename_at_202_110 );
inline void _FuncProfilerDebugAgentTickdump_meta_2fe36a71df996f32 ( Context * __context__, profiler::ProfilerDebugAgent & __self_rename_at_236_115, Context & __ctx_rename_at_236_116, uint64_t __tid_rename_at_236_117 );
inline void _FuncProfilerDebugAgentTickdump_events_2e5a65fdc0508d94 ( Context * __context__, profiler::ProfilerDebugAgent & __self_rename_at_245_121, uint64_t __tid_rename_at_245_122 );
inline void _FuncProfilerDebugAgentTickdump_context_2fe36a71df996f32 ( Context * __context__, profiler::ProfilerDebugAgent & __self_rename_at_250_124, Context & __ctx_rename_at_250_125, uint64_t __tid_rename_at_250_126 );
inline void _FuncProfilerDebugAgent_0x27___finalize_654360e8c20a8414 ( Context * __context__, profiler::ProfilerDebugAgent & __self_rename_at_51_127 );
inline void debug_agent_8ae6632f339fc097 ( Context * __context__, Context const  & __ctx_rename_at_261_128 );
inline profiler::ProfilerDebugAgent ProfilerDebugAgent_35e3ca121f3f1290 ( Context * __context__ );
inline TTable<char *,int64_t> _FuncbuiltinTickto_table_moveTick5858896087460481804_d77906b4b315fd45 ( Context * __context__, TDim<AutoTuple<char *,int64_t>,4> & __a_rename_at_1488_129 );
...
inline void _FuncbuiltinTickfinalizeTick5454204887383796109_757e5d077d6225ca ( Context * __context__, TTable<SimFunction *,profiler::PerfNode *> &  __a_rename_at_1226_6 )
{
    Sequence DAS_COMMENT((profiler::PerfNode * *)) _temp_make_local_1228_19_32; _temp_make_local_1228_19_32;
    {
        ...
        das_iterator<Sequence DAS_COMMENT((profiler::PerfNode *))> __aV_iterator((_temp_make_local_1228_19_32 = (_FuncbuiltinTickvaluesTick1351216622833168869_3e6efebe440ad8cc(__context__,das_arg<TTable<SimFunction *,profiler::PerfNode *>>::pass(__a_rename_at_1226_6)))));
        ...
        {
            finalize_1d6fbca1e949373b(__context__,(*__aV_rename_at_1228_7));
        }
...
inline void _FuncbuiltinTickfinalizeTick5454204887383796109_5fea2602eb0f6bad ( Context * __context__, TTable<uint64_t,profiler::PerfContext> &  __a_rename_at_1226_8 )
{
    Sequence DAS_COMMENT((profiler::PerfContext *)) _temp_make_local_1228_19_32; _temp_make_local_1228_19_32;
    {
        ...
        das_iterator<Sequence DAS_COMMENT((profiler::PerfContext))> __aV_iterator((_temp_make_local_1228_19_32 = (_FuncbuiltinTickvaluesTick1351216622833168869_7763660ae57a05fd(__context__,das_arg<TTable<uint64_t,profiler::PerfContext>>::pass(__a_rename_at_1226_8)))));
        ...
        {
            finalize_6444fe3d819b336b(__context__,das_arg<profiler::PerfContext>::pass((*__aV_rename_at_1228_9)));
        }
...
{
    {
        ...
        {
            finalize_4bb047444d42f1a(__context__,das_arg<profiler::PerfEvent>::pass((*__aV_rename_at_1217_13)));
        }
...
inline void finalize_251c534cd3dbcda7 ( Context * __context__, profiler::PerfNode &  ____this_rename_at_17_16 )
{
    _FuncbuiltinTickfinalizeTick5454204887383796109_757e5d077d6225ca(__context__,das_arg<TTable<SimFunction *,profiler::PerfNode *>>::pass(____this_rename_at_17_16.children));
...
inline void finalize_6444fe3d819b336b ( Context * __context__, profiler::PerfContext &  ____this_rename_at_38_25 )
{
    _FuncbuiltinTickfinalizeTick13836114024949725080_b0c3c1951a12b5ee(__context__,das_arg<TArray<profiler::PerfEvent>>::pass(____this_rename_at_38_25.events));
...
inline void _FuncbuiltinTickpopTick1161079256290593740_bbece6ed9c77046c ( Context * __context__, TArray<profiler::PerfNode *> &  __Arr_rename_at_132_42 )
{
    _FuncbuiltinTickresizeTick4811697762258667383_83d28e7ff3027146(__context__,das_arg<TArray<profiler::PerfNode *>>::pass(__Arr_rename_at_132_42),builtin_array_size(das_arg<TArray<profiler::PerfNode *>>::pass(__Arr_rename_at_132_42)) - 1);
}
...
inline void finalize_1d6fbca1e949373b ( Context * __context__, profiler::PerfNode * & ____this_rename_at_233_43 )
{
    ...
    {
        finalize_251c534cd3dbcda7(__context__,das_arg<profiler::PerfNode>::pass(das_deref(__context__,____this_rename_at_233_43)));
...
inline void finalize_9e167f5d77b26095 ( Context * __context__, profiler::ProfilerDebugAgent &  ____this_rename_at_51_44 )
{
    _FuncbuiltinTickfinalizeTick5454204887383796109_5fea2602eb0f6bad(__context__,das_arg<TTable<uint64_t,profiler::PerfContext>>::pass(____this_rename_at_51_44.events));
    _FuncbuiltinTickfinalizeTick5454204887383796109_780e6e93194ee2a8(__context__,das_arg<TTable<uint64_t,void>>::pass(____this_rename_at_51_44.instrumented));
    _FuncbuiltinTickfinalizeTick5454204887383796109_976cf4566653f283(__context__,das_arg<TTable<char *,int64_t>>::pass(____this_rename_at_51_44.map_time_units));
...
inline void _FuncdebugapiTickinstall_new_thread_local_debug_agentTick15124441463860820031_f22238c2acb8f53a ( Context * __context__, profiler::ProfilerDebugAgent * __agentPtr_rename_at_51_45 )
{
    ...
    smart_ptr_raw<DebugAgent> __agentAdapter_rename_at_54_47; memset((void*)&__agentAdapter_rename_at_54_47,0,sizeof(__agentAdapter_rename_at_54_47));
    {
        ...
        /* end finally */ });
        __agentInfo_rename_at_53_46 = ((StructInfo const  *)_FuncrttiTickclass_infoTick15801393167907430156_5a8d7b1584de65c3(__context__,das_arg<profiler::ProfilerDebugAgent>::pass(das_deref(__context__,__agentPtr_rename_at_51_45))));
...
inline bool _FuncProfilerDebugAgentTickis_time_unit_correct_fab989a1861d3b1 ( Context * __context__, profiler::ProfilerDebugAgent &  __self_rename_at_66_51, char * const  __unit_rename_at_66_52 )
{
    return das_auto_cast<bool>::cast(_FuncbuiltinTickkey_existsTick16808803843923989214_3ecd0f9150dfb207(__context__,das_arg<TTable<char *,int64_t>>::pass(__self_rename_at_66_51.map_time_units),__unit_rename_at_66_52));
}
...
inline void _FuncProfilerDebugAgentTickonInstall_57049db1d4217d7a ( Context * __context__, profiler::ProfilerDebugAgent &  __self_rename_at_74_56, DebugAgent * const  __agent_rename_at_74_57 )
{
    ...
    TArray<char *> __args_rename_at_76_58; das_zero(__args_rename_at_76_58); das_move(__args_rename_at_76_58, _FuncbuiltinTickget_command_line_argumentsTick14327939727965569528_ac834a7fbcde97f3(__context__));
    {
...
inline void _FuncProfilerDebugAgentTickonCreateContext_71c97ce0570194ae ( Context * __context__, profiler::ProfilerDebugAgent &  __self_rename_at_111_68, Context &  __ctx_rename_at_111_69 )
{
    if ( !(das_invoke_method<bool,offsetof(profiler::ProfilerDebugAgent,isProfileable)>::invoke<profiler::ProfilerDebugAgent &,Context &>(__context__,nullptr,das_arg<profiler::ProfilerDebugAgent>::pass(__self_rename_at_111_68),das_arg<Context>::pass(__ctx_rename_at_111_69))) || _FuncbuiltinTickkey_existsTick16808803843923989214_11cf4ba0ef6c0808(__context__,das_arg<TTable<uint64_t,void>>::pass(__self_rename_at_111_68.instrumented),((__ctx_rename_at_111_69).getCodeAllocatorId())) )
    {
        return ;
    } else {
        _FuncbuiltinTickinsertTick10959621454228962049_46890e73916e9f08(__context__,das_arg<TTable<uint64_t,void>>::pass(__self_rename_at_111_68.instrumented),((__ctx_rename_at_111_69).getCodeAllocatorId()));
        das_copy(__self_rename_at_111_68.events(_FuncbuiltinTickintptrTick11320822648609276562_8c85e7dff751212(__context__,das_auto_cast<void * const >::cast(das_ref(__context__,__ctx_rename_at_111_69))),__context__).enabled,!__self_rename_at_111_68.manual);
...
inline void _FuncProfilerDebugAgentTickonDestroyContext_71c97ce0570194ae ( Context * __context__, profiler::ProfilerDebugAgent &  __self_rename_at_122_73, Context &  __ctx_rename_at_122_74 )
{
    if ( !das_invoke_method<bool,offsetof(profiler::ProfilerDebugAgent,isProfileable)>::invoke<profiler::ProfilerDebugAgent &,Context &>(__context__,nullptr,das_arg<profiler::ProfilerDebugAgent>::pass(__self_rename_at_122_73),das_arg<Context>::pass(__ctx_rename_at_122_74)) )
    {
        ...
        uint64_t __tid_rename_at_126_75 = ((uint64_t)_FuncbuiltinTickintptrTick11320822648609276562_8c85e7dff751212(__context__,das_auto_cast<void * const >::cast(das_ref(__context__,__ctx_rename_at_122_74))));
        if ( _FuncbuiltinTickkey_existsTick16808803843923989214_4d84a94cfa919a28(__context__,das_arg<TTable<uint64_t,profiler::PerfContext>>::pass(__self_rename_at_122_73.events),__tid_rename_at_126_75) )
        {
            ...
            finalize_6444fe3d819b336b(__context__,das_arg<profiler::PerfContext>::pass(__self_rename_at_122_73.events(__tid_rename_at_126_75,__context__)));
        };
        _FuncbuiltinTickeraseTick5639988512056021548_df117d886971474b(__context__,das_arg<TTable<uint64_t,void>>::pass(__self_rename_at_122_73.instrumented),((__ctx_rename_at_122_74).getCodeAllocatorId()));
    };
}

inline void _FuncProfilerDebugAgentTickonInstrumentFunctionWithMemory_ce0e0f34c7ebe105 ( Context * __context__, profiler::ProfilerDebugAgent &  __self_rename_at_133_76, Context &  __ctx_rename_at_133_77, SimFunction * __fun_rename_at_133_78, bool __entering_rename_at_133_79, uint64_t __userData_rename_at_133_80 )
{
    uint64_t __tid_rename_at_135_81 = ((uint64_t)_FuncbuiltinTickintptrTick11320822648609276562_8c85e7dff751212(__context__,das_auto_cast<void * const >::cast(das_ref(__context__,__ctx_rename_at_133_77))));
    ...
    if ( (*__ev_rename_at_136_82).enabled )
    {
        ...
        _FuncbuiltinTickpushTick10769833213962245646_a4fe723844ff9e7(__context__,das_arg<TArray<profiler::PerfEvent>>::pass((*__ev_rename_at_136_82).events),das_arg<profiler::PerfEvent>::pass((([&]() -> profiler::PerfEvent& {
...
inline void _FuncProfilerDebugAgentTickonInstrumentFunction_ce0e0f34c7ebe105 ( Context * __context__, profiler::ProfilerDebugAgent &  __self_rename_at_149_84, Context &  __ctx_rename_at_149_85, SimFunction * __fun_rename_at_149_86, bool __entering_rename_at_149_87, uint64_t __userData_rename_at_149_88 )
{
    uint64_t __tid_rename_at_151_89 = ((uint64_t)_FuncbuiltinTickintptrTick11320822648609276562_8c85e7dff751212(__context__,das_auto_cast<void * const >::cast(das_ref(__context__,__ctx_rename_at_149_85))));
    ...
    if ( (*__ev_rename_at_152_90).enabled )
    {
        ...
        _FuncbuiltinTickpushTick10769833213962245646_a4fe723844ff9e7(__context__,das_arg<TArray<profiler::PerfEvent>>::pass((*__ev_rename_at_152_90).events),das_arg<profiler::PerfEvent>::pass((([&]() -> profiler::PerfEvent& {
...
inline void _FuncProfilerDebugAgentTickdump_node_5564b1a08048649a ( Context * __context__, profiler::ProfilerDebugAgent &  __self_rename_at_179_100, profiler::PerfNode * const  __node_rename_at_179_101, int32_t __tab_rename_at_179_102 )
{
    if ( __node_rename_at_179_101 == nullptr )
    {
        ...
        if ( __node_rename_at_179_101->fun != nullptr )
        {
            ...
            if ( __self_rename_at_179_100.report_memory )
            {
                ...
                uint64_t __shb_rename_at_188_106 = __node_rename_at_179_101->total_string_heap_bytes;
                {
                    ...
                    das_iterator<Sequence DAS_COMMENT((profiler::PerfNode * const ))> __ch_iterator((_temp_make_local_189_27_96 = (_FuncbuiltinTickvaluesTick1935193042646774172_32cd4ef14d502aa8(__context__,__node_rename_at_179_101->children))));
        ...
        };
        {
            ...
            // ch: profiler::PerfNode? const&
            das_iterator<Sequence DAS_COMMENT((profiler::PerfNode * const ))> __ch_iterator((_temp_make_local_198_19_128 = (_FuncbuiltinTickvaluesTick1935193042646774172_32cd4ef14d502aa8(__context__,__node_rename_at_179_101->children))));
...
inline void _FuncProfilerDebugAgentTickdump_context_stack_2e5a65fdc0508d94 ( Context * __context__, profiler::ProfilerDebugAgent &  __self_rename_at_202_109, uint64_t __tid_rename_at_202_110 )
{
    ...
    profiler::PerfNode * __sp_rename_at_206_113 = __root_rename_at_204_111;
    {
        ...
        for ( ; __need_loop_207 ; __need_loop_207 = __ev_iterator.next(__context__,(__ev_rename_at_207_114)) )
        {
            if ( __self_rename_at_202_109.manual && builtin_string_startswith((*__ev_rename_at_207_114).fun->mangledName /*mangledName*/,((char *) "@profiler_boost::"),__context__) )
            {
                ...
                {
                    _FuncbuiltinTickpushTick10769833213962245646_e6ba59383edc565d(__context__,das_arg<TArray<profiler::PerfNode *>>::pass(__stack_rename_at_205_112),__sp_rename_at_206_113);
                    if ( !_FuncbuiltinTickkey_existsTick16808803843923989214_68628851d23190b9(__context__,das_arg<TTable<SimFunction *,profiler::PerfNode *>>::pass(__sp_rename_at_206_113->children),(*__ev_rename_at_207_114).fun) )
                    {
    ...
    finalize_1d6fbca1e949373b(__context__,__root_rename_at_204_111);
}
...
inline void _FuncProfilerDebugAgentTickdump_context_2fe36a71df996f32 ( Context * __context__, profiler::ProfilerDebugAgent &  __self_rename_at_250_124, Context &  __ctx_rename_at_250_125, uint64_t __tid_rename_at_250_126 )
{
    ...
    _FuncbuiltinTickfinalizeTick13836114024949725080_b0c3c1951a12b5ee(__context__,das_arg<TArray<profiler::PerfEvent>>::pass(__self_rename_at_250_124.events(__tid_rename_at_250_126,__context__).events));
    _FuncbuiltinTickeraseTick5639988512056021548_768b6f71c44f25ae(__context__,das_arg<TTable<uint64_t,profiler::PerfContext>>::pass(__self_rename_at_250_124.events),__tid_rename_at_250_126);
}

inline void _FuncProfilerDebugAgent_0x27___finalize_654360e8c20a8414 ( Context * __context__, profiler::ProfilerDebugAgent &  __self_rename_at_51_127 )
{
    finalize_9e167f5d77b26095(__context__,das_arg<profiler::ProfilerDebugAgent>::pass(__self_rename_at_51_127));
}

inline void debug_agent_8ae6632f339fc097 ( Context * __context__, Context const  &  __ctx_rename_at_261_128 )
{
    DAS_ASSERT((das_get_bitfield(thisContext(__context__).category /*category*/,1u << 1)));
    _FuncdebugapiTickinstall_new_thread_local_debug_agentTick15124441463860820031_f22238c2acb8f53a(__context__,das_new<profiler::ProfilerDebugAgent>::make_and_init(__context__,[&]() { return ProfilerDebugAgent_35e3ca121f3f1290(__context__); }));
}
...
inline profiler::ProfilerDebugAgent ProfilerDebugAgent_35e3ca121f3f1290 ( Context * __context__ )
{
    ...
    return /* <- */ das_auto_cast_move<profiler::ProfilerDebugAgent>::cast((([&]() -> profiler::ProfilerDebugAgent {
        ...
        das_move((__mks_51.map_time_units),(_FuncbuiltinTickto_table_moveTick5858896087460481804_d77906b4b315fd45(__context__,das_arg<TDim<AutoTuple<char *,int64_t>,4>>::pass((([&]() -> TDim<AutoTuple<char *,int64_t>,4>& {
...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    aotLib[0x4afd20fcc1d03d48] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_AotCMRES<&_FuncbuiltinTickvaluesTick1351216622833168869_3e6efebe440ad8cc>>();
    };
    aotLib[0x13a0b0f907f9c837] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_AotCMRES<&_FuncbuiltinTickvaluesTick1351216622833168869_7763660ae57a05fd>>();
    };
    aotLib[0x440395038340e653] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&finalize_4bb047444d42f1a>>();
    };
    aotLib[0x32a670708343b253] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncrttiTickclass_infoTick15801393167907430156_5a8d7b1584de65c3>>();
    };
    aotLib[0xd7f4aa5c79d21ded] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncbuiltinTickfinalizeTick5454204887383796109_757e5d077d6225ca>>();
    };
    aotLib[0x6130acc1fa5a43da] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncbuiltinTickfinalizeTick5454204887383796109_5fea2602eb0f6bad>>();
    };
    aotLib[0xc37f495c5b7b9afb] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncbuiltinTickfinalizeTick5454204887383796109_780e6e93194ee2a8>>();
    };
    aotLib[0xd0022c6cbd91d9cf] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncbuiltinTickfinalizeTick5454204887383796109_976cf4566653f283>>();
    };
    aotLib[0xf6a372fe6516309b] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncbuiltinTickfinalizeTick13836114024949725080_b0c3c1951a12b5ee>>();
    };
    aotLib[0x128b8e2cdc20b50e] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncbuiltinTickresizeTick4811697762258667383_83d28e7ff3027146>>();
    };
    aotLib[0x864a8b62e1852c28] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&finalize_251c534cd3dbcda7>>();
    };
    aotLib[0xaa806c417db457c3] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncbuiltinTickkey_existsTick16808803843923989214_3ecd0f9150dfb207>>();
    };
    aotLib[0x6e8294b64cd4b46a] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncbuiltinTickkey_existsTick16808803843923989214_11cf4ba0ef6c0808>>();
    };
    aotLib[0xdf1a80036ff3eb56] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncbuiltinTickinsertTick10959621454228962049_46890e73916e9f08>>();
    };
    aotLib[0x245f503fe18a5b31] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncbuiltinTickkey_existsTick16808803843923989214_4d84a94cfa919a28>>();
    };
    aotLib[0xe8e27635a1417e6f] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&finalize_6444fe3d819b336b>>();
    };
    aotLib[0xbb5593f7a143b317] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncbuiltinTickeraseTick5639988512056021548_df117d886971474b>>();
    };
    aotLib[0xe2a6d43475ee6953] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncbuiltinTickpushTick10769833213962245646_a4fe723844ff9e7>>();
    };
    aotLib[0x511feaf0ce0a388e] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncbuiltinTickkey_existsTick16808803843923989214_68628851d23190b9>>();
    };
    aotLib[0xa0b0eaf7ab61bd8d] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncbuiltinTickeraseTick5639988512056021548_768b6f71c44f25ae>>();
    };
    aotLib[0xc933787210650b6a] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_AotCMRES<&_FuncbuiltinTickget_command_line_argumentsTick14327939727965569528_ac834a7fbcde97f3>>();
    };
    aotLib[0x72b3f4d61785b10a] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncbuiltinTickintptrTick11320822648609276562_8c85e7dff751212>>();
    };
    aotLib[0x23b9a0690be8e4b1] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_AotCMRES<&_FuncbuiltinTickvaluesTick1935193042646774172_32cd4ef14d502aa8>>();
    };
    aotLib[0xeb63f8b098901fee] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncbuiltinTickpushTick10769833213962245646_e6ba59383edc565d>>();
    };
    aotLib[0xf2469be6e4494065] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncbuiltinTickbackTick18296309835877697278_3b40803e261b168b>>();
    };
    aotLib[0xef5832d7da711d2f] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncbuiltinTickpopTick1161079256290593740_bbece6ed9c77046c>>();
    };
    aotLib[0x60c16d74f1de19f1] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&finalize_1d6fbca1e949373b>>();
    };
    aotLib[0x6e0f6e26ccb44290] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&finalize_9e167f5d77b26095>>();
    };
    aotLib[0x477bbb85cd97c41e] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncdebugapiTickinstall_new_thread_local_debug_agentTick15124441463860820031_f22238c2acb8f53a>>();
    };
    aotLib[0xce8905138f7825a5] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&set_enable_profiler_1fb51d4dfe399b06>>();
    };
    aotLib[0xfd0b0fb37c3c3178] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncProfilerDebugAgentTickdependency_2e38601952f42fa2>>();
    };
    aotLib[0xb33110b69950ed21] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncProfilerDebugAgentTickis_time_unit_correct_fab989a1861d3b1>>();
    };
    aotLib[0xca790c51988a4249] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncProfilerDebugAgentTickconvert_ns_to_unit_d7917a1786066152>>();
    };
    aotLib[0xe000b64fc73dda43] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncProfilerDebugAgentTickonInstall_57049db1d4217d7a>>();
    };
    aotLib[0x4a4289212163a022] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncProfilerDebugAgentTickonUninstall_57049db1d4217d7a>>();
    };
    aotLib[0xc30992e047e08fee] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncProfilerDebugAgentTickisProfileable_482e69b251f0de1d>>();
    };
    aotLib[0x701c100bd4d1a6a1] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncProfilerDebugAgentTickonCreateContext_71c97ce0570194ae>>();
    };
    aotLib[0xd473cf1f049c7e38] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncProfilerDebugAgentTickenable_profiler_6e062781f165864b>>();
    };
    aotLib[0x5e17cebbebb3bf0b] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncProfilerDebugAgentTickonDestroyContext_71c97ce0570194ae>>();
    };
    aotLib[0x87b4a15a14605f5f] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncProfilerDebugAgentTickonInstrumentFunctionWithMemory_ce0e0f34c7ebe105>>();
    };
    aotLib[0x87b4a15a14605f5f] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncProfilerDebugAgentTickonInstrumentFunction_ce0e0f34c7ebe105>>();
    };
    aotLib[0x52078b828eefdf39] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncProfilerDebugAgentTickdump_f967d4c425c2d2b6>>();
    };
    aotLib[0x52078b828eefdf39] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncProfilerDebugAgentTickwrite_f967d4c425c2d2b6>>();
    };
    aotLib[0xa7e938893f84ad1b] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncProfilerDebugAgentTickdump_event_a1415c332cd3a2e8>>();
    };
    aotLib[0x3ef23f3011921aff] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncProfilerDebugAgentTickdump_node_5564b1a08048649a>>();
    };
    aotLib[0x2a4078488245a5c6] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncProfilerDebugAgentTickdump_context_stack_2e5a65fdc0508d94>>();
    };
    aotLib[0x91140a2b1b16d405] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncProfilerDebugAgentTickdump_meta_2fe36a71df996f32>>();
    };
    aotLib[0x82d7cba0da9818ec] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncProfilerDebugAgentTickdump_events_2e5a65fdc0508d94>>();
    };
    aotLib[0xdf54d60d23b53380] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncProfilerDebugAgentTickdump_context_2fe36a71df996f32>>();
    };
    aotLib[0x180396339a0ea73d] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncProfilerDebugAgent_0x27___finalize_654360e8c20a8414>>();
    };
    aotLib[0xeb967e44c8a42d7b] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&debug_agent_8ae6632f339fc097>>();
    };
    aotLib[0x4ead373d747bed56] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_AotCMRES<&ProfilerDebugAgent_35e3ca121f3f1290>>();
    };
    aotLib[0xe906353d597919a3] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_AotCMRES<&_FuncbuiltinTickto_table_moveTick5858896087460481804_d77906b4b315fd45>>();
    };
    // [[ init script ]]
