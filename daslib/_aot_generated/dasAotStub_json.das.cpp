...
inline bool _FuncbuiltinTicknextTick17450348357676149856_ba3f4a54e51a0d57 ( Context * __context__, Sequence DAS_COMMENT((int32_t)) & __it_rename_at_1223_4, int32_t & __value_rename_at_1223_5 );
...
inline bool _FuncbuiltinTicknextTick17450348357676149856_1b3ef80a3dcc04cd ( Context * __context__, Sequence DAS_COMMENT((json::TokenAt)) & __it_rename_at_1223_13, json::TokenAt & __value_rename_at_1223_14 );
...
inline bool _FuncbuiltinTickkey_existsTick16808803843923989214_963e1e05a7a36522 ( Context * __context__, TTable<char *,json::JsonValue *> const  & __Tab_rename_at_1014_17, char * const  __at_rename_at_1014_18 );
...
inline bool _FuncbuiltinTicknextTick17450348357676149856_ba3f4a54e51a0d57 ( Context * __context__, Sequence DAS_COMMENT((int32_t)) &  __it_rename_at_1223_4, int32_t & __value_rename_at_1223_5 )
{
    return das_auto_cast<bool>::cast(builtin_iterator_iterate(das_arg<Sequence DAS_COMMENT((int32_t))>::pass(__it_rename_at_1223_4),das_auto_cast<void * const >::cast(das_ref(__context__,__value_rename_at_1223_5)),__context__));
}
...
inline bool _FuncbuiltinTicknextTick17450348357676149856_1b3ef80a3dcc04cd ( Context * __context__, Sequence DAS_COMMENT((json::TokenAt)) &  __it_rename_at_1223_13, json::TokenAt &  __value_rename_at_1223_14 )
{
    return das_auto_cast<bool>::cast(builtin_iterator_iterate(das_arg<Sequence DAS_COMMENT((json::TokenAt))>::pass(__it_rename_at_1223_13),das_auto_cast<void * const >::cast(das_ref(__context__,__value_rename_at_1223_14)),__context__));
}
...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    ...
    aotLib[0x7fa3294d3c5e8e91] = +[](Context & ctx) -> SimNode* { // _Func_lambda_json_99_1Tickfunction_68f4b5ef1fe57bcb
        return ctx.code->makeNode<SimNode_Aot<bool (*) ( Context * __context__, json::_lambda_json_99_1 & , json::TokenAt &  ),&_Func_lambda_json_99_1Tickfunction_68f4b5ef1fe57bcb>>();
    };
    ...
    aotLib[0x18d007417d793e4c] = +[](Context & ctx) -> SimNode* { // JV_ce211d1e71008fa9
        return ctx.code->makeNode<SimNode_Aot<json::JsonValue * (*) ( Context * __context__, char * const   ),&JV_ce211d1e71008fa9>>();
    };
    aotLib[0x139c1d56191f1ac] = +[](Context & ctx) -> SimNode* { // JV_43c82a6d7fd1ff94
        return ctx.code->makeNode<SimNode_Aot<json::JsonValue * (*) ( Context * __context__, double  ),&JV_43c82a6d7fd1ff94>>();
    };
    aotLib[0x4e0c157e87d12c39] = +[](Context & ctx) -> SimNode* { // JV_3089bab5056075c5
        return ctx.code->makeNode<SimNode_Aot<json::JsonValue * (*) ( Context * __context__, bool  ),&JV_3089bab5056075c5>>();
    };
    aotLib[0x8b3ae76e1fdfcd2a] = +[](Context & ctx) -> SimNode* { // JVNull_3f0f085424b7fe8
        return ctx.code->makeNode<SimNode_Aot<json::JsonValue * (*) ( Context * __context__ ),&JVNull_3f0f085424b7fe8>>();
    };
    aotLib[0xe8ce6088f32f0d16] = +[](Context & ctx) -> SimNode* { // JV_6901630789757c95
        return ctx.code->makeNode<SimNode_Aot<json::JsonValue * (*) ( Context * __context__, TTable<char *,json::JsonValue *> &  ),&JV_6901630789757c95>>();
    };
    aotLib[0x6466ee36f75495d3] = +[](Context & ctx) -> SimNode* { // JV_6c9dca23db320dde
        return ctx.code->makeNode<SimNode_Aot<json::JsonValue * (*) ( Context * __context__, TArray<json::JsonValue *> &  ),&JV_6c9dca23db320dde>>();
    };
    aotLib[0xac41379e52273f7b] = +[](Context & ctx) -> SimNode* { // lexer_2df326c8b334fd59
    ...
    aotLib[0xa5ed318ebd5141f9] = +[](Context & ctx) -> SimNode* { // lexer_aac99b31b3891faa
    ...
    aotLib[0xb96eaee5f5d14a85] = +[](Context & ctx) -> SimNode* { // _lexer_a791902f9ba041bc
    ...
    aotLib[0x44e2593187450abc] = +[](Context & ctx) -> SimNode* { // parse_value_98ae1ad97bf60f4e
    ...
    aotLib[0x991773493b8221c] = +[](Context & ctx) -> SimNode* { // read_json_6774330ff8c847be
        return ctx.code->makeNode<SimNode_Aot<json::JsonValue * (*) ( Context * __context__, char * const  , char * &  ),&read_json_6774330ff8c847be>>();
    };
    aotLib[0x134e4e8655b3b71a] = +[](Context & ctx) -> SimNode* { // read_json_2d3b7389aacf6c4e
    ...
    aotLib[0xd0ecb0a00f735caf] = +[](Context & ctx) -> SimNode* { // try_fixing_broken_json_775d055e7662f545
        return ctx.code->makeNode<SimNode_Aot<char * (*) ( Context * __context__, char *  ),&try_fixing_broken_json_775d055e7662f545>>();
    };
    // [[ init script ]]
