...
inline void finalize_bda5ea234ce3ad8c ( Context * __context__, json::_lambda_json_99_1 & ____this_rename_at_99_1 );
inline Sequence DAS_COMMENT((json::TokenAt)) _FuncbuiltinTickeachTick9663565701927713696_9ce2a5e86273e194 ( Context * __context__, Lambda DAS_COMMENT((bool,json::TokenAt)) const  __lam_rename_at_1322_2 );
inline bool _FuncbuiltinTicknextTick17450348357676149856_6751f3fd7b34b9e ( Context * __context__, Sequence DAS_COMMENT((int32_t)) & __it_rename_at_1256_4, int32_t & __value_rename_at_1256_5 );
inline Sequence DAS_COMMENT((int32_t)) _FuncbuiltinTickeachTick4044332007967089362_96a71d72011909f8 ( Context * __context__, char * const  __str_rename_at_1289_6 );
inline void _FuncbuiltinTickpushTick14133213201864676143_d8f0a51920afdbe4 ( Context * __context__, TArray<uint8_t> & __Arr_rename_at_165_8, uint8_t __value_rename_at_165_9 );
inline bool _Func_lambda_json_99_1Tickfunction_27d560477f29a0c4 ( Context * __context__, json::_lambda_json_99_1 & ____this_rename_at_99_10, json::TokenAt & ___yield_99_rename_at_99_11 );
inline void _Func_lambda_json_99_1Tickfinalizer_2e4d67628ff73926 ( Context * __context__, json::_lambda_json_99_1 * ____this_rename_at_99_12 );
inline bool _FuncbuiltinTicknextTick17450348357676149856_686917353b494c90 ( Context * __context__, Sequence DAS_COMMENT((json::TokenAt)) & __it_rename_at_1256_13, json::TokenAt & __value_rename_at_1256_14 );
inline void _FuncbuiltinTickpushTick10769833213962245646_5c4aa59ea5c32b48 ( Context * __context__, TArray<json::JsonValue *> & __Arr_rename_at_181_15, json::JsonValue * __value_rename_at_181_16 );
inline bool _FuncbuiltinTickkey_existsTick16808803843923989214_51185dc1b63313f8 ( Context * __context__, TTable<char *,json::JsonValue *> const  & __Tab_rename_at_1047_17, char * const  __at_rename_at_1047_18 );
inline void _FuncbuiltinTickinsertTick4246857231018487965_52e5e5baef8a8ea5 ( Context * __context__, TTable<char *,json::JsonValue *> & __Tab_rename_at_939_19, char * const  __at_rename_at_939_20, json::JsonValue * __val_rename_at_939_21 );
inline Sequence DAS_COMMENT((char *)) _FuncbuiltinTickkeysTick2205854368403803976_b6a8552be4d86f3b ( Context * __context__, TTable<char *,json::JsonValue *> const  & __a_rename_at_1161_22 );
inline Sequence DAS_COMMENT((json::JsonValue * &)) _FuncbuiltinTickvaluesTick1935193042646774172_b355b361a7492b46 ( Context * __context__, TTable<char *,json::JsonValue *> const  & __a_rename_at_1176_24 );
inline json::JsonValue * JV_b2228ffdb8e8ec21 ( Context * __context__, char * const  __v_rename_at_48_26 );
inline json::JsonValue * JV_8cb09cc91a575635 ( Context * __context__, double __v_rename_at_53_27 );
inline json::JsonValue * JV_a4a41970208d5958 ( Context * __context__, bool __v_rename_at_57_28 );
inline json::JsonValue * JVNull_7d0b1e47ab78fd43 ( Context * __context__ );
inline json::JsonValue * JV_344af34dfc7c93a2 ( Context * __context__, TTable<char *,json::JsonValue *> & __v_rename_at_66_29 );
inline json::JsonValue * JV_6d16e2b9179b5882 ( Context * __context__, TArray<json::JsonValue *> & __v_rename_at_70_30 );
inline Sequence DAS_COMMENT((json::TokenAt)) lexer_114980da761d5cb9 ( Context * __context__, char * const  __text_rename_at_74_31 );
inline Sequence DAS_COMMENT((json::TokenAt)) lexer_9bce7d3666c86fc2 ( Context * __context__, TArray<uint8_t> const  & __text_rename_at_79_33 );
inline bool next_51dcdca9b655516f ( Context * __context__, Sequence DAS_COMMENT((int32_t)) & __text_rename_at_84_35, int32_t & __character_rename_at_84_36, int32_t & __line_rename_at_84_37, int32_t & __row_rename_at_84_38 );
inline Sequence DAS_COMMENT((json::TokenAt)) _lexer_4291d050e86065c4 ( Context * __context__, char * __stext_rename_at_98_39 );
inline bool expect_token_6becf9158efbcd1c ( Context * __context__, Sequence DAS_COMMENT((json::TokenAt)) & __itv_rename_at_219_40, json::TokenAt & __ahead_rename_at_219_41, int32_t __vindex_rename_at_219_42, char * & __error_rename_at_219_43 );
inline bool expect_symbol_6becf9158efbcd1c ( Context * __context__, Sequence DAS_COMMENT((json::TokenAt)) & __itv_rename_at_231_44, json::TokenAt & __ahead_rename_at_231_45, int32_t __sym_rename_at_231_46, char * & __error_rename_at_231_47 );
inline json::JsonValue * parse_value_7bbd2fedbd3ae536 ( Context * __context__, Sequence DAS_COMMENT((json::TokenAt)) & __itv_rename_at_246_48, char * & __error_rename_at_246_49 );
inline json::JsonValue * read_json_7ac2768f720418f1 ( Context * __context__, char * const  __text_rename_at_342_59, char * & __error_rename_at_342_60 );
inline json::JsonValue * read_json_8d363565d571a8f ( Context * __context__, TArray<uint8_t> const  & __text_rename_at_352_63, char * & __error_rename_at_352_64 );
inline bool set_no_trailing_zeros_2474436cde185d41 ( Context * __context__, bool __value_rename_at_362_67 );
inline bool set_no_empty_arrays_2474436cde185d41 ( Context * __context__, bool __value_rename_at_371_69 );
inline bool set_allow_duplicate_keys_2474436cde185d41 ( Context * __context__, bool __value_rename_at_380_71 );
inline void write_value_f2bc0a23fa15bbe0 ( Context * __context__, StringBuilderWriter & __writer_rename_at_388_73, json::JsonValue * const  __jsv_rename_at_388_74, int32_t __depth_rename_at_388_75 );
inline char * write_json_34022532ff2e1f41 ( Context * __context__, json::JsonValue * const  __val_rename_at_462_83 );
inline char * write_json_e9b0aebc7e210d59 ( Context * __context__, json::JsonValue * const  __val_rename_at_470_86 );
inline char * try_fixing_broken_json_9db34ecdbaf08fe5 ( Context * __context__, char * __bad_rename_at_477_87 );
...
inline void finalize_bda5ea234ce3ad8c ( Context * __context__, json::_lambda_json_99_1 &  ____this_rename_at_99_1 )
{
    ...
    _FuncbuiltinTickfinalizeTick13836114024949725080_8dc91cad3b75b3c8(__context__,das_arg<TArray<uint8_t>>::pass(____this_rename_at_99_1.str));
...
inline bool _Func_lambda_json_99_1Tickfunction_27d560477f29a0c4 ( Context * __context__, json::_lambda_json_99_1 &  ____this_rename_at_99_10, json::TokenAt &  ___yield_99_rename_at_99_11 )
{
    ...
    das_move(____this_rename_at_99_10.tin,_FuncbuiltinTickeachTick4044332007967089362_96a71d72011909f8(__context__,____this_rename_at_99_10.stext));
    ...
    while ( is_white_space(____this_rename_at_99_10.ahead) && next_51dcdca9b655516f(__context__,das_arg<Sequence DAS_COMMENT((int32_t))>::pass(____this_rename_at_99_10.tin),____this_rename_at_99_10.ahead,____this_rename_at_99_10.line,____this_rename_at_99_10.row) )
    {
    };
    if ( builtin_iterator_empty(das_arg<Sequence DAS_COMMENT((int32_t))>::pass(____this_rename_at_99_10.tin)) )
    {
    ...
    label_1:;;
    _FuncbuiltinTicknextTick17450348357676149856_6751f3fd7b34b9e(__context__,das_arg<Sequence DAS_COMMENT((int32_t))>::pass(____this_rename_at_99_10.tin),____this_rename_at_99_10.ahead);
    goto label_33;
    label_32:;;
    ...
    label_7:;;
    if ( !(next_51dcdca9b655516f(__context__,das_arg<Sequence DAS_COMMENT((int32_t))>::pass(____this_rename_at_99_10.tin),____this_rename_at_99_10.ahead,____this_rename_at_99_10.line,____this_rename_at_99_10.row) && (____this_rename_at_99_10.ahead != 34)) )
    {
        goto label_8;
    };
    ...
    if ( !next_51dcdca9b655516f(__context__,das_arg<Sequence DAS_COMMENT((int32_t))>::pass(____this_rename_at_99_10.tin),____this_rename_at_99_10.ahead,____this_rename_at_99_10.line,____this_rename_at_99_10.row) )
    {
        goto label_3;
    };
    ...
    _FuncbuiltinTickpushTick14133213201864676143_d8f0a51920afdbe4(__context__,das_arg<TArray<uint8_t>>::pass(____this_rename_at_99_10.str),uint8_t(____this_rename_at_99_10.ahead));
    goto label_4;
    label_3:;;
    das_copy(___yield_99_rename_at_99_11,(([&]() -> json::TokenAt {
    ...
    while ( next_51dcdca9b655516f(__context__,das_arg<Sequence DAS_COMMENT((int32_t))>::pass(____this_rename_at_99_10.tin),____this_rename_at_99_10.ahead,____this_rename_at_99_10.line,____this_rename_at_99_10.row) && is_number(____this_rename_at_99_10.ahead) )
    {
        _FuncbuiltinTickpushTick14133213201864676143_d8f0a51920afdbe4(__context__,das_arg<TArray<uint8_t>>::pass(____this_rename_at_99_10.str),uint8_t(____this_rename_at_99_10.ahead));
    ...
    {
        _FuncbuiltinTickpushTick14133213201864676143_d8f0a51920afdbe4(__context__,das_arg<TArray<uint8_t>>::pass(____this_rename_at_99_10.str),uint8_t(____this_rename_at_99_10.ahead));
        next_51dcdca9b655516f(__context__,das_arg<Sequence DAS_COMMENT((int32_t))>::pass(____this_rename_at_99_10.tin),____this_rename_at_99_10.ahead,____this_rename_at_99_10.line,____this_rename_at_99_10.row);
        if ( ((____this_rename_at_99_10.ahead == 43) || (____this_rename_at_99_10.ahead == 45)) || is_number(____this_rename_at_99_10.ahead) )
        {
            _FuncbuiltinTickpushTick14133213201864676143_d8f0a51920afdbe4(__context__,das_arg<TArray<uint8_t>>::pass(____this_rename_at_99_10.str),uint8_t(____this_rename_at_99_10.ahead));
        };
    ...
    _FuncbuiltinTickpushTick14133213201864676143_d8f0a51920afdbe4(__context__,das_arg<TArray<uint8_t>>::pass(____this_rename_at_99_10.str),uint8_t(____this_rename_at_99_10.ahead));
    while ( next_51dcdca9b655516f(__context__,das_arg<Sequence DAS_COMMENT((int32_t))>::pass(____this_rename_at_99_10.tin),____this_rename_at_99_10.ahead,____this_rename_at_99_10.line,____this_rename_at_99_10.row) && is_alpha(____this_rename_at_99_10.ahead) )
    {
        _FuncbuiltinTickpushTick14133213201864676143_d8f0a51920afdbe4(__context__,das_arg<TArray<uint8_t>>::pass(____this_rename_at_99_10.str),uint8_t(____this_rename_at_99_10.ahead));
    };
...
inline void _Func_lambda_json_99_1Tickfinalizer_2e4d67628ff73926 ( Context * __context__, json::_lambda_json_99_1 * ____this_rename_at_99_12 )
{
    ...
    finalize_bda5ea234ce3ad8c(__context__,das_arg<json::_lambda_json_99_1>::pass(das_deref(__context__,____this_rename_at_99_12)));
...
inline Sequence DAS_COMMENT((json::TokenAt)) lexer_114980da761d5cb9 ( Context * __context__, char * const  __text_rename_at_74_31 )
{
    ...
    return /* <- */ das_auto_cast_move<Sequence DAS_COMMENT((json::TokenAt))>::cast(_lexer_4291d050e86065c4(__context__,__stext_rename_at_75_32));
}
...
inline Sequence DAS_COMMENT((json::TokenAt)) lexer_9bce7d3666c86fc2 ( Context * __context__, TArray<uint8_t> const  &  __text_rename_at_79_33 )
{
    ...
    return /* <- */ das_auto_cast_move<Sequence DAS_COMMENT((json::TokenAt))>::cast(_lexer_4291d050e86065c4(__context__,__stext_rename_at_80_34));
}

inline bool next_51dcdca9b655516f ( Context * __context__, Sequence DAS_COMMENT((int32_t)) &  __text_rename_at_84_35, int32_t & __character_rename_at_84_36, int32_t & __line_rename_at_84_37, int32_t & __row_rename_at_84_38 )
{
    if ( _FuncbuiltinTicknextTick17450348357676149856_6751f3fd7b34b9e(__context__,das_arg<Sequence DAS_COMMENT((int32_t))>::pass(__text_rename_at_84_35),__character_rename_at_84_36) )
    {
...
inline Sequence DAS_COMMENT((json::TokenAt)) _lexer_4291d050e86065c4 ( Context * __context__, char * __stext_rename_at_98_39 )
{
    return /* <- */ das_auto_cast_move<Sequence DAS_COMMENT((json::TokenAt))>::cast(_FuncbuiltinTickeachTick9663565701927713696_9ce2a5e86273e194(__context__,das_ascend<bool,json::_lambda_json_99_1>::make(__context__,&__type_info__2a52f700eb676896,(([&]() -> json::_lambda_json_99_1 {
...
inline bool expect_token_6becf9158efbcd1c ( Context * __context__, Sequence DAS_COMMENT((json::TokenAt)) &  __itv_rename_at_219_40, json::TokenAt &  __ahead_rename_at_219_41, int32_t __vindex_rename_at_219_42, char * & __error_rename_at_219_43 )
{
    if ( !_FuncbuiltinTicknextTick17450348357676149856_686917353b494c90(__context__,das_arg<Sequence DAS_COMMENT((json::TokenAt))>::pass(__itv_rename_at_219_40),das_arg<json::TokenAt>::pass(__ahead_rename_at_219_41)) )
    {
...
inline bool expect_symbol_6becf9158efbcd1c ( Context * __context__, Sequence DAS_COMMENT((json::TokenAt)) &  __itv_rename_at_231_44, json::TokenAt &  __ahead_rename_at_231_45, int32_t __sym_rename_at_231_46, char * & __error_rename_at_231_47 )
{
    if ( !_FuncbuiltinTicknextTick17450348357676149856_686917353b494c90(__context__,das_arg<Sequence DAS_COMMENT((json::TokenAt))>::pass(__itv_rename_at_231_44),das_arg<json::TokenAt>::pass(__ahead_rename_at_231_45)) )
    {
...
inline json::JsonValue * parse_value_7bbd2fedbd3ae536 ( Context * __context__, Sequence DAS_COMMENT((json::TokenAt)) &  __itv_rename_at_246_48, char * & __error_rename_at_246_49 )
{
    ...
    if ( !_FuncbuiltinTicknextTick17450348357676149856_686917353b494c90(__context__,das_arg<Sequence DAS_COMMENT((json::TokenAt))>::pass(__itv_rename_at_246_48),das_arg<json::TokenAt>::pass(__ahead_rename_at_247_50)) )
    {
        ...
        if ( das_get_auto_variant_field<int32_t,4,char *,double,bool,void *,int32_t,char *>::is(__ahead_rename_at_247_50.value) )
        {
            ...
            if ( __sym_rename_at_252_51 == 93 )
            {
                ...
                if ( __sym_rename_at_252_51 == 91 )
                {
                    ...
                    {
                        json::JsonValue * __value_rename_at_260_53 = parse_value_7bbd2fedbd3ae536(__context__,das_arg<Sequence DAS_COMMENT((json::TokenAt))>::pass(__itv_rename_at_246_48),__error_rename_at_246_49);
                        if ( __value_rename_at_260_53 == nullptr )
                        {
                            if ( builtin_string_startswith(__error_rename_at_246_49,((char *) "unexpected ]"),__context__) && (builtin_array_size(das_arg<TArray<json::JsonValue *>>::pass(__arr_rename_at_258_52)) == 0) )
                            {
                                ...
                                return das_auto_cast<json::JsonValue *>::cast(JV_6d16e2b9179b5882(__context__,das_arg<TArray<json::JsonValue *>>::pass(__arr_rename_at_258_52)));
                            } else {
                                return das_auto_cast<json::JsonValue *>::cast(nullptr);
                            };
                        };
                        _FuncbuiltinTickpushTick10769833213962245646_5c4aa59ea5c32b48(__context__,das_arg<TArray<json::JsonValue *>>::pass(__arr_rename_at_258_52),__value_rename_at_260_53);
                        if ( !expect_token_6becf9158efbcd1c(__context__,das_arg<Sequence DAS_COMMENT((json::TokenAt))>::pass(__itv_rename_at_246_48),das_arg<json::TokenAt>::pass(__ahead_rename_at_247_50),4,__error_rename_at_246_49) )
                        {
                            return das_auto_cast<json::JsonValue *>::cast(nullptr);
                        } else {
                ...
                } else if ( __sym_rename_at_252_51 == 123 )
                {
                    ...
                    while ( !builtin_iterator_empty(das_arg<Sequence DAS_COMMENT((json::TokenAt))>::pass(__itv_rename_at_246_48)) )
                    {
                        if ( !expect_token_6becf9158efbcd1c(__context__,das_arg<Sequence DAS_COMMENT((json::TokenAt))>::pass(__itv_rename_at_246_48),das_arg<json::TokenAt>::pass(__ahead_rename_at_247_50),0,__error_rename_at_246_49) )
                        {
                            ...
                            {
                                das_copy(__error_rename_at_246_49,nullptr);
                                return das_auto_cast<json::JsonValue *>::cast(JV_344af34dfc7c93a2(__context__,das_arg<TTable<char *,json::JsonValue *>>::pass(__tab_rename_at_286_55)));
                            } else {
                                return das_auto_cast<json::JsonValue *>::cast(nullptr);
                            };
                        };
                        ...
                        if ( !expect_symbol_6becf9158efbcd1c(__context__,das_arg<Sequence DAS_COMMENT((json::TokenAt))>::pass(__itv_rename_at_246_48),das_arg<json::TokenAt>::pass(__ahead_rename_at_247_50),58,__error_rename_at_246_49) )
                        {
                            return das_auto_cast<json::JsonValue *>::cast(nullptr);
                        } else {
                            json::JsonValue * __value_rename_at_299_57 = parse_value_7bbd2fedbd3ae536(__context__,das_arg<Sequence DAS_COMMENT((json::TokenAt))>::pass(__itv_rename_at_246_48),__error_rename_at_246_49);
                            if ( __value_rename_at_299_57 == nullptr )
                            {
                                return das_auto_cast<json::JsonValue *>::cast(nullptr);
                            } else {
                                if ( !das_global<bool,0x30e401a8d3210d31>(__context__) /*allow_duplicate_keys*/ && _FuncbuiltinTickkey_existsTick16808803843923989214_51185dc1b63313f8(__context__,das_arg<TTable<char *,json::JsonValue *>>::pass(__tab_rename_at_286_55),__key_rename_at_295_56) )
                                {
                                    ...
                                    _FuncbuiltinTickinsertTick4246857231018487965_52e5e5baef8a8ea5(__context__,das_arg<TTable<char *,json::JsonValue *>>::pass(__tab_rename_at_286_55),__key_rename_at_295_56,__value_rename_at_299_57);
                                    if ( !expect_token_6becf9158efbcd1c(__context__,das_arg<Sequence DAS_COMMENT((json::TokenAt))>::pass(__itv_rename_at_246_48),das_arg<json::TokenAt>::pass(__ahead_rename_at_247_50),4,__error_rename_at_246_49) )
                                    {
                                        return das_auto_cast<json::JsonValue *>::cast(nullptr);
                                    } else {
        ...
        {
            return das_auto_cast<json::JsonValue *>::cast(JV_b2228ffdb8e8ec21(__context__,das_get_auto_variant_field<char *,0,char *,double,bool,void *,int32_t,char *>::as(__ahead_rename_at_247_50.value,__context__)));
        } else if ( das_get_auto_variant_field<double,1,char *,double,bool,void *,int32_t,char *>::is(__ahead_rename_at_247_50.value) )
        {
            return das_auto_cast<json::JsonValue *>::cast(JV_8cb09cc91a575635(__context__,das_get_auto_variant_field<double,1,char *,double,bool,void *,int32_t,char *>::as(__ahead_rename_at_247_50.value,__context__)));
        } else if ( das_get_auto_variant_field<bool,2,char *,double,bool,void *,int32_t,char *>::is(__ahead_rename_at_247_50.value) )
        {
            return das_auto_cast<json::JsonValue *>::cast(JV_a4a41970208d5958(__context__,das_get_auto_variant_field<bool,2,char *,double,bool,void *,int32_t,char *>::as(__ahead_rename_at_247_50.value,__context__)));
        } else if ( das_get_auto_variant_field<void *,3,char *,double,bool,void *,int32_t,char *>::is(__ahead_rename_at_247_50.value) )
        {
            return das_auto_cast<json::JsonValue *>::cast(JVNull_7d0b1e47ab78fd43(__context__));
        } else {
...
inline json::JsonValue * read_json_7ac2768f720418f1 ( Context * __context__, char * const  __text_rename_at_342_59, char * & __error_rename_at_342_60 )
{
    ...
    Sequence DAS_COMMENT((json::TokenAt)) __lex_rename_at_346_61; das_zero(__lex_rename_at_346_61); das_move(__lex_rename_at_346_61, lexer_114980da761d5cb9(__context__,__text_rename_at_342_59));
    json::JsonValue * __res_rename_at_347_62 = parse_value_7bbd2fedbd3ae536(__context__,das_arg<Sequence DAS_COMMENT((json::TokenAt))>::pass(__lex_rename_at_346_61),__error_rename_at_342_60);
...
inline json::JsonValue * read_json_8d363565d571a8f ( Context * __context__, TArray<uint8_t> const  &  __text_rename_at_352_63, char * & __error_rename_at_352_64 )
{
    ...
    Sequence DAS_COMMENT((json::TokenAt)) __lex_rename_at_354_65; das_zero(__lex_rename_at_354_65); das_move(__lex_rename_at_354_65, lexer_9bce7d3666c86fc2(__context__,__text_rename_at_352_63));
    json::JsonValue * __res_rename_at_355_66 = parse_value_7bbd2fedbd3ae536(__context__,das_arg<Sequence DAS_COMMENT((json::TokenAt))>::pass(__lex_rename_at_354_65),__error_rename_at_352_64);
        ...
        if ( builtin_array_size(das_get_auto_variant_field<TArray<json::JsonValue *>,1,TTable<char *,json::JsonValue *>,TArray<json::JsonValue *>,char *,double,bool,void *>::as(__jsv_rename_at_388_74->value,__context__)) == 0 )
        {
            ...
            bool __first_rename_at_406_76 = true;
            {
                ...
                for ( ; __need_loop_407 ; __need_loop_407 = __elem_iterator.next(__context__,(__elem_rename_at_407_77)) )
                {
                    ...
                    write_value_f2bc0a23fa15bbe0(__context__,das_arg<StringBuilderWriter>::pass(__writer_rename_at_388_73),(*__elem_rename_at_407_77),__depth_rename_at_388_75 + 1);
                }
    ...
    } else if ( das_get_auto_variant_field<TTable<char *,json::JsonValue *>,0,TTable<char *,json::JsonValue *>,TArray<json::JsonValue *>,char *,double,bool,void *>::is(__jsv_rename_at_388_74->value) )
    {
        if ( builtin_table_size(das_get_auto_variant_field<TTable<char *,json::JsonValue *>,0,TTable<char *,json::JsonValue *>,TArray<json::JsonValue *>,char *,double,bool,void *>::as(__jsv_rename_at_388_74->value,__context__)) == 0 )
        {
            ...
            bool __first_rename_at_425_78 = true;
            {
                ...
                // elemK: string
                das_iterator<Sequence DAS_COMMENT((char *))> __elemK_iterator((_temp_make_local_426_33_80 = (_FuncbuiltinTickkeysTick2205854368403803976_b6a8552be4d86f3b(__context__,das_get_auto_variant_field<TTable<char *,json::JsonValue *>,0,TTable<char *,json::JsonValue *>,TArray<json::JsonValue *>,char *,double,bool,void *>::as(__jsv_rename_at_388_74->value,__context__)))));
                ...
                for ( ; __need_loop_426 ; __need_loop_426 = __elemK_iterator.next(__context__,(__elemK_rename_at_426_81)) && __elemV_iterator.next(__context__,(__elemV_rename_at_426_82)) )
                {
                    ...
                    write_value_f2bc0a23fa15bbe0(__context__,das_arg<StringBuilderWriter>::pass(__writer_rename_at_388_73),(*__elemV_rename_at_426_82),__depth_rename_at_388_75 + 1);
                }
...
inline char * write_json_34022532ff2e1f41 ( Context * __context__, json::JsonValue * const  __val_rename_at_462_83 )
{
    char * __st_rename_at_464_84 = ((char *)(char *)(((char * const )(builtin_build_string_T([&](StringBuilderWriter & __writer_rename_at_464_85) DAS_AOT_INLINE_LAMBDA -> void{
        write_value_f2bc0a23fa15bbe0(__context__,das_arg<StringBuilderWriter>::pass(__writer_rename_at_464_85),__val_rename_at_462_83,0);
...
inline char * write_json_e9b0aebc7e210d59 ( Context * __context__, json::JsonValue * const  __val_rename_at_470_86 )
{
    return das_auto_cast<char *>::cast(write_json_34022532ff2e1f41(__context__,das_cast<json::JsonValue *>::cast(__val_rename_at_470_86)));
}

inline char * try_fixing_broken_json_9db34ecdbaf08fe5 ( Context * __context__, char * __bad_rename_at_477_87 ) { das_stack_prologue __prologue(__context__,272,"try_fixing_broken_json " DAS_FILE_LINE);
{
...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    ...
    aotLib[0xa46ab7a07a743f1c] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&finalize_bda5ea234ce3ad8c>>();
    };
    aotLib[0xede798fd8f468e26] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_AotCMRES<&_FuncbuiltinTickeachTick9663565701927713696_9ce2a5e86273e194>>();
    };
    ...
    aotLib[0x4cb144e39a5b0296] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_Func_lambda_json_99_1Tickfunction_27d560477f29a0c4>>();
    };
    aotLib[0x4c7132fa0dc457a8] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_Func_lambda_json_99_1Tickfinalizer_2e4d67628ff73926>>();
    };
    aotLib[0x128a72e95b057588] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncbuiltinTicknextTick17450348357676149856_686917353b494c90>>();
    };
    aotLib[0x2e3dc1144d05127] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncbuiltinTickpushTick10769833213962245646_5c4aa59ea5c32b48>>();
    };
    ...
    aotLib[0x4acdd78b465ce69b] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncbuiltinTickinsertTick4246857231018487965_52e5e5baef8a8ea5>>();
    };
    aotLib[0xac7da30f826a907e] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_AotCMRES<&_FuncbuiltinTickkeysTick2205854368403803976_b6a8552be4d86f3b>>();
    };
    aotLib[0x90c7a616c52f6ed8] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_AotCMRES<&_FuncbuiltinTickvaluesTick1935193042646774172_b355b361a7492b46>>();
    };
    aotLib[0x18d3ef5b2e3f6666] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&JV_b2228ffdb8e8ec21>>();
    };
    aotLib[0x34ec74566b76bd5e] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&JV_8cb09cc91a575635>>();
    };
    aotLib[0x430bb1b0a939520e] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&JV_a4a41970208d5958>>();
    };
    aotLib[0x5dd11834cd20b61e] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&JVNull_7d0b1e47ab78fd43>>();
    };
    aotLib[0xa3dd5a175d8f6c76] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&JV_344af34dfc7c93a2>>();
    };
    aotLib[0x23b15b034b1b0d08] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&JV_6d16e2b9179b5882>>();
    };
    aotLib[0x937d8781be1ef4a1] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_AotCMRES<&lexer_114980da761d5cb9>>();
    };
    aotLib[0x39c31cec95b156d7] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_AotCMRES<&lexer_9bce7d3666c86fc2>>();
    };
    aotLib[0x4cc01ce64e0d2430] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&next_51dcdca9b655516f>>();
    };
    aotLib[0x8f91d12922ab55fa] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_AotCMRES<&_lexer_4291d050e86065c4>>();
    };
    aotLib[0x164571a65de36fa9] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&expect_token_6becf9158efbcd1c>>();
    };
    aotLib[0x164571a65de36fa9] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&expect_symbol_6becf9158efbcd1c>>();
    };
    aotLib[0x24732871b1c2458f] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&parse_value_7bbd2fedbd3ae536>>();
    };
    aotLib[0xd00032a61a8f99e3] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&read_json_7ac2768f720418f1>>();
    };
    aotLib[0xf5e7d500622b3e94] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&read_json_8d363565d571a8f>>();
    };
    aotLib[0x98159e016c3a99ac] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&set_no_trailing_zeros_2474436cde185d41>>();
    };
    aotLib[0x98159e016c3a99ac] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&set_no_empty_arrays_2474436cde185d41>>();
    };
    aotLib[0x98159e016c3a99ac] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&set_allow_duplicate_keys_2474436cde185d41>>();
    };
    aotLib[0x9aaf42d6ac06203d] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&write_value_f2bc0a23fa15bbe0>>();
    };
    aotLib[0x4564c505d0fc877] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&write_json_34022532ff2e1f41>>();
    };
    aotLib[0x10a584d4c2bebd19] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&write_json_e9b0aebc7e210d59>>();
    };
    aotLib[0xb30eb3f2dd29b4c4] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&try_fixing_broken_json_9db34ecdbaf08fe5>>();
    };
    // [[ init script ]]
