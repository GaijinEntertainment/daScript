...
inline uint64_t hash0_477bbb09c1630917 ( Context * __context__, char * const  __s_rename_at_367_0 );
...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    aotLib[0x7244f47c0198a8fd] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&hash0_477bbb09c1630917>>();
    };
    // [[ init script ]]
