...
namespace das {
namespace _anon_12245729921973336413 {
...
inline uint64_t hash0_6d152d454c1ca84 ( Context * __context__, char * const  __s_rename_at_367_0 );
...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    aotLib[0xd3e464a2b9b6b3aa] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&hash0_6d152d454c1ca84>>();
    };
    // [[ init script ]]
    aotLib[0x2e1632333550096] = +[](Context & ctx) -> SimNode* {
...
AotListBase impl_aot_hash_map(_anon_12245729921973336413::registerAotFunctions);
} // namespace das
