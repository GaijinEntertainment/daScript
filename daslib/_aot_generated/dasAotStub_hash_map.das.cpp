...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    aotLib[0x8be35780fdf30ef] = +[](Context & ctx) -> SimNode* { // hash0_9965be70952193f9
        return ctx.code->makeNode<SimNode_Aot<uint64_t (*) ( Context * __context__, char * const   ),&hash0_9965be70952193f9>>();
    };
    // [[ init script ]]
