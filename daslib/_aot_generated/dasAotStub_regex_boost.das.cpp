...
inline void finalize_33949679bbb57f6f ( Context * __context__, TTuple<16,range,char *> & ____this_rename_at_1187_0 );
inline void _FuncbuiltinTickfinalizeTick13836114024949725080_6f9d59028ece8191 ( Context * __context__, TArray<regex::ReNode *> & __a_rename_at_1183_1 );
...
inline StructInfo const  * _FuncrttiTickclass_infoTick15801393167907430156_d2848a0dd68f9045 ( Context * __context__, regex_boost::RegexReader const  & __cl_rename_at_116_5 );
inline void finalize_ce48cc2769f1ff86 ( Context * __context__, regex::ReNode & ____this_rename_at_29_6 );
inline void _FuncbuiltinTickfinalizeTick13836114024949725080_ced2994fb9435cfe ( Context * __context__, TArray<TTuple<16,range,char *>> & __a_rename_at_1183_7 );
...
{
    {
        ...
        das_iterator<TArray<regex::ReNode *>> __aV_iterator(__a_rename_at_1183_1);
        regex::ReNode * * __aV_rename_at_1185_2;
        __need_loop_1185 = __aV_iterator.first(__context__,(__aV_rename_at_1185_2)) && __need_loop_1185;
        for ( ; __need_loop_1185 ; __need_loop_1185 = __aV_iterator.next(__context__,(__aV_rename_at_1185_2)) )
        {
            finalize_975dc1c3269122c3(__context__,(*__aV_rename_at_1185_2));
        }
        __aV_iterator.close(__context__,(__aV_rename_at_1185_2));
    };
    builtin_array_free(das_arg<TArray<regex::ReNode *>>::pass(__a_rename_at_1183_1),8,__context__,((LineInfoArg *)(&LineInfo::g_LineInfoNULL)));
}
...
{
    {
        ...
        das_iterator<TArray<TTuple<16,range,char *>>> __aV_iterator(__a_rename_at_1183_7);
        TTuple<16,range,char *> * __aV_rename_at_1185_8;
        ...
        {
            finalize_33949679bbb57f6f(__context__,das_arg<TTuple<16,range,char *>>::pass((*__aV_rename_at_1185_8)));
        }
        __aV_iterator.close(__context__,(__aV_rename_at_1185_8));
    };
    builtin_array_free(das_arg<TArray<TTuple<16,range,char *>>>::pass(__a_rename_at_1183_7),16,__context__,((LineInfoArg *)(&LineInfo::g_LineInfoNULL)));
}
...
inline void finalize_53d748a680ec146b ( Context * __context__, regex::Regex &  ____this_rename_at_48_10 )
{
    ...
    _FuncbuiltinTickfinalizeTick13836114024949725080_ced2994fb9435cfe(__context__,das_arg<TArray<TTuple<16,range,char *>>>::pass(____this_rename_at_48_10.groups));
    memset(&(____this_rename_at_48_10), 0, 80);
}

static void registerAotFunctions ( AotLibrary & aotLib ) {
    aotLib[0xa9e3b6750d79e922] = +[](Context & ctx) -> SimNode* { // finalize_33949679bbb57f6f
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, TTuple<16,range,char *> &  ),&finalize_33949679bbb57f6f>>();
    };
    aotLib[0x1ec7afd9ea734cbd] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTickfinalizeTick13836114024949725080_6f9d59028ece8191
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, TArray<regex::ReNode *> &  ),&_FuncbuiltinTickfinalizeTick13836114024949725080_6f9d59028ece8191>>();
    };
    ...
    aotLib[0x446daf4019e35107] = +[](Context & ctx) -> SimNode* { // _FuncrttiTickclass_infoTick15801393167907430156_d2848a0dd68f9045
        return ctx.code->makeNode<SimNode_Aot<StructInfo const  * (*) ( Context * __context__, regex_boost::RegexReader const  &  ),&_FuncrttiTickclass_infoTick15801393167907430156_d2848a0dd68f9045>>();
    };
    aotLib[0xba3f0e2f8f6c2af9] = +[](Context & ctx) -> SimNode* { // finalize_ce48cc2769f1ff86
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, regex::ReNode &  ),&finalize_ce48cc2769f1ff86>>();
    };
    aotLib[0x10077f308e6c3336] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTickfinalizeTick13836114024949725080_ced2994fb9435cfe
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, TArray<TTuple<16,range,char *>> &  ),&_FuncbuiltinTickfinalizeTick13836114024949725080_ced2994fb9435cfe>>();
    };
    aotLib[0x2f11042503d3f047] = +[](Context & ctx) -> SimNode* { // finalize_975dc1c3269122c3
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, regex::ReNode * &  ),&finalize_975dc1c3269122c3>>();
    };
    aotLib[0x7e949fe6fbaa5320] = +[](Context & ctx) -> SimNode* { // finalize_53d748a680ec146b
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, regex::Regex &  ),&finalize_53d748a680ec146b>>();
    };
