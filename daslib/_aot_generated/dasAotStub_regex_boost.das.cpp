...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    aotLib[0xa9e3b6750d79e922] = +[](Context & ctx) -> SimNode* { // finalize_33949679bbb57f6f
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, AutoTuple<range,char *> &  ),&finalize_33949679bbb57f6f>>();
    };
    ...
    aotLib[0x5152f0b4c062a0cd] = +[](Context & ctx) -> SimNode* { // _FuncrttiTickclass_infoTick15801393167907430156_36c9eb4e6b5afb54
        return ctx.code->makeNode<SimNode_Aot<StructInfo const  * (*) ( Context * __context__, regex_boost::RegexReader const  &  ),&_FuncrttiTickclass_infoTick15801393167907430156_36c9eb4e6b5afb54>>();
    };
    ...
    aotLib[0x10077f308e6c3336] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTickfinalizeTick13836114024949725080_ced2994fb9435cfe
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, TArray<AutoTuple<range,char *>> &  ),&_FuncbuiltinTickfinalizeTick13836114024949725080_ced2994fb9435cfe>>();
    };
