...
static_assert(sizeof(QsortMacro)==48,"structure size mismatch with DAS");
static_assert(offsetof(QsortMacro,__rtti)==0,"structure field offset mismatch with DAS");
static_assert(offsetof(QsortMacro,__finalize)==8,"structure field offset mismatch with DAS");
static_assert(offsetof(QsortMacro,preVisit)==16,"structure field offset mismatch with DAS");
static_assert(offsetof(QsortMacro,visit)==24,"structure field offset mismatch with DAS");
static_assert(offsetof(QsortMacro,canVisitArgument)==32,"structure field offset mismatch with DAS");
static_assert(offsetof(QsortMacro,canFoldReturnResult)==40,"structure field offset mismatch with DAS");
}
...
inline StructInfo const  * _FuncrttiTickclass_infoTick15801393167907430156_5e42182ceaeb5ece ( Context * __context__, sort_boost::QsortMacro const  & __cl_rename_at_116_2 );
...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    ...
    aotLib[0xf63acf38a69d9069] = +[](Context & ctx) -> SimNode* { // _FuncrttiTickclass_infoTick15801393167907430156_5e42182ceaeb5ece
        return ctx.code->makeNode<SimNode_Aot<StructInfo const  * (*) ( Context * __context__, sort_boost::QsortMacro const  &  ),&_FuncrttiTickclass_infoTick15801393167907430156_5e42182ceaeb5ece>>();
    };
