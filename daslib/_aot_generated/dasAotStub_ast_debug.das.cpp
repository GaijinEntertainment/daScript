...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    aotLib[0xd944b240f1dadce5] = +[](Context & ctx) -> SimNode* { // _FuncrttiTickclass_infoTick15801393167907430156_c81a84221fb6bad2
        return ctx.code->makeNode<SimNode_Aot<StructInfo const  * (*) ( Context * __context__, ast_debug::SampleStackWalker const  &  ),&_FuncrttiTickclass_infoTick15801393167907430156_c81a84221fb6bad2>>();
    };
    ...
    aotLib[0x1abaf737439ed2ef] = +[](Context & ctx) -> SimNode* { // _FuncrttiTickclass_infoTick15801393167907430156_7c5d3c9bad07d43c
        return ctx.code->makeNode<SimNode_Aot<StructInfo const  * (*) ( Context * __context__, ast_debug::ContextStateAgent const  &  ),&_FuncrttiTickclass_infoTick15801393167907430156_7c5d3c9bad07d43c>>();
    };
    ...
    aotLib[0x86519d383a236a85] = +[](Context & ctx) -> SimNode* { // _FuncdebugapiTickmake_stack_walkerTick10101906578839871846_229ea554e31d57ca
        return ctx.code->makeNode<SimNode_Aot<smart_ptr_raw<StackWalker> (*) ( Context * __context__, ast_debug::SampleStackWalker * const   ),&_FuncdebugapiTickmake_stack_walkerTick10101906578839871846_229ea554e31d57ca>>();
    };
    aotLib[0x9e24c1a5d7a1647e] = +[](Context & ctx) -> SimNode* { // finalize_500fce7609128ffb
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, ast_debug::SampleStackWalker * &  ),&finalize_500fce7609128ffb>>();
    };
    aotLib[0x16be1c7d7571ba3d] = +[](Context & ctx) -> SimNode* { // finalize_5733f4cfa043e920
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, ast_debug::SampleStackWalker &  ),&finalize_5733f4cfa043e920>>();
    };
    aotLib[0xc8fd86923428452f] = +[](Context & ctx) -> SimNode* { // _FuncdebugapiTickinstall_new_debug_agentTick3897311473844341055_3e1c20224cd19f2e
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, ast_debug::ContextStateAgent * , char * const   ),&_FuncdebugapiTickinstall_new_debug_agentTick3897311473844341055_3e1c20224cd19f2e>>();
    };
    aotLib[0x955a91178f2a8500] = +[](Context & ctx) -> SimNode* { // _FuncSampleStackWalkerTickonArgument_b3c1b48f676b9bbd
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, ast_debug::SampleStackWalker & , FuncInfo const  & , int32_t , VarInfo const  & , float4  ),&_FuncSampleStackWalkerTickonArgument_b3c1b48f676b9bbd>>();
    };
    aotLib[0x1d8e0b6a1c5583c6] = +[](Context & ctx) -> SimNode* { // _FuncSampleStackWalkerTickonVariable_b047f0cc7c7030d6
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, ast_debug::SampleStackWalker & , FuncInfo const  & , LocalVariableInfo const  & , void * const  , bool  ),&_FuncSampleStackWalkerTickonVariable_b047f0cc7c7030d6>>();
    };
    aotLib[0xbe942b4a73c4cd55] = +[](Context & ctx) -> SimNode* { // _FuncSampleStackWalkerTickonAfterCall_eedb864288cb4a8a
        return ctx.code->makeNode<SimNode_Aot<bool (*) ( Context * __context__, ast_debug::SampleStackWalker & , Prologue const  &  ),&_FuncSampleStackWalkerTickonAfterCall_eedb864288cb4a8a>>();
    };
    aotLib[0x6c77ecfde1d92d7] = +[](Context & ctx) -> SimNode* { // _FuncSampleStackWalker_0x27___finalize_af21cd893b46a727
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, ast_debug::SampleStackWalker &  ),&_FuncSampleStackWalker_0x27___finalize_af21cd893b46a727>>();
    };
    aotLib[0x3fbf295fb400101b] = +[](Context & ctx) -> SimNode* { // ContextStateAgent_e10fdff26046cd6f
        return ctx.code->makeNode<SimNode_AotCMRES<ast_debug::ContextStateAgent (*) ( Context * __context__ ),&ContextStateAgent_e10fdff26046cd6f>>();
    };
    aotLib[0x954f3558ded65d8] = +[](Context & ctx) -> SimNode* { // _FuncContextStateAgentTickContextStateAgent_ce0829614ebac3e5
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, ast_debug::ContextStateAgent &  ),&_FuncContextStateAgentTickContextStateAgent_ce0829614ebac3e5>>();
    };
    aotLib[0x2af306b9895d5228] = +[](Context & ctx) -> SimNode* { // finalize_dcfff9e2129da1aa
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, ast_debug::ContextStateAgent &  ),&finalize_dcfff9e2129da1aa>>();
    };
    aotLib[0x30e88d3b4dd372e] = +[](Context & ctx) -> SimNode* { // _FuncContextStateAgentTickonCollect_d5b055adc3fcc695
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, ast_debug::ContextStateAgent & , Context & , LineInfo const  &  ),&_FuncContextStateAgentTickonCollect_d5b055adc3fcc695>>();
    };
    aotLib[0x2ae71cff664419fd] = +[](Context & ctx) -> SimNode* { // _FuncContextStateAgent_0x27___finalize_c2bf11f8c2d8aef
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, ast_debug::ContextStateAgent &  ),&_FuncContextStateAgent_0x27___finalize_c2bf11f8c2d8aef>>();
    };
    aotLib[0xe4e00ea64d552d51] = +[](Context & ctx) -> SimNode* { // state_agent_a7d0d7fe180b2c1a
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, Context const  &  ),&state_agent_a7d0d7fe180b2c1a>>();
    };
    aotLib[0xbddc52318f02e163] = +[](Context & ctx) -> SimNode* { // SampleStackWalker_b9ed6b4c0fa80af2
        return ctx.code->makeNode<SimNode_AotCMRES<ast_debug::SampleStackWalker (*) ( Context * __context__ ),&SampleStackWalker_b9ed6b4c0fa80af2>>();
    };
