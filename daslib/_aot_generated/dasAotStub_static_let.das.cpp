...
namespace das {
namespace _anon_12899149697214899600 {
...
inline void finalize_84028d264ddd10c4 ( Context * __context__, AutoTuple<char *,char *> & ____this_rename_at_1219_0 );
inline void _FuncbuiltinTickpushTick10769833213962245646_577e5c7310ce42 ( Context * __context__, TArray<ast::AstFunctionAnnotation *> & __Arr_rename_at_181_1, ast::AstFunctionAnnotation * __value_rename_at_181_2 );
inline StructInfo const  * _FuncrttiTickclass_infoTick15801393167907430156_3bf9bd6aebeb25a3 ( Context * __context__, static_let::StaticLetMacro const  & __cl_rename_at_116_3 );
inline smart_ptr_raw<FunctionAnnotation> _FuncastTickmake_function_annotationTick3074191368936885601_893bb7e06f785d1f ( Context * __context__, char * const  __name_rename_at_631_4, static_let::StaticLetMacro * __someClassPtr_rename_at_631_5 );
inline void _FuncbuiltinTickfinalizeTick13836114024949725080_8e095076fa204dfd ( Context * __context__, TArray<AutoTuple<char *,char *>> & __a_rename_at_1215_7 );
inline void _FuncbuiltinTickpushTick10769833213962245646_dff06e65c02f87d3 ( Context * __context__, TArray<AutoTuple<char *,char *>> & __Arr_rename_at_181_9, AutoTuple<char *,char *> & __value_rename_at_181_10 );
inline void _Funcast_boostTicksetup_tag_annotationTick4095297895764883997_286c1774085879cf ( Context * __context__, char * const  __name_rename_at_273_11, char * const  __tag_rename_at_273_12, static_let::StaticLetMacro * __classPtr_rename_at_273_13 );
inline void static_let_8328d14da776fd ( Context * __context__, Block DAS_COMMENT((void)) const  & __blk_rename_at_15_15 );
inline void static_let_finalize_8328d14da776fd ( Context * __context__, Block DAS_COMMENT((void)) const  & __blk_rename_at_22_16 );
inline bool make_shutdown_function_b9e052347ea15843 ( Context * __context__, char * const  __varname_rename_at_27_17, LineInfo const  & __at_rename_at_27_18 );
...
inline smart_ptr_raw<FunctionAnnotation> _FuncastTickmake_function_annotationTick3074191368936885601_893bb7e06f785d1f ( Context * __context__, char * const  __name_rename_at_631_4, static_let::StaticLetMacro * __someClassPtr_rename_at_631_5 )
{
    _FuncbuiltinTickpushTick10769833213962245646_577e5c7310ce42(__context__,das_arg<TArray<ast::AstFunctionAnnotation *>>::pass(das_global<TArray<ast::AstFunctionAnnotation *>,0x70a17c19e372bb43>(__context__) /*gc_root_AstFunctionAnnotation*/),das_reinterpret<ast::AstFunctionAnnotation *>::pass(__someClassPtr_rename_at_631_5));
    StructInfo const  * __classInfo_rename_at_634_6 = ((StructInfo const  *)_FuncrttiTickclass_infoTick15801393167907430156_3bf9bd6aebeb25a3(__context__,das_arg<static_let::StaticLetMacro>::pass(das_deref(__context__,__someClassPtr_rename_at_631_5))));
...
{
    {
        ...
        {
            finalize_84028d264ddd10c4(__context__,das_arg<AutoTuple<char *,char *>>::pass((*__aV_rename_at_1217_8)));
        }
...
inline void _Funcast_boostTicksetup_tag_annotationTick4095297895764883997_286c1774085879cf ( Context * __context__, char * const  __name_rename_at_273_11, char * const  __tag_rename_at_273_12, static_let::StaticLetMacro * __classPtr_rename_at_273_13 )
{
    ...
    /* end finally */ });
    __ann_rename_at_274_14; das_zero(__ann_rename_at_274_14); das_move(__ann_rename_at_274_14, _FuncastTickmake_function_annotationTick3074191368936885601_893bb7e06f785d1f(__context__,__name_rename_at_273_11,__classPtr_rename_at_273_13));
...
inline bool make_shutdown_function_b9e052347ea15843 ( Context * __context__, char * const  __varname_rename_at_27_17, LineInfo const  &  __at_rename_at_27_18 ) { das_stack_prologue __prologue(__context__,288,"make_shutdown_function " DAS_FILE_LINE);
{
...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    aotLib[0xe720ce28e06b0bc7] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&finalize_84028d264ddd10c4>>();
    };
    ...
    aotLib[0x37951e25a0e6e9e7] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncrttiTickclass_infoTick15801393167907430156_3bf9bd6aebeb25a3>>();
    };
    aotLib[0xf21a4110c181b739] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncastTickmake_function_annotationTick3074191368936885601_893bb7e06f785d1f>>();
    };
    aotLib[0x25211d381884cfd1] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncbuiltinTickfinalizeTick13836114024949725080_8e095076fa204dfd>>();
    };
    aotLib[0xcac43e8bfb5f62cb] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncbuiltinTickpushTick10769833213962245646_dff06e65c02f87d3>>();
    };
    aotLib[0xdb896e6bdf8eb96e] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_Funcast_boostTicksetup_tag_annotationTick4095297895764883997_286c1774085879cf>>();
    };
    aotLib[0x33cb3f0588352b8f] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&static_let_8328d14da776fd>>();
    };
    aotLib[0x33cb3f0588352b8f] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&static_let_finalize_8328d14da776fd>>();
    };
    aotLib[0xe9a49bf07420914f] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&make_shutdown_function_b9e052347ea15843>>();
    };
    // [[ init script ]]
...
AotListBase impl_aot_static_let(_anon_12899149697214899600::registerAotFunctions);
} // namespace das
