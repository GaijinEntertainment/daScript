...
static_assert(sizeof(StaticLetMacro)==112,"structure size mismatch with DAS");
static_assert(offsetof(StaticLetMacro,__rtti)==0,"structure field offset mismatch with DAS");
static_assert(offsetof(StaticLetMacro,__finalize)==8,"structure field offset mismatch with DAS");
static_assert(offsetof(StaticLetMacro,transform)==16,"structure field offset mismatch with DAS");
static_assert(offsetof(StaticLetMacro,verifyCall)==24,"structure field offset mismatch with DAS");
static_assert(offsetof(StaticLetMacro,apply)==32,"structure field offset mismatch with DAS");
static_assert(offsetof(StaticLetMacro,generic_apply)==40,"structure field offset mismatch with DAS");
static_assert(offsetof(StaticLetMacro,finish)==48,"structure field offset mismatch with DAS");
static_assert(offsetof(StaticLetMacro,patch)==56,"structure field offset mismatch with DAS");
static_assert(offsetof(StaticLetMacro,fixup)==64,"structure field offset mismatch with DAS");
static_assert(offsetof(StaticLetMacro,lint)==72,"structure field offset mismatch with DAS");
static_assert(offsetof(StaticLetMacro,complete)==80,"structure field offset mismatch with DAS");
static_assert(offsetof(StaticLetMacro,isCompatible)==88,"structure field offset mismatch with DAS");
static_assert(offsetof(StaticLetMacro,isSpecialized)==96,"structure field offset mismatch with DAS");
static_assert(offsetof(StaticLetMacro,appendToMangledName)==104,"structure field offset mismatch with DAS");
}

inline void finalize_d24b8ca870748b86 ( Context * __context__, TTuple<16,char *,char *> & ____this_rename_at_1187_0 );
inline void _FuncbuiltinTickpushTick10769833213962245646_17d5a7b0b5dc7d2a ( Context * __context__, TArray<ast::AstFunctionAnnotation *> & __Arr_rename_at_181_1, ast::AstFunctionAnnotation * __value_rename_at_181_2 );
inline StructInfo const  * _FuncrttiTickclass_infoTick15801393167907430156_5d353fe13d802a5e ( Context * __context__, static_let::StaticLetMacro const  & __cl_rename_at_116_3 );
inline smart_ptr_raw<FunctionAnnotation> _FuncastTickmake_function_annotationTick3074191368936885601_345b553515fa2eeb ( Context * __context__, char * const  __name_rename_at_622_4, static_let::StaticLetMacro * __someClassPtr_rename_at_622_5 );
inline void _FuncbuiltinTickfinalizeTick13836114024949725080_b70d4a3adda2fff ( Context * __context__, TArray<TTuple<16,char *,char *>> & __a_rename_at_1183_7 );
inline void _FuncbuiltinTickpushTick10769833213962245646_b1d2457362f3ba22 ( Context * __context__, TArray<TTuple<16,char *,char *>> & __Arr_rename_at_181_9, TTuple<16,char *,char *> & __value_rename_at_181_10 );
inline void _Funcast_boostTicksetup_tag_annotationTick4095297895764883997_e39b89eebe404e31 ( Context * __context__, char * const  __name_rename_at_273_11, char * const  __tag_rename_at_273_12, static_let::StaticLetMacro * __classPtr_rename_at_273_13 );
inline void static_let_ff319dd1eed67c66 ( Context * __context__, Block DAS_COMMENT((void)) const  & __blk_rename_at_15_15 );
inline void static_let_finalize_ff319dd1eed67c66 ( Context * __context__, Block DAS_COMMENT((void)) const  & __blk_rename_at_22_16 );
inline bool make_shutdown_function_ac3d2b9ea5a9dd23 ( Context * __context__, char * const  __varname_rename_at_27_17, LineInfo const  & __at_rename_at_27_18 );
...
inline smart_ptr_raw<FunctionAnnotation> _FuncastTickmake_function_annotationTick3074191368936885601_345b553515fa2eeb ( Context * __context__, char * const  __name_rename_at_622_4, static_let::StaticLetMacro * __someClassPtr_rename_at_622_5 )
{
    ...
    StructInfo const  * __classInfo_rename_at_625_6 = ((StructInfo const  *)_FuncrttiTickclass_infoTick15801393167907430156_5d353fe13d802a5e(__context__,das_arg<static_let::StaticLetMacro>::pass(das_deref(__context__,__someClassPtr_rename_at_622_5))));
...
{
    {
        ...
        das_iterator<TArray<TTuple<16,char *,char *>>> __aV_iterator(__a_rename_at_1183_7);
        TTuple<16,char *,char *> * __aV_rename_at_1185_8;
        __need_loop_1185 = __aV_iterator.first(__context__,(__aV_rename_at_1185_8)) && __need_loop_1185;
        for ( ; __need_loop_1185 ; __need_loop_1185 = __aV_iterator.next(__context__,(__aV_rename_at_1185_8)) )
        {
            finalize_d24b8ca870748b86(__context__,das_arg<TTuple<16,char *,char *>>::pass((*__aV_rename_at_1185_8)));
        }
        __aV_iterator.close(__context__,(__aV_rename_at_1185_8));
    };
    builtin_array_free(das_arg<TArray<TTuple<16,char *,char *>>>::pass(__a_rename_at_1183_7),16,__context__,((LineInfoArg *)(&LineInfo::g_LineInfoNULL)));
}

inline void _FuncbuiltinTickpushTick10769833213962245646_b1d2457362f3ba22 ( Context * __context__, TArray<TTuple<16,char *,char *>> &  __Arr_rename_at_181_9, TTuple<16,char *,char *> &  __value_rename_at_181_10 )
{
    das_copy(__Arr_rename_at_181_9(builtin_array_push_back(das_arg<TArray<TTuple<16,char *,char *>>>::pass(__Arr_rename_at_181_9),16,__context__,((LineInfoArg *)(&LineInfo::g_LineInfoNULL))),__context__),__value_rename_at_181_10);
}
...
inline void _Funcast_boostTicksetup_tag_annotationTick4095297895764883997_e39b89eebe404e31 ( Context * __context__, char * const  __name_rename_at_273_11, char * const  __tag_rename_at_273_12, static_let::StaticLetMacro * __classPtr_rename_at_273_13 )
{
    ...
    /* end finally */ });
    __ann_rename_at_274_14; das_zero(__ann_rename_at_274_14); das_move(__ann_rename_at_274_14, _FuncastTickmake_function_annotationTick3074191368936885601_345b553515fa2eeb(__context__,__name_rename_at_273_11,__classPtr_rename_at_273_13));
    das_invoke_function<void>::invoke<char * const ,smart_ptr_raw<FunctionAnnotation>>(__context__,nullptr,Func(__context__->fnByMangledName(/*@ast_boost::apply_tag_annotation Cs Y<FunctionAnnotationPtr>1<H<ast::FunctionAnnotation>>?M*/ 8536632802977626562u)),__tag_rename_at_273_12,__ann_rename_at_274_14);
...
inline bool make_shutdown_function_ac3d2b9ea5a9dd23 ( Context * __context__, char * const  __varname_rename_at_27_17, LineInfo const  &  __at_rename_at_27_18 ) { das_stack_prologue __prologue(__context__,288,"make_shutdown_function " DAS_FILE_LINE);
{
    ...
    das_vector_emplace_back(das_arg<das::vector<smart_ptr<Expression>>>::pass(__blk_rename_at_32_21->list /*list*/),das_reinterpret<smart_ptr<Expression>>::pass(__delv_rename_at_33_22));
...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    aotLib[0x862432cec51b33cf] = +[](Context & ctx) -> SimNode* { // finalize_d24b8ca870748b86
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, TTuple<16,char *,char *> &  ),&finalize_d24b8ca870748b86>>();
    };
    ...
    aotLib[0x546304aa99c2822f] = +[](Context & ctx) -> SimNode* { // _FuncrttiTickclass_infoTick15801393167907430156_5d353fe13d802a5e
        return ctx.code->makeNode<SimNode_Aot<StructInfo const  * (*) ( Context * __context__, static_let::StaticLetMacro const  &  ),&_FuncrttiTickclass_infoTick15801393167907430156_5d353fe13d802a5e>>();
    };
    aotLib[0x921a287bddcb8c80] = +[](Context & ctx) -> SimNode* { // _FuncastTickmake_function_annotationTick3074191368936885601_345b553515fa2eeb
        return ctx.code->makeNode<SimNode_Aot<smart_ptr_raw<FunctionAnnotation> (*) ( Context * __context__, char * const  , static_let::StaticLetMacro *  ),&_FuncastTickmake_function_annotationTick3074191368936885601_345b553515fa2eeb>>();
    };
    aotLib[0x5b349e585a56ecb8] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTickfinalizeTick13836114024949725080_b70d4a3adda2fff
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, TArray<TTuple<16,char *,char *>> &  ),&_FuncbuiltinTickfinalizeTick13836114024949725080_b70d4a3adda2fff>>();
    };
    aotLib[0xc37d291e9b8998b0] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTickpushTick10769833213962245646_b1d2457362f3ba22
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, TArray<TTuple<16,char *,char *>> & , TTuple<16,char *,char *> &  ),&_FuncbuiltinTickpushTick10769833213962245646_b1d2457362f3ba22>>();
    };
    aotLib[0x6e5f49b4df6c0e9a] = +[](Context & ctx) -> SimNode* { // _Funcast_boostTicksetup_tag_annotationTick4095297895764883997_e39b89eebe404e31
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, char * const  , char * const  , static_let::StaticLetMacro *  ),&_Funcast_boostTicksetup_tag_annotationTick4095297895764883997_e39b89eebe404e31>>();
    };
    aotLib[0x6ddc33860091a8dd] = +[](Context & ctx) -> SimNode* { // static_let_ff319dd1eed67c66
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, Block DAS_COMMENT((void)) const  &  ),&static_let_ff319dd1eed67c66>>();
    };
    aotLib[0x6ddc33860091a8dd] = +[](Context & ctx) -> SimNode* { // static_let_finalize_ff319dd1eed67c66
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, Block DAS_COMMENT((void)) const  &  ),&static_let_finalize_ff319dd1eed67c66>>();
    };
    aotLib[0x17df57f13d2e5158] = +[](Context & ctx) -> SimNode* { // make_shutdown_function_ac3d2b9ea5a9dd23
        return ctx.code->makeNode<SimNode_Aot<bool (*) ( Context * __context__, char * const  , LineInfo const  &  ),&make_shutdown_function_ac3d2b9ea5a9dd23>>();
    };
    // [[ init script ]]
