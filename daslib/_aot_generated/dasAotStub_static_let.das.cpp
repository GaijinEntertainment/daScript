...
inline smart_ptr_raw<FunctionAnnotation> _FuncastTickmake_function_annotationTick3074191368936885601_93352451674cb798 ( Context * __context__, char * const  __name_rename_at_626_4, static_let::StaticLetMacro * __someClassPtr_rename_at_626_5 );
...
inline smart_ptr_raw<FunctionAnnotation> _FuncastTickmake_function_annotationTick3074191368936885601_93352451674cb798 ( Context * __context__, char * const  __name_rename_at_626_4, static_let::StaticLetMacro * __someClassPtr_rename_at_626_5 )
{
    _FuncbuiltinTickpushTick10769833213962245646_e64fa0322491795(__context__,das_arg<TArray<ast::AstFunctionAnnotation *>>::pass(das_global<TArray<ast::AstFunctionAnnotation *>,0x70a17c19e372bb43>(__context__) /*gc_root_AstFunctionAnnotation*/),das_reinterpret<ast::AstFunctionAnnotation *>::pass(__someClassPtr_rename_at_626_5));
    StructInfo const  * __classInfo_rename_at_629_6 = ((StructInfo const  *)_FuncrttiTickclass_infoTick15801393167907430156_e752f39e965b4026(__context__,das_arg<static_let::StaticLetMacro>::pass(das_deref(__context__,__someClassPtr_rename_at_626_5))));
    return /* <- */ das_auto_cast_move<smart_ptr_raw<FunctionAnnotation>>::cast(makeFunctionAnnotation(__name_rename_at_626_4,das_auto_cast<void * const >::cast(__someClassPtr_rename_at_626_5),__classInfo_rename_at_629_6,__context__));
}
...
inline void _Funcast_boostTicksetup_tag_annotationTick4095297895764883997_54c2da3d6fda4cde ( Context * __context__, char * const  __name_rename_at_273_11, char * const  __tag_rename_at_273_12, static_let::StaticLetMacro * __classPtr_rename_at_273_13 )
{
    ...
    /* end finally */ });
    __ann_rename_at_274_14; das_zero(__ann_rename_at_274_14); das_move(__ann_rename_at_274_14, _FuncastTickmake_function_annotationTick3074191368936885601_93352451674cb798(__context__,__name_rename_at_273_11,__classPtr_rename_at_273_13));
...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    aotLib[0x862432cec51b33cf] = +[](Context & ctx) -> SimNode* { // finalize_d24b8ca870748b86
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, AutoTuple<char *,char *> &  ),&finalize_d24b8ca870748b86>>();
    };
    ...
    aotLib[0x2f32c6d20f10880e] = +[](Context & ctx) -> SimNode* { // _FuncrttiTickclass_infoTick15801393167907430156_e752f39e965b4026
        return ctx.code->makeNode<SimNode_Aot<StructInfo const  * (*) ( Context * __context__, static_let::StaticLetMacro const  &  ),&_FuncrttiTickclass_infoTick15801393167907430156_e752f39e965b4026>>();
    };
    aotLib[0xd11ec08ac48d0405] = +[](Context & ctx) -> SimNode* { // _FuncastTickmake_function_annotationTick3074191368936885601_93352451674cb798
        return ctx.code->makeNode<SimNode_Aot<smart_ptr_raw<FunctionAnnotation> (*) ( Context * __context__, char * const  , static_let::StaticLetMacro *  ),&_FuncastTickmake_function_annotationTick3074191368936885601_93352451674cb798>>();
    };
    aotLib[0x5b349e585a56ecb8] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTickfinalizeTick13836114024949725080_b70d4a3adda2fff
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, TArray<AutoTuple<char *,char *>> &  ),&_FuncbuiltinTickfinalizeTick13836114024949725080_b70d4a3adda2fff>>();
    };
    aotLib[0xc37d291e9b8998b0] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTickpushTick10769833213962245646_b1d2457362f3ba22
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, TArray<AutoTuple<char *,char *>> & , AutoTuple<char *,char *> &  ),&_FuncbuiltinTickpushTick10769833213962245646_b1d2457362f3ba22>>();
    };
    aotLib[0xa6a0c77eb5c9c0b0] = +[](Context & ctx) -> SimNode* { // _Funcast_boostTicksetup_tag_annotationTick4095297895764883997_54c2da3d6fda4cde
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, char * const  , char * const  , static_let::StaticLetMacro *  ),&_Funcast_boostTicksetup_tag_annotationTick4095297895764883997_54c2da3d6fda4cde>>();
    };
