...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    ...
    aotLib[0x8e9da741b004b839] = +[](Context & ctx) -> SimNode* { // _FuncrttiTickclass_infoTick15801393167907430156_9fd87b225af26eb8
        return ctx.code->makeNode<SimNode_Aot<StructInfo const  * (*) ( Context * __context__, json_boost::BetterJsonMacro const  &  ),&_FuncrttiTickclass_infoTick15801393167907430156_9fd87b225af26eb8>>();
    };
    ...
    aotLib[0x621bc12228fb29bb] = +[](Context & ctx) -> SimNode* { // _FuncrttiTickclass_infoTick15801393167907430156_d01402ef40f6562a
        return ctx.code->makeNode<SimNode_Aot<StructInfo const  * (*) ( Context * __context__, json_boost::JsonReader const  &  ),&_FuncrttiTickclass_infoTick15801393167907430156_d01402ef40f6562a>>();
    };
    aotLib[0xf020fec97fe5f7be] = +[](Context & ctx) -> SimNode* { // _FuncQmarkSqblSqbr_3538a35cc5ccc9d5
    ...
    aotLib[0x90ce6642cb555679] = +[](Context & ctx) -> SimNode* { // _FuncQmarkSqblSqbr_5655a09dd3be2073
    ...
    aotLib[0xf020fec97fe5f7be] = +[](Context & ctx) -> SimNode* { // _FuncQmarkDot_3538a35cc5ccc9d5
    ...
    aotLib[0x90ce6642cb555679] = +[](Context & ctx) -> SimNode* { // _FuncQmarkDot_5655a09dd3be2073
    ...
    aotLib[0xa661d1639a571f4f] = +[](Context & ctx) -> SimNode* { // _FuncQmarkSqblSqbr_ba0b0aab6632dd31
    ...
    aotLib[0xbb4bf8b0c412ba3f] = +[](Context & ctx) -> SimNode* { // _FuncQmarkSqblSqbr_d744859b79ee77ab
    ...
    aotLib[0xaac7aaf08c3470bf] = +[](Context & ctx) -> SimNode* { // _FuncQmarkDotTickvalue_7c5354fba05537e2
        return ctx.code->makeNode<SimNode_Aot<AutoVariant<TTable<char *,json::JsonValue *>,TArray<json::JsonValue *>,char *,double,bool,void *> const  * (*) ( Context * __context__, json::JsonValue const  * const   ),&_FuncQmarkDotTickvalue_7c5354fba05537e2>>();
    };
    aotLib[0xf4e4a4de8ae59bb1] = +[](Context & ctx) -> SimNode* { // _FuncQmarkDotTickvalue_2bdf5bca6f9d0002
        return ctx.code->makeNode<SimNode_Aot<AutoVariant<TTable<char *,json::JsonValue *>,TArray<json::JsonValue *>,char *,double,bool,void *> * (*) ( Context * __context__, json::JsonValue *  ),&_FuncQmarkDotTickvalue_2bdf5bca6f9d0002>>();
    };
    aotLib[0xc4c8feb11410cd0a] = +[](Context & ctx) -> SimNode* { // JV_de08d1a11663707
        return ctx.code->makeNode<SimNode_Aot<json::JsonValue * (*) ( Context * __context__, float  ),&JV_de08d1a11663707>>();
    };
    aotLib[0xa1a929ec68f6efa5] = +[](Context & ctx) -> SimNode* { // JV_2fa74720cd155930
        return ctx.code->makeNode<SimNode_Aot<json::JsonValue * (*) ( Context * __context__, int32_t  ),&JV_2fa74720cd155930>>();
    };
    aotLib[0xac6ad6292aec793d] = +[](Context & ctx) -> SimNode* { // JV_549d699b656608a2
        return ctx.code->makeNode<SimNode_Aot<json::JsonValue * (*) ( Context * __context__, Bitfield  ),&JV_549d699b656608a2>>();
    };
    aotLib[0xabb40867ec5a2a4b] = +[](Context & ctx) -> SimNode* { // JV_840ec78279ac852d
        return ctx.code->makeNode<SimNode_Aot<json::JsonValue * (*) ( Context * __context__, int8_t  ),&JV_840ec78279ac852d>>();
    };
    aotLib[0x7eebfe09b878d154] = +[](Context & ctx) -> SimNode* { // JV_526f504129917241
        return ctx.code->makeNode<SimNode_Aot<json::JsonValue * (*) ( Context * __context__, uint8_t  ),&JV_526f504129917241>>();
    };
    aotLib[0xb187bc5951542f77] = +[](Context & ctx) -> SimNode* { // JV_17760da7cd1ea0ee
        return ctx.code->makeNode<SimNode_Aot<json::JsonValue * (*) ( Context * __context__, int16_t  ),&JV_17760da7cd1ea0ee>>();
    };
    aotLib[0xb7aed417e8aa85cc] = +[](Context & ctx) -> SimNode* { // JV_30573b250fcf268b
        return ctx.code->makeNode<SimNode_Aot<json::JsonValue * (*) ( Context * __context__, uint16_t  ),&JV_30573b250fcf268b>>();
    };
    aotLib[0xfba41459b91c9a0d] = +[](Context & ctx) -> SimNode* { // JV_c85629fe70fc95b5
        return ctx.code->makeNode<SimNode_Aot<json::JsonValue * (*) ( Context * __context__, uint32_t  ),&JV_c85629fe70fc95b5>>();
    };
    aotLib[0xa239927c68d23b11] = +[](Context & ctx) -> SimNode* { // JV_b0de7f0f7332ba2d
        return ctx.code->makeNode<SimNode_Aot<json::JsonValue * (*) ( Context * __context__, int64_t  ),&JV_b0de7f0f7332ba2d>>();
    };
    aotLib[0x432b947077ba23da] = +[](Context & ctx) -> SimNode* { // JV_8425ea1d753a21fb
        return ctx.code->makeNode<SimNode_Aot<json::JsonValue * (*) ( Context * __context__, uint64_t  ),&JV_8425ea1d753a21fb>>();
    };
