...
inline smart_ptr_raw<FunctionAnnotation> _FuncastTickmake_function_annotationTick3074191368936885601_95ba3a9d4de4e95b ( Context * __context__, char * const  __name_rename_at_626_42, refactor::ExtractMethodMacro * __someClassPtr_rename_at_626_43 );
inline smart_ptr_raw<FunctionAnnotation> _FuncastTickmake_function_annotationTick3074191368936885601_e08431098b248a79 ( Context * __context__, char * const  __name_rename_at_626_45, refactor::ExtractVariableFunction * __someClassPtr_rename_at_626_46 );
...
inline smart_ptr_raw<FunctionAnnotation> _FuncastTickmake_function_annotationTick3074191368936885601_95ba3a9d4de4e95b ( Context * __context__, char * const  __name_rename_at_626_42, refactor::ExtractMethodMacro * __someClassPtr_rename_at_626_43 )
{
    _FuncbuiltinTickpushTick10769833213962245646_e64fa0322491795(__context__,das_arg<TArray<ast::AstFunctionAnnotation *>>::pass(das_global<TArray<ast::AstFunctionAnnotation *>,0x70a17c19e372bb43>(__context__) /*gc_root_AstFunctionAnnotation*/),das_reinterpret<ast::AstFunctionAnnotation *>::pass(__someClassPtr_rename_at_626_43));
    StructInfo const  * __classInfo_rename_at_629_44 = ((StructInfo const  *)_FuncrttiTickclass_infoTick15801393167907430156_f71f3d89fb753b2(__context__,das_arg<refactor::ExtractMethodMacro>::pass(das_deref(__context__,__someClassPtr_rename_at_626_43))));
    return /* <- */ das_auto_cast_move<smart_ptr_raw<FunctionAnnotation>>::cast(makeFunctionAnnotation(__name_rename_at_626_42,das_auto_cast<void * const >::cast(__someClassPtr_rename_at_626_43),__classInfo_rename_at_629_44,__context__));
}

inline smart_ptr_raw<FunctionAnnotation> _FuncastTickmake_function_annotationTick3074191368936885601_e08431098b248a79 ( Context * __context__, char * const  __name_rename_at_626_45, refactor::ExtractVariableFunction * __someClassPtr_rename_at_626_46 )
{
    _FuncbuiltinTickpushTick10769833213962245646_e64fa0322491795(__context__,das_arg<TArray<ast::AstFunctionAnnotation *>>::pass(das_global<TArray<ast::AstFunctionAnnotation *>,0x70a17c19e372bb43>(__context__) /*gc_root_AstFunctionAnnotation*/),das_reinterpret<ast::AstFunctionAnnotation *>::pass(__someClassPtr_rename_at_626_46));
    StructInfo const  * __classInfo_rename_at_629_47 = ((StructInfo const  *)_FuncrttiTickclass_infoTick15801393167907430156_42f12d0f0ca9b24d(__context__,das_arg<refactor::ExtractVariableFunction>::pass(das_deref(__context__,__someClassPtr_rename_at_626_46))));
    return /* <- */ das_auto_cast_move<smart_ptr_raw<FunctionAnnotation>>::cast(makeFunctionAnnotation(__name_rename_at_626_45,das_auto_cast<void * const >::cast(__someClassPtr_rename_at_626_46),__classInfo_rename_at_629_47,__context__));
}
...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    ...
    aotLib[0x2af26f08da38ed03] = +[](Context & ctx) -> SimNode* { // _FuncrttiTickclass_infoTick15801393167907430156_f71f3d89fb753b2
        return ctx.code->makeNode<SimNode_Aot<StructInfo const  * (*) ( Context * __context__, refactor::ExtractMethodMacro const  &  ),&_FuncrttiTickclass_infoTick15801393167907430156_f71f3d89fb753b2>>();
    };
    aotLib[0x3fdd65aa3293d0d8] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTickpushTick10769833213962245646_9a94d5ed4f7c5f3d
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, TArray<ast::AstCallMacro *> & , ast::AstCallMacro *  ),&_FuncbuiltinTickpushTick10769833213962245646_9a94d5ed4f7c5f3d>>();
    };
    aotLib[0xfe124f9bcef0523e] = +[](Context & ctx) -> SimNode* { // _FuncrttiTickclass_infoTick15801393167907430156_7fc1c676a0c803b0
        return ctx.code->makeNode<SimNode_Aot<StructInfo const  * (*) ( Context * __context__, refactor::ExtractVariableMacro const  &  ),&_FuncrttiTickclass_infoTick15801393167907430156_7fc1c676a0c803b0>>();
    };
    aotLib[0xe1a51901728bc04f] = +[](Context & ctx) -> SimNode* { // _FuncrttiTickclass_infoTick15801393167907430156_42f12d0f0ca9b24d
        return ctx.code->makeNode<SimNode_Aot<StructInfo const  * (*) ( Context * __context__, refactor::ExtractVariableFunction const  &  ),&_FuncrttiTickclass_infoTick15801393167907430156_42f12d0f0ca9b24d>>();
    };
    aotLib[0x5042114dcf9ac7a8] = +[](Context & ctx) -> SimNode* { // finalize_435c75a1641e15fa
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, AutoVariant<TTable<char *,json::JsonValue *>,TArray<json::JsonValue *>,char *,double,bool,void *> &  ),&finalize_435c75a1641e15fa>>();
    };
    ...
    aotLib[0xfd5b833add5565f4] = +[](Context & ctx) -> SimNode* { // _Funcjson_boostTickJVTick13966542468881610056_6e31ec00abc1b8a7
    ...
    aotLib[0xaf5f924cc62e5c1e] = +[](Context & ctx) -> SimNode* { // _FuncastTickmake_function_annotationTick3074191368936885601_95ba3a9d4de4e95b
        return ctx.code->makeNode<SimNode_Aot<smart_ptr_raw<FunctionAnnotation> (*) ( Context * __context__, char * const  , refactor::ExtractMethodMacro *  ),&_FuncastTickmake_function_annotationTick3074191368936885601_95ba3a9d4de4e95b>>();
    };
    aotLib[0x623f20bc72fba5e8] = +[](Context & ctx) -> SimNode* { // _FuncastTickmake_function_annotationTick3074191368936885601_e08431098b248a79
        return ctx.code->makeNode<SimNode_Aot<smart_ptr_raw<FunctionAnnotation> (*) ( Context * __context__, char * const  , refactor::ExtractVariableFunction *  ),&_FuncastTickmake_function_annotationTick3074191368936885601_e08431098b248a79>>();
    };
    aotLib[0x88b5cdec914a1cf1] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTickto_table_moveTick5858896087460481804_9bc7a430485b2b12
        return ctx.code->makeNode<SimNode_AotCMRES<TTable<char *,char *> (*) ( Context * __context__, TDim<AutoTuple<char *,char *>,6> &  ),&_FuncbuiltinTickto_table_moveTick5858896087460481804_9bc7a430485b2b12>>();
    };
    ...
    aotLib[0x9344d52fd248ddfa] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTicksortTick5995501125257068354_37074a96ed1276f6
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, TArray<macro_boost::CapturedVariable> & , Block DAS_COMMENT((bool,macro_boost::CapturedVariable const ,macro_boost::CapturedVariable const )) const  &  ),&_FuncbuiltinTicksortTick5995501125257068354_37074a96ed1276f6>>();
    };
    ...
    aotLib[0xd4192796e0f41fad] = +[](Context & ctx) -> SimNode* { // _Funcjson_boostTickJVTick13966542468881610056_1ada305f850b7c84
    ...
    aotLib[0x67f52afaba677a32] = +[](Context & ctx) -> SimNode* { // _Funcast_boostTicksetup_tag_annotationTick4095297895764883997_480816f933565535
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, char * const  , char * const  , refactor::ExtractMethodMacro *  ),&_Funcast_boostTicksetup_tag_annotationTick4095297895764883997_480816f933565535>>();
    };
    aotLib[0x602b1ac43b89d11b] = +[](Context & ctx) -> SimNode* { // _Funcast_boostTicksetup_tag_annotationTick4095297895764883997_a30263d9bfe747d3
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, char * const  , char * const  , refactor::ExtractVariableFunction *  ),&_Funcast_boostTicksetup_tag_annotationTick4095297895764883997_a30263d9bfe747d3>>();
    };
    aotLib[0xae7b5b7e5141af91] = +[](Context & ctx) -> SimNode* { // _Funcjson_boostTickJVTick13966542468881610056_802f12bd209d8b61
    ...
    aotLib[0x5686a48ef3d1db6e] = +[](Context & ctx) -> SimNode* { // JV_b6f7ce5a2e653514
