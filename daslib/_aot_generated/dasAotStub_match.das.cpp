...
inline Expression * _FuncbuiltinTickget_ptrTick5807679485210906136_e7e091949cec6eca ( Context * __context__, smart_ptr<Expression> __src_rename_at_1732_11 );
...
inline Expression * _FuncbuiltinTickget_ptrTick8468476673553620226_1bb8b96fa387e2c9 ( Context * __context__, smart_ptr<Expression> const  __src_rename_at_1726_66 );
...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    ...
    aotLib[0x90ce7b780ab559b3] = +[](Context & ctx) -> SimNode* { // _FuncrttiTickclass_infoTick15801393167907430156_14482599e5d01774
        return ctx.code->makeNode<SimNode_Aot<StructInfo const  * (*) ( Context * __context__, match::MatchMacro const  &  ),&_FuncrttiTickclass_infoTick15801393167907430156_14482599e5d01774>>();
    };
    aotLib[0x3096cfdd34ff84b0] = +[](Context & ctx) -> SimNode* { // _FuncrttiTickclass_infoTick15801393167907430156_cb4cd03341f58180
        return ctx.code->makeNode<SimNode_Aot<StructInfo const  * (*) ( Context * __context__, match::StaticMatchMacro const  &  ),&_FuncrttiTickclass_infoTick15801393167907430156_cb4cd03341f58180>>();
    };
    aotLib[0x847f38a00e8e7e8d] = +[](Context & ctx) -> SimNode* { // _FuncrttiTickclass_infoTick15801393167907430156_4a6f9c0a519aac5b
        return ctx.code->makeNode<SimNode_Aot<StructInfo const  * (*) ( Context * __context__, match::MultiMatchMacro const  &  ),&_FuncrttiTickclass_infoTick15801393167907430156_4a6f9c0a519aac5b>>();
    };
    aotLib[0x8d92289ec99ae4e4] = +[](Context & ctx) -> SimNode* { // _FuncrttiTickclass_infoTick15801393167907430156_7cd1d67f64fe3e91
        return ctx.code->makeNode<SimNode_Aot<StructInfo const  * (*) ( Context * __context__, match::StaticMultiMatchMacro const  &  ),&_FuncrttiTickclass_infoTick15801393167907430156_7cd1d67f64fe3e91>>();
    };
    ...
    aotLib[0x9aa6322995645e2c] = +[](Context & ctx) -> SimNode* { // _FuncrttiTickclass_infoTick15801393167907430156_7ba19a495954c081
        return ctx.code->makeNode<SimNode_Aot<StructInfo const  * (*) ( Context * __context__, match::MatchAsIs const  &  ),&_FuncrttiTickclass_infoTick15801393167907430156_7ba19a495954c081>>();
    };
    aotLib[0xf92ab6937854236c] = +[](Context & ctx) -> SimNode* { // _FuncrttiTickclass_infoTick15801393167907430156_76522b9b3e47321
        return ctx.code->makeNode<SimNode_Aot<StructInfo const  * (*) ( Context * __context__, match::MatchCopy const  &  ),&_FuncrttiTickclass_infoTick15801393167907430156_76522b9b3e47321>>();
    };
    ...
    aotLib[0xf2cd6da948827d52] = +[](Context & ctx) -> SimNode* { // _Funcast_boostTickconvert_to_expressionTick11707039267614988023_ad6868fe4237fa10
    ...
    aotLib[0x574517dc6880c7c7] = +[](Context & ctx) -> SimNode* { // _Funcast_boostTickconvert_to_expressionTick2307832460972925437_9df83295710ab92
    ...
    aotLib[0x2071654b51fc0c3c] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTickfinalizeTick13836114024949725080_5dcbdce47081955f
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, TArray<smart_ptr_raw<ExprIfThenElse>> &  ),&_FuncbuiltinTickfinalizeTick13836114024949725080_5dcbdce47081955f>>();
    };
    ...
    aotLib[0x854a274a3c6b7e0f] = +[](Context & ctx) -> SimNode* { // finalize_6a3a1e840a2c86c6
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, match::MatchTo &  ),&finalize_6a3a1e840a2c86c6>>();
    };
    ...
    aotLib[0xaca0dd8b4d6252a1] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTickemplaceTick13923705686753630697_c7cece75493a5357
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, TArray<smart_ptr_raw<ExprIfThenElse>> & , smart_ptr_raw<ExprIfThenElse> &  ),&_FuncbuiltinTickemplaceTick13923705686753630697_c7cece75493a5357>>();
    };
