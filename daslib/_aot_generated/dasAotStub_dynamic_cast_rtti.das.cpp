...
inline smart_ptr_raw<Expression> _FuncbuiltinTickadd_ptr_refTick918185754185293024_1239f5efeee7e02b ( Context * __context__, smart_ptr<Expression> const  __src_rename_at_1744_7 );
...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    ...
    aotLib[0xfa21a95f35ee6f9f] = +[](Context & ctx) -> SimNode* { // _FuncrttiTickclass_infoTick15801393167907430156_fc51eeac631cc95
        return ctx.code->makeNode<SimNode_Aot<StructInfo const  * (*) ( Context * __context__, dynamic_cast_rtti::ClassAsIs const  &  ),&_FuncrttiTickclass_infoTick15801393167907430156_fc51eeac631cc95>>();
    };
