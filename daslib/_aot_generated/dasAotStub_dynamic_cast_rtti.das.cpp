...
namespace das {
namespace _anon_6666896008859407974 {
...
static_assert(sizeof(ClassAsIs)==40,"structure size mismatch with DAS");
static_assert(offsetof(ClassAsIs,__rtti)==0,"structure field offset mismatch with DAS");
static_assert(offsetof(ClassAsIs,__finalize)==8,"structure field offset mismatch with DAS");
static_assert(offsetof(ClassAsIs,visitExprIsVariant)==16,"structure field offset mismatch with DAS");
static_assert(offsetof(ClassAsIs,visitExprAsVariant)==24,"structure field offset mismatch with DAS");
static_assert(offsetof(ClassAsIs,visitExprSafeAsVariant)==32,"structure field offset mismatch with DAS");
}
...
inline void _FuncbuiltinTickpushTick10769833213962245646_5fc7cdb5157ef6b5 ( Context * __context__, TArray<ast::AstVariantMacro *> & __Arr_rename_at_181_2, ast::AstVariantMacro * __value_rename_at_181_3 );
inline StructInfo const  * _FuncrttiTickclass_infoTick15801393167907430156_8c96e1644433a90c ( Context * __context__, dynamic_cast_rtti::ClassAsIs const  & __cl_rename_at_116_4 );
inline smart_ptr_raw<Expression> _FuncbuiltinTickclone_to_moveTick2007252383599261567_f2b3835e02761391 ( Context * __context__, smart_ptr_raw<Expression> const  __clone_src_rename_at_1057_5 );
inline smart_ptr_raw<Expression> _FuncbuiltinTickadd_ptr_refTick918185754185293024_1239f5efeee7e02b ( Context * __context__, smart_ptr<Expression> const  __src_rename_at_1745_7 );
...
inline smart_ptr_raw<Expression> _FuncbuiltinTickadd_ptr_refTick918185754185293024_1239f5efeee7e02b ( Context * __context__, smart_ptr<Expression> const  __src_rename_at_1745_7 )
{
    smart_ptr_raw<Expression> __dst_rename_at_1747_8; das_zero(__dst_rename_at_1747_8); das_move(__dst_rename_at_1747_8, _FuncbuiltinTickclone_to_moveTick2007252383599261567_f2b3835e02761391(__context__,das_cast<smart_ptr_raw<Expression>>::cast(__src_rename_at_1745_7)));
...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    ...
    aotLib[0x3b449fe5ecd55896] = +[](Context & ctx) -> SimNode* { // _FuncrttiTickclass_infoTick15801393167907430156_8c96e1644433a90c
        return ctx.code->makeNode<SimNode_Aot<StructInfo const  * (*) ( Context * __context__, dynamic_cast_rtti::ClassAsIs const  &  ),&_FuncrttiTickclass_infoTick15801393167907430156_8c96e1644433a90c>>();
    };
    aotLib[0x8dda8ab561179a1d] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTickclone_to_moveTick2007252383599261567_f2b3835e02761391
        return ctx.code->makeNode<SimNode_Aot<smart_ptr_raw<Expression> (*) ( Context * __context__, smart_ptr_raw<Expression> const   ),&_FuncbuiltinTickclone_to_moveTick2007252383599261567_f2b3835e02761391>>();
    };
    aotLib[0xe6569bb0f6883bd0] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTickadd_ptr_refTick918185754185293024_1239f5efeee7e02b
        return ctx.code->makeNode<SimNode_Aot<smart_ptr_raw<Expression> (*) ( Context * __context__, smart_ptr<Expression> const   ),&_FuncbuiltinTickadd_ptr_refTick918185754185293024_1239f5efeee7e02b>>();
    };
	resolveTypeInfoAnnotations();
}

} // namespace _anon_6666896008859407974
AotListBase impl_aot_dynamic_cast_rtti(_anon_6666896008859407974::registerAotFunctions);
} // namespace das
