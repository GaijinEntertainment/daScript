...
namespace das {
namespace _anon_3220451013671923165 {
...
inline void _FuncbuiltinTickfinalizeTick13836114024949725080_947eb3679f75acfb ( Context * __context__, TArray<uint8_t> & __a_rename_at_1183_10 );
...
inline TTuple<16,char *,int32_t> base64_decode_3d5513d573c262f1 ( Context * __context__, char * const  ___in_rename_at_59_20 );
...
inline void _FuncbuiltinTickfinalizeTick13836114024949725080_947eb3679f75acfb ( Context * __context__, TArray<uint8_t> &  __a_rename_at_1183_10 )
{
    builtin_array_free(das_arg<TArray<uint8_t>>::pass(__a_rename_at_1183_10),1,__context__,((LineInfoArg *)(&LineInfo::g_LineInfoNULL)));
}
...
inline TTuple<16,char *,int32_t> base64_decode_3d5513d573c262f1 ( Context * __context__, char * const  ___in_rename_at_59_20 ) { das_stack_prologue __prologue(__context__,160,"base64_decode " DAS_FILE_LINE);
{
    ...
    return das_auto_cast_ref<TTuple<16,char *,int32_t>>::cast((([&]() -> TTuple<16,char *,int32_t> {
        TTuple<16,char *,int32_t> __mkt_66;
        das_get_tuple_field<char *,0>::get(__mkt_66) = ((char * const )(builtin_string_from_array(das_arg<TArray<uint8_t>>::pass(__out_rename_at_61_21),__context__,((LineInfoArg *)(&LineInfo::g_LineInfoNULL)))));
        das_get_tuple_field<int32_t,8>::get(__mkt_66) = __outlen_rename_at_62_22;
        return __mkt_66;
    })()));
}}
...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    ...
    aotLib[0x9f60f64d62951eb2] = +[](Context & ctx) -> SimNode* { // _Funcbase64Tickbase64_decodeTick6318730225425972510_f3ca55d5d6b47398
        return ctx.code->makeNode<SimNode_Aot<int32_t (*) ( Context * __context__, TArray<uint8_t> const  & , TArray<uint8_t> &  ),&_Funcbase64Tickbase64_decodeTick6318730225425972510_f3ca55d5d6b47398>>();
    };
    ...
    aotLib[0x8f0063f632262254] = +[](Context & ctx) -> SimNode* { // _Funcbase64Tickbase64_encodeTick16780245076805804220_3d161b0536e07d09
        return ctx.code->makeNode<SimNode_Aot<char * (*) ( Context * __context__, TArray<uint8_t> const  &  ),&_Funcbase64Tickbase64_encodeTick16780245076805804220_3d161b0536e07d09>>();
    };
    aotLib[0x6e4d312664a2e0a5] = +[](Context & ctx) -> SimNode* { // BASE64_DECODE_OUT_SIZE_52c7be8c3e0ae854
        return ctx.code->makeNode<SimNode_Aot<int32_t (*) ( Context * __context__, int32_t  ),&BASE64_DECODE_OUT_SIZE_52c7be8c3e0ae854>>();
    };
    aotLib[0xe75e6fa2c152211f] = +[](Context & ctx) -> SimNode* { // BASE64_ENCODE_OUT_SIZE_5f651cc9c2907b91
        return ctx.code->makeNode<SimNode_Aot<int32_t (*) ( Context * __context__, int32_t  ),&BASE64_ENCODE_OUT_SIZE_5f651cc9c2907b91>>();
    };
    aotLib[0x662428414d9da582] = +[](Context & ctx) -> SimNode* { // base64_decode_3d5513d573c262f1
        return ctx.code->makeNode<SimNode_AotCMRES<TTuple<16,char *,int32_t> (*) ( Context * __context__, char * const   ),&base64_decode_3d5513d573c262f1>>();
    };
    aotLib[0x1124ea3fff3a8fd0] = +[](Context & ctx) -> SimNode* { // base64_decode_2e5f373672d155a6
        return ctx.code->makeNode<SimNode_Aot<int32_t (*) ( Context * __context__, char * const  , TArray<uint8_t> &  ),&base64_decode_2e5f373672d155a6>>();
    };
    aotLib[0x1690e9f77ac4d037] = +[](Context & ctx) -> SimNode* { // base64_encode_80cb32b433fba65f
        return ctx.code->makeNode<SimNode_Aot<char * (*) ( Context * __context__, char * const   ),&base64_encode_80cb32b433fba65f>>();
    };
    // [[ init script ]]
...
AotListBase impl_aot_base64(_anon_3220451013671923165::registerAotFunctions);
} // namespace das
