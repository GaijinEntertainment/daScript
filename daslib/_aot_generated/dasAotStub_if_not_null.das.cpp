...
inline smart_ptr_raw<Expression> _FuncbuiltinTickclone_to_moveTick2007252383599261567_f072870b89539ecd ( Context * __context__, smart_ptr_raw<Expression> const  __clone_src_rename_at_1089_2 );
...
inline smart_ptr_raw<Expression> _FuncbuiltinTickadd_ptr_refTick918185754185293024_f22c6071e6b0ab0b ( Context * __context__, smart_ptr_raw<Expression> const  __src_rename_at_1777_7 );
...
inline smart_ptr_raw<Expression> _FuncbuiltinTickadd_ptr_refTick918185754185293024_f22c6071e6b0ab0b ( Context * __context__, smart_ptr_raw<Expression> const  __src_rename_at_1777_7 )
{
    smart_ptr_raw<Expression> __dst_rename_at_1779_8; das_zero(__dst_rename_at_1779_8); das_move(__dst_rename_at_1779_8, _FuncbuiltinTickclone_to_moveTick2007252383599261567_f072870b89539ecd(__context__,das_cast<smart_ptr_raw<Expression>>::cast(__src_rename_at_1777_7)));
