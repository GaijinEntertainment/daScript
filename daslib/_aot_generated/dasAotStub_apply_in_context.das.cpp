...
inline StructInfo const  * _FuncrttiTickclass_infoTick15801393167907430156_d5670a1526eca536 ( Context * __context__, apply_in_context::AppendCondAnnotation const  & __cl_rename_at_116_2 );
inline void _FuncbuiltinTickemplace_newTick990257600204377963_3af2bc704dc8522 ( Context * __context__, TArray<smart_ptr_raw<Expression>> & __Arr_rename_at_1036_7, smart_ptr_raw<Expression> __value_rename_at_1036_8 );
inline smart_ptr_raw<Expression> _Funcast_boostTickconvert_to_expressionTick2307832460972925437_1353e3976627f140 ( Context * __context__, char * __value_rename_at_878_9 );
inline void _FuncbuiltinTickfinalizeTick13836114024949725080_9f199f97decbabbe ( Context * __context__, TArray<smart_ptr_raw<Expression>> & __a_rename_at_1215_10 );
inline void _FuncbuiltinTickfinalizeTick13836114024949725080_70f04f60487df041 ( Context * __context__, TArray<smart_ptr_raw<Variable>> & __a_rename_at_1215_12 );
inline char * _FuncastTickdescribeTick2562845734617055679_b1fd376d21aa823f ( Context * __context__, smart_ptr_raw<TypeDecl> const  __decl_rename_at_38_14, bool __extra_rename_at_38_15, bool __contracts_rename_at_38_16, bool __modules_rename_at_38_17 );
inline void _FuncbuiltinTickemplace_newTick990257600204377963_41746a9dfe098539 ( Context * __context__, TArray<smart_ptr_raw<Variable>> & __Arr_rename_at_1036_18, smart_ptr_raw<Variable> __value_rename_at_1036_19 );
inline void clone_c457b03ffcf7a4b5 ( Context * __context__, smart_ptr_raw<Expression> & __dest_rename_at_103_20, void * const  __src_rename_at_103_21 );
...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    ...
    aotLib[0x9cacde66afd117ce] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncrttiTickclass_infoTick15801393167907430156_d5670a1526eca536>>();
    };
    ...
    aotLib[0x7cbce32259e1125a] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_Funcast_boostTickconvert_to_expressionTick2307832460972925437_1353e3976627f140>>();
    };
