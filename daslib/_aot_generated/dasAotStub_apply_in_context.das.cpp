...
static_assert(sizeof(AppendCondAnnotation)==112,"structure size mismatch with DAS");
static_assert(offsetof(AppendCondAnnotation,__rtti)==0,"structure field offset mismatch with DAS");
static_assert(offsetof(AppendCondAnnotation,__finalize)==8,"structure field offset mismatch with DAS");
static_assert(offsetof(AppendCondAnnotation,transform)==16,"structure field offset mismatch with DAS");
static_assert(offsetof(AppendCondAnnotation,verifyCall)==24,"structure field offset mismatch with DAS");
static_assert(offsetof(AppendCondAnnotation,apply)==32,"structure field offset mismatch with DAS");
static_assert(offsetof(AppendCondAnnotation,generic_apply)==40,"structure field offset mismatch with DAS");
static_assert(offsetof(AppendCondAnnotation,finish)==48,"structure field offset mismatch with DAS");
static_assert(offsetof(AppendCondAnnotation,patch)==56,"structure field offset mismatch with DAS");
static_assert(offsetof(AppendCondAnnotation,fixup)==64,"structure field offset mismatch with DAS");
static_assert(offsetof(AppendCondAnnotation,lint)==72,"structure field offset mismatch with DAS");
static_assert(offsetof(AppendCondAnnotation,complete)==80,"structure field offset mismatch with DAS");
static_assert(offsetof(AppendCondAnnotation,isCompatible)==88,"structure field offset mismatch with DAS");
static_assert(offsetof(AppendCondAnnotation,isSpecialized)==96,"structure field offset mismatch with DAS");
static_assert(offsetof(AppendCondAnnotation,appendToMangledName)==104,"structure field offset mismatch with DAS");
}
...
inline StructInfo const  * _FuncrttiTickclass_infoTick15801393167907430156_e490f6030169654c ( Context * __context__, apply_in_context::AppendCondAnnotation const  & __cl_rename_at_116_2 );
inline smart_ptr_raw<Expression> _Funcast_boostTickconvert_to_expressionTick2307832460972925437_18f6180a84ebd1be ( Context * __context__, char * __value_rename_at_799_7 );
inline void _FuncbuiltinTickfinalizeTick13836114024949725080_473a42788c45df36 ( Context * __context__, TArray<smart_ptr_raw<Expression>> & __a_rename_at_1183_8 );
inline void _FuncbuiltinTickfinalizeTick13836114024949725080_c6f9bc68b25c5dd6 ( Context * __context__, TArray<smart_ptr_raw<Variable>> & __a_rename_at_1183_10 );
inline char * _FuncastTickdescribeTick2562845734617055679_2756234bd8d22e89 ( Context * __context__, smart_ptr_raw<TypeDecl> const  __decl_rename_at_37_12, bool __extra_rename_at_37_13, bool __contracts_rename_at_37_14, bool __modules_rename_at_37_15 );
inline void clone_7cec36cff492af46 ( Context * __context__, smart_ptr<Expression> & __dest_rename_at_103_16, void * const  __src_rename_at_103_17 );
...
{
    {
        ...
        das_iterator<TArray<smart_ptr_raw<Expression>>> __aV_iterator(__a_rename_at_1183_8);
        smart_ptr_raw<Expression> * __aV_rename_at_1185_9;
        __need_loop_1185 = __aV_iterator.first(__context__,(__aV_rename_at_1185_9)) && __need_loop_1185;
        for ( ; __need_loop_1185 ; __need_loop_1185 = __aV_iterator.next(__context__,(__aV_rename_at_1185_9)) )
        {
            das_delete_handle<smart_ptr_raw<Expression>>::clear(__context__,(*__aV_rename_at_1185_9));
        }
        __aV_iterator.close(__context__,(__aV_rename_at_1185_9));
    };
    builtin_array_free(das_arg<TArray<smart_ptr_raw<Expression>>>::pass(__a_rename_at_1183_8),8,__context__,((LineInfoArg *)(&LineInfo::g_LineInfoNULL)));
}
...
{
    {
        ...
        das_iterator<TArray<smart_ptr_raw<Variable>>> __aV_iterator(__a_rename_at_1183_10);
        smart_ptr_raw<Variable> * __aV_rename_at_1185_11;
        ...
        {
            das_delete_handle<smart_ptr_raw<Variable>>::clear(__context__,(*__aV_rename_at_1185_11));
        }
        __aV_iterator.close(__context__,(__aV_rename_at_1185_11));
    };
    builtin_array_free(das_arg<TArray<smart_ptr_raw<Variable>>>::pass(__a_rename_at_1183_10),8,__context__,((LineInfoArg *)(&LineInfo::g_LineInfoNULL)));
}

inline char * _FuncastTickdescribeTick2562845734617055679_2756234bd8d22e89 ( Context * __context__, smart_ptr_raw<TypeDecl> const  __decl_rename_at_37_12, bool __extra_rename_at_37_13, bool __contracts_rename_at_37_14, bool __modules_rename_at_37_15 )
{
    return das_auto_cast<char *>::cast(((char * const )(ast_describe_typedecl(__decl_rename_at_37_12,__extra_rename_at_37_13,__contracts_rename_at_37_14,__modules_rename_at_37_15,__context__,((LineInfoArg *)(&LineInfo::g_LineInfoNULL))))));
}
...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    ...
    aotLib[0xfbc2961d4347f1e5] = +[](Context & ctx) -> SimNode* { // _FuncrttiTickclass_infoTick15801393167907430156_e490f6030169654c
        return ctx.code->makeNode<SimNode_Aot<StructInfo const  * (*) ( Context * __context__, apply_in_context::AppendCondAnnotation const  &  ),&_FuncrttiTickclass_infoTick15801393167907430156_e490f6030169654c>>();
    };
    aotLib[0xd8a5dfa304e0643a] = +[](Context & ctx) -> SimNode* { // _Funcast_boostTickconvert_to_expressionTick2307832460972925437_18f6180a84ebd1be
        return ctx.code->makeNode<SimNode_Aot<smart_ptr_raw<Expression> (*) ( Context * __context__, char *  ),&_Funcast_boostTickconvert_to_expressionTick2307832460972925437_18f6180a84ebd1be>>();
    };
