...
inline uint32_t _FuncrandomTickrandom_uintTick15141358123050100739_ef3b7f931cb99db2 ( Context * __context__, int4 & __seed_rename_at_45_0 );
inline void finalize_834bc34bd1cb6e89 ( Context * __context__, random::_lambda_random_111_1 & ____this_rename_at_111_2 );
inline Sequence DAS_COMMENT((uint32_t)) _FuncbuiltinTickeachTick9663565701927713696_7cf84d67740fc90e ( Context * __context__, Lambda DAS_COMMENT((bool,uint32_t &)) const  __lam_rename_at_1322_3 );
inline int4 _FuncrandomTickrandom_seedTick15287272150245073176_260f06c48ec316a5 ( Context * __context__, int32_t __seed_rename_at_16_5 );
inline bool _Func_lambda_random_111_1Tickfunction_51ddc37ab71cce7d ( Context * __context__, random::_lambda_random_111_1 & ____this_rename_at_111_6, uint32_t & ___yield_111_rename_at_111_7 );
inline void _Func_lambda_random_111_1Tickfinalizer_bc7faabb247cb756 ( Context * __context__, random::_lambda_random_111_1 * ____this_rename_at_111_8 );
inline Sequence DAS_COMMENT((uint32_t)) each_random_uint_37d32fa983e97304 ( Context * __context__, int32_t __rnd_seed_rename_at_110_9 );
...
inline bool _Func_lambda_random_111_1Tickfunction_51ddc37ab71cce7d ( Context * __context__, random::_lambda_random_111_1 &  ____this_rename_at_111_6, uint32_t & ___yield_111_rename_at_111_7 )
{
    ...
    label_0:;;
    das_copy(____this_rename_at_111_6.seed,_FuncrandomTickrandom_seedTick15287272150245073176_260f06c48ec316a5(__context__,____this_rename_at_111_6.rnd_seed));
    label_1:;;
    das_copy(___yield_111_rename_at_111_7,_FuncrandomTickrandom_uintTick15141358123050100739_ef3b7f931cb99db2(__context__,____this_rename_at_111_6.seed));
...
inline void _Func_lambda_random_111_1Tickfinalizer_bc7faabb247cb756 ( Context * __context__, random::_lambda_random_111_1 * ____this_rename_at_111_8 )
{
    finalize_834bc34bd1cb6e89(__context__,das_arg<random::_lambda_random_111_1>::pass(das_deref(__context__,____this_rename_at_111_8)));
    das_delete_lambda_struct<random::_lambda_random_111_1 *>::clear(__context__,____this_rename_at_111_8);
}

inline Sequence DAS_COMMENT((uint32_t)) each_random_uint_37d32fa983e97304 ( Context * __context__, int32_t __rnd_seed_rename_at_110_9 )
{
    return /* <- */ das_auto_cast_move<Sequence DAS_COMMENT((uint32_t))>::cast(_FuncbuiltinTickeachTick9663565701927713696_7cf84d67740fc90e(__context__,das_ascend<bool,random::_lambda_random_111_1>::make(__context__,&__type_info__9a1e4d1c219d09d2,(([&]() -> random::_lambda_random_111_1 {
...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    aotLib[0x25d9f7e18294f72e] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncrandomTickrandom_uintTick15141358123050100739_ef3b7f931cb99db2>>();
    };
    aotLib[0x513767af907a7f77] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&finalize_834bc34bd1cb6e89>>();
    };
    aotLib[0x5c350bb789b008b4] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_AotCMRES<&_FuncbuiltinTickeachTick9663565701927713696_7cf84d67740fc90e>>();
    };
    aotLib[0x51b33da40512b394] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncrandomTickrandom_seedTick15287272150245073176_260f06c48ec316a5>>();
    };
    aotLib[0xf5fe403cb054c3ba] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_Func_lambda_random_111_1Tickfunction_51ddc37ab71cce7d>>();
    };
    aotLib[0x1d7b856d500dae3] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_Func_lambda_random_111_1Tickfinalizer_bc7faabb247cb756>>();
    };
    aotLib[0x6d0cbf4452a1fba] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_AotCMRES<&each_random_uint_37d32fa983e97304>>();
    };
    // [[ init script ]]
