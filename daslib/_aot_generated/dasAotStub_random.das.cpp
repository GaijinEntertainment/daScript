...
VarInfo __struct_info__cbf23cd3d353cb53_field_1 =  { Type::tFunction, nullptr, nullptr, nullptr, &__type_info__af63eb4c86020609, nullptr, (TypeInfo **)__type_info__e568005b4bb4b751_arg_types_var_14695875414544599891, __type_info__e568005b4bb4b751_arg_names_var_14695875414544599891, 1, 0, nullptr, 12, 8, UINT64_C(0xe568005b4bb4b751), "__finalize", 8, 0 };
VarInfo __struct_info__cbf23cd3d353cb53_field_2 =  { Type::tInt, nullptr, nullptr, nullptr, nullptr, nullptr, nullptr, nullptr, 0, 0, nullptr, 28, 4, UINT64_C(0xa88be1f0aee7ad04), "__yield", 16, 0 };
VarInfo __struct_info__cbf23cd3d353cb53_field_3 =  { Type::tInt, nullptr, nullptr, nullptr, nullptr, nullptr, nullptr, nullptr, 0, 0, nullptr, 28, 4, UINT64_C(0xf1dfb90660a0c61a), "rnd_seed", 20, 0 };
VarInfo __struct_info__cbf23cd3d353cb53_field_4 =  { Type::tInt4, nullptr, nullptr, nullptr, nullptr, nullptr, nullptr, nullptr, 0, 0, nullptr, 28, 16, UINT64_C(0x158534154e75611d), "seed", 24, 0 };
...
static_assert(sizeof(_lambda_random_111_1)==40,"structure size mismatch with DAS");
static_assert(offsetof(_lambda_random_111_1,__lambda)==0,"structure field offset mismatch with DAS");
static_assert(offsetof(_lambda_random_111_1,__finalize)==8,"structure field offset mismatch with DAS");
static_assert(offsetof(_lambda_random_111_1,__yield)==16,"structure field offset mismatch with DAS");
static_assert(offsetof(_lambda_random_111_1,rnd_seed)==20,"structure field offset mismatch with DAS");
static_assert(offsetof(_lambda_random_111_1,seed)==24,"structure field offset mismatch with DAS");
}
...
inline Sequence DAS_COMMENT((uint32_t)) _FuncbuiltinTickeachTick9663565701927713696_aee705fe23b1c7b9 ( Context * __context__, Lambda DAS_COMMENT((bool,uint32_t &)) const  __lam_rename_at_1290_3 );
...
inline void finalize_4ae6526745d6b78f ( Context * __context__, random::_lambda_random_111_1 &  ____this_rename_at_111_2 )
{
    memset(&(____this_rename_at_111_2), 0, 40);
}

inline Sequence DAS_COMMENT((uint32_t)) _FuncbuiltinTickeachTick9663565701927713696_aee705fe23b1c7b9 ( Context * __context__, Lambda DAS_COMMENT((bool,uint32_t &)) const  __lam_rename_at_1290_3 )
{
    Sequence DAS_COMMENT((uint32_t)) __it_rename_at_1292_4; das_zero(__it_rename_at_1292_4);
    builtin_make_lambda_iterator(das_arg<Sequence DAS_COMMENT((uint32_t))>::pass(__it_rename_at_1292_4),__lam_rename_at_1290_3,4,__context__,((LineInfoArg *)(&LineInfo::g_LineInfoNULL)));
    return /* <- */ das_auto_cast_move<Sequence DAS_COMMENT((uint32_t))>::cast(__it_rename_at_1292_4);
}
...
inline Sequence DAS_COMMENT((uint32_t)) each_random_uint_afea9e974e8227bf ( Context * __context__, int32_t __rnd_seed_rename_at_110_9 )
{
    return /* <- */ das_auto_cast_move<Sequence DAS_COMMENT((uint32_t))>::cast(_FuncbuiltinTickeachTick9663565701927713696_aee705fe23b1c7b9(__context__,das_ascend<bool,random::_lambda_random_111_1>::make(__context__,&__type_info__9a1e4d1c219d09d2,(([&]() -> random::_lambda_random_111_1 {
        ...
        das_zero(__mks_111);
        das_copy((__mks_111.__lambda),(Func(__context__->fnByMangledName(/*@random::_lambda_random_111_1`function XS<random::_lambda_random_111_1> &u*/ 13066077622209519560u))));
        das_copy((__mks_111.__finalize),(Func(__context__->fnByMangledName(/*@random::_lambda_random_111_1`finalizer X1<S<random::_lambda_random_111_1>>?*/ 10047542400742821959u))));
...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    aotLib[0x390bb07ee4f51e50] = +[](Context & ctx) -> SimNode* { // _FuncrandomTickrandom_uintTick15141358123050100739_ace3444e720a3102
        return ctx.code->makeNode<SimNode_Aot<uint32_t (*) ( Context * __context__, int4 &  ),&_FuncrandomTickrandom_uintTick15141358123050100739_ace3444e720a3102>>();
    };
    aotLib[0x78e003330fac06f1] = +[](Context & ctx) -> SimNode* { // finalize_4ae6526745d6b78f
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, random::_lambda_random_111_1 &  ),&finalize_4ae6526745d6b78f>>();
    };
    aotLib[0xbdd618fbc7ac3e7d] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTickeachTick9663565701927713696_aee705fe23b1c7b9
        return ctx.code->makeNode<SimNode_AotCMRES<Sequence DAS_COMMENT((uint32_t)) (*) ( Context * __context__, Lambda DAS_COMMENT((bool,uint32_t &)) const   ),&_FuncbuiltinTickeachTick9663565701927713696_aee705fe23b1c7b9>>();
    };
    aotLib[0x6fb77c0f7353e48d] = +[](Context & ctx) -> SimNode* { // _FuncrandomTickrandom_seedTick15287272150245073176_dd30826a0cea51ed
        return ctx.code->makeNode<SimNode_Aot<int4 (*) ( Context * __context__, int32_t  ),&_FuncrandomTickrandom_seedTick15287272150245073176_dd30826a0cea51ed>>();
    };
    aotLib[0xabd94a563e16633e] = +[](Context & ctx) -> SimNode* { // _Func_lambda_random_111_1Tickfunction_f401add82667d26
        return ctx.code->makeNode<SimNode_Aot<bool (*) ( Context * __context__, random::_lambda_random_111_1 & , uint32_t &  ),&_Func_lambda_random_111_1Tickfunction_f401add82667d26>>();
    };
    aotLib[0xc930f58f7e2fe2df] = +[](Context & ctx) -> SimNode* { // _Func_lambda_random_111_1Tickfinalizer_a949ea6b2586918a
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, random::_lambda_random_111_1 *  ),&_Func_lambda_random_111_1Tickfinalizer_a949ea6b2586918a>>();
    };
    aotLib[0x60d5f8aa8ce7975b] = +[](Context & ctx) -> SimNode* { // each_random_uint_afea9e974e8227bf
        return ctx.code->makeNode<SimNode_AotCMRES<Sequence DAS_COMMENT((uint32_t)) (*) ( Context * __context__, int32_t  ),&each_random_uint_afea9e974e8227bf>>();
    };
    // [[ init script ]]
