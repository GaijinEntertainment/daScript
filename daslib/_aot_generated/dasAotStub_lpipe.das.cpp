...
namespace das {
namespace _anon_14365561541905494207 {
...
static_assert(sizeof(LpipeMacro)==48,"structure size mismatch with DAS");
static_assert(offsetof(LpipeMacro,__rtti)==0,"structure field offset mismatch with DAS");
static_assert(offsetof(LpipeMacro,__finalize)==8,"structure field offset mismatch with DAS");
static_assert(offsetof(LpipeMacro,preVisit)==16,"structure field offset mismatch with DAS");
static_assert(offsetof(LpipeMacro,visit)==24,"structure field offset mismatch with DAS");
static_assert(offsetof(LpipeMacro,canVisitArgument)==32,"structure field offset mismatch with DAS");
static_assert(offsetof(LpipeMacro,canFoldReturnResult)==40,"structure field offset mismatch with DAS");
}
...
inline StructInfo const  * _FuncrttiTickclass_infoTick15801393167907430156_c2226896bb23013a ( Context * __context__, lpipe::LpipeMacro const  & __cl_rename_at_116_2 );
...
inline smart_ptr_raw<Expression> lpipe_expr_e67a42ebecb119e3 ( Context * __context__, smart_ptr_raw<Expression> & __fnCall_rename_at_15_3, smart_ptr_raw<Expression> & __arg_rename_at_15_4 )
{
    ExprVar * __pVar_rename_at_17_5; memset(&__pVar_rename_at_17_5,0,sizeof(__pVar_rename_at_17_5));
    smart_ptr<Expression> __pCall_rename_at_18_6; memset(&__pCall_rename_at_18_6,0,sizeof(__pCall_rename_at_18_6));
    ExprLooksLikeCall * __pCallFunc_rename_at_20_7; memset(&__pCallFunc_rename_at_20_7,0,sizeof(__pCallFunc_rename_at_20_7));
    smart_ptr<Expression> __cCopy_rename_at_24_8; memset(&__cCopy_rename_at_24_8,0,sizeof(__cCopy_rename_at_24_8));
    smart_ptr<Expression> __cCopy_rename_at_28_9; memset(&__cCopy_rename_at_28_9,0,sizeof(__cCopy_rename_at_28_9));
    smart_ptr<Expression> __cCopy_rename_at_32_10; memset(&__cCopy_rename_at_32_10,0,sizeof(__cCopy_rename_at_32_10));
    smart_ptr<Expression> ___VarcLetTickatTick41Tick20_rename_at_41_11; memset(&___VarcLetTickatTick41Tick20_rename_at_41_11,0,sizeof(___VarcLetTickatTick41Tick20_rename_at_41_11));
    ExprLet * __pLet_rename_at_36_12; memset(&__pLet_rename_at_36_12,0,sizeof(__pLet_rename_at_36_12));
    if ( SimPolicy<char *>::Equ(cast<char *>::from(__fnCall_rename_at_15_3->__rtti /*__rtti*/),cast<char *>::from(((char *) "ExprVar")),*__context__,nullptr) )
    {
        ...
        das_delete_handle<smart_ptr<Expression>>::clear(__context__,__pCall_rename_at_18_6);
        /* end finally */ });
    ...
    } else if ( SimPolicy<char *>::Equ(cast<char *>::from(__fnCall_rename_at_15_3->__rtti /*__rtti*/),cast<char *>::from(((char *) "ExprCopy")),*__context__,nullptr) )
    {
        ...
        das_delete_handle<smart_ptr<Expression>>::clear(__context__,__cCopy_rename_at_24_8);
        /* end finally */ });
    ...
    } else if ( SimPolicy<char *>::Equ(cast<char *>::from(__fnCall_rename_at_15_3->__rtti /*__rtti*/),cast<char *>::from(((char *) "ExprMove")),*__context__,nullptr) )
    {
        ...
        das_delete_handle<smart_ptr<Expression>>::clear(__context__,__cCopy_rename_at_28_9);
        /* end finally */ });
    ...
    } else if ( SimPolicy<char *>::Equ(cast<char *>::from(__fnCall_rename_at_15_3->__rtti /*__rtti*/),cast<char *>::from(((char *) "ExprClone")),*__context__,nullptr) )
    {
        ...
        das_delete_handle<smart_ptr<Expression>>::clear(__context__,__cCopy_rename_at_32_10);
        /* end finally */ });
    ...
    } else if ( SimPolicy<char *>::Equ(cast<char *>::from(__fnCall_rename_at_15_3->__rtti /*__rtti*/),cast<char *>::from(((char *) "ExprLet")),*__context__,nullptr) )
    {
        ...
        das_delete_handle<smart_ptr<Expression>>::clear(__context__,___VarcLetTickatTick41Tick20_rename_at_41_11);
        /* end finally */ });
        ___VarcLetTickatTick41Tick20_rename_at_41_11; das_zero(___VarcLetTickatTick41Tick20_rename_at_41_11);
...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    ...
    aotLib[0xb23fe996c4800328] = +[](Context & ctx) -> SimNode* { // _FuncrttiTickclass_infoTick15801393167907430156_c2226896bb23013a
        return ctx.code->makeNode<SimNode_Aot<StructInfo const  * (*) ( Context * __context__, lpipe::LpipeMacro const  &  ),&_FuncrttiTickclass_infoTick15801393167907430156_c2226896bb23013a>>();
    };
    aotLib[0x7d603bf2fe172b61] = +[](Context & ctx) -> SimNode* { // lpipe_expr_e67a42ebecb119e3
        return ctx.code->makeNode<SimNode_Aot<smart_ptr_raw<Expression> (*) ( Context * __context__, smart_ptr_raw<Expression> & , smart_ptr_raw<Expression> &  ),&lpipe_expr_e67a42ebecb119e3>>();
    };
	resolveTypeInfoAnnotations();
}

} // namespace _anon_14365561541905494207
AotListBase impl_aot_lpipe(_anon_14365561541905494207::registerAotFunctions);
} // namespace das
