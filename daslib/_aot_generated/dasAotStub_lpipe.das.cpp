...
inline StructInfo const  * _FuncrttiTickclass_infoTick15801393167907430156_5260331b04e7021a ( Context * __context__, lpipe::LpipeMacro const  & __cl_rename_at_116_2 );
inline smart_ptr_raw<Expression> lpipe_expr_4f63f6eacaa1aab1 ( Context * __context__, smart_ptr_raw<Expression> & __fnCall_rename_at_15_3, smart_ptr_raw<Expression> & __arg_rename_at_15_4 );
...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    ...
    aotLib[0x979f05e88b05ff36] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncrttiTickclass_infoTick15801393167907430156_5260331b04e7021a>>();
    };
    aotLib[0xa5ca9f2951791a15] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&lpipe_expr_4f63f6eacaa1aab1>>();
    };
