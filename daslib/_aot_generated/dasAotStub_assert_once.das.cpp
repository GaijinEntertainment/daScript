...
inline smart_ptr_raw<FunctionAnnotation> _FuncastTickmake_function_annotationTick3074191368936885601_6bab12f5f9e25838 ( Context * __context__, char * const  __name_rename_at_626_7, assert_once::AssertOnceMacro * __someClassPtr_rename_at_626_8 );
inline smart_ptr_raw<Expression> _FuncbuiltinTickadd_ptr_refTick918185754185293024_99178115c59ca766 ( Context * __context__, smart_ptr<Expression> const  __src_rename_at_1744_10 );
...
inline smart_ptr_raw<FunctionAnnotation> _FuncastTickmake_function_annotationTick3074191368936885601_6bab12f5f9e25838 ( Context * __context__, char * const  __name_rename_at_626_7, assert_once::AssertOnceMacro * __someClassPtr_rename_at_626_8 )
{
    _FuncbuiltinTickpushTick10769833213962245646_e64fa0322491795(__context__,das_arg<TArray<ast::AstFunctionAnnotation *>>::pass(das_global<TArray<ast::AstFunctionAnnotation *>,0x70a17c19e372bb43>(__context__) /*gc_root_AstFunctionAnnotation*/),das_reinterpret<ast::AstFunctionAnnotation *>::pass(__someClassPtr_rename_at_626_8));
    StructInfo const  * __classInfo_rename_at_629_9 = ((StructInfo const  *)_FuncrttiTickclass_infoTick15801393167907430156_3ea7f9688fb14bce(__context__,das_arg<assert_once::AssertOnceMacro>::pass(das_deref(__context__,__someClassPtr_rename_at_626_8))));
    return /* <- */ das_auto_cast_move<smart_ptr_raw<FunctionAnnotation>>::cast(makeFunctionAnnotation(__name_rename_at_626_7,das_auto_cast<void * const >::cast(__someClassPtr_rename_at_626_8),__classInfo_rename_at_629_9,__context__));
}
...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    ...
    aotLib[0x810749aa1b0c9d25] = +[](Context & ctx) -> SimNode* { // _FuncrttiTickclass_infoTick15801393167907430156_3ea7f9688fb14bce
        return ctx.code->makeNode<SimNode_Aot<StructInfo const  * (*) ( Context * __context__, assert_once::AssertOnceMacro const  &  ),&_FuncrttiTickclass_infoTick15801393167907430156_3ea7f9688fb14bce>>();
    };
    ...
    aotLib[0x8c9c2a33ef31bb7f] = +[](Context & ctx) -> SimNode* { // _FuncastTickmake_function_annotationTick3074191368936885601_6bab12f5f9e25838
        return ctx.code->makeNode<SimNode_Aot<smart_ptr_raw<FunctionAnnotation> (*) ( Context * __context__, char * const  , assert_once::AssertOnceMacro *  ),&_FuncastTickmake_function_annotationTick3074191368936885601_6bab12f5f9e25838>>();
    };
    ...
    aotLib[0xdd00c9048cfbde53] = +[](Context & ctx) -> SimNode* { // _Funcast_boostTicksetup_tag_annotationTick4095297895764883997_189bebae607425a2
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, char * const  , char * const  , assert_once::AssertOnceMacro *  ),&_Funcast_boostTicksetup_tag_annotationTick4095297895764883997_189bebae607425a2>>();
    };
