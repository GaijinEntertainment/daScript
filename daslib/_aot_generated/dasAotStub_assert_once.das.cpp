...
static_assert(sizeof(AssertOnceMacro)==112,"structure size mismatch with DAS");
static_assert(offsetof(AssertOnceMacro,__rtti)==0,"structure field offset mismatch with DAS");
static_assert(offsetof(AssertOnceMacro,__finalize)==8,"structure field offset mismatch with DAS");
static_assert(offsetof(AssertOnceMacro,transform)==16,"structure field offset mismatch with DAS");
static_assert(offsetof(AssertOnceMacro,verifyCall)==24,"structure field offset mismatch with DAS");
static_assert(offsetof(AssertOnceMacro,apply)==32,"structure field offset mismatch with DAS");
static_assert(offsetof(AssertOnceMacro,generic_apply)==40,"structure field offset mismatch with DAS");
static_assert(offsetof(AssertOnceMacro,finish)==48,"structure field offset mismatch with DAS");
static_assert(offsetof(AssertOnceMacro,patch)==56,"structure field offset mismatch with DAS");
static_assert(offsetof(AssertOnceMacro,fixup)==64,"structure field offset mismatch with DAS");
static_assert(offsetof(AssertOnceMacro,lint)==72,"structure field offset mismatch with DAS");
static_assert(offsetof(AssertOnceMacro,complete)==80,"structure field offset mismatch with DAS");
static_assert(offsetof(AssertOnceMacro,isCompatible)==88,"structure field offset mismatch with DAS");
static_assert(offsetof(AssertOnceMacro,isSpecialized)==96,"structure field offset mismatch with DAS");
static_assert(offsetof(AssertOnceMacro,appendToMangledName)==104,"structure field offset mismatch with DAS");
}
...
inline void _FuncbuiltinTickpushTick10769833213962245646_17d5a7b0b5dc7d2a ( Context * __context__, TArray<ast::AstFunctionAnnotation *> & __Arr_rename_at_181_2, ast::AstFunctionAnnotation * __value_rename_at_181_3 );
inline StructInfo const  * _FuncrttiTickclass_infoTick15801393167907430156_d7ffb2c655cc1bdf ( Context * __context__, assert_once::AssertOnceMacro const  & __cl_rename_at_116_4 );
inline smart_ptr_raw<Expression> _FuncbuiltinTickclone_to_moveTick2007252383599261567_aef78db477a0d6c0 ( Context * __context__, smart_ptr_raw<Expression> const  __clone_src_rename_at_1057_5 );
inline smart_ptr_raw<FunctionAnnotation> _FuncastTickmake_function_annotationTick3074191368936885601_c02ac993fa9ade33 ( Context * __context__, char * const  __name_rename_at_622_7, assert_once::AssertOnceMacro * __someClassPtr_rename_at_622_8 );
inline smart_ptr_raw<Expression> _FuncbuiltinTickadd_ptr_refTick918185754185293024_99178115c59ca766 ( Context * __context__, smart_ptr<Expression> const  __src_rename_at_1745_10 );
inline void _Funcast_boostTicksetup_tag_annotationTick4095297895764883997_2028437bae1c32e7 ( Context * __context__, char * const  __name_rename_at_273_12, char * const  __tag_rename_at_273_13, assert_once::AssertOnceMacro * __classPtr_rename_at_273_14 );
...
inline smart_ptr_raw<Expression> _FuncbuiltinTickclone_to_moveTick2007252383599261567_aef78db477a0d6c0 ( Context * __context__, smart_ptr_raw<Expression> const  __clone_src_rename_at_1057_5 )
{
    smart_ptr_raw<Expression> __clone_dest_rename_at_1059_6; das_zero(__clone_dest_rename_at_1059_6);
    clone_912660ab1e667e4b(__context__,__clone_dest_rename_at_1059_6,__clone_src_rename_at_1057_5);
    return /* <- */ das_auto_cast_move<smart_ptr_raw<Expression>>::cast(__clone_dest_rename_at_1059_6);
}
...
inline smart_ptr_raw<FunctionAnnotation> _FuncastTickmake_function_annotationTick3074191368936885601_c02ac993fa9ade33 ( Context * __context__, char * const  __name_rename_at_622_7, assert_once::AssertOnceMacro * __someClassPtr_rename_at_622_8 )
{
    ...
    StructInfo const  * __classInfo_rename_at_625_9 = ((StructInfo const  *)_FuncrttiTickclass_infoTick15801393167907430156_d7ffb2c655cc1bdf(__context__,das_arg<assert_once::AssertOnceMacro>::pass(das_deref(__context__,__someClassPtr_rename_at_622_8))));
...
inline smart_ptr_raw<Expression> _FuncbuiltinTickadd_ptr_refTick918185754185293024_99178115c59ca766 ( Context * __context__, smart_ptr<Expression> const  __src_rename_at_1745_10 )
{
    smart_ptr_raw<Expression> __dst_rename_at_1747_11; das_zero(__dst_rename_at_1747_11); das_move(__dst_rename_at_1747_11, _FuncbuiltinTickclone_to_moveTick2007252383599261567_aef78db477a0d6c0(__context__,das_cast<smart_ptr_raw<Expression>>::cast(__src_rename_at_1745_10)));
    return /* <- */ das_auto_cast_move<smart_ptr_raw<Expression>>::cast(__dst_rename_at_1747_11);
}
...
inline void _Funcast_boostTicksetup_tag_annotationTick4095297895764883997_2028437bae1c32e7 ( Context * __context__, char * const  __name_rename_at_273_12, char * const  __tag_rename_at_273_13, assert_once::AssertOnceMacro * __classPtr_rename_at_273_14 )
{
    ...
    /* end finally */ });
    __ann_rename_at_274_15; das_zero(__ann_rename_at_274_15); das_move(__ann_rename_at_274_15, _FuncastTickmake_function_annotationTick3074191368936885601_c02ac993fa9ade33(__context__,__name_rename_at_273_12,__classPtr_rename_at_273_14));
    das_invoke_function<void>::invoke<char * const ,smart_ptr_raw<FunctionAnnotation>>(__context__,nullptr,Func(__context__->fnByMangledName(/*@ast_boost::apply_tag_annotation Cs Y<FunctionAnnotationPtr>1<H<ast::FunctionAnnotation>>?M*/ 8536632802977626562u)),__tag_rename_at_273_13,__ann_rename_at_274_15);
...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    ...
    aotLib[0xbd294df3d4019952] = +[](Context & ctx) -> SimNode* { // _FuncrttiTickclass_infoTick15801393167907430156_d7ffb2c655cc1bdf
        return ctx.code->makeNode<SimNode_Aot<StructInfo const  * (*) ( Context * __context__, assert_once::AssertOnceMacro const  &  ),&_FuncrttiTickclass_infoTick15801393167907430156_d7ffb2c655cc1bdf>>();
    };
    aotLib[0xe00a0430d3102987] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTickclone_to_moveTick2007252383599261567_aef78db477a0d6c0
        return ctx.code->makeNode<SimNode_Aot<smart_ptr_raw<Expression> (*) ( Context * __context__, smart_ptr_raw<Expression> const   ),&_FuncbuiltinTickclone_to_moveTick2007252383599261567_aef78db477a0d6c0>>();
    };
    aotLib[0xa5e8e38842886235] = +[](Context & ctx) -> SimNode* { // _FuncastTickmake_function_annotationTick3074191368936885601_c02ac993fa9ade33
        return ctx.code->makeNode<SimNode_Aot<smart_ptr_raw<FunctionAnnotation> (*) ( Context * __context__, char * const  , assert_once::AssertOnceMacro *  ),&_FuncastTickmake_function_annotationTick3074191368936885601_c02ac993fa9ade33>>();
    };
    aotLib[0x8be5dd1d8499ca7c] = +[](Context & ctx) -> SimNode* { // _FuncbuiltinTickadd_ptr_refTick918185754185293024_99178115c59ca766
        return ctx.code->makeNode<SimNode_Aot<smart_ptr_raw<Expression> (*) ( Context * __context__, smart_ptr<Expression> const   ),&_FuncbuiltinTickadd_ptr_refTick918185754185293024_99178115c59ca766>>();
    };
    aotLib[0x4a5aaab9d670c42f] = +[](Context & ctx) -> SimNode* { // _Funcast_boostTicksetup_tag_annotationTick4095297895764883997_2028437bae1c32e7
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, char * const  , char * const  , assert_once::AssertOnceMacro *  ),&_Funcast_boostTicksetup_tag_annotationTick4095297895764883997_2028437bae1c32e7>>();
    };
    aotLib[0x95fa1e41a663ef04] = +[](Context & ctx) -> SimNode* { // assert_once_8ac889dd20bd4989
        return ctx.code->makeNode<SimNode_Aot<void (*) ( Context * __context__, bool , char * const   ),&assert_once_8ac889dd20bd4989>>();
    };
    // [[ init script ]]
