...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    aotLib[0xf8cfe9a85cf8fdd1] = +[](Context & ctx) -> SimNode* { // degrees_328d4d049bd30cef
        return ctx.code->makeNode<SimNode_Aot<float (*) ( Context * __context__, float  ),&degrees_328d4d049bd30cef>>();
    };
    aotLib[0x603e1dd85478753] = +[](Context & ctx) -> SimNode* { // radians_ee8c5a366585b95f
        return ctx.code->makeNode<SimNode_Aot<float (*) ( Context * __context__, float  ),&radians_ee8c5a366585b95f>>();
    };
    aotLib[0x144bc2dbab160c31] = +[](Context & ctx) -> SimNode* { // RGBA_TO_UCOLOR_8f89c82e07162cc6
        return ctx.code->makeNode<SimNode_Aot<uint32_t (*) ( Context * __context__, float , float , float , float  ),&RGBA_TO_UCOLOR_8f89c82e07162cc6>>();
    };
    aotLib[0x97dfe3b86dee2820] = +[](Context & ctx) -> SimNode* { // RGBA_TO_UCOLOR_df49aebb37a8d688
        return ctx.code->makeNode<SimNode_Aot<uint32_t (*) ( Context * __context__, float4  ),&RGBA_TO_UCOLOR_df49aebb37a8d688>>();
    };
    aotLib[0xaa35b1021da529dd] = +[](Context & ctx) -> SimNode* { // UCOLOR_TO_RGBA_21168ce8b8a51982
        return ctx.code->makeNode<SimNode_Aot<float4 (*) ( Context * __context__, uint32_t  ),&UCOLOR_TO_RGBA_21168ce8b8a51982>>();
    };
    aotLib[0xf7e603df189060a3] = +[](Context & ctx) -> SimNode* { // UCOLOR_TO_RGB_a553283ab423e6b5
        return ctx.code->makeNode<SimNode_Aot<float3 (*) ( Context * __context__, uint32_t  ),&UCOLOR_TO_RGB_a553283ab423e6b5>>();
    };
    aotLib[0xe51f41dd8b88ba2] = +[](Context & ctx) -> SimNode* { // linear_to_SRGB_90213175148fa8e
        return ctx.code->makeNode<SimNode_Aot<float (*) ( Context * __context__, float  ),&linear_to_SRGB_90213175148fa8e>>();
    };
    aotLib[0x936baa5b38c3cd18] = +[](Context & ctx) -> SimNode* { // linear_to_SRGB_2e29306dc06d8b4
        return ctx.code->makeNode<SimNode_Aot<float3 (*) ( Context * __context__, float3  ),&linear_to_SRGB_2e29306dc06d8b4>>();
    };
    aotLib[0x633c5437ca0b500] = +[](Context & ctx) -> SimNode* { // linear_to_SRGB_1da25f3c83567208
        return ctx.code->makeNode<SimNode_Aot<float4 (*) ( Context * __context__, float4  ),&linear_to_SRGB_1da25f3c83567208>>();
    };
    aotLib[0x9608254a0b6c3bda] = +[](Context & ctx) -> SimNode* { // is_intersecting_3ca7c7524f1c9dc5
        return ctx.code->makeNode<SimNode_Aot<bool (*) ( Context * __context__, math_boost::AABR const  & , math_boost::AABR const  &  ),&is_intersecting_3ca7c7524f1c9dc5>>();
    };
    aotLib[0x46727c5df780304d] = +[](Context & ctx) -> SimNode* { // is_intersecting_c31d318a049eb335
        return ctx.code->makeNode<SimNode_Aot<bool (*) ( Context * __context__, math_boost::AABB const  & , math_boost::AABB const  &  ),&is_intersecting_c31d318a049eb335>>();
    };
    aotLib[0x9f7c1c8e559736c5] = +[](Context & ctx) -> SimNode* { // is_intersecting_7b1ab43c978ef6b
        return ctx.code->makeNode<SimNode_Aot<bool (*) ( Context * __context__, math_boost::Ray const  & , math_boost::AABB const  & , float , float  ),&is_intersecting_7b1ab43c978ef6b>>();
    };
    aotLib[0x63f1702616d0946d] = +[](Context & ctx) -> SimNode* { // look_at_lh_cbb8ffd0a0e23fe4
        return ctx.code->makeNode<SimNode_AotCMRES<float4x4 (*) ( Context * __context__, float3 , float3 , float3  ),&look_at_lh_cbb8ffd0a0e23fe4>>();
    };
    aotLib[0xed8a56bf67a96fb8] = +[](Context & ctx) -> SimNode* { // look_at_rh_b237be682c2bdd82
        return ctx.code->makeNode<SimNode_AotCMRES<float4x4 (*) ( Context * __context__, float3 , float3 , float3  ),&look_at_rh_b237be682c2bdd82>>();
    };
    aotLib[0x88691fd07df33dd8] = +[](Context & ctx) -> SimNode* { // perspective_lh_955bc910ea34b8d8
        return ctx.code->makeNode<SimNode_AotCMRES<float4x4 (*) ( Context * __context__, float , float , float , float  ),&perspective_lh_955bc910ea34b8d8>>();
    };
    aotLib[0x40df745e700e8d42] = +[](Context & ctx) -> SimNode* { // perspective_rh_e09d74c3c9231ca2
        return ctx.code->makeNode<SimNode_AotCMRES<float4x4 (*) ( Context * __context__, float , float , float , float  ),&perspective_rh_e09d74c3c9231ca2>>();
    };
    aotLib[0xccc723f440725a4d] = +[](Context & ctx) -> SimNode* { // perspective_rh_opengl_448c2e9e57ce734f
        return ctx.code->makeNode<SimNode_AotCMRES<float4x4 (*) ( Context * __context__, float , float , float , float  ),&perspective_rh_opengl_448c2e9e57ce734f>>();
    };
    aotLib[0x59d6f1be891889d1] = +[](Context & ctx) -> SimNode* { // ortho_rh_9ba657365d994f79
        return ctx.code->makeNode<SimNode_AotCMRES<float4x4 (*) ( Context * __context__, float , float , float , float , float , float  ),&ortho_rh_9ba657365d994f79>>();
    };
    aotLib[0x55899e1f1210a683] = +[](Context & ctx) -> SimNode* { // plane_dot_fbb442007739e1a5
        return ctx.code->makeNode<SimNode_Aot<float (*) ( Context * __context__, float4 , float4  ),&plane_dot_fbb442007739e1a5>>();
    };
    aotLib[0x4af3d9821225b63d] = +[](Context & ctx) -> SimNode* { // plane_normalize_b33d45ea1c8c4042
        return ctx.code->makeNode<SimNode_Aot<float4 (*) ( Context * __context__, float4  ),&plane_normalize_b33d45ea1c8c4042>>();
    };
    aotLib[0x995db7d5e25da56b] = +[](Context & ctx) -> SimNode* { // plane_from_point_normal_fedc1a1c58148189
        return ctx.code->makeNode<SimNode_Aot<float4 (*) ( Context * __context__, float3 , float3  ),&plane_from_point_normal_fedc1a1c58148189>>();
    };
    aotLib[0x77473aac7878f0a4] = +[](Context & ctx) -> SimNode* { // planar_shadow_a86997e7f64f1f6a
        return ctx.code->makeNode<SimNode_AotCMRES<float4x4 (*) ( Context * __context__, float4 , float4  ),&planar_shadow_a86997e7f64f1f6a>>();
    };
