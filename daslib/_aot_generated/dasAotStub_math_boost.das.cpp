...
inline float degrees_d16f61cbd99498a5 ( Context * __context__, float __f_rename_at_31_0 );
inline float radians_d16f61cbd99498a5 ( Context * __context__, float __f_rename_at_36_1 );
inline uint32_t RGBA_TO_UCOLOR_994028edc83de025 ( Context * __context__, float __x_rename_at_41_2, float __y_rename_at_41_3, float __z_rename_at_41_4, float __w_rename_at_41_5 );
inline uint32_t RGBA_TO_UCOLOR_8f67bcd334e48a07 ( Context * __context__, float4 __xyzw_rename_at_46_6 );
inline float4 UCOLOR_TO_RGBA_949ce0c815b58f1b ( Context * __context__, uint32_t __x_rename_at_50_7 );
inline float3 UCOLOR_TO_RGB_39b29466fc7ae3ca ( Context * __context__, uint32_t __x_rename_at_59_8 );
inline float linear_to_SRGB_d16f61cbd99498a5 ( Context * __context__, float __x_rename_at_67_9 );
inline float3 linear_to_SRGB_5287c54559b41489 ( Context * __context__, float3 __c_rename_at_76_10 );
inline float4 linear_to_SRGB_c4bc3d73af81eb41 ( Context * __context__, float4 __c_rename_at_80_11 );
inline bool is_intersecting_354093f505aa072 ( Context * __context__, math_boost::AABR const  & __a_rename_at_84_12, math_boost::AABR const  & __b_rename_at_84_13 );
inline bool is_intersecting_6fde9bd5cb9b7752 ( Context * __context__, math_boost::AABB const  & __a_rename_at_90_14, math_boost::AABB const  & __b_rename_at_90_15 );
inline bool is_intersecting_39e55c4d5f951c1 ( Context * __context__, math_boost::Ray const  & __ray_rename_at_95_16, math_boost::AABB const  & __aabb_rename_at_95_17, float __Tmin_rename_at_95_18, float __Tmax_rename_at_95_19 );
inline float4x4 look_at_lh_6f0979295ad58f12 ( Context * __context__, float3 __Eye_rename_at_106_27, float3 __At_rename_at_106_28, float3 __Up_rename_at_106_29 );
inline float4x4 look_at_rh_6f0979295ad58f12 ( Context * __context__, float3 __Eye_rename_at_121_34, float3 __At_rename_at_121_35, float3 __Up_rename_at_121_36 );
inline float4x4 perspective_lh_e88773b140f76d05 ( Context * __context__, float __fovy_rename_at_136_41, float __aspect_rename_at_136_42, float __zn_rename_at_136_43, float __zf_rename_at_136_44 );
inline float4x4 perspective_rh_e88773b140f76d05 ( Context * __context__, float __fovy_rename_at_150_48, float __aspect_rename_at_150_49, float __zn_rename_at_150_50, float __zf_rename_at_150_51 );
inline float4x4 perspective_rh_opengl_e88773b140f76d05 ( Context * __context__, float __fovy_rename_at_164_55, float __aspect_rename_at_164_56, float __zn_rename_at_164_57, float __zf_rename_at_164_58 );
inline float4x4 ortho_rh_838ea0800c9b4c85 ( Context * __context__, float __left_rename_at_178_62, float __right_rename_at_178_63, float __bottom_rename_at_178_64, float __top_rename_at_178_65, float __zNear_rename_at_178_66, float __zFar_rename_at_178_67 );
inline float plane_dot_b6f47999a0488421 ( Context * __context__, float4 __Plane_rename_at_191_69, float4 __Vec_rename_at_191_70 );
inline float4 plane_normalize_c4bc3d73af81eb41 ( Context * __context__, float4 __Plane_rename_at_196_71 );
inline float4 plane_from_point_normal_6a3214da3296d13 ( Context * __context__, float3 __p_rename_at_202_73, float3 __n_rename_at_202_74 );
inline float4x4 planar_shadow_aa0df22a02defd21 ( Context * __context__, float4 __Light_rename_at_207_75, float4 __Plane_rename_at_207_76 );
...
inline float3 linear_to_SRGB_5287c54559b41489 ( Context * __context__, float3 __c_rename_at_76_10 )
{
    return das_auto_cast<float3>::cast(float3(linear_to_SRGB_d16f61cbd99498a5(__context__,v_extract_x(__c_rename_at_76_10) /*x*/),linear_to_SRGB_d16f61cbd99498a5(__context__,v_extract_y(__c_rename_at_76_10) /*y*/),linear_to_SRGB_d16f61cbd99498a5(__context__,v_extract_z(__c_rename_at_76_10) /*z*/)));
}

inline float4 linear_to_SRGB_c4bc3d73af81eb41 ( Context * __context__, float4 __c_rename_at_80_11 )
{
    return das_auto_cast<float4>::cast(float4(linear_to_SRGB_d16f61cbd99498a5(__context__,v_extract_x(__c_rename_at_80_11) /*x*/),linear_to_SRGB_d16f61cbd99498a5(__context__,v_extract_y(__c_rename_at_80_11) /*y*/),linear_to_SRGB_d16f61cbd99498a5(__context__,v_extract_z(__c_rename_at_80_11) /*z*/),v_extract_w(__c_rename_at_80_11) /*w*/));
}
...
inline float4x4 planar_shadow_aa0df22a02defd21 ( Context * __context__, float4 __Light_rename_at_207_75, float4 __Plane_rename_at_207_76 )
{
    float4 __P_rename_at_209_77 = ((float4)plane_normalize_c4bc3d73af81eb41(__context__,__Plane_rename_at_207_76));
...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    aotLib[0x59e95f064058f5b5] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&degrees_d16f61cbd99498a5>>();
    };
    aotLib[0x59e95f064058f5b5] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&radians_d16f61cbd99498a5>>();
    };
    aotLib[0x90b60b90edeec216] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&RGBA_TO_UCOLOR_994028edc83de025>>();
    };
    aotLib[0xb32f4e42a744aefd] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&RGBA_TO_UCOLOR_8f67bcd334e48a07>>();
    };
    aotLib[0x67ad1d07efa9df9b] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&UCOLOR_TO_RGBA_949ce0c815b58f1b>>();
    };
    aotLib[0x75c2c4f2c8a23357] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&UCOLOR_TO_RGB_39b29466fc7ae3ca>>();
    };
    aotLib[0x59e95f064058f5b5] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&linear_to_SRGB_d16f61cbd99498a5>>();
    };
    aotLib[0x644362c67f93df42] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&linear_to_SRGB_5287c54559b41489>>();
    };
    aotLib[0xfbcd692396796d07] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&linear_to_SRGB_c4bc3d73af81eb41>>();
    };
    aotLib[0x88cb92f4954d54fc] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&is_intersecting_354093f505aa072>>();
    };
    aotLib[0xccab2377fac82f49] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&is_intersecting_6fde9bd5cb9b7752>>();
    };
    aotLib[0x1bcd2ccd4ed6d697] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&is_intersecting_39e55c4d5f951c1>>();
    };
    aotLib[0x17c58f60137ec330] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_AotCMRES<&look_at_lh_6f0979295ad58f12>>();
    };
    aotLib[0x17c58f60137ec330] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_AotCMRES<&look_at_rh_6f0979295ad58f12>>();
    };
    aotLib[0x26902c7cab116f10] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_AotCMRES<&perspective_lh_e88773b140f76d05>>();
    };
    aotLib[0x26902c7cab116f10] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_AotCMRES<&perspective_rh_e88773b140f76d05>>();
    };
    aotLib[0x26902c7cab116f10] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_AotCMRES<&perspective_rh_opengl_e88773b140f76d05>>();
    };
    aotLib[0x20a71388f6e2ed44] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_AotCMRES<&ortho_rh_838ea0800c9b4c85>>();
    };
    aotLib[0x32251534bc24fe9b] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&plane_dot_b6f47999a0488421>>();
    };
    aotLib[0x367b056f6dcbb0aa] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&plane_normalize_c4bc3d73af81eb41>>();
    };
    aotLib[0x7c88c35c558f0a2c] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&plane_from_point_normal_6a3214da3296d13>>();
    };
    aotLib[0x7b6e418958d6fca4] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_AotCMRES<&planar_shadow_aa0df22a02defd21>>();
    };
