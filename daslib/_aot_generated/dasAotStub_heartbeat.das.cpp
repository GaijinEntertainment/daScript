...
inline smart_ptr_raw<VisitorAdapter> _FuncastTickmake_visitorTick897644165917210720_1409610740da7d77 ( Context * __context__, heartbeat::AddHeartbeat const  & __someClass_rename_at_679_4 );
...
inline smart_ptr_raw<VisitorAdapter> _FuncastTickmake_visitorTick897644165917210720_1409610740da7d77 ( Context * __context__, heartbeat::AddHeartbeat const  &  __someClass_rename_at_679_4 )
{
    heartbeat::AddHeartbeat const  * __classPtr_rename_at_682_5 = ((heartbeat::AddHeartbeat const  *)das_ref(__context__,__someClass_rename_at_679_4));
    StructInfo const  * __classInfo_rename_at_683_6 = ((StructInfo const  *)_FuncrttiTickclass_infoTick15801393167907430156_b138d1c218a1b994(__context__,__someClass_rename_at_679_4));
    return /* <- */ das_auto_cast_move<smart_ptr_raw<VisitorAdapter>>::cast(makeVisitor(das_auto_cast<void * const >::cast(__classPtr_rename_at_682_5),__classInfo_rename_at_683_6,__context__));
}
...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    ...
    aotLib[0x7ee07d0772e7a6f2] = +[](Context & ctx) -> SimNode* { // _FuncrttiTickclass_infoTick15801393167907430156_af4b722b0484f9aa
        return ctx.code->makeNode<SimNode_Aot<StructInfo const  * (*) ( Context * __context__, heartbeat::HeartbeatPass const  &  ),&_FuncrttiTickclass_infoTick15801393167907430156_af4b722b0484f9aa>>();
    };
    aotLib[0xc0ff19b8a520fb4a] = +[](Context & ctx) -> SimNode* { // _FuncrttiTickclass_infoTick15801393167907430156_b138d1c218a1b994
        return ctx.code->makeNode<SimNode_Aot<StructInfo const  * (*) ( Context * __context__, heartbeat::AddHeartbeat const  &  ),&_FuncrttiTickclass_infoTick15801393167907430156_b138d1c218a1b994>>();
    };
    aotLib[0x570bcdcf54609085] = +[](Context & ctx) -> SimNode* { // _FuncastTickmake_visitorTick897644165917210720_1409610740da7d77
        return ctx.code->makeNode<SimNode_Aot<smart_ptr_raw<VisitorAdapter> (*) ( Context * __context__, heartbeat::AddHeartbeat const  &  ),&_FuncastTickmake_visitorTick897644165917210720_1409610740da7d77>>();
    };
