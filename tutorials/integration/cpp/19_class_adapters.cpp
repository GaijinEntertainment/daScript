...
//
// Shows how to let daScript classes derive from a C++ abstract base class
...
//      to daScript class methods
//
// On the daScript side, a class simply extends TutorialBaseClass and
...
//   - Virtual dispatch across the C++/daScript boundary
...
// =========================================================================
// Layer 2: Generated class adapter (bridges C++ vtable → daScript methods)
// =========================================================================
//
...
//   get_<method>(self)   — returns the Func pointer if the daScript class
//                          overrides the method
//   invoke_<method>(ctx, fn, self, args...) — calls the daScript method
...
// (for daScript method lookup).  When C++ calls obj->update(dt) through
// the vtable, the adapter checks whether the daScript class overrides
...
protected:
    void *    classPtr;   // pointer to the daScript class instance
    Context * context;    // daScript execution context
};

// =========================================================================
// Registration function exposed to daScript
// =========================================================================
...
// =========================================================================
//
// We embed the daScript module file (19_class_adapters_module.das) as a
