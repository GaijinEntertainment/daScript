...
spell - the build names the ones it skips. `-lib` carries the annotation itself; add
`require daslib/export_c` only to compile that same source without the JIT. Then:
