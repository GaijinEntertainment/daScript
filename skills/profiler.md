...
agent in [profiler](https://daslang.io/doc/stdlib/generated/profiler.html). It has two modes:
...
[Perfetto UI](https://ui.perfetto.dev/) to explore the call tree. A tree
...
* - Flag
  - Meaning
* - `--das-profiler`
  - Required prefix flag that auto-requires [profiler](https://daslang.io/doc/stdlib/generated/profiler.html).
...
`DapiDebugAgent` in [debugapi](https://daslang.io/doc/stdlib/generated/debugapi.html).
...
[debugapi](https://daslang.io/doc/stdlib/generated/debugapi.html) for the complete list of
...
* [profiler](https://daslang.io/doc/stdlib/generated/profiler.html) --- generated API reference for
  the `profiler` module (classes, structs, helpers).
* [profiler_boost](https://daslang.io/doc/stdlib/generated/profiler_boost.html) --- cross-context enable
  / disable helpers used from user code.
* [debugapi](https://daslang.io/doc/stdlib/generated/debugapi.html) --- C++ `DapiDebugAgent` binding
