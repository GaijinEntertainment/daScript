...
- Full driver-layer reference (verbs, the `wait_*` family, one-host-per-port): `skills/internal/imgui_playwright.md`. <!-- repo-only -->
  App lifecycle/harness contract: `skills/imgui_application.md`. <!-- repo-only -->
