...
* - `-k / --keep`
  ...
  - Pattern name to KEEP despite default skip (repeatable).
    ...
    See [utils_detect_dupe_patterns](https://daslang.io/doc/reference/utils/detect_dupe.html#utils-detect-dupe-patterns)
* - `-v / --verbose`
  - off
  - Per-file progress
* - `-?`
...
An AI judge ([utils_find_dupe](https://daslang.io/doc/reference/utils/find_dupe.html#utils-find-dupe)) can consume the resulting JSON
...
The [utils_mcp](https://daslang.io/doc/reference/utils/mcp.html#utils-mcp) server exposes two tools that wrap the engine
