...
daslang was born out of concrete problems at [Gaijin Entertainment](https://gaijin.net/).
...
3. **Language enthusiasts and standalone users** — a growing group. They want modules, packages,
   ...
   Platforms like [edenspark.io](https://edenspark.io/) (currently in early beta) aim to serve this community.
...
As the [blog post](https://borisbat.github.io/dascf-blog/2023/12/28/daslang-it-is/) put it:
