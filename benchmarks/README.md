...
| `scalar_crt.das` | the rest of the lane-trick scalar family (log, log2, exp2, pow, sin, cos, tan) against the CRT twins `UnitTest` binds (`crt_logf`...); same shape as `exp.das` |
