...
#define IMPLEMENT_OP1_SCALAR_FUSION_POINT(OPNAME) \
    ...
    IMPLEMENT_ANY_OP1_FUSION_POINT(__forceinline,OPNAME,Bool,bool);

#define IMPLEMENT_OP1_WORKHORSE_FUSION_POINT(OPNAME) \
    IMPLEMENT_OP1_SCALAR_FUSION_POINT(OPNAME); \
    IMPLEMENT_ANY_OP1_FUSION_POINT(__forceinline,OPNAME,Ptr,StringPtr); \
    IMPLEMENT_ANY_OP1_FUSION_POINT(__forceinline,OPNAME,Ptr,VoidPtr);

#define IMPLEMENT_OP1_VEC(OPNAME,CTYPE) \
    IMPLEMENT_ANY_OP1_FUSION_POINT(__forceinline,OPNAME,,CTYPE)
