...
namespace das {
    ...
    DAS_RT_API Time builtin_clock();
    DAS_RT_API Time builtin_mktime(int year, int month, int mday, int hour, int min, int sec);
    DAS_RT_API void builtin_sleep ( uint32_t msec );
    DAS_RT_API void builtin_exit ( int32_t ec );
}
