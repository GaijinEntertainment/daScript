...
namespace das {
    ...
    DAS_API bool delete_string ( char * & str, Context * context, LineInfoArg * at );

    DAS_API char * builtin_build_string ( const TBlock<void,StringBuilderWriter> & block, Context * context, LineInfoArg * lineinfo );
    DAS_API uint64_t builtin_build_hash ( const TBlock<void,StringBuilderWriter> & block, Context * context, LineInfoArg * at );
    DAS_API vec4f builtin_write_string ( Context & context, SimNode_CallBase * call, vec4f * args );

    DAS_API void builtin_string_peek ( const char * str, const TBlock<void,TTemporary<TArray<uint8_t> const>> & block, Context * context, LineInfoArg * lineinfo );
    ...
    DAS_API char* builtin_string_tolower ( const char *str, Context * context, LineInfoArg * at );
    DAS_API char* builtin_string_tolower_in_place ( char* str );
    DAS_API char* builtin_string_toupper ( const char *str, Context * context, LineInfoArg * at );
    DAS_API char* builtin_string_toupper_in_place ( char* str );
    DAS_API char* builtin_string_chop( const char * str, int start, int length, Context * context, LineInfoArg * at );
    DAS_API int builtin_string_stricmp( const char * a, const char * b );

    DAS_API uint8_t string_to_uint8 ( const char *str, Context * context, LineInfoArg * at );
    DAS_API int8_t string_to_int8 ( const char *str, Context * context, LineInfoArg * at );
    DAS_API uint16_t string_to_uint16 ( const char *str, Context * context, LineInfoArg * at );
    DAS_API int16_t string_to_int16 ( const char *str, Context * context, LineInfoArg * at );
    DAS_API uint32_t string_to_uint ( const char *str, Context * context, LineInfoArg * at );
    DAS_API int32_t string_to_int ( const char *str, Context * context, LineInfoArg * at );
    DAS_API uint64_t string_to_uint64 ( const char *str, Context * context, LineInfoArg * at );
    DAS_API int64_t string_to_int64 ( const char *str, Context * context, LineInfoArg * at );
    DAS_API float string_to_float ( const char *str, Context * context, LineInfoArg * at );
    DAS_API double string_to_double ( const char *str, Context * context, LineInfoArg * at );
    DAS_API float fast_to_float ( const char *str );
    DAS_API double fast_to_double ( const char *str );
    DAS_API int8_t fast_to_int8 ( const char *str, bool hex );
    DAS_API uint8_t fast_to_uint8 ( const char *str, bool hex );
    DAS_API int16_t fast_to_int16 ( const char *str, bool hex );
    DAS_API uint16_t fast_to_uint16 ( const char *str, bool hex );
    DAS_API int32_t fast_to_int ( const char *str, bool hex );
    DAS_API uint32_t fast_to_uint ( const char *str, bool hex );
    DAS_API int64_t fast_to_int64 ( const char *str, bool hex );
    DAS_API uint64_t fast_to_uint64 ( const char *str, bool hex );
    ...
    DAS_API StringBuilderWriter & write_string_char(StringBuilderWriter & writer, int32_t ch);
    DAS_API StringBuilderWriter & write_string_chars(StringBuilderWriter & writer, int32_t ch, int32_t count);
    DAS_API StringBuilderWriter & write_escape_string ( StringBuilderWriter & writer, char * str );
    ...
    DAS_API char * builtin_string_ltrim ( char* s, Context * context, LineInfoArg * at );
    DAS_API char * builtin_string_trim ( char* s, Context * context, LineInfoArg * at );
    ...
    DAS_API StringBuilderWriter & fmt_and_write_i8 ( StringBuilderWriter & writer, const char * fmt, int8_t value, Context * context, LineInfoArg * at );
    DAS_API StringBuilderWriter & fmt_and_write_u8 ( StringBuilderWriter & writer, const char * fmt, uint8_t value, Context * context, LineInfoArg * at );
    DAS_API StringBuilderWriter & fmt_and_write_i16 ( StringBuilderWriter & writer, const char * fmt, int16_t value, Context * context, LineInfoArg * at );
    DAS_API StringBuilderWriter & fmt_and_write_u16 ( StringBuilderWriter & writer, const char * fmt, uint16_t value, Context * context, LineInfoArg * at );
    DAS_API StringBuilderWriter & fmt_and_write_i32 ( StringBuilderWriter & writer, const char * fmt, int32_t value, Context * context, LineInfoArg * at );
    DAS_API StringBuilderWriter & fmt_and_write_u32 ( StringBuilderWriter & writer, const char * fmt, uint32_t value, Context * context, LineInfoArg * at );
    DAS_API StringBuilderWriter & fmt_and_write_i64 ( StringBuilderWriter & writer, const char * fmt, int64_t value, Context * context, LineInfoArg * at );
    DAS_API StringBuilderWriter & fmt_and_write_u64 ( StringBuilderWriter & writer, const char * fmt, uint64_t value, Context * context, LineInfoArg * at );
    DAS_API StringBuilderWriter & fmt_and_write_f ( StringBuilderWriter & writer, const char * fmt, float value, Context * context, LineInfoArg * at );
    DAS_API StringBuilderWriter & fmt_and_write_d ( StringBuilderWriter & writer, const char * fmt, double value, Context * context, LineInfoArg * at );
    ...
    DAS_API int8_t convert_from_string_int8 ( const char * str, ConversionResult & result, int32_t & offset, bool hex );
    DAS_API uint8_t convert_from_string_uint8 ( const char * str, ConversionResult & result, int32_t & offset, bool hex );
    DAS_API int16_t convert_from_string_int16 ( const char * str, ConversionResult & result, int32_t & offset, bool hex );
    DAS_API uint16_t convert_from_string_uint16 ( const char * str, ConversionResult & result, int32_t & offset, bool hex );
    DAS_API int32_t convert_from_string_int32 ( const char * str, ConversionResult & result, int32_t & offset, bool hex );
    DAS_API uint32_t convert_from_string_uint32 ( const char * str, ConversionResult & result, int32_t & offset, bool hex );
    DAS_API int64_t convert_from_string_int64 ( const char * str, ConversionResult & result, int32_t & offset, bool hex );
