...
namespace das {
    DAS_CC_API char * ast_describe_typedecl ( TypeDecl * t, bool d_extra, bool d_contracts, bool d_module, Context * context, LineInfoArg * at );
    DAS_CC_API char * ast_describe_typedecl_cpp ( TypeDecl * t, bool d_substitureRef, bool d_skipRef, bool d_skipConst, bool d_redundantConst, bool d_ChooseSmartPtr, Context * context, LineInfoArg * at );
    DAS_CC_API char * ast_describe_expression ( Expression * t, Context * context, LineInfoArg * at );
    DAS_CC_API char * ast_describe_function ( Function * t, Context * context, LineInfoArg * at );
    ...
    DAS_CC_API char * ast_find_enum_name ( Enumeration * enu, int64_t value, Context * context, LineInfoArg * at );
    ...
    DAS_CC_API void aotMacroPrefix( TypeInfoMacro *macro, StringBuilderWriter *ss, ExpressionPtr expr);
    DAS_CC_API void aotMacroSuffix( TypeInfoMacro *macro, StringBuilderWriter *ss, ExpressionPtr expr);
    DAS_CC_API const char *getAotName(Function* func, ExprCallFunc *call, Context * context, LineInfoArg * at );
    DAS_CC_API void aotBody( StructureAnnotation *structure, StructurePtr st, const AnnotationArgumentList & args, StringBuilderWriter *writer, Context * context, LineInfoArg * at);
    DAS_CC_API void aotPreVisitGetFieldPtr(TypeAnnotation *ann, StringBuilderWriter *ss, const char *name, Context * context, LineInfoArg * at);
    DAS_CC_API void aotPreVisitGetField(TypeAnnotation *ann, StringBuilderWriter *ss, const char *name, Context * context, LineInfoArg * at);
    DAS_CC_API void aotVisitGetField(TypeAnnotation *ann, StringBuilderWriter *ss, const char *name, Context * context, LineInfoArg * at);
    DAS_CC_API bool aotNeedTypeInfo(const TypeInfoMacro *macro, ExpressionPtr expr);
    DAS_CC_API void aotVisitGetFieldPtr( TypeAnnotation* ann, StringBuilderWriter *ss, const char *name, Context * context, LineInfoArg * at );
    DAS_CC_API const char * getAotArgumentSuffix(Function* func, ExprCallFunc * call, int argIndex, Context * context, LineInfoArg * at );
    DAS_CC_API const char * getAotArgumentPrefix(Function* func, ExprCallFunc * call, int argIndex, Context * context, LineInfoArg * at );
    DAS_CC_API bool isAstSameType(TypeDecl * argType, TypeDecl * passType, bool refMatters,
                       bool constMatters,
                       bool temporaryMatters,
                       bool allowSubstitute, Context * context, LineInfoArg * at );
    DAS_CC_API void aotFuncPrefix(FunctionAnnotation* ann, StringBuilderWriter * stg, ExprCallFunc *call, Context * context, LineInfoArg * at );
    DAS_CC_API void aotStructPrefix(StructureAnnotation* ann, Structure *structure, const AnnotationArgumentList &args,
                         StringBuilderWriter * stg, Context * context, LineInfoArg * at );
    DAS_CC_API const char * stringBuilderStr(StringBuilderWriter *ss, Context * context, LineInfoArg * at);
    DAS_CC_API void stringBuilderClear(StringBuilderWriter *ss);

    DAS_CC_API const Structure * findFieldParent( Structure * structure, const char *name, Context * context, LineInfoArg * at );
    DAS_CC_API TypeDeclPtr makeBlockType(ExprBlock *blk);
    // Note: it will be removed once DebugInfoHelper rewritten in das

    DAS_CC_API TypeInfo * makeTypeInfo ( DebugInfoHelper * helper, TypeInfo * info, const TypeDeclPtr & type );
    DAS_CC_API VarInfo * makeVariableDebugInfo ( DebugInfoHelper * helper, Variable *var );
    DAS_CC_API VarInfo * makeStructVariableDebugInfo ( DebugInfoHelper * helper, const Structure * st, const Structure::FieldDeclaration * var );
    DAS_CC_API StructInfo * makeStructureDebugInfo ( DebugInfoHelper * helper, const Structure * st );
    DAS_CC_API FuncInfo * makeFunctionDebugInfo ( DebugInfoHelper * helper, const Function * fn );
    DAS_CC_API EnumInfo * makeEnumDebugInfo ( DebugInfoHelper * helper, const Enumeration * en );
    DAS_CC_API FuncInfo * makeInvokeableTypeDebugInfo ( DebugInfoHelper * helper, TypeDeclPtr blk, const LineInfo & at );

    template <typename T>
    using DebugBlockT = TBlock<void,const char *, T>;

    DAS_CC_API void debug_helper_iter_structs(DebugInfoHelper * helper, const DebugBlockT<StructInfo*> & block, Context * context, LineInfoArg * at);
    DAS_CC_API void debug_helper_iter_types(DebugInfoHelper * helper, const DebugBlockT<TypeInfo*> & block, Context * context, LineInfoArg * at);
    DAS_CC_API void debug_helper_iter_vars(DebugInfoHelper * helper, const DebugBlockT<VarInfo*> & block, Context * context, LineInfoArg * at);
    DAS_CC_API void debug_helper_iter_funcs(DebugInfoHelper * helper, const DebugBlockT<FuncInfo*> & block, Context * context, LineInfoArg * at);
    ...
    DAS_CC_API void for_each_module_function(Module *module, const TBlock<void,FunctionPtr> &blk, Context * context, LineInfoArg * at);
    DAS_CC_API uint64_t getInitSemanticHashWithDep(ProgramPtr program, uint64_t semH);
    DAS_CC_API uint64_t getFunctionHashById(Function *fun, int id, void * pctx, Context * context, LineInfoArg * at);
    ...
    DAS_CC_API void runMacroFunction ( Context * context, const string & message, const callable<void()> & subexpr );

    class DAS_CC_API VisitorAdapter : public Visitor, AstVisitor_Adapter {
    public:
    ...
    public:
        ...
        */
        ...
        virtual bool canVisitTryCatchBody ( ExprTryCatch * expr ) override;
...
#undef VISIT_EXPR
    ...
    DAS_CC_API TypeDecl * astVisitTypeDecl ( TypeDecl * type, VisitorAdapter * adapter, Context * context, LineInfoArg * line_info);
    DAS_CC_API void astVisitBlockFinally ( ExprBlock * expr, VisitorAdapter * adapter, Context * context, LineInfoArg * line_info );
    DAS_CC_API PassMacroPtr makePassMacro ( const char * name, const void * pClass, const StructInfo * info, Context * context );
    DAS_CC_API void makeVisitor ( const void * pClass, const StructInfo * info,
            const TBlock<void,VisitorAdapter*> & blk, Context * context, LineInfoArg * at );
    DAS_CC_API void addModuleInferMacro ( Module * module, PassMacroPtr _newM, Context * );
    DAS_CC_API void addModuleInferDirtyMacro ( Module * module, PassMacroPtr newM, Context * context );
    ...
    DAS_CC_API void addModuleForLoopMacro ( Module * module, ForLoopMacroPtr _newM, Context * );
    DAS_CC_API CaptureMacroPtr makeCaptureMacro ( const char * name, const void * pClass, const StructInfo * info, Context * context );
    DAS_CC_API void addModuleCaptureMacro ( Module * module, CaptureMacroPtr _newM, Context * );
    DAS_CC_API TypeMacroPtr makeTypeMacro ( const char * name, const void * pClass, const StructInfo * info, Context * context );
    DAS_CC_API void addModuleTypeMacro ( Module * module, TypeMacroPtr _newM, Context *, LineInfoArg * );
    DAS_CC_API SimulateMacroPtr makeSimulateMacro ( const char * name, const void * pClass, const StructInfo * info, Context * context );
    DAS_CC_API void addModuleSimulateMacro ( Module * module, SimulateMacroPtr _newM, Context * );
    DAS_CC_API void addModuleFunctionAnnotation ( Module * module, FunctionAnnotationPtr & ann, Context * context, LineInfoArg * at );
    DAS_CC_API FunctionAnnotationPtr makeFunctionAnnotation ( const char * name, void * pClass, const StructInfo * info, Context * context );
    DAS_CC_API StructureAnnotationPtr makeStructureAnnotation ( const char * name, void * pClass, const StructInfo * info, Context * context );
    DAS_CC_API EnumerationAnnotationPtr makeEnumerationAnnotation ( const char * name, void * pClass, const StructInfo * info, Context * context );
    DAS_CC_API void addModuleStructureAnnotation ( Module * module, StructureAnnotationPtr & ann, Context * context, LineInfoArg * at );
    DAS_CC_API void addStructureStructureAnnotation ( Structure * st, StructureAnnotationPtr & _ann, Context * context, LineInfoArg * at );
    DAS_CC_API void addModuleEnumerationAnnotation ( Module * module, EnumerationAnnotationPtr & ann, Context * context, LineInfoArg * at );
    DAS_CC_API int addEnumerationEntry ( Enumeration * enu, const char* name );
    DAS_CC_API void forEachFunction ( Module * module, const char * name, const TBlock<void,FunctionPtr> & block, Context * context, LineInfoArg * lineInfo );
    DAS_CC_API void forEachGenericFunction ( Module * module, const char * name, const TBlock<void,FunctionPtr> & block, Context * context, LineInfoArg * lineInfo );
    DAS_CC_API bool addModuleFunction ( Module * module, FunctionPtr & func, Context * context, LineInfoArg * lineInfo );
    DAS_CC_API bool addModuleGeneric ( Module * module, FunctionPtr & func, Context * context, LineInfoArg * lineInfo );
    DAS_CC_API bool addModuleVariable ( Module * module, VariablePtr & var, Context * context, LineInfoArg * lineInfo );
    DAS_CC_API bool addModuleKeyword ( Module * module, char * kwd, bool needOxfordComma, Context * context, LineInfoArg * lineInfo );
    DAS_CC_API bool addModuleTypeFunction ( Module * module, char * kwd, Context * context, LineInfoArg * lineInfo );
    DAS_CC_API VariablePtr findModuleVariable ( Module * module, const char * name );
    DAS_CC_API bool removeModuleStructure ( Module * module, StructurePtr & _stru );
    ...
    DAS_CC_API void addModuleCommentReader ( Module * module, CommentReaderPtr _newM, Context * context, LineInfoArg * lineInfo );
    DAS_CC_API void addModuleCallMacro ( Module * module, CallMacroPtr newM, Context * context, LineInfoArg * lineInfo );
    DAS_CC_API CallMacroPtr makeCallMacro ( const char * name, const void * pClass, const StructInfo * info, Context * context );
    DAS_CC_API TypeInfoMacroPtr makeTypeInfoMacro ( const char * name, const void * pClass, const StructInfo * info, Context * context );
    DAS_CC_API void addModuleTypeInfoMacro ( Module * module, TypeInfoMacroPtr _newM, Context * context, LineInfoArg * at );
    DAS_CC_API void addFunctionFunctionAnnotation(Function * func, FunctionAnnotationPtr & ann, Context* context, LineInfoArg* at);
    DAS_CC_API void addAndApplyFunctionAnnotation ( Function * func, AnnotationDeclarationPtr & ann, Context * context, LineInfoArg * at );
    DAS_CC_API void addBlockBlockAnnotation ( ExprBlock * block, FunctionAnnotationPtr & _ann, Context * context, LineInfoArg * at );
    DAS_CC_API void addAndApplyBlockAnnotation ( ExprBlock * blk, AnnotationDeclarationPtr & ann, Context * context, LineInfoArg * at );
    DAS_CC_API void addAndApplyStructAnnotation ( Structure * st, AnnotationDeclarationPtr & ann, Context * context, LineInfoArg * at );
    DAS_CC_API void visitEnumeration ( ProgramPtr program, Enumeration * enumeration, VisitorAdapter * adapter, Context * context, LineInfoArg * line_info );
    DAS_CC_API void visitStructure ( ProgramPtr program, Structure * structure, VisitorAdapter * adapter, Context * context, LineInfoArg * line_info );
    ...
    DAS_CC_API void delete_expression ( ExpressionPtr expr );
    DAS_CC_API void delete_type ( TypeDeclPtr typ );
    DAS_CC_API void forceAtRaw ( Expression * expr, const LineInfo & at );
    ...
    DAS_CC_API float4 evalSingleExpression ( ExpressionPtr expr, bool & ok );
    DAS_CC_API float4 evalSingleExpressionInContext ( ExpressionPtr expr, smart_ptr_raw<Context> useCtx, bool & ok );
    DAS_CC_API ExpressionPtr makeCall ( const LineInfo & at, const char * name );
    DAS_CC_API bool builtin_isVisibleDirectly ( Module * from, Module * too );
    DAS_CC_API bool builtin_hasField ( TypeDeclPtr ptr, const char * field, bool constant );
    DAS_CC_API TypeDeclPtr builtin_fieldType ( TypeDeclPtr ptr, const char * field, bool constant );
    DAS_CC_API Module * findRttiModule ( smart_ptr<Program> THAT_PROGRAM, const char * name, Context *, LineInfoArg *);
    DAS_CC_API AnnotationPtr module_find_annotation ( const Module* module, const char *name );
    DAS_CC_API TypeAnnotation* module_find_type_annotation ( const Module* module, const char *name );
    DAS_CC_API Function * findRttiFunction ( Module * mod, Func func, Context * context, LineInfoArg * line_info );
    DAS_CC_API void ast_gc_guard ( const TBlock<void> & block, Context * context, LineInfoArg * at );
    DAS_CC_API void for_each_module ( Program * prog, const TBlock<void,Module *> & block, Context * context, LineInfoArg * at );
    DAS_CC_API void for_each_module_no_order ( Program * prog, const TBlock<void,Module *> & block, Context * context, LineInfoArg * at );
    DAS_CC_API void for_each_typedef ( Module * mod, const TBlock<void,TTemporary<char *>,TypeDecl *> & block, Context * context, LineInfoArg * at );
    DAS_CC_API void for_each_enumeration ( Module * mod, const TBlock<void,Enumeration *> & block, Context * context, LineInfoArg * at );
    ...
    DAS_CC_API void for_each_variant_macro ( Module * mod, const TBlock<void,VariantMacroPtr> & block, Context * context, LineInfoArg * at );
    ...
    DAS_CC_API bool isSameAstType ( TypeDeclPtr THIS, TypeDeclPtr decl, RefMatters refMatters, ConstMatters constMatters, TemporaryMatters temporaryMatters, Context * context, LineInfoArg * at );
    ...
    DAS_CC_API void builtin_structure_for_each_field ( const BasicStructureAnnotation & ann,
                                        const TBlock<void,char *,char*,TypeDecl *,uint32_t> & block, Context * context, LineInfoArg * at );
    DAS_CC_API TypeInfo * getHandledTypeFieldType ( TypeAnnotationPtr annotation, char * name, Context * context, LineInfoArg * at );
    DAS_CC_API TypeDeclPtr getHandledTypeFieldTypeDecl ( TypeAnnotationPtr annotation, char * name, bool isConst, Context * context, LineInfoArg * at );
    ...
    DAS_CC_API int32_t getVectorLength(void* vec, TypeDecl * type, Context * context, LineInfoArg * at);
    DAS_CC_API bool addModuleRequire ( Module * module, Module * reqModule, bool publ );
    DAS_CC_API void findMatchingVariable ( Program * program, Function * func, const char * _name, bool seePrivate,
        const TBlock<void,TTemporary<TArray<Variable *>>> & block, Context * context, LineInfoArg * arg );
    DAS_CC_API Module * getCurrentSearchModule(Program * program, Function * func, const char * _moduleName);
    DAS_CC_API bool canAccessGlobalVariable ( const VariablePtr & pVar, Module * mod, Module * thisMod );
    DAS_CC_API TypeDeclPtr inferGenericTypeEx ( TypeDecl * type, TypeDecl * passType, bool topLevel, bool isPassType );
    DAS_CC_API void updateAliasMapEx ( smart_ptr_raw<Program> program, TypeDecl * argType, TypeDecl * passType, Context * context, LineInfoArg * at );
    DAS_CC_API void forceAtRaw ( Expression * expr, const LineInfo & at );
    DAS_CC_API void forceAtFunctionRaw ( Function * func, const LineInfo & at );
    DAS_CC_API void forceGeneratedRaw ( Expression * expr, bool setGenerated );
    DAS_CC_API void forceGeneratedFunctionRaw ( Function * func, bool setGenerated );
    DAS_CC_API bool add_structure_alias ( Structure * structure, char * name, const TypeDeclPtr & aliasType, Context * context, LineInfoArg * at );
    DAS_CC_API void for_each_structure_alias ( Structure * structure, const TBlock<void,TypeDecl *> & block, Context * context, LineInfoArg * at );
    DAS_CC_API TypeDeclPtr get_structure_alias ( Structure * structure, const char * aliasName, Context * context, LineInfoArg * at );
    DAS_CC_API Function * findCompilingFunctionByMangledNameHash(char * module_name, uint64_t mnh, Context * context, LineInfoArg * at);
    DAS_CC_API bool isCppKeyword ( const char * str );
    DAS_CC_API bool isDasKeyword ( const char * str );
