...
namespace  das {
    ...
    struct SimPolicy_String {
        ...
        static __forceinline bool Equ     ( char * a, char * b, Context & ) { return strcmp(to_rts(a), to_rts(b))==0; }
        static __forceinline bool NotEqu  ( char * a, char * b, Context & ) { return (bool) strcmp(to_rts(a), to_rts(b)); }
        // basic
