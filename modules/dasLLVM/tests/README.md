...
Files ending in `_client`, `_client_lib`, `_lib`, `_tuner`, or `_root` (a program root a test builds
or runs through a child daslang) are child-process fixtures rather than standalone test cases.
