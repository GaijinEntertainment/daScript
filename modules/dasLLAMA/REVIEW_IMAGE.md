...
**A decline on any sink an image save writes through, wherever that code lives, never fails the
load: warn, and serve what is still whole - the image already built in memory, or the carrier
as loaded.**
