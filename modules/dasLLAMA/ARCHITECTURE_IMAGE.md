...
planes as top-level `Model` fields of the same name (`q51q`, `q51s`). Every walk over the table -
the image writer and the map-back alike - skips a slot whose format is not `kq_sb`, because
