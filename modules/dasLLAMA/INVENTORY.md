...
> family** (ARCHITECTURE §1.5): `dasllama_math_vulkan.das` 316 (entry/facade) ·
...
| **(b2) Q8_0 requant (vulkan intra-file)** | 1134–1164 vs 1805–1834 vs inlined 2196–2224 | ~75–86% identical ×3 — **RESOLVED (class-kernel arc)**: shared free fns `q8_amax3`/`q8_pack4` + the `ActRqMembers`/`rq_cls` family | Delta = `act_mul` vs plain read. |
...
| **(d) kq batch tiles (vulkan intra-file)** | 3160–3277 (k4), 3281–3393 (q40), 3398–3520 (k5), 3526–3658 (k6) | **~91% identical ×4** — **RESOLVED (class-kernel arc)**: `KqBatchBase` + thin `stage_w`/`stage_ws`/`blk_fma` overrides per format | Verbatim 40-line preamble + activation stage + 4×sdot4 block + 20-line store. |
...
| **(f) region-list meta unpack (vulkan)** | 12 copies: 131–142, 240–252, 343–355, 411–425, 619–631, 764–777, 881–892, 1001–1011, 3163–3172, 3284–3293, 3401–3410, 3529–3538 | copy-paste ×12 — **RESOLVED (class-kernel arc)**: `region_rec` base method on the batch families | 10–14 lines each; tile edge E varies. |
| **(g) subgroup partial-sum reduce (vulkan)** | 5 copies: 2092–2107, 2136–2151, 2180–2195, 2247–2261, 2338–2352 | copy-paste ×5 — **RESOLVED (class-kernel arc)**: `RmsWgBase` workgroup-rms methods shared by the ar_*/qk_rms/qkn_rope family | Verbatim in the ar_* / qk_rms / qkn_rope_kv family. |
