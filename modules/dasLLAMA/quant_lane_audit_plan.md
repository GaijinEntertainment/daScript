...
Charter (Boris, 2026-08-04, on the heels of the gemma-26B hunt): audit EVERY weight format x
every kernel lane x both platforms, plug the holes, ONE PR at the end, targeted profiling
...
## Lane x format x backend coverage (CPU)
...
| k4/k5/k6/q40 | mm/4xrows/batch/groupn/batch_groupn/repack | gen | gen | kernels |
