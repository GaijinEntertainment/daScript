...
- `ARCHITECTURE_GPU_VULKAN_NROW.md` - sec.2.2ao-2.2ap: the N-row token command a batched step's rows go through, and the residual step's two forms it holds bit for bit
