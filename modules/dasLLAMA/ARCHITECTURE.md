...
- `ARCHITECTURE_TTS_MEMORY.md` - sec.2.31, 2.51, 2.52: the per-synthesis carrier, the
  generator's six buffers, and the chunk-sized peak with its cap and the idle release.
