...
performance row of the engine this repository builds lands in `../PERF_LEDGER.md`; a number an
instrument here prints is `../REVIEW_MEASUREMENT.md`'s wherever a diff records it, and a
