...
**A CPU timing a diff adds or moves in `tune_kernels.das` outside its `benches` list runs before
`dot_q8q8_laneq4x4`, never after it.** Running that bench pins one matmul backend for the rest of
