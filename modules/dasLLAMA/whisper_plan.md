...
3. mel filters: i32 n_mel, i32 n_fft(=201 bins), then n_melxn_fft f32 - filterbank comes FROM
...
convert activations to f16 (f16xf16 dot, f32 accum). We compute f32 throughout on
