...
`README.md`. A grammar-drift fixture - a test that asserts the tree-sitter grammar
(`tree-sitter-daslang/grammar.js`) parses a pinned set of constructs (`test_grammar_canary.das`) - applies
