# -*- coding: utf-8 -*-
#
# VENDORED from daslang/doc/source/daslang.py — keep the module/role name
# `daslang` so generated RST emitted by daslib/rst (`.. das:function::`) stays
# byte-compatible across daslang and dasImgui. Diff and reconcile annually
# against upstream; do not fork the directive set.
"""
    daslang
    ~~~~~~~~~~~~~~~~~~~~~~~~~
